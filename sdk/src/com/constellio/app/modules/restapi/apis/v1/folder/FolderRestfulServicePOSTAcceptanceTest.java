...
public class FolderRestfulServicePOSTAcceptanceTest extends BaseFolderRestfulServiceAcceptanceTest {
	...
	public void testCreateFolderWithEmptyExtAttributeValues() throws Exception {
		...
		FolderDto folderDto = response.readEntity(FolderDto.class);
		Folder folder = rm.getFolder(folderDto.getId());
		assertThat(folder.<String>get(fakeMetadata1)).isNull();
		assertThat(folder.<List<String>>get(fakeMetadata2)).isEqualTo(emptyList());
	}

	@Test
	public void testCreateFolderWithNullExtAttributeValues() throws Exception {
		addUsrMetadata(MetadataValueType.STRING, "value1", singletonList("value2"));
