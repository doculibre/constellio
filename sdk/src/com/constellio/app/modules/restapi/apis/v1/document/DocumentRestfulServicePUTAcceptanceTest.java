...
public class DocumentRestfulServicePUTAcceptanceTest extends BaseDocumentRestfulServiceAcceptanceTest {
	...
	public void testUpdateFullDocument() throws Exception {
		...
		assertThat(doc.getExtendedAttributes()).extracting("key", "values")
				.containsOnly(tuple(fakeMetadata1, singletonList("value1b")), tuple(fakeMetadata2, emptyList()));
	...
	public void testUpdateDocumentWithEmptyExtAttributeValues() throws Exception {
		...
		Document updatedDocument = rm.getDocument(minDocumentToUpdate.getId());
		assertThat(updatedDocument.<String>get(fakeMetadata1)).isNull();
		assertThat(updatedDocument.<List<String>>get(fakeMetadata2)).isEmpty();
	}

	@Test
	public void testUpdateDocumentWithNullExtAttributeValues() throws Exception {
		addUsrMetadata(MetadataValueType.STRING, "value1", singletonList("value2"));
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithoutItself() throws Exception {
		...
		Response putResponse = sendConsolidateRequest(otherDocumentWithContent.getId(), docUpdate);
		DocumentDto result = putResponse.readEntity(DocumentDto.class);
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithItself() throws Exception {
		Document otherDocumentWithContent = getTestDocumentForConsolidationWithContent();

		String mergeSourceIds = otherDocumentWithContent.getId() + "," + id;

		DocumentDto docUpdate = DocumentDto.builder().id(id).title("aNewTitle").folderId(records.folder_A42).build();
		Response putResponse = sendConsolidateRequest(mergeSourceIds, docUpdate);
		DocumentDto result = putResponse.readEntity(DocumentDto.class);
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithNoDocuments() throws Exception {
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithoutContentWithNoDocuments() throws Exception {
		...
		Response putResponse = sendConsolidateRequest(mergeSourceIds, otherDocument);
		DocumentDto result = putResponse.readEntity(DocumentDto.class);
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithoutContentWithDocument() throws Exception {
		...
		Response putResponse = sendConsolidateRequest(mergeSourceIds, docWithoutContent);
		DocumentDto result = putResponse.readEntity(DocumentDto.class);
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithoutContentWithDocumentWithoutContent() throws Exception {
		Document documentWithoutContent = getTestDocumentForConsolidationWithoutContentForTransaction();
		...
		Response putResponse = sendConsolidateRequest(mergeSourceIds, docWithoutContent);
		RestApiErrorResponse error = putResponse.readEntity(RestApiErrorResponse.class);

		assertThat(putResponse.getStatus()).isEqualTo(Status.BAD_REQUEST.getStatusCode());
		assertThat(error.getMessage()).doesNotContain(OPEN_BRACE).doesNotContain(CLOSE_BRACE)
				.isEqualTo($(new CannotReadContentException(otherDocumentWithoutContent.getId()).getValidationError()));
	}

	@Test
	public void testUpdateAndConsolidateDocumentWithDocumentWithoutContent() throws Exception {
		...
		DocumentDto docWithContent = DocumentDto.builder().id(id).folderId(folderId)
				.title(documentWithoutContent.getTitle()).build();
		Response putResponse = sendConsolidateRequest(mergeSourceIds, docWithContent);
		RestApiErrorResponse error = putResponse.readEntity(RestApiErrorResponse.class);
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithNonExistentId() throws Exception {
		...
		assertThat(putResponse.getStatus()).isEqualTo(Status.NOT_FOUND.getStatusCode());
		assertThat(error.getMessage()).doesNotContain(OPEN_BRACE).doesNotContain(CLOSE_BRACE)
				.isEqualTo($(new RecordNotFoundException(mergeSourceIds).getValidationError()));
	}

	@Test
	public void testUpdateAndConsolidateDocumentWithIdOfWrongSchema() throws Exception {
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithIdsInWrongFormat() throws Exception {
		Document otherDocumentWithContent = getTestDocumentForConsolidationWithContent();
	...
	@Test
	public void testUpdateFileAndConsolidateDocument() throws Exception {
		Document otherDocumentWithContent = getTestDocumentForConsolidationWithContent();

		DocumentDto docUpdate = DocumentDto.builder().id(id).title("aNewTitle").folderId(records.folder_A42).build();
		Response putResponse = buildPutQuery().request().header("host", host)
				.header(CustomHttpHeaders.MERGE_SOURCE, otherDocumentWithContent.getId())
				.build("PUT", entity(buildMultiPart(docUpdate, fileToUpdate), MULTIPART_FORM_DATA_TYPE)).invoke();
		RestApiErrorResponse error = putResponse.readEntity(RestApiErrorResponse.class);
	...
	@Test
	public void testUpdateContentAndConsolidateDocument() throws Exception {
		Document otherDocumentWithContent = getTestDocumentForConsolidationWithContent();
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithoutDocumentAccess() throws Exception {
		Document otherDocumentWithContent = getTestDocumentForConsolidationWithContent();
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithLogicallyDeletedDocument() throws Exception {
		Document documentWithContent = getTestDocumentForConsolidationWithContentForTransaction();
		Document deletedDocumentWithContent = getTestDocumentForConsolidationWithoutContentForTransaction();
	...
	@Test
	public void testUpdateAndConsolidateDocumentWithPhysicallyDeletedDocument() throws Exception {
		Document documentWithContent = getTestDocumentForConsolidationWithContentForTransaction();
		Document deletedDocumentWithContent = getTestDocumentForConsolidationWithoutContentForTransaction();
		recordServices.execute(new Transaction(documentWithContent, deletedDocumentWithContent));
		recordServices.logicallyDelete(deletedDocumentWithContent, User.GOD);
	...
	@Test
	public void testUpdateAndConsolidateDocumentUnsupportedContentMediaType() throws Exception {
		Document documentWithContent = getTestDocumentForConsolidationWithContentForTransaction();

		String xmlTestFileName = "javaClassTestFile.java";
		...
		DocumentDto docUpdate = DocumentDto.builder().id(id).title("aNewTitle").folderId(records.folder_A42).build();
		Response putResponse = sendConsolidateRequest(documentWithUnsupportedContentMediaType.getId(), docUpdate);
		RestApiErrorResponse error = putResponse.readEntity(RestApiErrorResponse.class);
	...
	private Response sendConsolidateRequest(String mergeSourceIds, DocumentDto docUpdate)
			throws Exception {
		return buildPutQuery().request().header("host", host)
				.header(CustomHttpHeaders.MERGE_SOURCE, mergeSourceIds)
				.put(entity(buildMultiPart(docUpdate), MULTIPART_FORM_DATA_TYPE));
	}
