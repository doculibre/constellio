...
public class FolderRestfulServicePUTAcceptanceTest extends BaseFolderRestfulServiceAcceptanceTest {
	...
	public void testUpdateFolderWithEmptyExtAttributeValues() throws Exception {
		...
		Folder folder = rm.getFolder(minFolderToUpdate.getId());
		assertThat(folder.<String>get(fakeMetadata1)).isNull();
		assertThat(folder.<List<String>>get(fakeMetadata2)).isEmpty();
	}

	@Test
	public void testUpdateFolderWithNullExtAttributeValues() throws Exception {
		addUsrMetadata(MetadataValueType.STRING, "value1", singletonList("value2"));
