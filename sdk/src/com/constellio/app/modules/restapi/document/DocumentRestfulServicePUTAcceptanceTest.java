...
public class DocumentRestfulServicePUTAcceptanceTest extends BaseDocumentRestfulServiceAcceptanceTest {
    ...
    private Response doPutQuery(String flushMode, DocumentDto document, File file, String ... excludedParam) throws Exception {
        return doPutQuery(document, file, flushMode, null, true, excludedParam);
    }

    private Response doPutQuery(Set<String> filters, DocumentDto document, File file, String ... excludedParam) throws Exception {
        return doPutQuery(document, file, null, filters, true, excludedParam);
    }

    private Response doPutQuery(DocumentDto document, File file, boolean calculateSignature, String ... excludedParam) throws Exception {
        return doPutQuery(document, file, null, null, calculateSignature, excludedParam);
    }

    private Response doPutQuery(DocumentDto document, File file, String flushMode, Set<String> filters, boolean calculateSignature, String ... excludedParam) throws Exception {
