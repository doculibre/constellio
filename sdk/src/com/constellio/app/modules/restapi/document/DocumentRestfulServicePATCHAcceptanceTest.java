...
public class DocumentRestfulServicePATCHAcceptanceTest extends BaseDocumentRestfulServiceAcceptanceTest {
    ...
    public void testPartialUpdateDocumentWithStartDateOnly() throws Exception {
        ...
        Record record = recordServices.getDocumentById(doc.getId());
        List<Authorization> authorizations = filterInheritedAuthorizations(authorizationsServices.getRecordAuthorizations(record), record.getId());
        assertThat(authorizations).extracting("detail.startDate").containsOnly(toLocalDate(documentToPartialUpdate.getDirectAces().get(0).getStartDate()));
    ...
    private Response doPatchQuery(String flushMode, DocumentDto document, File file, String ... excludedParam) throws Exception {
        return doPatchQuery(document, file, flushMode, null, true, excludedParam);
    }

    private Response doPatchQuery(Set<String> filters, DocumentDto document, File file, String ... excludedParam) throws Exception {
        return doPatchQuery(document, file, null, filters, true, excludedParam);
    }

    private Response doPatchQuery(DocumentDto document, File file, boolean calculateSignature, String ... excludedParam) throws Exception {
        return doPatchQuery(document, file, null, null, calculateSignature, excludedParam);
    }

    private Response doPatchQuery(DocumentDto document, File file, String flushMode, Set<String> filters, boolean calculateSignature, String ... excludedParam) throws Exception {
