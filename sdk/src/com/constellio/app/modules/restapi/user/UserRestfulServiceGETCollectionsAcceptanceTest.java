...
public class UserRestfulServiceGETCollectionsAcceptanceTest extends BaseRestfulServiceAcceptanceTest {

	@Before
	public void setUp() throws Exception {
		setUpTest();

		webTarget = newWebTarget("v1/user/credentials/collections", new ObjectMapper());
	...
	public void validateService() {
		...
		UsersByCollectionDto usersByCollectionDto = response.readEntity(UsersByCollectionDto.class);
		assertThat(usersByCollectionDto.getUsersByCollection()).isNotEmpty();
	}
