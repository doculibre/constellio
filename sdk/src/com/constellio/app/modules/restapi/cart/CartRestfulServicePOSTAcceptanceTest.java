...
public class CartRestfulServicePOSTAcceptanceTest extends BaseRestfulServiceAcceptanceTest {
	...
	public void validateService() {
		...
		CartDto cartDtoDto = response.readEntity(CartDto.class);
		assertThat(cartDtoDto.getId()).isNotNull().isNotEmpty();
		assertThat(cartDtoDto.getOwner()).isEqualTo(users.bobIn(zeCollection).getId());
		assertThat(cartDtoDto.getTitle()).isEqualTo(cartToAdd.getTitle());

		Cart cart = rm.getCart(cartDtoDto.getId());
		assertThat(cart).isNotNull();
		assertThat(cart.getId()).isEqualTo(cartDtoDto.getId());
		assertThat(cart.getOwner()).isEqualTo(cartDtoDto.getOwner());
		assertThat(cart.getTitle()).isEqualTo(cartDtoDto.getTitle());
	}
