...
//
//		presenter = new RecordWithCopyRetentionRuleParametersPresenter()
//
//	}
//
//	@Test
...
//
//		Folder folderInW_rule1 = transaction.add(rm.newFolder().setAdministrativeUnitEntered(records.unitId_10a).setTitle("1")
//				.setCategoryEntered("w").setRetentionRuleEntered(rule1));
//		Folder folderInW100_rule2 = transaction.add(rm.newFolder().setAdministrativeUnitEntered(records.unitId_10a).setTitle("2")
//				.setCategoryEntered("w100").setRetentionRuleEntered(rule2));
//		Folder folderInW110 = transaction.add(rm.newFolder().setAdministrativeUnitEntered(records.unitId_10a).setTitle("3")
//				.setCategoryEntered("w110").setRetentionRuleEntered(rule6));
//
//		recordServices.execute(transaction);
//
//		//Validate documents in folder
//		when(fields.getType()).thenReturn(type1);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_1_C);
//
//		when(fields.getType()).thenReturn(type2);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_2_C);
//
//		when(fields.getType()).thenReturn(type3);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_3_C);
//
//		when(fields.getType()).thenReturn(type4);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_4_C);
//
...
//		when(fields.getType()).thenReturn(type1);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_8_C);
//
//		when(fields.getType()).thenReturn(type2);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_2_C);
...
//		when(fields.getType()).thenReturn(type3);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_10_C);
//
//		when(fields.getType()).thenReturn(type4);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_9_C);
//
//		when(fields.getType()).thenReturn(null);
//		when(fields.getSchemaType()).thenReturn(SCHEMA_TYPE);
//		assertThat(presenter.getOptions(folderInW_rule1.getId())).containsOnly(principal888_4_C);
