...
public class FolderValidatorAcceptanceTest extends ConstellioTest {
	...
	public void testSmallerOpeningDateThanEndingDateThenThrowException()
	...
	@Test
	public void testGreaterOpingDateThanEndingDateThenOk()
		...
		Record record = searchServices
				.searchSingleResult(from(rm.folder.schemaType()).where(Schemas.IDENTIFIER).isEqualTo(FOLDER_ID));
