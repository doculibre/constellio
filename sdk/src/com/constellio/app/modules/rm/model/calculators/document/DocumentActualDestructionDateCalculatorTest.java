 ...
 */
public class DocumentActualDestructionDateCalculatorTest extends ConstellioTest {

	@Mock CalculatorParameters parameters;
	DocumentActualDestructionDateCalculator calculator;
	LocalDate localDate = TimeProvider.getLocalDate();

	@Before
	public void setUp()
			throws Exception {
		calculator = new DocumentActualDestructionDateCalculator();
	...
	public void givenParamRetentionRuleIdWhenCalculateThenReturnParam()
			throws Exception {
		when(parameters.get(calculator.folderActualDestructionDateParam)).thenReturn(localDate);
