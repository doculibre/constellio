 ...
 */
public class DocumentExpectedDepositDateCalculatorTest extends ConstellioTest {

	@Mock CalculatorParameters parameters;
	DocumentExpectedDepositDateCalculator calculator;
	LocalDate localDate = TimeProvider.getLocalDate();

	@Before
	public void setUp()
			throws Exception {
		calculator = new DocumentExpectedDepositDateCalculator();
	...
	public void givenParamRetentionRuleIdWhenCalculateThenReturnParam()
		...
		when(parameters.get(calculator.folderExpectedDepositDateParam)).thenReturn(localDate);
