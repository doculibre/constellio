...
public class RMSchemasDeleteAcceptTest extends ConstellioTest {
	...
	public void givenUnusedAdministrativeUnitThenDeletable()
		...
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit10().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit10a().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit11().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit11b().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit12().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit12b().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(recordServices.validateLogicallyDeletable(records.getUnit12c().getWrappedRecord(), admin).isEmpty()).isTrue();

		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit20().getWrappedRecord(), admin))).isEqualTo(referencedRecordErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit30c().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(records.getUnit30().getWrappedRecord(), admin))).isEqualTo(referencedAndContainsRecordsErrorMessage);
		...
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit10().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit10a().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit11().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit11b().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit12().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit12b().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		...
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit20().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit30c().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyThenPhysicallyDeletable(records.getUnit30().getWrappedRecord(), admin))).isEqualTo(usedInConfigsError);
	...
	public void whenLogicallyDeletingVariableRetentionPeriodThenOnlyPossibleIfNotUsedAndNot888And999()
		...
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(period888.getWrappedRecord(), admin))).isEqualTo(cannotDeleteVariableRetentionPeriodError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(period999.getWrappedRecord(), admin))).isEqualTo(cannotDeleteVariableRetentionPeriodError);
		...
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(period42.getWrappedRecord(), admin))).isEqualTo(variableRetentionRuleUserInRetentionRuleError);
		assertThat(MessageUtils.getCannotDeleteWindow(recordServices.validateLogicallyDeletable(period666.getWrappedRecord(), admin))).isEqualTo(variableRetentionRuleUserInRetentionRuleError);
