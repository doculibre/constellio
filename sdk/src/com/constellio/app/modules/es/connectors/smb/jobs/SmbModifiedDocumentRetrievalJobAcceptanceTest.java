...
public class SmbModifiedDocumentRetrievalJobAcceptanceTest extends ConstellioTest {
	...
	private SmbModifiedDocumentRetrievalJob retrievalJob;
	...
	public void givenFullDTOWhenExecutingThenSendFullDocumentToObserver()
		...
		retrievalJob = new SmbModifiedDocumentRetrievalJob(connector, FILE_URL, smbService, eventObserver, smbRecordService, updater, "", jobFactory);
