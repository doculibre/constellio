...
public class ReportsRecordsAcceptTest extends ConstellioTest {
	...
	public void testConvertConteneurWithIdentifierToXML()
		...
		String contenuSeul = ru.convertContainerWithIdentifierToXML(
				...
				new ReportField(rm.containerRecord.title().getType(), rm.containerRecord.title().getLabel(i18n.getLanguage()),
						ContainerRecord.SCHEMA_TYPE, rm.containerRecord.title().getCode(), getAppLayerFactory()),
				new ReportField(rm.containerRecord.capacity().getType(),
						rm.containerRecord.storageSpace().getLabel(i18n.getLanguage()), ContainerRecord.SCHEMA_TYPE,
						rm.containerRecord.storageSpace().getCode(), getAppLayerFactory()));
		...
		String conteneurWithMultipleIds = ru
				.convertContainerWithIdentifierToXML(asList(records.containerId_bac05, records.containerId_bac07),
						...
						new ReportField(rm.containerRecord.capacity().getType(), rm.containerRecord.capacity().getLocalCode(),
								ContainerRecord.SCHEMA_TYPE, rm.containerRecord.capacity().getCode(), getAppLayerFactory()));
