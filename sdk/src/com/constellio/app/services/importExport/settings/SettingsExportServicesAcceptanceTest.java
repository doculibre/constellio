...
public class SettingsExportServicesAcceptanceTest extends ConstellioTest {
	...
	public void whenExportingThenGlobalConfigsAreOK()
		...
		assertThat(settings.getConfigs()).extracting("key").contains("userTitlePattern", "userRolesInAuthorizations", "logoLink", "metadataPopulatePriority", "titleMetadataPopulatePriority", "constellioUrl", "dateFormat", "dateTimeFormat", "parsedContentMaxLengthInKilooctets", "contentMaxLengthForParsingInMegaoctets", "cleanDuringInstall", "inUpdateProcess", "batchProcessingMode", "trashPurgeDelaiInDays", "defaultTaxonomy", "sortType", "maxSelectableSearchResults", "writeZZRecordsInTlog", "cmisNeverReturnACL", "icapScanActivated", "icapResponseTimeout", "ckeditorToolbarConfig", "documentRetentionRules", "enforceCategoryAndRuleRelationshipInFolder", "calculatedCloseDate", "calculatedCloseDateNumberOfYearWhenFixedRule", "calculatedCloseDateNumberOfYearWhenVariableRule", "calculatedSemiActiveDateNumberOfYearWhenOpenRule", "calculatedInactiveDateNumberOfYearWhenOpenRule", "decommissioningDateBasedOn", "yearEndDate", "closeDateRequiredDaysBeforeYearEnd", "deleteFolderRecordsWithDestruction", "deleteDocumentRecordsWithDestruction", "copyRuleTypeAlwaysModifiable", "copyRulePrincipalRequired", "minorVersionsPurgedOn", "alsoPurgeCurrentVersionIfMinor", "PDFACreatedOn", "requireApprovalForClosing", "requireApprovalForTransfer", "requireApprovalForDepositOfActive", "requireApprovalForDepositOfSemiActive", "requireApprovalForDestructionOfActive", "requireApprovalForDestructionOfSemiActive", "linkableCategoryMustNotBeRoot", "linkableCategoryMustHaveApprovedRules", "containerRecyclingAllowed", "mixedContainersAllowed", "activesInContainerAllowed", "displaySemiActiveInTrees", "displayDepositedInTrees", "displayDestroyedInTrees", "displayContainersInTrees", "enabled", "switchUserPossible", "downloadAllUserContent", "editUserDocuments", "backupRetentionPeriodInDays", "tokenDurationInHours", "readOnlyWarning", "borrowingDurationDays", "openHolder", "documentsTypeChoice", "workflowsEnabled", "allowModificationOfArchivisticStatusAndExpectedDates", "calculatedMetadatasBasedOnFirstTimerangePart", "defaultTabInFolderDisplay");
	}
