...
public class SystemSetupServicesUnitTest extends ConstellioTest {
	...
	public void givenCollectionWithModulesThenInstallAllRequiredModulesThenEnableModulesInCollections()
		...
		verify(constellioModulesManager).installValidModuleAndGetInvalidOnes(constellioModule1, collectionsListManager);
		verify(constellioModulesManager).installValidModuleAndGetInvalidOnes(constellioModule3, collectionsListManager);

		verify(constellioModulesManager).enableValidModuleAndGetInvalidOnes("collection1", constellioModule1);
		verify(constellioModulesManager).enableValidModuleAndGetInvalidOnes("collection1", constellioModule2);
		verify(constellioModulesManager).enableValidModuleAndGetInvalidOnes("collection2", constellioModule2);
		verify(constellioModulesManager).enableValidModuleAndGetInvalidOnes("collection2", constellioModule3);
		verify(systemSetupService).addAdminToTheNewCollection("collection1");
		verify(systemSetupService).addAdminToTheNewCollection("collection2");
	}
}
