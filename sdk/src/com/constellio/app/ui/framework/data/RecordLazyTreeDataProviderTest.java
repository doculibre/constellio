...
public class RecordLazyTreeDataProviderTest extends ConstellioTest {
	...
	RecordLazyTreeDataProvider dataProvider;

	@Before
	public void setUp()
			throws Exception {
		when(treeNodesDataProvider.getTaxonomyCode()).thenReturn(zeTaxonomy);
		dataProvider = spy(new RecordLazyTreeDataProvider(treeNodesDataProvider));
	...
	public void given19ResultsWhenGetChildConceptsThenAllInformationsAvailableForFurtherCalls()
		...
		when(treeNodesDataProvider.getChildrenNodes("parent1", 0, 20)).thenReturn(parent1ChildrenResponse);

		LinkableTaxonomySearchResponse parent2ChildrenResponse = new LinkableTaxonomySearchResponse(21, testRecords(30, 50));
		when(treeNodesDataProvider.getChildrenNodes("parent2", 0, 20)).thenReturn(parent2ChildrenResponse);
		...
		verify(treeNodesDataProvider).getRootNodes(0, 20);
		verify(treeNodesDataProvider).getChildrenNodes("parent1", 0, 20);
		verify(treeNodesDataProvider).getChildrenNodes("parent2", 0, 20);
		verifyNoMoreInteractions(treeNodesDataProvider);
	...
	public void givenExpandedRootNodesThenMaximumUpdated()
		...
		when(treeNodesDataProvider.getRootNodes(0, 20)).thenReturn(nodeResponse1);

		LinkableTaxonomySearchResponse nodeResponse2 = new LinkableTaxonomySearchResponse(27, testRecords(20, 27));
		when(treeNodesDataProvider.getRootNodes(20, 27)).thenReturn(nodeResponse2);
	...
	public void givenExpandedChildNodesThenMaximumUpdated()
		...
		when(treeNodesDataProvider.getChildrenNodes("parent1", 0, 20)).thenReturn(parent1ChildrenResponse1);

		LinkableTaxonomySearchResponse parent1ChildrenResponse2 = new LinkableTaxonomySearchResponse(45, testRecords(20, 40));
		when(treeNodesDataProvider.getChildrenNodes("parent1", 20, 40)).thenReturn(parent1ChildrenResponse2);

		LinkableTaxonomySearchResponse parent1ChildrenResponse3 = new LinkableTaxonomySearchResponse(46, testRecords(40, 46));
		when(treeNodesDataProvider.getChildrenNodes("parent1", 40, 60)).thenReturn(parent1ChildrenResponse3);
	...
	@Test
	public void givenRecordInTreeThenValidLeafStatus()
			throws Exception {
