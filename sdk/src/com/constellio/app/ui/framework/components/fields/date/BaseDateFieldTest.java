...
public class BaseDateFieldTest {
	...
	@Test
	public void givenDateStringWithoutAnySeparatorAsInTheConfiguredFormatThenStringParsedAndCorrectDateIsReturned()
			throws Exception {
		assertThat(BaseDateField.handleUnparsableDateString("20051214", DATE_FORMAT)).isEqualTo(DOCULIBRE_BIRTHDATE);
	}

	@Test
	public void givenDateStringInTheConfiguredFormatButInReverseOrderThenStringParsedAndCorrectDateIsReturned()
			throws Exception {
		assertThat(BaseDateField.handleUnparsableDateString("14-12-2005", DATE_FORMAT)).isEqualTo(DOCULIBRE_BIRTHDATE);
	}

	@Test
	public void givenDateStringWithoutAnySeparatorAsInTheConfiguredFormatButInReverseOrderThenStringParsedAndCorrectDateIsReturned()
			throws Exception {
		assertThat(BaseDateField.handleUnparsableDateString("14122005", DATE_FORMAT)).isEqualTo(DOCULIBRE_BIRTHDATE);
	}

	@Test
	public void givenDateStringInTheConfiguredFormatButInReverseOrderAndWithDifferentSeparatorThenStringParsedAndCorrectDateIsReturned()
			throws Exception {
		assertThat(BaseDateField.handleUnparsableDateString("14.12/2005", DATE_FORMAT)).isEqualTo(DOCULIBRE_BIRTHDATE);
	}
