...
@UiTest
public class CollectionGroupRolesViewAcceptTest extends ConstellioTest {
	...
	public void setUp()
		...
		page = new CollectionGroupRolesPage(driver).navigateToPage(group);
	}

	@Test
	public void givenRolesAddedAndRemovedThenAddAndRemoveTheRoles() {
		assertThat(page.getTitle()).contains(group.getTitle());
