...
public class ReadConstellioLanguageTableMain extends ConstellioLanguageTableIO {
	...
	private static Map<String, String> flattenMapWithFilter(Map<String, Map<String, String>> twoDimensionMap,
															String keyNameFilter) {
	 ...
	 */
	private Map<String, Map<String, String>> addIconsFromFrenchPropertyFiles(
			Map<String, Map<String, String>> valuesInArabicWithoutIcons,
			Map<String, Map<String, String>> valuesInFrenchWithoutIcons) {
	 ...
	 * @throws IOException
	 */
	private Map<String, Map<String, String>> getExcelFileInfos(File file, int columnIndexReadToKey,
															   int columnIndexReadToValue) throws IOException {
	 ...
	 */
	private Map<String, String> getExcelSheetInfos(Sheet currentSheet, int columnIndexReadToKey,
												   int columnIndexReadToValue) {
