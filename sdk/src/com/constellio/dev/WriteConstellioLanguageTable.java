...
public class WriteConstellioLanguageTable extends ConstellioLanguageTableIO implements ReportWriter {

    private ReportModelImpl model;
    private WritableWorkbook workbook;

    public WriteConstellioLanguageTable(String minVersion, boolean isWriteMode) throws IOException {
    ...
    private static void writeLanguageFile() throws IOException {
        WriteConstellioLanguageTable convertConstellioLanguageTable = new WriteConstellioLanguageTable("7_6_3", true);
