...
public class LogicalOrMetadaAggregationHandlerAcceptanceTest extends ConstellioTest {
	...
	public void setUp() throws Exception {
		...
		defineSchemasManager().using(schemas.with(new MetadataSchemaTypesConfigurator() {
			...
			public void configure(MetadataSchemaTypesBuilder schemaTypes) {
				...
				zeType.createMetadata("boolean").defineDataEntry().asAggregatedOr(metadatasByRefMetadata);
			}
		}));
	...
	@Test
	public void givenAnotherSchemaIsFalseAndThirdSchemaIsTrueThenZeSchemaIsTrue() throws Exception {
		Transaction transaction = new Transaction();
		...
		assertThat(recordServices.getDocumentById("zeSchema1").<Boolean>get(zeSchema.metadata("boolean"))).isTrue();
	}

	@Test
	public void givenAnotherSchemaIsTrueAndThirdSchemaIsFalseThenZeSchemaIsTrue() throws Exception {
		Transaction transaction = new Transaction();
	...
	@Test
	public void givenAnotherSchemaIsFalseAndThirdSchemaIsFalseThenZeSchemaIsFalse() throws Exception {
		Transaction transaction = new Transaction();
		transaction.add(recordServices.getDocumentById("anotherSchema1").set(anotherSchema.metadata("boolean"), false));
		transaction.add(recordServices.getDocumentById("thirdSchema1").set(thirdSchema.metadata("boolean"), false));
		recordServices.execute(transaction);
	...
	@Test
	public void givenAnotherSchemaIsTrueAndAnotherSchemaIsFalseAndThirdSchemaIsFalseThenZeSchemaIsTrue()
			throws Exception {
		Transaction transaction = new Transaction();
		transaction.add(recordServices.getDocumentById("anotherSchema1").set(anotherSchema.metadata("boolean"), true));
