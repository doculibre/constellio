...
*/
package com.constellio.model.services.records.validators.extensions;

import static com.constellio.app.modules.rm.extensions.imports.RetentionRuleImportExtension.*;
...
public class RetentionRuleExtensionAcceptanceTest extends ConstellioTest {
	...
	public void givenRetentionRuleThenInvalidIdValueOnDocumentType() {
		...
		retentionRuleExtension.validate(importErrors, importData);
	...
	public void givenRetentionRuleThenInvalidCopyTypeOnCopyRetentionRule() {
		...
		retentionRuleExtension.prevalidate(importErrors, importData);
	...
	@Test
	public void givenALargeAmountOfScrapDataThenAFullStackOfError() {
		ValidationErrors validationErrors = new ValidationErrors();
		ImportDataErrors importErrors = new ImportDataErrors("retentionRule", validationErrors, importData);
		...
		assertThat(errors).hasSameSizeAs(expectedErrors);

		assertThat(errors).containsAll(expectedErrors);
	}

	@Test
	public void givenEmptyMetadatasThenInvalidStringValueError() {
		ValidationErrors validationErrors = new ValidationErrors();
		ImportDataErrors importErrors = new ImportDataErrors("retentionRule", validationErrors, importData);
		...
		List<ValidationError> errors = validationErrors.getValidationErrors();
		List<ValidationError> expectedErrors = errorsOnEmptyMetadata();
	...
	private List<ValidationError> errorsOnEmptyMetadata() {
		...
		expected.add(newValidationError(REQUIRED_VALUE,
				values));
