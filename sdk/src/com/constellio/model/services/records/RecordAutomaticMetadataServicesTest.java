...
public class RecordAutomaticMetadataServicesTest extends ConstellioTest {
	...
	//				.updateAutomaticMetadata(any(TransactionExecutionRecordContext.class), any(RecordImpl.class), any(RecordProvider.class),
	//						any(Metadata.class),
	...
	//				.updateAutomaticMetadata(any(TransactionExecutionRecordContext.class), eq(record), eq(recordProvider),
	...
	//
	//		services.updateAutomaticMetadata(recordContext, record, recordProvider, metadata, reindexedMetadata, schemas.getTypes(),
	//				zeTransaction);
	//
	...
	//		doNothing().when(services).setCalculatedValuesInRecords(eq(recordContext), eq(record), eq(metadata), eq(recordProvider), eq(
	...
	//
	//		verify(services)
	//				.setCalculatedValuesInRecords(recordContext, record, metadata, recordProvider, reindexedMetadata, schemas.getTypes(),
	//						zeTransaction);
	//
	//	}
	//
