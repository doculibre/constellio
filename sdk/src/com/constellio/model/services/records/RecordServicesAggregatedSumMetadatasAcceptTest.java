...
public class RecordServicesAggregatedSumMetadatasAcceptTest extends ConstellioTest {
	...
	public void setUp() throws Exception {
		...
		assertThat(rm.getDocument("fakeDocument").get(rm.document.metadata("number"))).isEqualTo(10.0);
		assertThat(rm.getFolder("fakeFolder").get(rm.folder.metadata("sum"))).isEqualTo(10.0);

		assertThat(rm.getDocument("fakeDocument2").get(rm.document.metadata("number"))).isEqualTo(100.0);
		assertThat(rm.getFolder("fakeFolder2").get(rm.folder.metadata("sum"))).isEqualTo(100.0);
	}
	...
	public void givenModifiedDocumentNumberThenIncrementFolderSum() throws Exception {
		...
		document.set(rm.document.metadata("number"), 5.0);
		recordServices.update(document.getWrappedRecord());
		waitForBatchProcess();

		assertThat(rm.getDocument("fakeDocument").get(rm.document.metadata("number"))).isEqualTo(5.0);
	...
	public void givenModifiedDocumentNumberAndModifiedFolderThenIncrementFolderSum() throws Exception {
		...
		assertThat(rm.getFolder("fakeFolder").get(rm.folder.metadata("sum"))).isEqualTo(65.0);
	}
	...
	public void givenMultipleModifiedDocumentNumberThenIncrementMultipleFolderSum() throws Exception {
		...
		assertThat(rm.getFolder("fakeFolder").get(rm.folder.metadata("sum"))).isEqualTo(30.0);

		assertThat(rm.getDocument("fakeDocument2").get(rm.document.metadata("number"))).isEqualTo(50.0);
		assertThat(rm.getFolder("fakeFolder2").get(rm.folder.metadata("sum"))).isEqualTo(150.0);
	}
	...
	public void givenTwoModifiedDocumentNumberAndOneFolderSumThenIncrementFolderSumTwice() throws Exception {
		...
		assertThat(rm.getDocument("fakeDocument2b").get(rm.document.metadata("number"))).isEqualTo(5.0);
		assertThat(rm.getFolder("fakeFolder2").get(rm.folder.metadata("sum"))).isEqualTo(105.0);
		...
		assertThat(rm.getFolder("fakeFolder2").get(rm.folder.metadata("sum"))).isEqualTo(185.0);
	}
	...
	public void givenModifiedDocumentNumberAndMultipleSchemaTypeSumThenIncrementAllSchemaTypeSum() throws Exception {
		...
		assertThat(rm.getDocument("fakeDocument").get(rm.document.metadata("number"))).isEqualTo(5.0);
		assertThat(rm.getFolder("fakeFolder").get(rm.folder.metadata("sum"))).isEqualTo(15.0);
		assertThat(rm.getRMTask("fakeTask").get(taskSum)).isEqualTo(15.0);
	}
	...
	public void givenCreatedDocumentAndCreatedFolderThenCorrectSum() throws Exception {
		...
		assertThat(rm.getDocument("fakeDocument4").get(rm.document.metadata("number"))).isEqualTo(3.0);
		assertThat(rm.getFolder("fakeFolder4").get(rm.folder.metadata("sum"))).isEqualTo(3.0);
	}
	...
	private void createTaskSumMetadata() {
		getModelLayerFactory().getMetadataSchemasManager().modify(zeCollection, new MetadataSchemaTypesAlteration() {
			@Override
			public void alter(MetadataSchemaTypesBuilder types) {
