...
public class RecordDeleteServicesAcceptanceTest extends ConstellioTest {
	...
	private void createCustomFolderSchema() {
		getModelLayerFactory()
			...
			public void alter(MetadataSchemaTypesBuilder types) {
				...
				defaultSchema.create(CUSTOM_VALUELIST_NEW_METADATA).setType(MetadataValueType.STRING);
	...
	public void givenReferencedMetadataWhenLogicallyThenPhysicallyDeletedThenError()
		...
		assertThat(deleteService.validateLogicallyThenPhysicallyDeletable(valueTest, users.adminIn(zeCollection)).isEmpty()).isFalse();
