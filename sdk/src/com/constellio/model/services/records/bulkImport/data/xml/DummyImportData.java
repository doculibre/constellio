...
public class DummyImportData {
	...
	public DummyImportData setSchema(String schema) {
		this.schema = schema;
		return this;
	}

	public DummyImportData setId(String id) {
		this.id = id;
		return this;
	}

	public DummyImportData addField(String key, Object value) {
