...
public class TaxonomiesSearchServices_VisibleTreesWithoutChildrenDetectionAndLoadedHasChildrenCacheAcceptTest extends ConstellioTest {
		...
		getDataLayerFactory().getExtensions().getSystemWideExtensions().bigVaultServerExtension
				.add(new BigVaultServerExtension() {
					...
					public void afterQuery(AfterQueryParams params) {
						...
						if (stacktrace.contains(TaxonomiesSearchServices_VisibleTreesWithoutChildrenDetectionAndLoadedHasChildrenCacheAcceptTest.class.getSimpleName())) {
