...
public class IsTrueOrNullCriterionTest extends ConstellioTest {
	@Mock Metadata textMetadata;
	@Mock Metadata booleanMetadata;
	private IsTrueOrNullCriterion criterion;
	...
	public void setUp() {
		...
		criterion = new IsTrueOrNullCriterion();
	}
	...
	public void givenBooleanMetadataWhenGetSolrQueryThenValidSolrQuery() {
		String expectedQuery = "enabled_s:__TRUE__ OR enabled_s:__NULL__";
