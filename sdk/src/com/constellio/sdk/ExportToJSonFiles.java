...
public class ExportToJSonFiles {
	...
	protected void exportDocuments(final File outputDir, final SearchServices searchServices,
								   final MetadataSchemaTypes types, final LogicalSearchQuery query)
	...
	private Map<String, String> getContentMetadata(Content content, ContentVersion contentVersion, File versionFile,
												   int versionIdx) {
