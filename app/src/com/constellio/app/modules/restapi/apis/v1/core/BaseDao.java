...
import static com.constellio.app.modules.restapi.RestApiConfigs.REST_API_DATE_FORMAT;
...
public abstract class BaseDao {
	...
	public static final String DEFAULT_REST_DATE_FORMAT = "yyyy-MM-dd";
	public static final String DEFAULT_REST_DATETIME_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSZZZ";
	...
	public String getDateFormat() {
		String format = systemConfigurationsManager.getValue(REST_API_DATE_FORMAT);
		return format == null ? DEFAULT_REST_DATE_FORMAT : format;
	}

	public String getDateTimeFormat() {
		String format = systemConfigurationsManager.getValue(RestApiConfigs.REST_API_DATETIME_FORMAT);
		return format == null ? DEFAULT_REST_DATETIME_FORMAT : format;
	}
