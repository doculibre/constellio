package com.constellio.app.modules.restapi.apis.v1.taxonomy.dao;
...
public class TaxonomyDao extends BaseDao {
	...
	public List<TaxonomySearchRecord> getTaxonomyNodes(Taxonomy taxonomy, Record parent, User user,
		...
		return getTaxonomyNodes(taxonomy, parent, user, schemaType, rowsStart, rowsLimit, requireWriteAccess, false);
	}

	public List<TaxonomySearchRecord> getTaxonomyNodes(Taxonomy taxonomy, Record parent, User user,
													   MetadataSchemaType schemaType, Integer rowsStart,
													   Integer rowsLimit, Boolean requireWriteAccess,
													   boolean forceLinkableCalculation) {
		...
		options.setForceLinkableCalculation(forceLinkableCalculation);
