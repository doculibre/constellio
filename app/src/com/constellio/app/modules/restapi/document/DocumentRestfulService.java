...
public class DocumentRestfulService {
    ...
    public Response getContent(@Parameter(required=true, description="Document Id") @QueryParam("id") String id,
        ...
        if (version == null) throw new RequiredParameterException("version");
    ...
    @ApiResponses(value={
            ...
            @ApiResponse(responseCode="403", description="Forbidden", content=@Content(mediaType="application/json", schema=@Schema(ref="Error"))),
            @ApiResponse(responseCode="404", description="Not Found", content=@Content(mediaType="application/json", schema=@Schema(ref="Error")))})
    public Response create(@Parameter(required=true, description="Folder Id") @QueryParam("folderId") String folderId,
                           @Parameter(required=true, description="Service Key") @QueryParam("serviceKey") String serviceKey,
        ...
        if (document == null) throw new RequiredParameterException("document");

        validateFlushValue(flush);
        validateFilterValues(filters);

        if (!method.equals(HttpMethods.POST)) throw new InvalidParameterException("method", method);

        if (document.getFolderId() == null) throw new RequiredParameterException("document.folderId");
        if (!document.getFolderId().equals(folderId)) throw new ParametersMustMatchException("folderId", "document.folderId");
        if (Strings.isNullOrEmpty(document.getTitle())) throw new RequiredParameterException("document.title");
    ...
    public Response update(@Parameter(required=true, description="Document Id") @QueryParam("id") String id,
        ...
        if (!method.equals(HttpMethods.PUT)) throw new InvalidParameterException("method", method);

        if (!id.equals(document.getId())) throw new ParametersMustMatchException("id", "document.id");
        if (Strings.isNullOrEmpty(document.getTitle())) throw new RequiredParameterException("document.title");
        if (Strings.isNullOrEmpty(document.getFolderId())) throw new RequiredParameterException("document.folderId");
    ...
    public Response updatePartial(@Parameter(required=true, description="Document Id") @QueryParam("id") String id,
        ...
        if (!method.equals(HttpMethods.PATCH)) throw new InvalidParameterException("method", method);
    ...
    public Response delete(@Parameter(required=true, description="Document Id") @QueryParam("id") String id,
        ...
        if (!method.equals(HttpMethods.DELETE)) throw new InvalidParameterException("method", method);
    ...
    private void validateRequiredParameters(String serviceKey, String method, String date, Integer expiration, String signature) {
        if (serviceKey == null) throw new RequiredParameterException("serviceKey");
        if (method == null) throw new RequiredParameterException("method");
        if (expiration == null) throw new RequiredParameterException("expiration");
        if (date == null) throw new RequiredParameterException("date");
        if (signature == null) throw new RequiredParameterException("signature");
    }
    
    private void validateDocument(DocumentDto document, InputStream fileStream) {
        if (document.getContent() == null && fileStream != null) throw new RequiredParameterException("document.content");
        if (document.getContent() != null && fileStream == null) throw new RequiredParameterException("file");
    ...
    private void validateFlushValue(String value) {
        if (value.equals("NOW") || value.equals("LATER")) return;

        if (!FLUSH_WITHIN_PATTERN.matcher(value).matches()) throw new InvalidParameterException(CustomHttpHeaders.FLUSH_MODE, value);
