...
public class DocumentService extends BaseService {
	...
	public DocumentDto create(String host, String folderId, String serviceKey, String method, String date,
							  ...
							  DocumentDto document, InputStream contentInputStream, String flushMode,
	...
	private DocumentDto adapt(DocumentDto document, Record documentRecord, MetadataSchema documentSchema,
							  boolean acesModified, Set<String> filters) {
		if (document == null) {
			document = DocumentDto.builder().build();
		}
	...
	private void validateParameters(String host, String id, String serviceKey, String schemaType, String method,
