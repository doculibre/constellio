...
public class FolderSmbConnectorUrlCalculator extends AbstractMetadataValueCalculator<String> {

	LocalDependency<String> urlParam = LocalDependency.toAString(ConnectorSmbFolder.URL);
