...
public class JobParams {
	...
	public JobParams(ConnectorSmb connector, ConnectorEventObserver eventObserver, ConnectorSmbUtils smbUtils,
					 ConnectorSmbInstance connectorInstance, SmbShareService smbShareService,
					 SmbRecordService smbRecordService, SmbDocumentOrFolderUpdater updater, SmbJobFactory jobFactory,
					 String url, String parentUrl) {
