...
public class ESMigrationTo5_1_5 extends MigrationHelper implements MigrationScript {
	...
	private void createConnectorTypes(String collection, MigrationResourcesProvider migrationResourcesProvider,
		...
		transaction.add(migration
				...
				.setDefaultAvailableConnectorFields(asList(
						field(ConnectorHttpDocument.SCHEMA_TYPE, "mimetype", STRING),
	...
	static class SchemaAlterationFor5_1_5 extends MetadataSchemasAlterationHelper {
