...
public final class GeneratedESMigrationCombo {
  ...
  public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
    ...
    MetadataSchemaTypeBuilder connectorHttpDocumentSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorHttpDocument",false).setInTransactionLog(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder connectorHttpDocumentSchema = connectorHttpDocumentSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder connectorInstanceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorInstance",false);
    ...
    MetadataSchemaTypeBuilder connectorLdapUserDocumentSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorLdapUserDocument",false).setInTransactionLog(false);
    MetadataSchemaBuilder connectorLdapUserDocumentSchema = connectorLdapUserDocumentSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder connectorSmbDocumentSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorSmbDocument",false).setInTransactionLog(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder connectorSmbDocumentSchema = connectorSmbDocumentSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder connectorSmbFolderSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorSmbFolder",false).setInTransactionLog(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder connectorSmbFolderSchema = connectorSmbFolderSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder connectorTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("connectorType",false);
    ...
    connectorHttpDocumentSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorHttpDocumentSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    connectorHttpDocumentSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    connectorHttpDocumentSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorHttpDocumentSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorHttpDocumentSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorHttpDocumentSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorHttpDocumentSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorHttpDocumentSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    connectorInstanceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorInstanceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    connectorInstanceSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    connectorInstanceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorInstanceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorInstanceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorInstanceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorInstanceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorInstanceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    connectorLdapUserDocumentSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorLdapUserDocumentSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    connectorLdapUserDocumentSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    connectorLdapUserDocumentSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorLdapUserDocumentSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorLdapUserDocumentSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorLdapUserDocumentSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorLdapUserDocumentSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorLdapUserDocumentSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    connectorSmbDocumentSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorSmbDocumentSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorSmbDocumentSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorSmbDocumentSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorSmbDocumentSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorSmbDocumentSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorSmbDocumentSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorSmbDocumentSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    connectorSmbFolderSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorSmbFolderSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorSmbFolderSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorSmbFolderSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorSmbFolderSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorSmbFolderSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorSmbFolderSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorSmbFolderSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    connectorTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    connectorTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    connectorTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    connectorTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    connectorTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    connectorTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    connectorTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    connectorTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    connectorTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
  ...
  private void createConnectorSmbFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorSmbFolderSchemaType, MetadataSchemaBuilder connectorSmbFolderSchema) {
    ...
    MetadataBuilder connectorSmbFolder_attachedPrincipalAncestorsIntIds = connectorSmbFolderSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbFolder_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorSmbFolder_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorSmbFolder_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorSmbFolder_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorSmbFolder_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbFolder_detachedPrincipalAncestorsIntIds = connectorSmbFolderSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbFolder_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorSmbFolder_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorSmbFolder_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorSmbFolder_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorSmbFolder_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbFolder_nestedAuthorizations = connectorSmbFolderSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorSmbFolder_nestedAuthorizations.setSystemReserved(true);
    connectorSmbFolder_nestedAuthorizations.setUndeletable(true);
    connectorSmbFolder_nestedAuthorizations.setMultiLingual(false);
    connectorSmbFolder_nestedAuthorizations.setEssentialInSummary(true);
    connectorSmbFolder_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorSmbFolder_principalAncestorsIntIds = connectorSmbFolderSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbFolder_principalAncestorsIntIds.setMultivalue(true);
    connectorSmbFolder_principalAncestorsIntIds.setSystemReserved(true);
    connectorSmbFolder_principalAncestorsIntIds.setUndeletable(true);
    connectorSmbFolder_principalAncestorsIntIds.setMultiLingual(false);
    connectorSmbFolder_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorSmbFolder_principalConceptsIntIds = connectorSmbFolderSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbFolder_principalConceptsIntIds.setMultivalue(true);
    connectorSmbFolder_principalConceptsIntIds.setSystemReserved(true);
    connectorSmbFolder_principalConceptsIntIds.setUndeletable(true);
    connectorSmbFolder_principalConceptsIntIds.setMultiLingual(false);
    connectorSmbFolder_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbFolder_secondaryConceptsIntIds = connectorSmbFolderSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbFolder_secondaryConceptsIntIds.setMultivalue(true);
    connectorSmbFolder_secondaryConceptsIntIds.setSystemReserved(true);
    connectorSmbFolder_secondaryConceptsIntIds.setUndeletable(true);
    connectorSmbFolder_secondaryConceptsIntIds.setMultiLingual(false);
    connectorSmbFolder_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConnectorInstanceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorInstanceSchemaType, MetadataSchemaBuilder connectorInstance_httpSchema, MetadataSchemaBuilder connectorInstance_ldapSchema, MetadataSchemaBuilder connectorInstance_smbSchema, MetadataSchemaBuilder connectorInstanceSchema) {
    ...
    MetadataBuilder connectorInstance_http_ignoreRobotsTxt = connectorInstance_httpSchema.create("ignoreRobotsTxt").setType(MetadataValueType.BOOLEAN);
    connectorInstance_http_ignoreRobotsTxt.setDefaultValue(false);
    ...
    MetadataBuilder connectorInstance_attachedPrincipalAncestorsIntIds = connectorInstanceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorInstance_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorInstance_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorInstance_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorInstance_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorInstance_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorInstance_detachedPrincipalAncestorsIntIds = connectorInstanceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorInstance_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorInstance_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorInstance_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorInstance_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorInstance_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorInstance_nestedAuthorizations = connectorInstanceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorInstance_nestedAuthorizations.setSystemReserved(true);
    connectorInstance_nestedAuthorizations.setUndeletable(true);
    connectorInstance_nestedAuthorizations.setMultiLingual(false);
    connectorInstance_nestedAuthorizations.setEssentialInSummary(true);
    connectorInstance_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorInstance_principalAncestorsIntIds = connectorInstanceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorInstance_principalAncestorsIntIds.setMultivalue(true);
    connectorInstance_principalAncestorsIntIds.setSystemReserved(true);
    connectorInstance_principalAncestorsIntIds.setUndeletable(true);
    connectorInstance_principalAncestorsIntIds.setMultiLingual(false);
    connectorInstance_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorInstance_principalConceptsIntIds = connectorInstanceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorInstance_principalConceptsIntIds.setMultivalue(true);
    connectorInstance_principalConceptsIntIds.setSystemReserved(true);
    connectorInstance_principalConceptsIntIds.setUndeletable(true);
    connectorInstance_principalConceptsIntIds.setMultiLingual(false);
    connectorInstance_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorInstance_secondaryConceptsIntIds = connectorInstanceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorInstance_secondaryConceptsIntIds.setMultivalue(true);
    connectorInstance_secondaryConceptsIntIds.setSystemReserved(true);
    connectorInstance_secondaryConceptsIntIds.setUndeletable(true);
    connectorInstance_secondaryConceptsIntIds.setMultiLingual(false);
    connectorInstance_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConnectorLdapUserDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorLdapUserDocumentSchemaType, MetadataSchemaBuilder connectorLdapUserDocumentSchema) {
    ...
    MetadataBuilder connectorLdapUserDocument_attachedPrincipalAncestorsIntIds = connectorLdapUserDocumentSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorLdapUserDocument_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorLdapUserDocument_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorLdapUserDocument_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorLdapUserDocument_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorLdapUserDocument_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorLdapUserDocument_detachedPrincipalAncestorsIntIds = connectorLdapUserDocumentSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorLdapUserDocument_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorLdapUserDocument_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorLdapUserDocument_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorLdapUserDocument_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorLdapUserDocument_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorLdapUserDocument_nestedAuthorizations = connectorLdapUserDocumentSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorLdapUserDocument_nestedAuthorizations.setSystemReserved(true);
    connectorLdapUserDocument_nestedAuthorizations.setUndeletable(true);
    connectorLdapUserDocument_nestedAuthorizations.setMultiLingual(false);
    connectorLdapUserDocument_nestedAuthorizations.setEssentialInSummary(true);
    connectorLdapUserDocument_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorLdapUserDocument_principalAncestorsIntIds = connectorLdapUserDocumentSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorLdapUserDocument_principalAncestorsIntIds.setMultivalue(true);
    connectorLdapUserDocument_principalAncestorsIntIds.setSystemReserved(true);
    connectorLdapUserDocument_principalAncestorsIntIds.setUndeletable(true);
    connectorLdapUserDocument_principalAncestorsIntIds.setMultiLingual(false);
    connectorLdapUserDocument_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorLdapUserDocument_principalConceptsIntIds = connectorLdapUserDocumentSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorLdapUserDocument_principalConceptsIntIds.setMultivalue(true);
    connectorLdapUserDocument_principalConceptsIntIds.setSystemReserved(true);
    connectorLdapUserDocument_principalConceptsIntIds.setUndeletable(true);
    connectorLdapUserDocument_principalConceptsIntIds.setMultiLingual(false);
    connectorLdapUserDocument_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorLdapUserDocument_secondaryConceptsIntIds = connectorLdapUserDocumentSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorLdapUserDocument_secondaryConceptsIntIds.setMultivalue(true);
    connectorLdapUserDocument_secondaryConceptsIntIds.setSystemReserved(true);
    connectorLdapUserDocument_secondaryConceptsIntIds.setUndeletable(true);
    connectorLdapUserDocument_secondaryConceptsIntIds.setMultiLingual(false);
    connectorLdapUserDocument_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConnectorTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorTypeSchemaType, MetadataSchemaBuilder connectorTypeSchema) {
    ...
    MetadataBuilder connectorType_attachedPrincipalAncestorsIntIds = connectorTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorType_detachedPrincipalAncestorsIntIds = connectorTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorType_nestedAuthorizations = connectorTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorType_nestedAuthorizations.setSystemReserved(true);
    connectorType_nestedAuthorizations.setUndeletable(true);
    connectorType_nestedAuthorizations.setMultiLingual(false);
    connectorType_nestedAuthorizations.setEssentialInSummary(true);
    connectorType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorType_principalAncestorsIntIds = connectorTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorType_principalAncestorsIntIds.setMultivalue(true);
    connectorType_principalAncestorsIntIds.setSystemReserved(true);
    connectorType_principalAncestorsIntIds.setUndeletable(true);
    connectorType_principalAncestorsIntIds.setMultiLingual(false);
    connectorType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorType_principalConceptsIntIds = connectorTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorType_principalConceptsIntIds.setMultivalue(true);
    connectorType_principalConceptsIntIds.setSystemReserved(true);
    connectorType_principalConceptsIntIds.setUndeletable(true);
    connectorType_principalConceptsIntIds.setMultiLingual(false);
    connectorType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorType_secondaryConceptsIntIds = connectorTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorType_secondaryConceptsIntIds.setMultivalue(true);
    connectorType_secondaryConceptsIntIds.setSystemReserved(true);
    connectorType_secondaryConceptsIntIds.setUndeletable(true);
    connectorType_secondaryConceptsIntIds.setMultiLingual(false);
    connectorType_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConnectorHttpDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorHttpDocumentSchemaType, MetadataSchemaBuilder connectorHttpDocumentSchema) {
    ...
    MetadataBuilder connectorHttpDocument_attachedPrincipalAncestorsIntIds = connectorHttpDocumentSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorHttpDocument_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorHttpDocument_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorHttpDocument_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorHttpDocument_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorHttpDocument_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorHttpDocument_detachedPrincipalAncestorsIntIds = connectorHttpDocumentSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorHttpDocument_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorHttpDocument_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorHttpDocument_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorHttpDocument_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorHttpDocument_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorHttpDocument_nestedAuthorizations = connectorHttpDocumentSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorHttpDocument_nestedAuthorizations.setSystemReserved(true);
    connectorHttpDocument_nestedAuthorizations.setUndeletable(true);
    connectorHttpDocument_nestedAuthorizations.setMultiLingual(false);
    connectorHttpDocument_nestedAuthorizations.setEssentialInSummary(true);
    connectorHttpDocument_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorHttpDocument_principalAncestorsIntIds = connectorHttpDocumentSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorHttpDocument_principalAncestorsIntIds.setMultivalue(true);
    connectorHttpDocument_principalAncestorsIntIds.setSystemReserved(true);
    connectorHttpDocument_principalAncestorsIntIds.setUndeletable(true);
    connectorHttpDocument_principalAncestorsIntIds.setMultiLingual(false);
    connectorHttpDocument_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorHttpDocument_principalConceptsIntIds = connectorHttpDocumentSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorHttpDocument_principalConceptsIntIds.setMultivalue(true);
    connectorHttpDocument_principalConceptsIntIds.setSystemReserved(true);
    connectorHttpDocument_principalConceptsIntIds.setUndeletable(true);
    connectorHttpDocument_principalConceptsIntIds.setMultiLingual(false);
    connectorHttpDocument_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorHttpDocument_secondaryConceptsIntIds = connectorHttpDocumentSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorHttpDocument_secondaryConceptsIntIds.setMultivalue(true);
    connectorHttpDocument_secondaryConceptsIntIds.setSystemReserved(true);
    connectorHttpDocument_secondaryConceptsIntIds.setUndeletable(true);
    connectorHttpDocument_secondaryConceptsIntIds.setMultiLingual(false);
    connectorHttpDocument_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConnectorSmbDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder connectorSmbDocumentSchemaType, MetadataSchemaBuilder connectorSmbDocumentSchema) {
    ...
    MetadataBuilder connectorSmbDocument_attachedPrincipalAncestorsIntIds = connectorSmbDocumentSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbDocument_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorSmbDocument_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorSmbDocument_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorSmbDocument_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorSmbDocument_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbDocument_detachedPrincipalAncestorsIntIds = connectorSmbDocumentSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbDocument_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    connectorSmbDocument_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    connectorSmbDocument_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    connectorSmbDocument_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    connectorSmbDocument_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbDocument_nestedAuthorizations = connectorSmbDocumentSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    connectorSmbDocument_nestedAuthorizations.setSystemReserved(true);
    connectorSmbDocument_nestedAuthorizations.setUndeletable(true);
    connectorSmbDocument_nestedAuthorizations.setMultiLingual(false);
    connectorSmbDocument_nestedAuthorizations.setEssentialInSummary(true);
    connectorSmbDocument_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder connectorSmbDocument_principalAncestorsIntIds = connectorSmbDocumentSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbDocument_principalAncestorsIntIds.setMultivalue(true);
    connectorSmbDocument_principalAncestorsIntIds.setSystemReserved(true);
    connectorSmbDocument_principalAncestorsIntIds.setUndeletable(true);
    connectorSmbDocument_principalAncestorsIntIds.setMultiLingual(false);
    connectorSmbDocument_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder connectorSmbDocument_principalConceptsIntIds = connectorSmbDocumentSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbDocument_principalConceptsIntIds.setMultivalue(true);
    connectorSmbDocument_principalConceptsIntIds.setSystemReserved(true);
    connectorSmbDocument_principalConceptsIntIds.setUndeletable(true);
    connectorSmbDocument_principalConceptsIntIds.setMultiLingual(false);
    connectorSmbDocument_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder connectorSmbDocument_secondaryConceptsIntIds = connectorSmbDocumentSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    connectorSmbDocument_secondaryConceptsIntIds.setMultivalue(true);
    connectorSmbDocument_secondaryConceptsIntIds.setSystemReserved(true);
    connectorSmbDocument_secondaryConceptsIntIds.setUndeletable(true);
    connectorSmbDocument_secondaryConceptsIntIds.setMultiLingual(false);
    connectorSmbDocument_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  public void applySchemasDisplay(SchemasDisplayManager manager) {
    ...
    transaction.add(manager.getMetadata(collection, "connectorInstance_http_ignoreRobotsTxt").withMetadataGroup("default:connectors.configurationTab").withInputType(MetadataInputType.FIELD).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
