...
public class ESMigrationTo7_6_1_1 extends MigrationHelper implements MigrationScript {
    ...
    static class SchemaAlterationFor7_6_1_1 extends MetadataSchemasAlterationHelper {
        ...
        protected void migrate(MetadataSchemaTypesBuilder typesBuilder) {
            ...
            documentDefaultSchema.get(ConnectorSmbDocument.CONNECTOR_URL).addLabel(Language.French, "Chemin réseau").setSearchable(true);
            ...
            folderDefaultSchema.get(ConnectorSmbFolder.CONNECTOR_URL).addLabel(Language.French, "Chemin réseau").setSearchable(true).setSystemReserved(false);
        }
    }
}
