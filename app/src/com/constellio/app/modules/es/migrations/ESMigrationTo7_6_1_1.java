...
public class ESMigrationTo7_6_1_1 extends MigrationHelper implements MigrationScript {
	...
	public void migrate(String collection, MigrationResourcesProvider migrationResourcesProvider,
		...
		metadataSchemasDisplayManager.saveMetadata(metadataSchemasDisplayManager
				.getMetadata(collection, ConnectorSmbDocument.DEFAULT_SCHEMA + "_" + ConnectorSmbDocument.CONNECTOR_URL)
				.withVisibleInAdvancedSearchStatus(true));
		metadataSchemasDisplayManager.saveMetadata(metadataSchemasDisplayManager
				.getMetadata(collection, ConnectorSmbFolder.DEFAULT_SCHEMA + "_" + ConnectorSmbFolder.CONNECTOR_URL)
				.withVisibleInAdvancedSearchStatus(true));
	}
