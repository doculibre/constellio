...
public class PdfGeneratorAsyncTask implements AsyncTask {
    ...
    public PdfGeneratorAsyncTask(List<String> documentIdList, String consolidedId,
                                 ...
                                 String userName, boolean withMetadata) throws ValidationException {
    ...
    public void execute(AsyncTaskExecutionParams params) throws ValidationException {
        ...
        try {
            ...
            DocumentListPDF documentListPDF = newDocumentListPdfWithContent(consolidedId, consolidatedTitle, resultInputStream, consilidatedName,
                    contentManager,userServices.getUserInCollection(userName,
                            params.getCollection()), schemasRecordsServices);

            Files.copy(Paths.get(fileTemporaryFile.getPath()), Paths.get("C:\\Users\\constellios\\Documents\\solr-5.0.0\\jonathan.pdf"), StandardCopyOption.REPLACE_EXISTING);
    ...
    public Object[] getInstanceParameters() {
        return new Object[] {documentIdList, consolidedId, consilidatedName, consolidatedTitle, userName,  withMetadata, languageCodeStr};
    }
}
