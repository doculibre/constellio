...
public class RMMigrationFrom9_3_UpdateTokensCalculator extends MigrationHelper implements MigrationScript {
	...
	class SchemaAlteration extends MetadataSchemasAlterationHelper {
		...
		protected void migrate(MetadataSchemaTypesBuilder typesBuilder) {
			for (MetadataSchemaTypeBuilder typeBuilder : RMTypes.rmSchemaTypes(typesBuilder)) {
