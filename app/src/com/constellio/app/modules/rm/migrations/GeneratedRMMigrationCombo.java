...
public final class GeneratedRMMigrationCombo {
  ...
  public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
    ...
    MetadataSchemaBuilder externalAccessUrl_signatureSchema = externalAccessUrlSchemaType.createCustomSchema("signature");
    ...
    MetadataSchemaTypeBuilder administrativeUnitSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("administrativeUnit",false);
    MetadataSchemaBuilder administrativeUnitSchema = administrativeUnitSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder bagInfoSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("bagInfo",false).setSecurity(false);
    MetadataSchemaBuilder bagInfoSchema = bagInfoSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder cartSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("cart",false).setSecurity(false);
    MetadataSchemaBuilder cartSchema = cartSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder categorySchemaType = typesBuilder.createNewSchemaTypeWithSecurity("category",false).setSecurity(false);
    MetadataSchemaBuilder categorySchema = categorySchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder containerRecordSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("containerRecord",false).setSecurity(false).setSmallCode("c");
    ...
    MetadataSchemaTypeBuilder ddvContainerRecordTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvContainerRecordType",false).setSecurity(false);
    MetadataSchemaBuilder ddvContainerRecordTypeSchema = ddvContainerRecordTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvDocumentTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvDocumentType",false).setSecurity(false);
    MetadataSchemaBuilder ddvDocumentTypeSchema = ddvDocumentTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvFolderTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvFolderType",false).setSecurity(false);
    MetadataSchemaBuilder ddvFolderTypeSchema = ddvFolderTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvMediumTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvMediumType",false).setSecurity(false);
    ...
    MetadataSchemaTypeBuilder ddvRequirementTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvRequirementType",false).setSecurity(false);
    MetadataSchemaBuilder ddvRequirementTypeSchema = ddvRequirementTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvStorageSpaceTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvStorageSpaceType",false).setSecurity(false);
    MetadataSchemaBuilder ddvStorageSpaceTypeSchema = ddvStorageSpaceTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvUserFunctionSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvUserFunction",false).setSecurity(false);
    MetadataSchemaBuilder ddvUserFunctionSchema = ddvUserFunctionSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvVariablePeriodSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvVariablePeriod",false).setSecurity(false);
    MetadataSchemaBuilder ddvVariablePeriodSchema = ddvVariablePeriodSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvYearTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvYearType",false).setSecurity(false);
    MetadataSchemaBuilder ddvYearTypeSchema = ddvYearTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder decommissioningListSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("decommissioningList",false).setSecurity(false);
    MetadataSchemaBuilder decommissioningListSchema = decommissioningListSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder documentSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("document",false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE).setSmallCode("d");
    MetadataSchemaBuilder document_emailSchema = documentSchemaType.createCustomSchema("email");
    document_emailSchema.defineValidators().add(DocumentValidator.class);
    ...
    MetadataSchemaTypeBuilder externalLinkSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("externalLink",false).setSecurity(false);
    MetadataSchemaBuilder externalLinkSchema = externalLinkSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder externalLinkTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("externalLinkType",false).setSecurity(false);
    MetadataSchemaBuilder externalLinkTypeSchema = externalLinkTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder filingSpaceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("filingSpace",false).setSecurity(false);
    MetadataSchemaBuilder filingSpaceSchema = filingSpaceSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder folderSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("folder",false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE).setSmallCode("f");
    ...
    MetadataSchemaTypeBuilder legalReferenceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("legalReference",false).setSecurity(false);
    MetadataSchemaBuilder legalReferenceSchema = legalReferenceSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder legalRequirementSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("legalRequirement",false).setSecurity(false);
    MetadataSchemaBuilder legalRequirementSchema = legalRequirementSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder legalRequirementReferenceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("legalRequirementReference",false).setSecurity(false);
    MetadataSchemaBuilder legalRequirementReferenceSchema = legalRequirementReferenceSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder retentionRuleSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("retentionRule",false).setSecurity(false);
    ...
    MetadataSchemaTypeBuilder retentionRuleDocumentTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("retentionRuleDocumentType",false).setSecurity(false);
    MetadataSchemaBuilder retentionRuleDocumentTypeSchema = retentionRuleDocumentTypeSchemaType.getDefaultSchema();
    retentionRuleDocumentTypeSchema.defineValidators().add(RuleDocumentTypeValidator.class);
    MetadataSchemaTypeBuilder storageSpaceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("storageSpace",false).setSecurity(false);
    ...
    MetadataSchemaTypeBuilder triggerSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("trigger",false).setSecurity(false);
    MetadataSchemaBuilder triggerSchema = triggerSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder triggerActionSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("triggerAction",false).setSecurity(false);
    MetadataSchemaBuilder triggerAction_moveInFolderSchema = triggerActionSchemaType.createCustomSchema("moveInFolder");
    MetadataSchemaBuilder triggerActionSchema = triggerActionSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder triggerActionTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("triggerActionType",false).setSecurity(false);
    MetadataSchemaBuilder triggerActionTypeSchema = triggerActionTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder triggerTypeSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("triggerType",false).setSecurity(false);
    MetadataSchemaBuilder triggerTypeSchema = triggerTypeSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder uniformSubdivisionSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("uniformSubdivision",false).setSecurity(false);
    ...
    administrativeUnitSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    administrativeUnitSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    administrativeUnitSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    administrativeUnitSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    administrativeUnitSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    administrativeUnitSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    administrativeUnitSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    administrativeUnitSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    administrativeUnitSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    bagInfoSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    bagInfoSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    bagInfoSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    bagInfoSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    bagInfoSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    bagInfoSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    bagInfoSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    bagInfoSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    bagInfoSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    cartSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    cartSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    cartSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    cartSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    cartSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    cartSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    cartSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    cartSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    cartSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    categorySchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    categorySchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    categorySchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    categorySchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    categorySchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    categorySchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    categorySchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    categorySchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    containerRecordSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    containerRecordSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    containerRecordSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    containerRecordSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    containerRecordSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    containerRecordSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    containerRecordSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    containerRecordSchema.get("title").defineDataEntry().asCalculated(ContainerTitleCalculator.class);
    containerRecordSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    ddvContainerRecordTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvContainerRecordTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvContainerRecordTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvContainerRecordTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvContainerRecordTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvContainerRecordTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvContainerRecordTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvContainerRecordTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvContainerRecordTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    ddvDocumentTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvDocumentTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvDocumentTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvDocumentTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvDocumentTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvDocumentTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvDocumentTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvDocumentTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvDocumentTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    ddvFolderTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvFolderTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvFolderTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvFolderTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvFolderTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvFolderTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvFolderTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvFolderTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvFolderTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    ddvMediumTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvMediumTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvMediumTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvMediumTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvMediumTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvMediumTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvMediumTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvMediumTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvMediumTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvMediumTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ddvRequirementTypeSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    ddvRequirementTypeSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    ddvRequirementTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvRequirementTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvRequirementTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvRequirementTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ddvRequirementTypeSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    ddvRequirementTypeSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    ddvRequirementTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvRequirementTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvRequirementTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvRequirementTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvRequirementTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvRequirementTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    ddvStorageSpaceTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvStorageSpaceTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvStorageSpaceTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvStorageSpaceTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvStorageSpaceTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvStorageSpaceTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvStorageSpaceTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvStorageSpaceTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvStorageSpaceTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvStorageSpaceTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ddvUserFunctionSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    ddvUserFunctionSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    ddvUserFunctionSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvUserFunctionSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvUserFunctionSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvUserFunctionSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ddvUserFunctionSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    ddvUserFunctionSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    ddvUserFunctionSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvUserFunctionSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvUserFunctionSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvUserFunctionSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvUserFunctionSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvUserFunctionSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    ddvVariablePeriodSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvVariablePeriodSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvVariablePeriodSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvVariablePeriodSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvVariablePeriodSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvVariablePeriodSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvVariablePeriodSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvVariablePeriodSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvVariablePeriodSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    ddvYearTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvYearTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvYearTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvYearTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    ddvYearTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvYearTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvYearTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvYearTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvYearTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    decommissioningListSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    decommissioningListSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    decommissioningListSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    decommissioningListSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    decommissioningListSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    decommissioningListSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    decommissioningListSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    decommissioningListSchema.get("status").defineDataEntry().asCalculated(DecomListStatusCalculator2.class);
    decommissioningListSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    documentSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    documentSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    documentSchema.get("categoryCode").defineDataEntry().asCopied(documentSchema.get("category"), typesBuilder.getMetadata("category_default_code"));
    ...
    documentSchema.get("contentCheckedOutDate").defineDataEntry().asCalculated(DocumentCheckedOutDateCalculator.class);
    documentSchema.get("contentCheckedOutFrom").defineDataEntry().asCalculated(DocumentCheckedOutSourceCalculator.class);
    ...
    documentSchema.get("currentContentSize").defineDataEntry().asCalculated(DocumentCurrentContentSizeCalculator.class);
    documentSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    documentSchema.get("filename").defineDataEntry().asCalculated(DocumentFilenameCalculator.class);
    ...
    documentSchema.get("hidden").defineDataEntry().asCalculated(DocumentHiddenStatusCalculator.class);
    ...
    documentSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    documentSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ...
    documentSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    documentSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    externalLinkSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    externalLinkSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    externalLinkSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    externalLinkSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    externalLinkSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    externalLinkSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    externalLinkSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    externalLinkSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    externalLinkSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    externalLinkSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    externalLinkSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    externalLinkSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    externalLinkSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    externalLinkSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    externalLinkSchema.get("typeCode").defineDataEntry().asCopied(externalLinkSchema.get("type"), typesBuilder.getMetadata("externalLinkType_default_code"));
    externalLinkTypeSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    externalLinkTypeSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    externalLinkTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    externalLinkTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    externalLinkTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    externalLinkTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    externalLinkTypeSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    externalLinkTypeSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    externalLinkTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    externalLinkTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    externalLinkTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    externalLinkTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    externalLinkTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    externalLinkTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    filingSpaceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    filingSpaceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    filingSpaceSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    filingSpaceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    filingSpaceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    filingSpaceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    filingSpaceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    filingSpaceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    filingSpaceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    folderSchema.get("actualDepositDate").defineDataEntry().asCalculated(FolderActualDepositDateCalculator.class);
    folderSchema.get("actualDestructionDate").defineDataEntry().asCalculated(FolderActualDestructionDateCalculator.class);
    folderSchema.get("actualTransferDate").defineDataEntry().asCalculated(FolderActualTransferDateCalculator.class);
    ...
    folderSchema.get("allowedDocumentTypes").defineDataEntry().asCalculated(FolderAllowedDocumentTypeCalculator.class);
    folderSchema.get("allowedFolderTypes").defineDataEntry().asCalculated(FolderAllowedFolderTypeCalculator.class);
    ...
    folderSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    folderSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    folderSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    folderSchema.get("hidden").defineDataEntry().asCalculated(FolderHiddenStatusCalculator.class);
    ...
    folderSchema.get("openingDate").defineDataEntry().asCalculated(FolderOpeningDateCalculator.class);
    ...
    folderSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    folderSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ...
    folderSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    folderSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    legalReferenceSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    legalReferenceSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    legalReferenceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    legalReferenceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    legalReferenceSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    legalReferenceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    legalReferenceSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    legalReferenceSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    legalReferenceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    legalReferenceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    legalReferenceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    legalReferenceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    legalReferenceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    legalReferenceSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    legalRequirementSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    legalRequirementSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    legalRequirementSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    legalRequirementSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    legalRequirementSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    legalRequirementSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    legalRequirementSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    legalRequirementSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    legalRequirementSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    legalRequirementSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    legalRequirementSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    legalRequirementSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    legalRequirementSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    legalRequirementSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    legalRequirementReferenceSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    legalRequirementReferenceSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    legalRequirementReferenceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    legalRequirementReferenceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    legalRequirementReferenceSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    legalRequirementReferenceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    legalRequirementReferenceSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    legalRequirementReferenceSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    legalRequirementReferenceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    legalRequirementReferenceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    legalRequirementReferenceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    legalRequirementReferenceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    legalRequirementReferenceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    legalRequirementReferenceSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    messageSchema.get("haslinkedDocuments").defineDataEntry().asCalculated(MessageHasLinkedDocumentCalculator.class);
    messageSchema.get("linkedDocumentsTitles").defineDataEntry().asCopied(messageSchema.get("linkedDocuments"), typesBuilder.getMetadata("document_default_title"));
    retentionRuleSchema.get("allReferences").defineDataEntry().asCalculated(RuleMediumTypeReferencesCalculator.class);
    retentionRuleSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    retentionRuleSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    retentionRuleSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    retentionRuleSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    retentionRuleSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    retentionRuleSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    retentionRuleSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    retentionRuleSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    retentionRuleSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    retentionRuleSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    retentionRuleDocumentTypeSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    retentionRuleDocumentTypeSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    retentionRuleDocumentTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    retentionRuleDocumentTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    retentionRuleDocumentTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    retentionRuleDocumentTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    retentionRuleDocumentTypeSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    retentionRuleDocumentTypeSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    retentionRuleDocumentTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    retentionRuleDocumentTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    retentionRuleDocumentTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    retentionRuleDocumentTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    retentionRuleDocumentTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    retentionRuleDocumentTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    storageSpaceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    storageSpaceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    storageSpaceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    storageSpaceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    storageSpaceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    storageSpaceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    storageSpaceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    storageSpaceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    storageSpaceSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    triggerSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    triggerSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    triggerSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    triggerSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    triggerSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    triggerSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    triggerSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    triggerSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    triggerSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    triggerSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    triggerSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    triggerSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    triggerSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    triggerSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    triggerActionSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    triggerActionSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    triggerActionSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    triggerActionSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    triggerActionSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    triggerActionSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    triggerActionSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    triggerActionSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    triggerActionSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    triggerActionSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    triggerActionSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    triggerActionSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    triggerActionSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    triggerActionSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    triggerActionTypeSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    triggerActionTypeSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    triggerActionTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    triggerActionTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    triggerActionTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    triggerActionTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    triggerActionTypeSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    triggerActionTypeSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    triggerActionTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    triggerActionTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    triggerActionTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    triggerActionTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    triggerActionTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    triggerActionTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    triggerTypeSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    triggerTypeSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    triggerTypeSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    triggerTypeSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    triggerTypeSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    triggerTypeSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    triggerTypeSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    triggerTypeSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    triggerTypeSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    triggerTypeSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    triggerTypeSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    triggerTypeSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    triggerTypeSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    triggerTypeSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    uniformSubdivisionSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    uniformSubdivisionSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    uniformSubdivisionSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    uniformSubdivisionSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    uniformSubdivisionSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    uniformSubdivisionSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    uniformSubdivisionSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    uniformSubdivisionSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    uniformSubdivisionSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
  ...
  private void createExternalLinkSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder externalLinkSchemaType, MetadataSchemaBuilder externalLinkSchema) {
    MetadataBuilder externalLink_allReferences = externalLinkSchema.create("allReferences").setType(MetadataValueType.STRING);
    externalLink_allReferences.setMultivalue(true);
    externalLink_allReferences.setSystemReserved(true);
    externalLink_allReferences.setUndeletable(true);
    externalLink_allReferences.setMultiLingual(false);
    MetadataBuilder externalLink_allRemovedAuths = externalLinkSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    externalLink_allRemovedAuths.setMultivalue(true);
    externalLink_allRemovedAuths.setSystemReserved(true);
    externalLink_allRemovedAuths.setUndeletable(true);
    externalLink_allRemovedAuths.setEssential(true);
    externalLink_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder externalLink_attachedAncestors = externalLinkSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    externalLink_attachedAncestors.setMultivalue(true);
    externalLink_attachedAncestors.setSystemReserved(true);
    externalLink_attachedAncestors.setUndeletable(true);
    externalLink_attachedAncestors.setEssential(true);
    externalLink_attachedAncestors.setMultiLingual(false);
    MetadataBuilder externalLink_attachedPrincipalAncestorsIntIds = externalLinkSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLink_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalLink_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalLink_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalLink_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalLink_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLink_autocomplete = externalLinkSchema.create("autocomplete").setType(MetadataValueType.STRING);
    externalLink_autocomplete.setMultivalue(true);
    externalLink_autocomplete.setSystemReserved(true);
    externalLink_autocomplete.setUndeletable(true);
    externalLink_autocomplete.setEssential(true);
    externalLink_autocomplete.setMultiLingual(true);
    MetadataBuilder externalLink_caption = externalLinkSchema.create("caption").setType(MetadataValueType.STRING);
    externalLink_caption.setSystemReserved(true);
    externalLink_caption.setUndeletable(true);
    externalLink_caption.setMultiLingual(false);
    externalLink_caption.setSortable(true);
    MetadataBuilder externalLink_createdBy = externalLinkSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    externalLink_createdBy.setSystemReserved(true);
    externalLink_createdBy.setUndeletable(true);
    externalLink_createdBy.setMultiLingual(false);
    externalLink_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalLink_createdOn = externalLinkSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    externalLink_createdOn.setSystemReserved(true);
    externalLink_createdOn.setUndeletable(true);
    externalLink_createdOn.setMultiLingual(false);
    externalLink_createdOn.setSortable(true);
    MetadataBuilder externalLink_deleted = externalLinkSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    externalLink_deleted.setSystemReserved(true);
    externalLink_deleted.setUndeletable(true);
    externalLink_deleted.setMultiLingual(false);
    MetadataBuilder externalLink_denyTokens = externalLinkSchema.create("denyTokens").setType(MetadataValueType.STRING);
    externalLink_denyTokens.setMultivalue(true);
    externalLink_denyTokens.setSystemReserved(true);
    externalLink_denyTokens.setUndeletable(true);
    externalLink_denyTokens.setMultiLingual(false);
    externalLink_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLink_detachedPrincipalAncestorsIntIds = externalLinkSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLink_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalLink_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalLink_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalLink_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalLink_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLink_detachedauthorizations = externalLinkSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    externalLink_detachedauthorizations.setSystemReserved(true);
    externalLink_detachedauthorizations.setUndeletable(true);
    externalLink_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder externalLink_errorOnPhysicalDeletion = externalLinkSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    externalLink_errorOnPhysicalDeletion.setSystemReserved(true);
    externalLink_errorOnPhysicalDeletion.setUndeletable(true);
    externalLink_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder externalLink_estimatedSize = externalLinkSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    externalLink_estimatedSize.setSystemReserved(true);
    externalLink_estimatedSize.setUndeletable(true);
    externalLink_estimatedSize.setMultiLingual(false);
    MetadataBuilder externalLink_hidden = externalLinkSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    externalLink_hidden.setSystemReserved(true);
    externalLink_hidden.setUndeletable(true);
    externalLink_hidden.setMultiLingual(false);
    MetadataBuilder externalLink_id = externalLinkSchema.create("id").setType(MetadataValueType.STRING);
    externalLink_id.setDefaultRequirement(true);
    externalLink_id.setSystemReserved(true);
    externalLink_id.setUndeletable(true);
    externalLink_id.setMultiLingual(false);
    externalLink_id.setSearchable(true);
    externalLink_id.setSortable(true);
    externalLink_id.setUniqueValue(true);
    externalLink_id.setUnmodifiable(true);
    MetadataBuilder externalLink_importedOn = externalLinkSchema.create("importedOn").setType(MetadataValueType.DATE_TIME);
    externalLink_importedOn.setUndeletable(true);
    MetadataBuilder externalLink_legacyIdentifier = externalLinkSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    externalLink_legacyIdentifier.setDefaultRequirement(true);
    externalLink_legacyIdentifier.setSystemReserved(true);
    externalLink_legacyIdentifier.setUndeletable(true);
    externalLink_legacyIdentifier.setMultiLingual(false);
    externalLink_legacyIdentifier.setSearchable(true);
    externalLink_legacyIdentifier.setUniqueValue(true);
    externalLink_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder externalLink_logicallyDeletedOn = externalLinkSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    externalLink_logicallyDeletedOn.setSystemReserved(true);
    externalLink_logicallyDeletedOn.setUndeletable(true);
    externalLink_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder externalLink_manualTokens = externalLinkSchema.create("manualTokens").setType(MetadataValueType.STRING);
    externalLink_manualTokens.setMultivalue(true);
    externalLink_manualTokens.setSystemReserved(true);
    externalLink_manualTokens.setUndeletable(true);
    externalLink_manualTokens.setMultiLingual(false);
    externalLink_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLink_markedForParsing = externalLinkSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    externalLink_markedForParsing.setSystemReserved(true);
    externalLink_markedForParsing.setUndeletable(true);
    externalLink_markedForParsing.setMultiLingual(false);
    MetadataBuilder externalLink_markedForPreviewConversion = externalLinkSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    externalLink_markedForPreviewConversion.setSystemReserved(true);
    externalLink_markedForPreviewConversion.setUndeletable(true);
    externalLink_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder externalLink_markedForReindexing = externalLinkSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    externalLink_markedForReindexing.setSystemReserved(true);
    externalLink_markedForReindexing.setUndeletable(true);
    externalLink_markedForReindexing.setMultiLingual(false);
    MetadataBuilder externalLink_migrationDataVersion = externalLinkSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    externalLink_migrationDataVersion.setSystemReserved(true);
    externalLink_migrationDataVersion.setUndeletable(true);
    externalLink_migrationDataVersion.setMultiLingual(false);
    externalLink_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder externalLink_modifiedBy = externalLinkSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    externalLink_modifiedBy.setSystemReserved(true);
    externalLink_modifiedBy.setUndeletable(true);
    externalLink_modifiedBy.setMultiLingual(false);
    externalLink_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalLink_modifiedOn = externalLinkSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    externalLink_modifiedOn.setSystemReserved(true);
    externalLink_modifiedOn.setUndeletable(true);
    externalLink_modifiedOn.setMultiLingual(false);
    externalLink_modifiedOn.setAvailableInSummary(true);
    externalLink_modifiedOn.setSortable(true);
    MetadataBuilder externalLink_nestedAuthorizations = externalLinkSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    externalLink_nestedAuthorizations.setSystemReserved(true);
    externalLink_nestedAuthorizations.setUndeletable(true);
    externalLink_nestedAuthorizations.setMultiLingual(false);
    externalLink_nestedAuthorizations.setEssentialInSummary(true);
    externalLink_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder externalLink_path = externalLinkSchema.create("path").setType(MetadataValueType.STRING);
    externalLink_path.setMultivalue(true);
    externalLink_path.setSystemReserved(true);
    externalLink_path.setUndeletable(true);
    externalLink_path.setMultiLingual(false);
    MetadataBuilder externalLink_pathParts = externalLinkSchema.create("pathParts").setType(MetadataValueType.STRING);
    externalLink_pathParts.setMultivalue(true);
    externalLink_pathParts.setSystemReserved(true);
    externalLink_pathParts.setUndeletable(true);
    externalLink_pathParts.setMultiLingual(false);
    MetadataBuilder externalLink_principalAncestorsIntIds = externalLinkSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLink_principalAncestorsIntIds.setMultivalue(true);
    externalLink_principalAncestorsIntIds.setSystemReserved(true);
    externalLink_principalAncestorsIntIds.setUndeletable(true);
    externalLink_principalAncestorsIntIds.setMultiLingual(false);
    externalLink_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLink_principalConceptsIntIds = externalLinkSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalLink_principalConceptsIntIds.setMultivalue(true);
    externalLink_principalConceptsIntIds.setSystemReserved(true);
    externalLink_principalConceptsIntIds.setUndeletable(true);
    externalLink_principalConceptsIntIds.setMultiLingual(false);
    externalLink_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLink_principalpath = externalLinkSchema.create("principalpath").setType(MetadataValueType.STRING);
    externalLink_principalpath.setSystemReserved(true);
    externalLink_principalpath.setUndeletable(true);
    externalLink_principalpath.setMultiLingual(false);
    MetadataBuilder externalLink_removedauthorizations = externalLinkSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    externalLink_removedauthorizations.setMultivalue(true);
    externalLink_removedauthorizations.setSystemReserved(true);
    externalLink_removedauthorizations.setUndeletable(true);
    externalLink_removedauthorizations.setMultiLingual(false);
    MetadataBuilder externalLink_schema = externalLinkSchema.create("schema").setType(MetadataValueType.STRING);
    externalLink_schema.setDefaultRequirement(true);
    externalLink_schema.setSystemReserved(true);
    externalLink_schema.setUndeletable(true);
    externalLink_schema.setMultiLingual(false);
    MetadataBuilder externalLink_secondaryConceptsIntIds = externalLinkSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalLink_secondaryConceptsIntIds.setMultivalue(true);
    externalLink_secondaryConceptsIntIds.setSystemReserved(true);
    externalLink_secondaryConceptsIntIds.setUndeletable(true);
    externalLink_secondaryConceptsIntIds.setMultiLingual(false);
    externalLink_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLink_shareDenyTokens = externalLinkSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    externalLink_shareDenyTokens.setMultivalue(true);
    externalLink_shareDenyTokens.setSystemReserved(true);
    externalLink_shareDenyTokens.setUndeletable(true);
    externalLink_shareDenyTokens.setMultiLingual(false);
    externalLink_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLink_shareTokens = externalLinkSchema.create("shareTokens").setType(MetadataValueType.STRING);
    externalLink_shareTokens.setMultivalue(true);
    externalLink_shareTokens.setSystemReserved(true);
    externalLink_shareTokens.setUndeletable(true);
    externalLink_shareTokens.setMultiLingual(false);
    externalLink_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLink_title = externalLinkSchema.create("title").setType(MetadataValueType.STRING);
    externalLink_title.setUndeletable(true);
    externalLink_title.setMultiLingual(false);
    externalLink_title.setAvailableInSummary(true);
    externalLink_title.setSchemaAutocomplete(true);
    externalLink_title.setSearchable(true);
    MetadataBuilder externalLink_tokens = externalLinkSchema.create("tokens").setType(MetadataValueType.STRING);
    externalLink_tokens.setMultivalue(true);
    externalLink_tokens.setSystemReserved(true);
    externalLink_tokens.setUndeletable(true);
    externalLink_tokens.setMultiLingual(false);
    MetadataBuilder externalLink_tokensHierarchy = externalLinkSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    externalLink_tokensHierarchy.setMultivalue(true);
    externalLink_tokensHierarchy.setSystemReserved(true);
    externalLink_tokensHierarchy.setUndeletable(true);
    externalLink_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder externalLink_type = externalLinkSchema.create("type").setType(MetadataValueType.REFERENCE);
    externalLink_type.setUndeletable(true);
    externalLink_type.setAvailableInSummary(true);
    externalLink_type.defineReferencesTo(asList(types.getSchema("externalLinkType_default")));
    MetadataBuilder externalLink_typeCode = externalLinkSchema.create("typeCode").setType(MetadataValueType.STRING);
    externalLink_typeCode.setUndeletable(true);
    MetadataBuilder externalLink_visibleInTrees = externalLinkSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    externalLink_visibleInTrees.setSystemReserved(true);
    externalLink_visibleInTrees.setUndeletable(true);
    externalLink_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createRetentionRuleDocumentTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder retentionRuleDocumentTypeSchemaType, MetadataSchemaBuilder retentionRuleDocumentTypeSchema) {
    MetadataBuilder retentionRuleDocumentType_allReferences = retentionRuleDocumentTypeSchema.create("allReferences").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_allReferences.setMultivalue(true);
    retentionRuleDocumentType_allReferences.setSystemReserved(true);
    retentionRuleDocumentType_allReferences.setUndeletable(true);
    retentionRuleDocumentType_allReferences.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_allRemovedAuths = retentionRuleDocumentTypeSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_allRemovedAuths.setMultivalue(true);
    retentionRuleDocumentType_allRemovedAuths.setSystemReserved(true);
    retentionRuleDocumentType_allRemovedAuths.setUndeletable(true);
    retentionRuleDocumentType_allRemovedAuths.setEssential(true);
    retentionRuleDocumentType_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_attachedAncestors = retentionRuleDocumentTypeSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_attachedAncestors.setMultivalue(true);
    retentionRuleDocumentType_attachedAncestors.setSystemReserved(true);
    retentionRuleDocumentType_attachedAncestors.setUndeletable(true);
    retentionRuleDocumentType_attachedAncestors.setEssential(true);
    retentionRuleDocumentType_attachedAncestors.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_attachedPrincipalAncestorsIntIds = retentionRuleDocumentTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    retentionRuleDocumentType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    retentionRuleDocumentType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    retentionRuleDocumentType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    retentionRuleDocumentType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_autocomplete = retentionRuleDocumentTypeSchema.create("autocomplete").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_autocomplete.setMultivalue(true);
    retentionRuleDocumentType_autocomplete.setSystemReserved(true);
    retentionRuleDocumentType_autocomplete.setUndeletable(true);
    retentionRuleDocumentType_autocomplete.setEssential(true);
    retentionRuleDocumentType_autocomplete.setMultiLingual(true);
    MetadataBuilder retentionRuleDocumentType_caption = retentionRuleDocumentTypeSchema.create("caption").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_caption.setSystemReserved(true);
    retentionRuleDocumentType_caption.setUndeletable(true);
    retentionRuleDocumentType_caption.setMultiLingual(false);
    retentionRuleDocumentType_caption.setSortable(true);
    MetadataBuilder retentionRuleDocumentType_category = retentionRuleDocumentTypeSchema.create("category").setType(MetadataValueType.REFERENCE);
    retentionRuleDocumentType_category.setUndeletable(true);
    retentionRuleDocumentType_category.setAvailableInSummary(true);
    retentionRuleDocumentType_category.defineReferencesTo(asList(types.getSchema("category_default")));
    MetadataBuilder retentionRuleDocumentType_createdBy = retentionRuleDocumentTypeSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    retentionRuleDocumentType_createdBy.setSystemReserved(true);
    retentionRuleDocumentType_createdBy.setUndeletable(true);
    retentionRuleDocumentType_createdBy.setMultiLingual(false);
    retentionRuleDocumentType_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder retentionRuleDocumentType_createdOn = retentionRuleDocumentTypeSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    retentionRuleDocumentType_createdOn.setSystemReserved(true);
    retentionRuleDocumentType_createdOn.setUndeletable(true);
    retentionRuleDocumentType_createdOn.setMultiLingual(false);
    retentionRuleDocumentType_createdOn.setSortable(true);
    MetadataBuilder retentionRuleDocumentType_deleted = retentionRuleDocumentTypeSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_deleted.setSystemReserved(true);
    retentionRuleDocumentType_deleted.setUndeletable(true);
    retentionRuleDocumentType_deleted.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_denyTokens = retentionRuleDocumentTypeSchema.create("denyTokens").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_denyTokens.setMultivalue(true);
    retentionRuleDocumentType_denyTokens.setSystemReserved(true);
    retentionRuleDocumentType_denyTokens.setUndeletable(true);
    retentionRuleDocumentType_denyTokens.setMultiLingual(false);
    retentionRuleDocumentType_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder retentionRuleDocumentType_detachedPrincipalAncestorsIntIds = retentionRuleDocumentTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    retentionRuleDocumentType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    retentionRuleDocumentType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    retentionRuleDocumentType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    retentionRuleDocumentType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_detachedauthorizations = retentionRuleDocumentTypeSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_detachedauthorizations.setSystemReserved(true);
    retentionRuleDocumentType_detachedauthorizations.setUndeletable(true);
    retentionRuleDocumentType_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_documentType = retentionRuleDocumentTypeSchema.create("documentType").setType(MetadataValueType.REFERENCE);
    retentionRuleDocumentType_documentType.setUndeletable(true);
    retentionRuleDocumentType_documentType.setAvailableInSummary(true);
    retentionRuleDocumentType_documentType.defineReferencesTo(asList(types.getSchema("ddvDocumentType_default")));
    MetadataBuilder retentionRuleDocumentType_errorOnPhysicalDeletion = retentionRuleDocumentTypeSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_errorOnPhysicalDeletion.setSystemReserved(true);
    retentionRuleDocumentType_errorOnPhysicalDeletion.setUndeletable(true);
    retentionRuleDocumentType_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_estimatedSize = retentionRuleDocumentTypeSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_estimatedSize.setSystemReserved(true);
    retentionRuleDocumentType_estimatedSize.setUndeletable(true);
    retentionRuleDocumentType_estimatedSize.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_hidden = retentionRuleDocumentTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_hidden.setSystemReserved(true);
    retentionRuleDocumentType_hidden.setUndeletable(true);
    retentionRuleDocumentType_hidden.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_id = retentionRuleDocumentTypeSchema.create("id").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_id.setDefaultRequirement(true);
    retentionRuleDocumentType_id.setSystemReserved(true);
    retentionRuleDocumentType_id.setUndeletable(true);
    retentionRuleDocumentType_id.setMultiLingual(false);
    retentionRuleDocumentType_id.setSearchable(true);
    retentionRuleDocumentType_id.setSortable(true);
    retentionRuleDocumentType_id.setUniqueValue(true);
    retentionRuleDocumentType_id.setUnmodifiable(true);
    MetadataBuilder retentionRuleDocumentType_legacyIdentifier = retentionRuleDocumentTypeSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_legacyIdentifier.setDefaultRequirement(true);
    retentionRuleDocumentType_legacyIdentifier.setSystemReserved(true);
    retentionRuleDocumentType_legacyIdentifier.setUndeletable(true);
    retentionRuleDocumentType_legacyIdentifier.setMultiLingual(false);
    retentionRuleDocumentType_legacyIdentifier.setSearchable(true);
    retentionRuleDocumentType_legacyIdentifier.setUniqueValue(true);
    retentionRuleDocumentType_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder retentionRuleDocumentType_logicallyDeletedOn = retentionRuleDocumentTypeSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    retentionRuleDocumentType_logicallyDeletedOn.setSystemReserved(true);
    retentionRuleDocumentType_logicallyDeletedOn.setUndeletable(true);
    retentionRuleDocumentType_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_manualTokens = retentionRuleDocumentTypeSchema.create("manualTokens").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_manualTokens.setMultivalue(true);
    retentionRuleDocumentType_manualTokens.setSystemReserved(true);
    retentionRuleDocumentType_manualTokens.setUndeletable(true);
    retentionRuleDocumentType_manualTokens.setMultiLingual(false);
    retentionRuleDocumentType_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder retentionRuleDocumentType_markedForParsing = retentionRuleDocumentTypeSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_markedForParsing.setSystemReserved(true);
    retentionRuleDocumentType_markedForParsing.setUndeletable(true);
    retentionRuleDocumentType_markedForParsing.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_markedForPreviewConversion = retentionRuleDocumentTypeSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_markedForPreviewConversion.setSystemReserved(true);
    retentionRuleDocumentType_markedForPreviewConversion.setUndeletable(true);
    retentionRuleDocumentType_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_markedForReindexing = retentionRuleDocumentTypeSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_markedForReindexing.setSystemReserved(true);
    retentionRuleDocumentType_markedForReindexing.setUndeletable(true);
    retentionRuleDocumentType_markedForReindexing.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_migrationDataVersion = retentionRuleDocumentTypeSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    retentionRuleDocumentType_migrationDataVersion.setSystemReserved(true);
    retentionRuleDocumentType_migrationDataVersion.setUndeletable(true);
    retentionRuleDocumentType_migrationDataVersion.setMultiLingual(false);
    retentionRuleDocumentType_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_modifiedBy = retentionRuleDocumentTypeSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    retentionRuleDocumentType_modifiedBy.setSystemReserved(true);
    retentionRuleDocumentType_modifiedBy.setUndeletable(true);
    retentionRuleDocumentType_modifiedBy.setMultiLingual(false);
    retentionRuleDocumentType_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder retentionRuleDocumentType_modifiedOn = retentionRuleDocumentTypeSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    retentionRuleDocumentType_modifiedOn.setSystemReserved(true);
    retentionRuleDocumentType_modifiedOn.setUndeletable(true);
    retentionRuleDocumentType_modifiedOn.setMultiLingual(false);
    retentionRuleDocumentType_modifiedOn.setAvailableInSummary(true);
    retentionRuleDocumentType_modifiedOn.setSortable(true);
    MetadataBuilder retentionRuleDocumentType_nestedAuthorizations = retentionRuleDocumentTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    retentionRuleDocumentType_nestedAuthorizations.setSystemReserved(true);
    retentionRuleDocumentType_nestedAuthorizations.setUndeletable(true);
    retentionRuleDocumentType_nestedAuthorizations.setMultiLingual(false);
    retentionRuleDocumentType_nestedAuthorizations.setEssentialInSummary(true);
    retentionRuleDocumentType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder retentionRuleDocumentType_path = retentionRuleDocumentTypeSchema.create("path").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_path.setMultivalue(true);
    retentionRuleDocumentType_path.setSystemReserved(true);
    retentionRuleDocumentType_path.setUndeletable(true);
    retentionRuleDocumentType_path.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_pathParts = retentionRuleDocumentTypeSchema.create("pathParts").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_pathParts.setMultivalue(true);
    retentionRuleDocumentType_pathParts.setSystemReserved(true);
    retentionRuleDocumentType_pathParts.setUndeletable(true);
    retentionRuleDocumentType_pathParts.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_principalAncestorsIntIds = retentionRuleDocumentTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_principalAncestorsIntIds.setMultivalue(true);
    retentionRuleDocumentType_principalAncestorsIntIds.setSystemReserved(true);
    retentionRuleDocumentType_principalAncestorsIntIds.setUndeletable(true);
    retentionRuleDocumentType_principalAncestorsIntIds.setMultiLingual(false);
    retentionRuleDocumentType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_principalConceptsIntIds = retentionRuleDocumentTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_principalConceptsIntIds.setMultivalue(true);
    retentionRuleDocumentType_principalConceptsIntIds.setSystemReserved(true);
    retentionRuleDocumentType_principalConceptsIntIds.setUndeletable(true);
    retentionRuleDocumentType_principalConceptsIntIds.setMultiLingual(false);
    retentionRuleDocumentType_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_principalpath = retentionRuleDocumentTypeSchema.create("principalpath").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_principalpath.setSystemReserved(true);
    retentionRuleDocumentType_principalpath.setUndeletable(true);
    retentionRuleDocumentType_principalpath.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_removedauthorizations = retentionRuleDocumentTypeSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_removedauthorizations.setMultivalue(true);
    retentionRuleDocumentType_removedauthorizations.setSystemReserved(true);
    retentionRuleDocumentType_removedauthorizations.setUndeletable(true);
    retentionRuleDocumentType_removedauthorizations.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_retentionRule = retentionRuleDocumentTypeSchema.create("retentionRule").setType(MetadataValueType.REFERENCE);
    retentionRuleDocumentType_retentionRule.setUndeletable(true);
    retentionRuleDocumentType_retentionRule.setAvailableInSummary(true);
    retentionRuleDocumentType_retentionRule.defineReferencesTo(asList(types.getSchema("retentionRule_default")));
    MetadataBuilder retentionRuleDocumentType_retentionRuleCopy = retentionRuleDocumentTypeSchema.create("retentionRuleCopy").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_retentionRuleCopy.setUndeletable(true);
    retentionRuleDocumentType_retentionRuleCopy.setAvailableInSummary(true);
    MetadataBuilder retentionRuleDocumentType_schema = retentionRuleDocumentTypeSchema.create("schema").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_schema.setDefaultRequirement(true);
    retentionRuleDocumentType_schema.setSystemReserved(true);
    retentionRuleDocumentType_schema.setUndeletable(true);
    retentionRuleDocumentType_schema.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_secondaryConceptsIntIds = retentionRuleDocumentTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    retentionRuleDocumentType_secondaryConceptsIntIds.setMultivalue(true);
    retentionRuleDocumentType_secondaryConceptsIntIds.setSystemReserved(true);
    retentionRuleDocumentType_secondaryConceptsIntIds.setUndeletable(true);
    retentionRuleDocumentType_secondaryConceptsIntIds.setMultiLingual(false);
    retentionRuleDocumentType_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRuleDocumentType_shareDenyTokens = retentionRuleDocumentTypeSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_shareDenyTokens.setMultivalue(true);
    retentionRuleDocumentType_shareDenyTokens.setSystemReserved(true);
    retentionRuleDocumentType_shareDenyTokens.setUndeletable(true);
    retentionRuleDocumentType_shareDenyTokens.setMultiLingual(false);
    retentionRuleDocumentType_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder retentionRuleDocumentType_shareTokens = retentionRuleDocumentTypeSchema.create("shareTokens").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_shareTokens.setMultivalue(true);
    retentionRuleDocumentType_shareTokens.setSystemReserved(true);
    retentionRuleDocumentType_shareTokens.setUndeletable(true);
    retentionRuleDocumentType_shareTokens.setMultiLingual(false);
    retentionRuleDocumentType_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder retentionRuleDocumentType_title = retentionRuleDocumentTypeSchema.create("title").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_title.setUndeletable(true);
    retentionRuleDocumentType_title.setMultiLingual(false);
    retentionRuleDocumentType_title.setAvailableInSummary(true);
    retentionRuleDocumentType_title.setSchemaAutocomplete(true);
    retentionRuleDocumentType_title.setSearchable(true);
    MetadataBuilder retentionRuleDocumentType_tokens = retentionRuleDocumentTypeSchema.create("tokens").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_tokens.setMultivalue(true);
    retentionRuleDocumentType_tokens.setSystemReserved(true);
    retentionRuleDocumentType_tokens.setUndeletable(true);
    retentionRuleDocumentType_tokens.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_tokensHierarchy = retentionRuleDocumentTypeSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    retentionRuleDocumentType_tokensHierarchy.setMultivalue(true);
    retentionRuleDocumentType_tokensHierarchy.setSystemReserved(true);
    retentionRuleDocumentType_tokensHierarchy.setUndeletable(true);
    retentionRuleDocumentType_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder retentionRuleDocumentType_visibleInTrees = retentionRuleDocumentTypeSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    retentionRuleDocumentType_visibleInTrees.setSystemReserved(true);
    retentionRuleDocumentType_visibleInTrees.setUndeletable(true);
    retentionRuleDocumentType_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createExternalLinkTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder externalLinkTypeSchemaType, MetadataSchemaBuilder externalLinkTypeSchema) {
    MetadataBuilder externalLinkType_abbreviation = externalLinkTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    externalLinkType_abbreviation.setUndeletable(true);
    externalLinkType_abbreviation.setMultiLingual(true);
    externalLinkType_abbreviation.setSearchable(true);
    externalLinkType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder externalLinkType_allReferences = externalLinkTypeSchema.create("allReferences").setType(MetadataValueType.STRING);
    externalLinkType_allReferences.setMultivalue(true);
    externalLinkType_allReferences.setSystemReserved(true);
    externalLinkType_allReferences.setUndeletable(true);
    externalLinkType_allReferences.setMultiLingual(false);
    MetadataBuilder externalLinkType_allRemovedAuths = externalLinkTypeSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    externalLinkType_allRemovedAuths.setMultivalue(true);
    externalLinkType_allRemovedAuths.setSystemReserved(true);
    externalLinkType_allRemovedAuths.setUndeletable(true);
    externalLinkType_allRemovedAuths.setEssential(true);
    externalLinkType_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder externalLinkType_attachedAncestors = externalLinkTypeSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    externalLinkType_attachedAncestors.setMultivalue(true);
    externalLinkType_attachedAncestors.setSystemReserved(true);
    externalLinkType_attachedAncestors.setUndeletable(true);
    externalLinkType_attachedAncestors.setEssential(true);
    externalLinkType_attachedAncestors.setMultiLingual(false);
    MetadataBuilder externalLinkType_attachedPrincipalAncestorsIntIds = externalLinkTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLinkType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalLinkType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalLinkType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalLinkType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalLinkType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_autocomplete = externalLinkTypeSchema.create("autocomplete").setType(MetadataValueType.STRING);
    externalLinkType_autocomplete.setMultivalue(true);
    externalLinkType_autocomplete.setSystemReserved(true);
    externalLinkType_autocomplete.setUndeletable(true);
    externalLinkType_autocomplete.setEssential(true);
    externalLinkType_autocomplete.setMultiLingual(true);
    MetadataBuilder externalLinkType_caption = externalLinkTypeSchema.create("caption").setType(MetadataValueType.STRING);
    externalLinkType_caption.setSystemReserved(true);
    externalLinkType_caption.setUndeletable(true);
    externalLinkType_caption.setMultiLingual(false);
    externalLinkType_caption.setSortable(true);
    MetadataBuilder externalLinkType_code = externalLinkTypeSchema.create("code").setType(MetadataValueType.STRING);
    externalLinkType_code.setDefaultRequirement(true);
    externalLinkType_code.setUndeletable(true);
    externalLinkType_code.setSchemaAutocomplete(true);
    externalLinkType_code.setSearchable(true);
    externalLinkType_code.setUniqueValue(true);
    externalLinkType_code.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder externalLinkType_comments = externalLinkTypeSchema.create("comments").setType(MetadataValueType.STRUCTURE);
    externalLinkType_comments.setMultivalue(true);
    externalLinkType_comments.defineStructureFactory(CommentFactory.class);
    MetadataBuilder externalLinkType_createdBy = externalLinkTypeSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    externalLinkType_createdBy.setSystemReserved(true);
    externalLinkType_createdBy.setUndeletable(true);
    externalLinkType_createdBy.setMultiLingual(false);
    externalLinkType_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalLinkType_createdOn = externalLinkTypeSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    externalLinkType_createdOn.setSystemReserved(true);
    externalLinkType_createdOn.setUndeletable(true);
    externalLinkType_createdOn.setMultiLingual(false);
    externalLinkType_createdOn.setSortable(true);
    MetadataBuilder externalLinkType_deleted = externalLinkTypeSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    externalLinkType_deleted.setSystemReserved(true);
    externalLinkType_deleted.setUndeletable(true);
    externalLinkType_deleted.setMultiLingual(false);
    MetadataBuilder externalLinkType_denyTokens = externalLinkTypeSchema.create("denyTokens").setType(MetadataValueType.STRING);
    externalLinkType_denyTokens.setMultivalue(true);
    externalLinkType_denyTokens.setSystemReserved(true);
    externalLinkType_denyTokens.setUndeletable(true);
    externalLinkType_denyTokens.setMultiLingual(false);
    externalLinkType_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLinkType_description = externalLinkTypeSchema.create("description").setType(MetadataValueType.TEXT);
    externalLinkType_description.setUndeletable(true);
    externalLinkType_description.setMultiLingual(true);
    externalLinkType_description.setSearchable(true);
    MetadataBuilder externalLinkType_detachedPrincipalAncestorsIntIds = externalLinkTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLinkType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalLinkType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalLinkType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalLinkType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalLinkType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_detachedauthorizations = externalLinkTypeSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    externalLinkType_detachedauthorizations.setSystemReserved(true);
    externalLinkType_detachedauthorizations.setUndeletable(true);
    externalLinkType_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder externalLinkType_errorOnPhysicalDeletion = externalLinkTypeSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    externalLinkType_errorOnPhysicalDeletion.setSystemReserved(true);
    externalLinkType_errorOnPhysicalDeletion.setUndeletable(true);
    externalLinkType_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder externalLinkType_estimatedSize = externalLinkTypeSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    externalLinkType_estimatedSize.setSystemReserved(true);
    externalLinkType_estimatedSize.setUndeletable(true);
    externalLinkType_estimatedSize.setMultiLingual(false);
    MetadataBuilder externalLinkType_hidden = externalLinkTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    externalLinkType_hidden.setSystemReserved(true);
    externalLinkType_hidden.setUndeletable(true);
    externalLinkType_hidden.setMultiLingual(false);
    MetadataBuilder externalLinkType_id = externalLinkTypeSchema.create("id").setType(MetadataValueType.STRING);
    externalLinkType_id.setDefaultRequirement(true);
    externalLinkType_id.setSystemReserved(true);
    externalLinkType_id.setUndeletable(true);
    externalLinkType_id.setMultiLingual(false);
    externalLinkType_id.setSearchable(true);
    externalLinkType_id.setSortable(true);
    externalLinkType_id.setUniqueValue(true);
    externalLinkType_id.setUnmodifiable(true);
    MetadataBuilder externalLinkType_legacyIdentifier = externalLinkTypeSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    externalLinkType_legacyIdentifier.setDefaultRequirement(true);
    externalLinkType_legacyIdentifier.setSystemReserved(true);
    externalLinkType_legacyIdentifier.setUndeletable(true);
    externalLinkType_legacyIdentifier.setMultiLingual(false);
    externalLinkType_legacyIdentifier.setSearchable(true);
    externalLinkType_legacyIdentifier.setUniqueValue(true);
    externalLinkType_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder externalLinkType_linkedSchema = externalLinkTypeSchema.create("linkedSchema").setType(MetadataValueType.STRING);
    externalLinkType_linkedSchema.setUndeletable(true);
    MetadataBuilder externalLinkType_logicallyDeletedOn = externalLinkTypeSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    externalLinkType_logicallyDeletedOn.setSystemReserved(true);
    externalLinkType_logicallyDeletedOn.setUndeletable(true);
    externalLinkType_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder externalLinkType_manualTokens = externalLinkTypeSchema.create("manualTokens").setType(MetadataValueType.STRING);
    externalLinkType_manualTokens.setMultivalue(true);
    externalLinkType_manualTokens.setSystemReserved(true);
    externalLinkType_manualTokens.setUndeletable(true);
    externalLinkType_manualTokens.setMultiLingual(false);
    externalLinkType_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLinkType_markedForParsing = externalLinkTypeSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    externalLinkType_markedForParsing.setSystemReserved(true);
    externalLinkType_markedForParsing.setUndeletable(true);
    externalLinkType_markedForParsing.setMultiLingual(false);
    MetadataBuilder externalLinkType_markedForPreviewConversion = externalLinkTypeSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    externalLinkType_markedForPreviewConversion.setSystemReserved(true);
    externalLinkType_markedForPreviewConversion.setUndeletable(true);
    externalLinkType_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder externalLinkType_markedForReindexing = externalLinkTypeSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    externalLinkType_markedForReindexing.setSystemReserved(true);
    externalLinkType_markedForReindexing.setUndeletable(true);
    externalLinkType_markedForReindexing.setMultiLingual(false);
    MetadataBuilder externalLinkType_migrationDataVersion = externalLinkTypeSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    externalLinkType_migrationDataVersion.setSystemReserved(true);
    externalLinkType_migrationDataVersion.setUndeletable(true);
    externalLinkType_migrationDataVersion.setMultiLingual(false);
    externalLinkType_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_modifiedBy = externalLinkTypeSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    externalLinkType_modifiedBy.setSystemReserved(true);
    externalLinkType_modifiedBy.setUndeletable(true);
    externalLinkType_modifiedBy.setMultiLingual(false);
    externalLinkType_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalLinkType_modifiedOn = externalLinkTypeSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    externalLinkType_modifiedOn.setSystemReserved(true);
    externalLinkType_modifiedOn.setUndeletable(true);
    externalLinkType_modifiedOn.setMultiLingual(false);
    externalLinkType_modifiedOn.setAvailableInSummary(true);
    externalLinkType_modifiedOn.setSortable(true);
    MetadataBuilder externalLinkType_nestedAuthorizations = externalLinkTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    externalLinkType_nestedAuthorizations.setSystemReserved(true);
    externalLinkType_nestedAuthorizations.setUndeletable(true);
    externalLinkType_nestedAuthorizations.setMultiLingual(false);
    externalLinkType_nestedAuthorizations.setEssentialInSummary(true);
    externalLinkType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder externalLinkType_path = externalLinkTypeSchema.create("path").setType(MetadataValueType.STRING);
    externalLinkType_path.setMultivalue(true);
    externalLinkType_path.setSystemReserved(true);
    externalLinkType_path.setUndeletable(true);
    externalLinkType_path.setMultiLingual(false);
    MetadataBuilder externalLinkType_pathParts = externalLinkTypeSchema.create("pathParts").setType(MetadataValueType.STRING);
    externalLinkType_pathParts.setMultivalue(true);
    externalLinkType_pathParts.setSystemReserved(true);
    externalLinkType_pathParts.setUndeletable(true);
    externalLinkType_pathParts.setMultiLingual(false);
    MetadataBuilder externalLinkType_principalAncestorsIntIds = externalLinkTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalLinkType_principalAncestorsIntIds.setMultivalue(true);
    externalLinkType_principalAncestorsIntIds.setSystemReserved(true);
    externalLinkType_principalAncestorsIntIds.setUndeletable(true);
    externalLinkType_principalAncestorsIntIds.setMultiLingual(false);
    externalLinkType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_principalConceptsIntIds = externalLinkTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalLinkType_principalConceptsIntIds.setMultivalue(true);
    externalLinkType_principalConceptsIntIds.setSystemReserved(true);
    externalLinkType_principalConceptsIntIds.setUndeletable(true);
    externalLinkType_principalConceptsIntIds.setMultiLingual(false);
    externalLinkType_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_principalpath = externalLinkTypeSchema.create("principalpath").setType(MetadataValueType.STRING);
    externalLinkType_principalpath.setSystemReserved(true);
    externalLinkType_principalpath.setUndeletable(true);
    externalLinkType_principalpath.setMultiLingual(false);
    MetadataBuilder externalLinkType_removedauthorizations = externalLinkTypeSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    externalLinkType_removedauthorizations.setMultivalue(true);
    externalLinkType_removedauthorizations.setSystemReserved(true);
    externalLinkType_removedauthorizations.setUndeletable(true);
    externalLinkType_removedauthorizations.setMultiLingual(false);
    MetadataBuilder externalLinkType_schema = externalLinkTypeSchema.create("schema").setType(MetadataValueType.STRING);
    externalLinkType_schema.setDefaultRequirement(true);
    externalLinkType_schema.setSystemReserved(true);
    externalLinkType_schema.setUndeletable(true);
    externalLinkType_schema.setMultiLingual(false);
    MetadataBuilder externalLinkType_secondaryConceptsIntIds = externalLinkTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalLinkType_secondaryConceptsIntIds.setMultivalue(true);
    externalLinkType_secondaryConceptsIntIds.setSystemReserved(true);
    externalLinkType_secondaryConceptsIntIds.setUndeletable(true);
    externalLinkType_secondaryConceptsIntIds.setMultiLingual(false);
    externalLinkType_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalLinkType_shareDenyTokens = externalLinkTypeSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    externalLinkType_shareDenyTokens.setMultivalue(true);
    externalLinkType_shareDenyTokens.setSystemReserved(true);
    externalLinkType_shareDenyTokens.setUndeletable(true);
    externalLinkType_shareDenyTokens.setMultiLingual(false);
    externalLinkType_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLinkType_shareTokens = externalLinkTypeSchema.create("shareTokens").setType(MetadataValueType.STRING);
    externalLinkType_shareTokens.setMultivalue(true);
    externalLinkType_shareTokens.setSystemReserved(true);
    externalLinkType_shareTokens.setUndeletable(true);
    externalLinkType_shareTokens.setMultiLingual(false);
    externalLinkType_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalLinkType_title = externalLinkTypeSchema.create("title").setType(MetadataValueType.STRING);
    externalLinkType_title.setDefaultRequirement(true);
    externalLinkType_title.setUndeletable(true);
    externalLinkType_title.setMultiLingual(true);
    externalLinkType_title.setAvailableInSummary(true);
    externalLinkType_title.setSchemaAutocomplete(true);
    externalLinkType_title.setSearchable(true);
    externalLinkType_title.setUniqueValue(true);
    externalLinkType_title.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder externalLinkType_tokens = externalLinkTypeSchema.create("tokens").setType(MetadataValueType.STRING);
    externalLinkType_tokens.setMultivalue(true);
    externalLinkType_tokens.setSystemReserved(true);
    externalLinkType_tokens.setUndeletable(true);
    externalLinkType_tokens.setMultiLingual(false);
    MetadataBuilder externalLinkType_tokensHierarchy = externalLinkTypeSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    externalLinkType_tokensHierarchy.setMultivalue(true);
    externalLinkType_tokensHierarchy.setSystemReserved(true);
    externalLinkType_tokensHierarchy.setUndeletable(true);
    externalLinkType_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder externalLinkType_visibleInTrees = externalLinkTypeSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    externalLinkType_visibleInTrees.setSystemReserved(true);
    externalLinkType_visibleInTrees.setUndeletable(true);
    externalLinkType_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createCartSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder cartSchemaType, MetadataSchemaBuilder cartSchema) {
    ...
    MetadataBuilder cart_attachedPrincipalAncestorsIntIds = cartSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    cart_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    cart_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    cart_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    cart_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    cart_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder cart_detachedPrincipalAncestorsIntIds = cartSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    cart_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    cart_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    cart_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    cart_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    cart_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder cart_hidden = cartSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    cart_hidden.setSystemReserved(true);
    cart_hidden.setUndeletable(true);
    cart_hidden.setMultiLingual(false);
    ...
    cart_modifiedOn.setAvailableInSummary(true);
    cart_modifiedOn.setSortable(true);
    MetadataBuilder cart_nestedAuthorizations = cartSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    cart_nestedAuthorizations.setSystemReserved(true);
    cart_nestedAuthorizations.setUndeletable(true);
    cart_nestedAuthorizations.setMultiLingual(false);
    cart_nestedAuthorizations.setEssentialInSummary(true);
    cart_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder cart_principalAncestorsIntIds = cartSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    cart_principalAncestorsIntIds.setMultivalue(true);
    cart_principalAncestorsIntIds.setSystemReserved(true);
    cart_principalAncestorsIntIds.setUndeletable(true);
    cart_principalAncestorsIntIds.setMultiLingual(false);
    cart_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder cart_principalConceptsIntIds = cartSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    cart_principalConceptsIntIds.setMultivalue(true);
    cart_principalConceptsIntIds.setSystemReserved(true);
    cart_principalConceptsIntIds.setUndeletable(true);
    cart_principalConceptsIntIds.setMultiLingual(false);
    cart_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder cart_secondaryConceptsIntIds = cartSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    cart_secondaryConceptsIntIds.setMultivalue(true);
    cart_secondaryConceptsIntIds.setSystemReserved(true);
    cart_secondaryConceptsIntIds.setUndeletable(true);
    cart_secondaryConceptsIntIds.setMultiLingual(false);
    cart_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    cart_title.setDefaultRequirement(true);
    cart_title.setUndeletable(true);
    cart_title.setMultiLingual(false);
    cart_title.setAvailableInSummary(true);
  ...
  private void createDdvYearTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvYearTypeSchemaType, MetadataSchemaBuilder ddvYearTypeSchema) {
    MetadataBuilder ddvYearType_abbreviation = ddvYearTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvYearType_abbreviation.setUndeletable(true);
    ddvYearType_abbreviation.setMultiLingual(true);
    ddvYearType_abbreviation.setSearchable(true);
    ddvYearType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvYearType_attachedPrincipalAncestorsIntIds = ddvYearTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvYearType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvYearType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvYearType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvYearType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvYearType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvYearType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvYearType_detachedPrincipalAncestorsIntIds = ddvYearTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvYearType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvYearType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvYearType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvYearType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvYearType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvYearType_hidden = ddvYearTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvYearType_hidden.setSystemReserved(true);
    ddvYearType_hidden.setUndeletable(true);
    ddvYearType_hidden.setMultiLingual(false);
    ...
    ddvYearType_modifiedOn.setAvailableInSummary(true);
    ddvYearType_modifiedOn.setSortable(true);
    MetadataBuilder ddvYearType_nestedAuthorizations = ddvYearTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvYearType_nestedAuthorizations.setSystemReserved(true);
    ddvYearType_nestedAuthorizations.setUndeletable(true);
    ddvYearType_nestedAuthorizations.setMultiLingual(false);
    ddvYearType_nestedAuthorizations.setEssentialInSummary(true);
    ddvYearType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvYearType_principalAncestorsIntIds = ddvYearTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvYearType_principalAncestorsIntIds.setMultivalue(true);
    ddvYearType_principalAncestorsIntIds.setSystemReserved(true);
    ddvYearType_principalAncestorsIntIds.setUndeletable(true);
    ddvYearType_principalAncestorsIntIds.setMultiLingual(false);
    ddvYearType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvYearType_principalConceptsIntIds = ddvYearTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvYearType_principalConceptsIntIds.setMultivalue(true);
    ddvYearType_principalConceptsIntIds.setSystemReserved(true);
    ddvYearType_principalConceptsIntIds.setUndeletable(true);
    ddvYearType_principalConceptsIntIds.setMultiLingual(false);
    ddvYearType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvYearType_secondaryConceptsIntIds = ddvYearTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvYearType_secondaryConceptsIntIds.setMultivalue(true);
    ddvYearType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvYearType_secondaryConceptsIntIds.setUndeletable(true);
    ddvYearType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvYearType_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createStorageSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder storageSpaceSchemaType, MetadataSchemaBuilder storageSpaceSchema) {
    ...
    MetadataBuilder storageSpace_attachedPrincipalAncestorsIntIds = storageSpaceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    storageSpace_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    storageSpace_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    storageSpace_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    storageSpace_attachedPrincipalAncestorsIntIds.setEssential(true);
    storageSpace_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    storageSpace_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder storageSpace_detachedPrincipalAncestorsIntIds = storageSpaceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    storageSpace_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    storageSpace_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    storageSpace_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    storageSpace_detachedPrincipalAncestorsIntIds.setEssential(true);
    storageSpace_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    storageSpace_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder storageSpace_hidden = storageSpaceSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    storageSpace_hidden.setSystemReserved(true);
    storageSpace_hidden.setUndeletable(true);
    storageSpace_hidden.setEssential(true);
    storageSpace_hidden.setMultiLingual(false);
    ...
    storageSpace_modifiedOn.setAvailableInSummary(true);
    storageSpace_modifiedOn.setSortable(true);
    MetadataBuilder storageSpace_nestedAuthorizations = storageSpaceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    storageSpace_nestedAuthorizations.setSystemReserved(true);
    storageSpace_nestedAuthorizations.setUndeletable(true);
    storageSpace_nestedAuthorizations.setEssential(true);
    storageSpace_nestedAuthorizations.setMultiLingual(false);
    storageSpace_nestedAuthorizations.setEssentialInSummary(true);
    storageSpace_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    storageSpace_parentStorageSpace.setCacheIndex(true);
    ...
    MetadataBuilder storageSpace_principalAncestorsIntIds = storageSpaceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    storageSpace_principalAncestorsIntIds.setMultivalue(true);
    storageSpace_principalAncestorsIntIds.setSystemReserved(true);
    storageSpace_principalAncestorsIntIds.setUndeletable(true);
    storageSpace_principalAncestorsIntIds.setEssential(true);
    storageSpace_principalAncestorsIntIds.setMultiLingual(false);
    storageSpace_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder storageSpace_principalConceptsIntIds = storageSpaceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    storageSpace_principalConceptsIntIds.setMultivalue(true);
    storageSpace_principalConceptsIntIds.setSystemReserved(true);
    storageSpace_principalConceptsIntIds.setUndeletable(true);
    storageSpace_principalConceptsIntIds.setEssential(true);
    storageSpace_principalConceptsIntIds.setMultiLingual(false);
    storageSpace_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder storageSpace_secondaryConceptsIntIds = storageSpaceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    storageSpace_secondaryConceptsIntIds.setMultivalue(true);
    storageSpace_secondaryConceptsIntIds.setSystemReserved(true);
    storageSpace_secondaryConceptsIntIds.setUndeletable(true);
    storageSpace_secondaryConceptsIntIds.setEssential(true);
    storageSpace_secondaryConceptsIntIds.setMultiLingual(false);
    storageSpace_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    storageSpace_title.setAvailableInSummary(true);
  ...
  private void createDdvRequirementTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvRequirementTypeSchemaType, MetadataSchemaBuilder ddvRequirementTypeSchema) {
    MetadataBuilder ddvRequirementType_abbreviation = ddvRequirementTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvRequirementType_abbreviation.setUndeletable(true);
    ddvRequirementType_abbreviation.setMultiLingual(true);
    ddvRequirementType_abbreviation.setSearchable(true);
    ddvRequirementType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvRequirementType_allReferences = ddvRequirementTypeSchema.create("allReferences").setType(MetadataValueType.STRING);
    ddvRequirementType_allReferences.setMultivalue(true);
    ddvRequirementType_allReferences.setSystemReserved(true);
    ddvRequirementType_allReferences.setUndeletable(true);
    ddvRequirementType_allReferences.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_allRemovedAuths = ddvRequirementTypeSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    ddvRequirementType_allRemovedAuths.setMultivalue(true);
    ddvRequirementType_allRemovedAuths.setSystemReserved(true);
    ddvRequirementType_allRemovedAuths.setUndeletable(true);
    ddvRequirementType_allRemovedAuths.setEssential(true);
    ddvRequirementType_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_attachedAncestors = ddvRequirementTypeSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    ddvRequirementType_attachedAncestors.setMultivalue(true);
    ddvRequirementType_attachedAncestors.setSystemReserved(true);
    ddvRequirementType_attachedAncestors.setUndeletable(true);
    ddvRequirementType_attachedAncestors.setEssential(true);
    ddvRequirementType_attachedAncestors.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_attachedPrincipalAncestorsIntIds = ddvRequirementTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvRequirementType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvRequirementType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvRequirementType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvRequirementType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvRequirementType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_autocomplete = ddvRequirementTypeSchema.create("autocomplete").setType(MetadataValueType.STRING);
    ddvRequirementType_autocomplete.setMultivalue(true);
    ddvRequirementType_autocomplete.setSystemReserved(true);
    ddvRequirementType_autocomplete.setUndeletable(true);
    ddvRequirementType_autocomplete.setEssential(true);
    ddvRequirementType_autocomplete.setMultiLingual(true);
    MetadataBuilder ddvRequirementType_caption = ddvRequirementTypeSchema.create("caption").setType(MetadataValueType.STRING);
    ddvRequirementType_caption.setSystemReserved(true);
    ddvRequirementType_caption.setUndeletable(true);
    ddvRequirementType_caption.setMultiLingual(false);
    ddvRequirementType_caption.setSortable(true);
    MetadataBuilder ddvRequirementType_code = ddvRequirementTypeSchema.create("code").setType(MetadataValueType.STRING);
    ddvRequirementType_code.setDefaultRequirement(true);
    ddvRequirementType_code.setUndeletable(true);
    ddvRequirementType_code.setSchemaAutocomplete(true);
    ddvRequirementType_code.setSearchable(true);
    ddvRequirementType_code.setUniqueValue(true);
    ddvRequirementType_code.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvRequirementType_comments = ddvRequirementTypeSchema.create("comments").setType(MetadataValueType.STRUCTURE);
    ddvRequirementType_comments.setMultivalue(true);
    ddvRequirementType_comments.defineStructureFactory(CommentFactory.class);
    MetadataBuilder ddvRequirementType_createdBy = ddvRequirementTypeSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    ddvRequirementType_createdBy.setSystemReserved(true);
    ddvRequirementType_createdBy.setUndeletable(true);
    ddvRequirementType_createdBy.setMultiLingual(false);
    ddvRequirementType_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvRequirementType_createdOn = ddvRequirementTypeSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    ddvRequirementType_createdOn.setSystemReserved(true);
    ddvRequirementType_createdOn.setUndeletable(true);
    ddvRequirementType_createdOn.setMultiLingual(false);
    ddvRequirementType_createdOn.setSortable(true);
    MetadataBuilder ddvRequirementType_deleted = ddvRequirementTypeSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_deleted.setSystemReserved(true);
    ddvRequirementType_deleted.setUndeletable(true);
    ddvRequirementType_deleted.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_denyTokens = ddvRequirementTypeSchema.create("denyTokens").setType(MetadataValueType.STRING);
    ddvRequirementType_denyTokens.setMultivalue(true);
    ddvRequirementType_denyTokens.setSystemReserved(true);
    ddvRequirementType_denyTokens.setUndeletable(true);
    ddvRequirementType_denyTokens.setMultiLingual(false);
    ddvRequirementType_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvRequirementType_description = ddvRequirementTypeSchema.create("description").setType(MetadataValueType.TEXT);
    ddvRequirementType_description.setUndeletable(true);
    ddvRequirementType_description.setMultiLingual(true);
    ddvRequirementType_description.setSearchable(true);
    MetadataBuilder ddvRequirementType_detachedPrincipalAncestorsIntIds = ddvRequirementTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvRequirementType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvRequirementType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvRequirementType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvRequirementType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvRequirementType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_detachedauthorizations = ddvRequirementTypeSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_detachedauthorizations.setSystemReserved(true);
    ddvRequirementType_detachedauthorizations.setUndeletable(true);
    ddvRequirementType_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_errorOnPhysicalDeletion = ddvRequirementTypeSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_errorOnPhysicalDeletion.setSystemReserved(true);
    ddvRequirementType_errorOnPhysicalDeletion.setUndeletable(true);
    ddvRequirementType_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_estimatedSize = ddvRequirementTypeSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    ddvRequirementType_estimatedSize.setSystemReserved(true);
    ddvRequirementType_estimatedSize.setUndeletable(true);
    ddvRequirementType_estimatedSize.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_hidden = ddvRequirementTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_hidden.setSystemReserved(true);
    ddvRequirementType_hidden.setUndeletable(true);
    ddvRequirementType_hidden.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_id = ddvRequirementTypeSchema.create("id").setType(MetadataValueType.STRING);
    ddvRequirementType_id.setDefaultRequirement(true);
    ddvRequirementType_id.setSystemReserved(true);
    ddvRequirementType_id.setUndeletable(true);
    ddvRequirementType_id.setMultiLingual(false);
    ddvRequirementType_id.setSearchable(true);
    ddvRequirementType_id.setSortable(true);
    ddvRequirementType_id.setUniqueValue(true);
    ddvRequirementType_id.setUnmodifiable(true);
    MetadataBuilder ddvRequirementType_legacyIdentifier = ddvRequirementTypeSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    ddvRequirementType_legacyIdentifier.setDefaultRequirement(true);
    ddvRequirementType_legacyIdentifier.setSystemReserved(true);
    ddvRequirementType_legacyIdentifier.setUndeletable(true);
    ddvRequirementType_legacyIdentifier.setMultiLingual(false);
    ddvRequirementType_legacyIdentifier.setSearchable(true);
    ddvRequirementType_legacyIdentifier.setUniqueValue(true);
    ddvRequirementType_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder ddvRequirementType_logicallyDeletedOn = ddvRequirementTypeSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    ddvRequirementType_logicallyDeletedOn.setSystemReserved(true);
    ddvRequirementType_logicallyDeletedOn.setUndeletable(true);
    ddvRequirementType_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_manualTokens = ddvRequirementTypeSchema.create("manualTokens").setType(MetadataValueType.STRING);
    ddvRequirementType_manualTokens.setMultivalue(true);
    ddvRequirementType_manualTokens.setSystemReserved(true);
    ddvRequirementType_manualTokens.setUndeletable(true);
    ddvRequirementType_manualTokens.setMultiLingual(false);
    ddvRequirementType_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvRequirementType_markedForParsing = ddvRequirementTypeSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_markedForParsing.setSystemReserved(true);
    ddvRequirementType_markedForParsing.setUndeletable(true);
    ddvRequirementType_markedForParsing.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_markedForPreviewConversion = ddvRequirementTypeSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_markedForPreviewConversion.setSystemReserved(true);
    ddvRequirementType_markedForPreviewConversion.setUndeletable(true);
    ddvRequirementType_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_markedForReindexing = ddvRequirementTypeSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_markedForReindexing.setSystemReserved(true);
    ddvRequirementType_markedForReindexing.setUndeletable(true);
    ddvRequirementType_markedForReindexing.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_migrationDataVersion = ddvRequirementTypeSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    ddvRequirementType_migrationDataVersion.setSystemReserved(true);
    ddvRequirementType_migrationDataVersion.setUndeletable(true);
    ddvRequirementType_migrationDataVersion.setMultiLingual(false);
    ddvRequirementType_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_modifiedBy = ddvRequirementTypeSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    ddvRequirementType_modifiedBy.setSystemReserved(true);
    ddvRequirementType_modifiedBy.setUndeletable(true);
    ddvRequirementType_modifiedBy.setMultiLingual(false);
    ddvRequirementType_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvRequirementType_modifiedOn = ddvRequirementTypeSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    ddvRequirementType_modifiedOn.setSystemReserved(true);
    ddvRequirementType_modifiedOn.setUndeletable(true);
    ddvRequirementType_modifiedOn.setMultiLingual(false);
    ddvRequirementType_modifiedOn.setAvailableInSummary(true);
    ddvRequirementType_modifiedOn.setSortable(true);
    MetadataBuilder ddvRequirementType_nestedAuthorizations = ddvRequirementTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvRequirementType_nestedAuthorizations.setSystemReserved(true);
    ddvRequirementType_nestedAuthorizations.setUndeletable(true);
    ddvRequirementType_nestedAuthorizations.setMultiLingual(false);
    ddvRequirementType_nestedAuthorizations.setEssentialInSummary(true);
    ddvRequirementType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder ddvRequirementType_path = ddvRequirementTypeSchema.create("path").setType(MetadataValueType.STRING);
    ddvRequirementType_path.setMultivalue(true);
    ddvRequirementType_path.setSystemReserved(true);
    ddvRequirementType_path.setUndeletable(true);
    ddvRequirementType_path.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_pathParts = ddvRequirementTypeSchema.create("pathParts").setType(MetadataValueType.STRING);
    ddvRequirementType_pathParts.setMultivalue(true);
    ddvRequirementType_pathParts.setSystemReserved(true);
    ddvRequirementType_pathParts.setUndeletable(true);
    ddvRequirementType_pathParts.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_principalAncestorsIntIds = ddvRequirementTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvRequirementType_principalAncestorsIntIds.setMultivalue(true);
    ddvRequirementType_principalAncestorsIntIds.setSystemReserved(true);
    ddvRequirementType_principalAncestorsIntIds.setUndeletable(true);
    ddvRequirementType_principalAncestorsIntIds.setMultiLingual(false);
    ddvRequirementType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_principalConceptsIntIds = ddvRequirementTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvRequirementType_principalConceptsIntIds.setMultivalue(true);
    ddvRequirementType_principalConceptsIntIds.setSystemReserved(true);
    ddvRequirementType_principalConceptsIntIds.setUndeletable(true);
    ddvRequirementType_principalConceptsIntIds.setMultiLingual(false);
    ddvRequirementType_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_principalpath = ddvRequirementTypeSchema.create("principalpath").setType(MetadataValueType.STRING);
    ddvRequirementType_principalpath.setSystemReserved(true);
    ddvRequirementType_principalpath.setUndeletable(true);
    ddvRequirementType_principalpath.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_removedauthorizations = ddvRequirementTypeSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    ddvRequirementType_removedauthorizations.setMultivalue(true);
    ddvRequirementType_removedauthorizations.setSystemReserved(true);
    ddvRequirementType_removedauthorizations.setUndeletable(true);
    ddvRequirementType_removedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_schema = ddvRequirementTypeSchema.create("schema").setType(MetadataValueType.STRING);
    ddvRequirementType_schema.setDefaultRequirement(true);
    ddvRequirementType_schema.setSystemReserved(true);
    ddvRequirementType_schema.setUndeletable(true);
    ddvRequirementType_schema.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_secondaryConceptsIntIds = ddvRequirementTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvRequirementType_secondaryConceptsIntIds.setMultivalue(true);
    ddvRequirementType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvRequirementType_secondaryConceptsIntIds.setUndeletable(true);
    ddvRequirementType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvRequirementType_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvRequirementType_shareDenyTokens = ddvRequirementTypeSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    ddvRequirementType_shareDenyTokens.setMultivalue(true);
    ddvRequirementType_shareDenyTokens.setSystemReserved(true);
    ddvRequirementType_shareDenyTokens.setUndeletable(true);
    ddvRequirementType_shareDenyTokens.setMultiLingual(false);
    ddvRequirementType_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvRequirementType_shareTokens = ddvRequirementTypeSchema.create("shareTokens").setType(MetadataValueType.STRING);
    ddvRequirementType_shareTokens.setMultivalue(true);
    ddvRequirementType_shareTokens.setSystemReserved(true);
    ddvRequirementType_shareTokens.setUndeletable(true);
    ddvRequirementType_shareTokens.setMultiLingual(false);
    ddvRequirementType_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvRequirementType_title = ddvRequirementTypeSchema.create("title").setType(MetadataValueType.STRING);
    ddvRequirementType_title.setDefaultRequirement(true);
    ddvRequirementType_title.setUndeletable(true);
    ddvRequirementType_title.setMultiLingual(true);
    ddvRequirementType_title.setAvailableInSummary(true);
    ddvRequirementType_title.setSchemaAutocomplete(true);
    ddvRequirementType_title.setSearchable(true);
    ddvRequirementType_title.setUniqueValue(true);
    ddvRequirementType_title.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvRequirementType_tokens = ddvRequirementTypeSchema.create("tokens").setType(MetadataValueType.STRING);
    ddvRequirementType_tokens.setMultivalue(true);
    ddvRequirementType_tokens.setSystemReserved(true);
    ddvRequirementType_tokens.setUndeletable(true);
    ddvRequirementType_tokens.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_tokensHierarchy = ddvRequirementTypeSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    ddvRequirementType_tokensHierarchy.setMultivalue(true);
    ddvRequirementType_tokensHierarchy.setSystemReserved(true);
    ddvRequirementType_tokensHierarchy.setUndeletable(true);
    ddvRequirementType_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder ddvRequirementType_visibleInTrees = ddvRequirementTypeSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    ddvRequirementType_visibleInTrees.setSystemReserved(true);
    ddvRequirementType_visibleInTrees.setUndeletable(true);
    ddvRequirementType_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createBagInfoSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder bagInfoSchemaType, MetadataSchemaBuilder bagInfoSchema) {
    ...
    MetadataBuilder bagInfo_attachedPrincipalAncestorsIntIds = bagInfoSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    bagInfo_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    bagInfo_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    bagInfo_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    bagInfo_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    bagInfo_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder bagInfo_detachedPrincipalAncestorsIntIds = bagInfoSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    bagInfo_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    bagInfo_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    bagInfo_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    bagInfo_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    bagInfo_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder bagInfo_hidden = bagInfoSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    bagInfo_hidden.setSystemReserved(true);
    bagInfo_hidden.setUndeletable(true);
    bagInfo_hidden.setMultiLingual(false);
    ...
    bagInfo_modifiedOn.setAvailableInSummary(true);
    bagInfo_modifiedOn.setSortable(true);
    MetadataBuilder bagInfo_nestedAuthorizations = bagInfoSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    bagInfo_nestedAuthorizations.setSystemReserved(true);
    bagInfo_nestedAuthorizations.setUndeletable(true);
    bagInfo_nestedAuthorizations.setMultiLingual(false);
    bagInfo_nestedAuthorizations.setEssentialInSummary(true);
    bagInfo_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder bagInfo_principalAncestorsIntIds = bagInfoSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    bagInfo_principalAncestorsIntIds.setMultivalue(true);
    bagInfo_principalAncestorsIntIds.setSystemReserved(true);
    bagInfo_principalAncestorsIntIds.setUndeletable(true);
    bagInfo_principalAncestorsIntIds.setMultiLingual(false);
    bagInfo_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder bagInfo_principalConceptsIntIds = bagInfoSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    bagInfo_principalConceptsIntIds.setMultivalue(true);
    bagInfo_principalConceptsIntIds.setSystemReserved(true);
    bagInfo_principalConceptsIntIds.setUndeletable(true);
    bagInfo_principalConceptsIntIds.setMultiLingual(false);
    bagInfo_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder bagInfo_secondaryConceptsIntIds = bagInfoSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    bagInfo_secondaryConceptsIntIds.setMultivalue(true);
    bagInfo_secondaryConceptsIntIds.setSystemReserved(true);
    bagInfo_secondaryConceptsIntIds.setUndeletable(true);
    bagInfo_secondaryConceptsIntIds.setMultiLingual(false);
    bagInfo_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    bagInfo_title.setAvailableInSummary(true);
  ...
  private void createDdvMediumTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvMediumTypeSchemaType, MetadataSchemaBuilder ddvMediumTypeSchema) {
    MetadataBuilder ddvMediumType_abbreviation = ddvMediumTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvMediumType_abbreviation.setUndeletable(true);
    ddvMediumType_abbreviation.setMultiLingual(true);
    ddvMediumType_abbreviation.setSearchable(true);
    ddvMediumType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvMediumType_attachedPrincipalAncestorsIntIds = ddvMediumTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvMediumType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvMediumType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvMediumType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvMediumType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvMediumType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvMediumType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvMediumType_detachedPrincipalAncestorsIntIds = ddvMediumTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvMediumType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvMediumType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvMediumType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvMediumType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvMediumType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvMediumType_hidden = ddvMediumTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvMediumType_hidden.setSystemReserved(true);
    ddvMediumType_hidden.setUndeletable(true);
    ddvMediumType_hidden.setMultiLingual(false);
    ...
    ddvMediumType_modifiedOn.setAvailableInSummary(true);
    ddvMediumType_modifiedOn.setSortable(true);
    MetadataBuilder ddvMediumType_nestedAuthorizations = ddvMediumTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvMediumType_nestedAuthorizations.setSystemReserved(true);
    ddvMediumType_nestedAuthorizations.setUndeletable(true);
    ddvMediumType_nestedAuthorizations.setMultiLingual(false);
    ddvMediumType_nestedAuthorizations.setEssentialInSummary(true);
    ddvMediumType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvMediumType_principalAncestorsIntIds = ddvMediumTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvMediumType_principalAncestorsIntIds.setMultivalue(true);
    ddvMediumType_principalAncestorsIntIds.setSystemReserved(true);
    ddvMediumType_principalAncestorsIntIds.setUndeletable(true);
    ddvMediumType_principalAncestorsIntIds.setMultiLingual(false);
    ddvMediumType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvMediumType_principalConceptsIntIds = ddvMediumTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvMediumType_principalConceptsIntIds.setMultivalue(true);
    ddvMediumType_principalConceptsIntIds.setSystemReserved(true);
    ddvMediumType_principalConceptsIntIds.setUndeletable(true);
    ddvMediumType_principalConceptsIntIds.setMultiLingual(false);
    ddvMediumType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvMediumType_secondaryConceptsIntIds = ddvMediumTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvMediumType_secondaryConceptsIntIds.setMultivalue(true);
    ddvMediumType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvMediumType_secondaryConceptsIntIds.setUndeletable(true);
    ddvMediumType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvMediumType_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvMediumType_title.setAvailableInSummary(true);
    ...
    ddvMediumType_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createFilingSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder filingSpaceSchemaType, MetadataSchemaBuilder filingSpaceSchema) {
    ...
    MetadataBuilder filingSpace_attachedPrincipalAncestorsIntIds = filingSpaceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    filingSpace_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    filingSpace_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    filingSpace_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    filingSpace_attachedPrincipalAncestorsIntIds.setEssential(true);
    filingSpace_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    filingSpace_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder filingSpace_detachedPrincipalAncestorsIntIds = filingSpaceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    filingSpace_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    filingSpace_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    filingSpace_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    filingSpace_detachedPrincipalAncestorsIntIds.setEssential(true);
    filingSpace_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    filingSpace_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder filingSpace_hidden = filingSpaceSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    filingSpace_hidden.setSystemReserved(true);
    filingSpace_hidden.setUndeletable(true);
    filingSpace_hidden.setEssential(true);
    filingSpace_hidden.setMultiLingual(false);
    ...
    filingSpace_modifiedOn.setAvailableInSummary(true);
    filingSpace_modifiedOn.setSortable(true);
    MetadataBuilder filingSpace_nestedAuthorizations = filingSpaceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    filingSpace_nestedAuthorizations.setSystemReserved(true);
    filingSpace_nestedAuthorizations.setUndeletable(true);
    filingSpace_nestedAuthorizations.setEssential(true);
    filingSpace_nestedAuthorizations.setMultiLingual(false);
    filingSpace_nestedAuthorizations.setEssentialInSummary(true);
    filingSpace_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder filingSpace_principalAncestorsIntIds = filingSpaceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    filingSpace_principalAncestorsIntIds.setMultivalue(true);
    filingSpace_principalAncestorsIntIds.setSystemReserved(true);
    filingSpace_principalAncestorsIntIds.setUndeletable(true);
    filingSpace_principalAncestorsIntIds.setEssential(true);
    filingSpace_principalAncestorsIntIds.setMultiLingual(false);
    filingSpace_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder filingSpace_principalConceptsIntIds = filingSpaceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    filingSpace_principalConceptsIntIds.setMultivalue(true);
    filingSpace_principalConceptsIntIds.setSystemReserved(true);
    filingSpace_principalConceptsIntIds.setUndeletable(true);
    filingSpace_principalConceptsIntIds.setEssential(true);
    filingSpace_principalConceptsIntIds.setMultiLingual(false);
    filingSpace_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder filingSpace_secondaryConceptsIntIds = filingSpaceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    filingSpace_secondaryConceptsIntIds.setMultivalue(true);
    filingSpace_secondaryConceptsIntIds.setSystemReserved(true);
    filingSpace_secondaryConceptsIntIds.setUndeletable(true);
    filingSpace_secondaryConceptsIntIds.setEssential(true);
    filingSpace_secondaryConceptsIntIds.setMultiLingual(false);
    filingSpace_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    filingSpace_title.setAvailableInSummary(true);
  ...
  private void createDdvFolderTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvFolderTypeSchemaType, MetadataSchemaBuilder ddvFolderTypeSchema) {
    MetadataBuilder ddvFolderType_abbreviation = ddvFolderTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvFolderType_abbreviation.setUndeletable(true);
    ddvFolderType_abbreviation.setMultiLingual(true);
    ddvFolderType_abbreviation.setSearchable(true);
    ddvFolderType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvFolderType_attachedPrincipalAncestorsIntIds = ddvFolderTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvFolderType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvFolderType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvFolderType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvFolderType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvFolderType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvFolderType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvFolderType_detachedPrincipalAncestorsIntIds = ddvFolderTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvFolderType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvFolderType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvFolderType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvFolderType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvFolderType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvFolderType_hidden = ddvFolderTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvFolderType_hidden.setSystemReserved(true);
    ddvFolderType_hidden.setUndeletable(true);
    ddvFolderType_hidden.setMultiLingual(false);
    ...
    ddvFolderType_modifiedOn.setAvailableInSummary(true);
    ddvFolderType_modifiedOn.setSortable(true);
    MetadataBuilder ddvFolderType_nestedAuthorizations = ddvFolderTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvFolderType_nestedAuthorizations.setSystemReserved(true);
    ddvFolderType_nestedAuthorizations.setUndeletable(true);
    ddvFolderType_nestedAuthorizations.setMultiLingual(false);
    ddvFolderType_nestedAuthorizations.setEssentialInSummary(true);
    ddvFolderType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvFolderType_principalAncestorsIntIds = ddvFolderTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvFolderType_principalAncestorsIntIds.setMultivalue(true);
    ddvFolderType_principalAncestorsIntIds.setSystemReserved(true);
    ddvFolderType_principalAncestorsIntIds.setUndeletable(true);
    ddvFolderType_principalAncestorsIntIds.setMultiLingual(false);
    ddvFolderType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvFolderType_principalConceptsIntIds = ddvFolderTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvFolderType_principalConceptsIntIds.setMultivalue(true);
    ddvFolderType_principalConceptsIntIds.setSystemReserved(true);
    ddvFolderType_principalConceptsIntIds.setUndeletable(true);
    ddvFolderType_principalConceptsIntIds.setMultiLingual(false);
    ddvFolderType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvFolderType_secondaryConceptsIntIds = ddvFolderTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvFolderType_secondaryConceptsIntIds.setMultivalue(true);
    ddvFolderType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvFolderType_secondaryConceptsIntIds.setUndeletable(true);
    ddvFolderType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvFolderType_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvFolderType_title.setAvailableInSummary(true);
    ...
    ddvFolderType_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createUniformSubdivisionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder uniformSubdivisionSchemaType, MetadataSchemaBuilder uniformSubdivisionSchema) {
    ...
    MetadataBuilder uniformSubdivision_attachedPrincipalAncestorsIntIds = uniformSubdivisionSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setEssential(true);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    uniformSubdivision_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder uniformSubdivision_detachedPrincipalAncestorsIntIds = uniformSubdivisionSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setEssential(true);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    uniformSubdivision_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder uniformSubdivision_hidden = uniformSubdivisionSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    uniformSubdivision_hidden.setSystemReserved(true);
    uniformSubdivision_hidden.setUndeletable(true);
    uniformSubdivision_hidden.setEssential(true);
    uniformSubdivision_hidden.setMultiLingual(false);
    ...
    uniformSubdivision_modifiedOn.setAvailableInSummary(true);
    uniformSubdivision_modifiedOn.setSortable(true);
    MetadataBuilder uniformSubdivision_nestedAuthorizations = uniformSubdivisionSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    uniformSubdivision_nestedAuthorizations.setSystemReserved(true);
    uniformSubdivision_nestedAuthorizations.setUndeletable(true);
    uniformSubdivision_nestedAuthorizations.setEssential(true);
    uniformSubdivision_nestedAuthorizations.setMultiLingual(false);
    uniformSubdivision_nestedAuthorizations.setEssentialInSummary(true);
    uniformSubdivision_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder uniformSubdivision_principalAncestorsIntIds = uniformSubdivisionSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    uniformSubdivision_principalAncestorsIntIds.setMultivalue(true);
    uniformSubdivision_principalAncestorsIntIds.setSystemReserved(true);
    uniformSubdivision_principalAncestorsIntIds.setUndeletable(true);
    uniformSubdivision_principalAncestorsIntIds.setEssential(true);
    uniformSubdivision_principalAncestorsIntIds.setMultiLingual(false);
    uniformSubdivision_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder uniformSubdivision_principalConceptsIntIds = uniformSubdivisionSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    uniformSubdivision_principalConceptsIntIds.setMultivalue(true);
    uniformSubdivision_principalConceptsIntIds.setSystemReserved(true);
    uniformSubdivision_principalConceptsIntIds.setUndeletable(true);
    uniformSubdivision_principalConceptsIntIds.setEssential(true);
    uniformSubdivision_principalConceptsIntIds.setMultiLingual(false);
    uniformSubdivision_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder uniformSubdivision_secondaryConceptsIntIds = uniformSubdivisionSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    uniformSubdivision_secondaryConceptsIntIds.setMultivalue(true);
    uniformSubdivision_secondaryConceptsIntIds.setSystemReserved(true);
    uniformSubdivision_secondaryConceptsIntIds.setUndeletable(true);
    uniformSubdivision_secondaryConceptsIntIds.setEssential(true);
    uniformSubdivision_secondaryConceptsIntIds.setMultiLingual(false);
    uniformSubdivision_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    uniformSubdivision_title.setAvailableInSummary(true);
  ...
  private void createAdministrativeUnitSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder administrativeUnitSchemaType, MetadataSchemaBuilder administrativeUnitSchema) {
    MetadataBuilder administrativeUnit_abbreviation = administrativeUnitSchema.create("abbreviation").setType(MetadataValueType.STRING);
    administrativeUnit_abbreviation.setUndeletable(true);
    administrativeUnit_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder administrativeUnit_attachedPrincipalAncestorsIntIds = administrativeUnitSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setEssential(true);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    administrativeUnit_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    administrativeUnit_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder administrativeUnit_detachedPrincipalAncestorsIntIds = administrativeUnitSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setEssential(true);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    administrativeUnit_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder administrativeUnit_functionUsers = administrativeUnitSchema.create("functionUsers").setType(MetadataValueType.REFERENCE);
    administrativeUnit_functionUsers.setMultivalue(true);
    administrativeUnit_functionUsers.setUndeletable(true);
    administrativeUnit_functionUsers.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder administrativeUnit_functions = administrativeUnitSchema.create("functions").setType(MetadataValueType.REFERENCE);
    administrativeUnit_functions.setMultivalue(true);
    administrativeUnit_functions.setUndeletable(true);
    administrativeUnit_functions.defineReferencesTo(types.getSchemaType("ddvUserFunction"));
    MetadataBuilder administrativeUnit_hidden = administrativeUnitSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    administrativeUnit_hidden.setSystemReserved(true);
    administrativeUnit_hidden.setUndeletable(true);
    administrativeUnit_hidden.setEssential(true);
    administrativeUnit_hidden.setMultiLingual(false);
    ...
    administrativeUnit_modifiedOn.setAvailableInSummary(true);
    administrativeUnit_modifiedOn.setSortable(true);
    MetadataBuilder administrativeUnit_nestedAuthorizations = administrativeUnitSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    administrativeUnit_nestedAuthorizations.setSystemReserved(true);
    administrativeUnit_nestedAuthorizations.setUndeletable(true);
    administrativeUnit_nestedAuthorizations.setEssential(true);
    administrativeUnit_nestedAuthorizations.setMultiLingual(false);
    administrativeUnit_nestedAuthorizations.setEssentialInSummary(true);
    administrativeUnit_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder administrativeUnit_parent = administrativeUnitSchema.create("parent").setType(MetadataValueType.REFERENCE);
    administrativeUnit_parent.setCacheIndex(true);
    ...
    MetadataBuilder administrativeUnit_principalAncestorsIntIds = administrativeUnitSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    administrativeUnit_principalAncestorsIntIds.setMultivalue(true);
    administrativeUnit_principalAncestorsIntIds.setSystemReserved(true);
    administrativeUnit_principalAncestorsIntIds.setUndeletable(true);
    administrativeUnit_principalAncestorsIntIds.setEssential(true);
    administrativeUnit_principalAncestorsIntIds.setMultiLingual(false);
    administrativeUnit_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder administrativeUnit_principalConceptsIntIds = administrativeUnitSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    administrativeUnit_principalConceptsIntIds.setMultivalue(true);
    administrativeUnit_principalConceptsIntIds.setSystemReserved(true);
    administrativeUnit_principalConceptsIntIds.setUndeletable(true);
    administrativeUnit_principalConceptsIntIds.setEssential(true);
    administrativeUnit_principalConceptsIntIds.setMultiLingual(false);
    administrativeUnit_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder administrativeUnit_secondaryConceptsIntIds = administrativeUnitSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    administrativeUnit_secondaryConceptsIntIds.setMultivalue(true);
    administrativeUnit_secondaryConceptsIntIds.setSystemReserved(true);
    administrativeUnit_secondaryConceptsIntIds.setUndeletable(true);
    administrativeUnit_secondaryConceptsIntIds.setEssential(true);
    administrativeUnit_secondaryConceptsIntIds.setMultiLingual(false);
    administrativeUnit_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    administrativeUnit_title.setAvailableInSummary(true);
    administrativeUnit_title.setSchemaAutocomplete(true);
    administrativeUnit_title.setSearchable(true);
    administrativeUnit_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createDdvDocumentTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvDocumentTypeSchemaType, MetadataSchemaBuilder ddvDocumentTypeSchema) {
    MetadataBuilder ddvDocumentType_abbreviation = ddvDocumentTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvDocumentType_abbreviation.setUndeletable(true);
    ddvDocumentType_abbreviation.setMultiLingual(true);
    ddvDocumentType_abbreviation.setSearchable(true);
    ddvDocumentType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvDocumentType_attachedPrincipalAncestorsIntIds = ddvDocumentTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvDocumentType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvDocumentType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvDocumentType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvDocumentType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvDocumentType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvDocumentType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvDocumentType_detachedPrincipalAncestorsIntIds = ddvDocumentTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvDocumentType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvDocumentType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvDocumentType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvDocumentType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvDocumentType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvDocumentType_hidden = ddvDocumentTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvDocumentType_hidden.setSystemReserved(true);
    ddvDocumentType_hidden.setUndeletable(true);
    ddvDocumentType_hidden.setMultiLingual(false);
    ...
    ddvDocumentType_modifiedOn.setAvailableInSummary(true);
    ddvDocumentType_modifiedOn.setSortable(true);
    MetadataBuilder ddvDocumentType_nestedAuthorizations = ddvDocumentTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvDocumentType_nestedAuthorizations.setSystemReserved(true);
    ddvDocumentType_nestedAuthorizations.setUndeletable(true);
    ddvDocumentType_nestedAuthorizations.setMultiLingual(false);
    ddvDocumentType_nestedAuthorizations.setEssentialInSummary(true);
    ddvDocumentType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder ddvDocumentType_parent = ddvDocumentTypeSchema.create("parent").setType(MetadataValueType.REFERENCE);
    ddvDocumentType_parent.setUndeletable(true);
    ddvDocumentType_parent.defineReferencesTo(asList(types.getSchema("ddvDocumentType_default")));
    ...
    MetadataBuilder ddvDocumentType_principalAncestorsIntIds = ddvDocumentTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvDocumentType_principalAncestorsIntIds.setMultivalue(true);
    ddvDocumentType_principalAncestorsIntIds.setSystemReserved(true);
    ddvDocumentType_principalAncestorsIntIds.setUndeletable(true);
    ddvDocumentType_principalAncestorsIntIds.setMultiLingual(false);
    ddvDocumentType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvDocumentType_principalConceptsIntIds = ddvDocumentTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvDocumentType_principalConceptsIntIds.setMultivalue(true);
    ddvDocumentType_principalConceptsIntIds.setSystemReserved(true);
    ddvDocumentType_principalConceptsIntIds.setUndeletable(true);
    ddvDocumentType_principalConceptsIntIds.setMultiLingual(false);
    ddvDocumentType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvDocumentType_secondaryConceptsIntIds = ddvDocumentTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvDocumentType_secondaryConceptsIntIds.setMultivalue(true);
    ddvDocumentType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvDocumentType_secondaryConceptsIntIds.setUndeletable(true);
    ddvDocumentType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvDocumentType_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvDocumentType_title.setAvailableInSummary(true);
    ...
    ddvDocumentType_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder folderSchemaType, MetadataSchemaBuilder folderSchema) {
    MetadataBuilder folder_abbreviation = folderSchema.create("abbreviation").setType(MetadataValueType.STRING);
    folder_abbreviation.setUndeletable(true);
    folder_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    folder_actualDepositDate.setEssentialInSummary(true);
    ...
    folder_actualDestructionDate.setEssentialInSummary(true);
    ...
    folder_actualTransferDate.setEssentialInSummary(true);
    ...
    folder_administrativeUnit.setCacheIndex(true);
    ...
    folder_administrativeUnitEntered.setCacheIndex(true);
    ...
    folder_allRemovedAuths.setEssentialInSummary(true);
    MetadataBuilder folder_allowedDocumentTypes = folderSchema.create("allowedDocumentTypes").setType(MetadataValueType.REFERENCE);
    folder_allowedDocumentTypes.setMultivalue(true);
    folder_allowedDocumentTypes.setSystemReserved(true);
    folder_allowedDocumentTypes.setUndeletable(true);
    folder_allowedDocumentTypes.defineReferencesTo(asList(types.getSchema("ddvDocumentType_default")));
    MetadataBuilder folder_allowedFolderTypes = folderSchema.create("allowedFolderTypes").setType(MetadataValueType.REFERENCE);
    folder_allowedFolderTypes.setMultivalue(true);
    folder_allowedFolderTypes.setSystemReserved(true);
    folder_allowedFolderTypes.setUndeletable(true);
    folder_allowedFolderTypes.defineReferencesTo(asList(types.getSchema("ddvFolderType_default")));
    ...
    MetadataBuilder folder_attachedPrincipalAncestorsIntIds = folderSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    folder_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    folder_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    folder_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    folder_attachedPrincipalAncestorsIntIds.setEssential(true);
    folder_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    folder_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    folder_autocomplete.setEssentialInSummary(true);
    ...
    folder_caption.setEssentialInSummary(true);
    ...
    folder_categoryEntered.setCacheIndex(true);
    ...
    folder_categoryEntered.defineTaxonomyRelationshipToType(types.getSchemaType("category"));
    ...
    folder_closingDate.setEssentialInSummary(true);
    ...
    MetadataBuilder folder_conversation = folderSchema.create("conversation").setType(MetadataValueType.REFERENCE);
    folder_conversation.setUndeletable(true);
    folder_conversation.defineReferencesTo(asList(types.getSchema("conversation_default")));
    ...
    MetadataBuilder folder_detachedPrincipalAncestorsIntIds = folderSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    folder_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    folder_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    folder_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    folder_detachedPrincipalAncestorsIntIds.setEssential(true);
    folder_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    folder_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    folder_documentsTokens.setEssentialInSummary(true);
    ...
    folder_expectedDepositDate.setEssentialInSummary(true);
    ...
    folder_expectedDestructionDate.setEssentialInSummary(true);
    ...
    folder_expectedTransferDate.setEssentialInSummary(true);
    MetadataBuilder folder_externalLinks = folderSchema.create("externalLinks").setType(MetadataValueType.REFERENCE);
    folder_externalLinks.setMultivalue(true);
    folder_externalLinks.setUndeletable(true);
    folder_externalLinks.defineReferencesTo(types.getSchemaType("externalLink"));
    ...
    folder_formCreatedOn.setEssentialInSummary(true);
    ...
    folder_formModifiedOn.setEssentialInSummary(true);
    ...
    MetadataBuilder folder_hidden = folderSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    folder_hidden.setSystemReserved(true);
    folder_hidden.setUndeletable(true);
    folder_hidden.setEssential(true);
    folder_hidden.setMultiLingual(false);
    ...
    MetadataBuilder folder_isModel = folderSchema.create("isModel").setType(MetadataValueType.BOOLEAN);
    folder_isModel.setSystemReserved(true);
    folder_isModel.setUndeletable(true);
    ...
    folder_mainCopyRule.setEssentialInSummary(true);
    ...
    folder_mainCopyRuleIdEntered.setEssential(true);
    ...
    folder_modifiedOn.setEssentialInSummary(true);
    folder_modifiedOn.setAvailableInSummary(true);
    folder_modifiedOn.setSortable(true);
    MetadataBuilder folder_nestedAuthorizations = folderSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    folder_nestedAuthorizations.setSystemReserved(true);
    folder_nestedAuthorizations.setUndeletable(true);
    folder_nestedAuthorizations.setEssential(true);
    folder_nestedAuthorizations.setMultiLingual(false);
    folder_nestedAuthorizations.setEssentialInSummary(true);
    folder_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    folder_openingDate.setEssentialInSummary(true);
    ...
    folder_parentFolder.setCacheIndex(true);
    ...
    folder_path.setEssentialInSummary(true);
    ...
    MetadataBuilder folder_principalAncestorsIntIds = folderSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    folder_principalAncestorsIntIds.setMultivalue(true);
    folder_principalAncestorsIntIds.setSystemReserved(true);
    folder_principalAncestorsIntIds.setUndeletable(true);
    folder_principalAncestorsIntIds.setEssential(true);
    folder_principalAncestorsIntIds.setMultiLingual(false);
    folder_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder folder_principalConceptsIntIds = folderSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    folder_principalConceptsIntIds.setMultivalue(true);
    folder_principalConceptsIntIds.setSystemReserved(true);
    folder_principalConceptsIntIds.setUndeletable(true);
    folder_principalConceptsIntIds.setEssential(true);
    folder_principalConceptsIntIds.setMultiLingual(false);
    folder_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    folder_principalpath.setEssentialInSummary(true);
    ...
    MetadataBuilder folder_secondaryConceptsIntIds = folderSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    folder_secondaryConceptsIntIds.setMultivalue(true);
    folder_secondaryConceptsIntIds.setSystemReserved(true);
    folder_secondaryConceptsIntIds.setUndeletable(true);
    folder_secondaryConceptsIntIds.setEssential(true);
    folder_secondaryConceptsIntIds.setMultiLingual(false);
    folder_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    folder_subFoldersTokens.setEssentialInSummary(true);
    ...
    folder_title.setAvailableInSummary(true);
    ...
    folder_title.defineValidators().add(IllegalCharactersValidator.class);
    ...
    folder_tokensHierarchy.setEssentialInSummary(true);
  ...
  private void createContainerRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder containerRecordSchemaType, MetadataSchemaBuilder containerRecordSchema) {
    ...
    containerRecord_administrativeUnits.setCacheIndex(true);
    ...
    MetadataBuilder containerRecord_attachedPrincipalAncestorsIntIds = containerRecordSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    containerRecord_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    containerRecord_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    containerRecord_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    containerRecord_attachedPrincipalAncestorsIntIds.setEssential(true);
    containerRecord_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    containerRecord_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder containerRecord_detachedPrincipalAncestorsIntIds = containerRecordSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    containerRecord_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    containerRecord_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    containerRecord_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    containerRecord_detachedPrincipalAncestorsIntIds.setEssential(true);
    containerRecord_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    containerRecord_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder containerRecord_hidden = containerRecordSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    containerRecord_hidden.setSystemReserved(true);
    containerRecord_hidden.setUndeletable(true);
    containerRecord_hidden.setEssential(true);
    containerRecord_hidden.setMultiLingual(false);
    ...
    containerRecord_modifiedOn.setAvailableInSummary(true);
    containerRecord_modifiedOn.setSortable(true);
    MetadataBuilder containerRecord_nestedAuthorizations = containerRecordSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    containerRecord_nestedAuthorizations.setSystemReserved(true);
    containerRecord_nestedAuthorizations.setUndeletable(true);
    containerRecord_nestedAuthorizations.setEssential(true);
    containerRecord_nestedAuthorizations.setMultiLingual(false);
    containerRecord_nestedAuthorizations.setEssentialInSummary(true);
    containerRecord_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder containerRecord_principalAncestorsIntIds = containerRecordSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    containerRecord_principalAncestorsIntIds.setMultivalue(true);
    containerRecord_principalAncestorsIntIds.setSystemReserved(true);
    containerRecord_principalAncestorsIntIds.setUndeletable(true);
    containerRecord_principalAncestorsIntIds.setEssential(true);
    containerRecord_principalAncestorsIntIds.setMultiLingual(false);
    containerRecord_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder containerRecord_principalConceptsIntIds = containerRecordSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    containerRecord_principalConceptsIntIds.setMultivalue(true);
    containerRecord_principalConceptsIntIds.setSystemReserved(true);
    containerRecord_principalConceptsIntIds.setUndeletable(true);
    containerRecord_principalConceptsIntIds.setEssential(true);
    containerRecord_principalConceptsIntIds.setMultiLingual(false);
    containerRecord_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder containerRecord_secondaryConceptsIntIds = containerRecordSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    containerRecord_secondaryConceptsIntIds.setMultivalue(true);
    containerRecord_secondaryConceptsIntIds.setSystemReserved(true);
    containerRecord_secondaryConceptsIntIds.setUndeletable(true);
    containerRecord_secondaryConceptsIntIds.setEssential(true);
    containerRecord_secondaryConceptsIntIds.setMultiLingual(false);
    containerRecord_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    containerRecord_storageSpace.setCacheIndex(true);
    ...
    containerRecord_title.setAvailableInSummary(true);
  ...
  private void createRetentionRuleSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder retentionRuleSchemaType, MetadataSchemaBuilder retentionRuleSchema) {
    ...
    MetadataBuilder retentionRule_applicationNotes = retentionRuleSchema.create("applicationNotes").setType(MetadataValueType.TEXT);
    retentionRule_applicationNotes.setUndeletable(true);
    ...
    MetadataBuilder retentionRule_attachedPrincipalAncestorsIntIds = retentionRuleSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRule_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    retentionRule_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    retentionRule_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    retentionRule_attachedPrincipalAncestorsIntIds.setEssential(true);
    retentionRule_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    retentionRule_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    retentionRule_code.setAvailableInSummary(true);
    ...
    MetadataBuilder retentionRule_detachedPrincipalAncestorsIntIds = retentionRuleSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRule_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    retentionRule_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    retentionRule_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    retentionRule_detachedPrincipalAncestorsIntIds.setEssential(true);
    retentionRule_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    retentionRule_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder retentionRule_hidden = retentionRuleSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    retentionRule_hidden.setSystemReserved(true);
    retentionRule_hidden.setUndeletable(true);
    retentionRule_hidden.setEssential(true);
    retentionRule_hidden.setMultiLingual(false);
    ...
    retentionRule_modifiedOn.setAvailableInSummary(true);
    retentionRule_modifiedOn.setSortable(true);
    MetadataBuilder retentionRule_nestedAuthorizations = retentionRuleSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    retentionRule_nestedAuthorizations.setSystemReserved(true);
    retentionRule_nestedAuthorizations.setUndeletable(true);
    retentionRule_nestedAuthorizations.setEssential(true);
    retentionRule_nestedAuthorizations.setMultiLingual(false);
    retentionRule_nestedAuthorizations.setEssentialInSummary(true);
    retentionRule_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder retentionRule_principalAncestorsIntIds = retentionRuleSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    retentionRule_principalAncestorsIntIds.setMultivalue(true);
    retentionRule_principalAncestorsIntIds.setSystemReserved(true);
    retentionRule_principalAncestorsIntIds.setUndeletable(true);
    retentionRule_principalAncestorsIntIds.setEssential(true);
    retentionRule_principalAncestorsIntIds.setMultiLingual(false);
    retentionRule_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder retentionRule_principalConceptsIntIds = retentionRuleSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    retentionRule_principalConceptsIntIds.setMultivalue(true);
    retentionRule_principalConceptsIntIds.setSystemReserved(true);
    retentionRule_principalConceptsIntIds.setUndeletable(true);
    retentionRule_principalConceptsIntIds.setEssential(true);
    retentionRule_principalConceptsIntIds.setMultiLingual(false);
    retentionRule_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder retentionRule_secondaryConceptsIntIds = retentionRuleSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    retentionRule_secondaryConceptsIntIds.setMultivalue(true);
    retentionRule_secondaryConceptsIntIds.setSystemReserved(true);
    retentionRule_secondaryConceptsIntIds.setUndeletable(true);
    retentionRule_secondaryConceptsIntIds.setEssential(true);
    retentionRule_secondaryConceptsIntIds.setMultiLingual(false);
    retentionRule_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    retentionRule_title.setAvailableInSummary(true);
    ...
    MetadataBuilder retentionRule_transaction = retentionRuleSchema.create("transaction").setType(MetadataValueType.ENUM);
    retentionRule_transaction.setUndeletable(true);
    retentionRule_transaction.defineAsEnum(RetentionRuleTransaction.class);
  ...
  private void createLegalReferenceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder legalReferenceSchemaType, MetadataSchemaBuilder legalReferenceSchema) {
    MetadataBuilder legalReference_allReferences = legalReferenceSchema.create("allReferences").setType(MetadataValueType.STRING);
    legalReference_allReferences.setMultivalue(true);
    legalReference_allReferences.setSystemReserved(true);
    legalReference_allReferences.setUndeletable(true);
    legalReference_allReferences.setMultiLingual(false);
    MetadataBuilder legalReference_allRemovedAuths = legalReferenceSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    legalReference_allRemovedAuths.setMultivalue(true);
    legalReference_allRemovedAuths.setSystemReserved(true);
    legalReference_allRemovedAuths.setUndeletable(true);
    legalReference_allRemovedAuths.setEssential(true);
    legalReference_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder legalReference_attachedAncestors = legalReferenceSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    legalReference_attachedAncestors.setMultivalue(true);
    legalReference_attachedAncestors.setSystemReserved(true);
    legalReference_attachedAncestors.setUndeletable(true);
    legalReference_attachedAncestors.setEssential(true);
    legalReference_attachedAncestors.setMultiLingual(false);
    MetadataBuilder legalReference_attachedPrincipalAncestorsIntIds = legalReferenceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalReference_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalReference_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalReference_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalReference_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalReference_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalReference_autocomplete = legalReferenceSchema.create("autocomplete").setType(MetadataValueType.STRING);
    legalReference_autocomplete.setMultivalue(true);
    legalReference_autocomplete.setSystemReserved(true);
    legalReference_autocomplete.setUndeletable(true);
    legalReference_autocomplete.setEssential(true);
    legalReference_autocomplete.setMultiLingual(true);
    MetadataBuilder legalReference_caption = legalReferenceSchema.create("caption").setType(MetadataValueType.STRING);
    legalReference_caption.setSystemReserved(true);
    legalReference_caption.setUndeletable(true);
    legalReference_caption.setMultiLingual(false);
    legalReference_caption.setSortable(true);
    MetadataBuilder legalReference_code = legalReferenceSchema.create("code").setType(MetadataValueType.STRING);
    legalReference_code.setUndeletable(true);
    legalReference_code.setAvailableInSummary(true);
    MetadataBuilder legalReference_createdBy = legalReferenceSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    legalReference_createdBy.setSystemReserved(true);
    legalReference_createdBy.setUndeletable(true);
    legalReference_createdBy.setMultiLingual(false);
    legalReference_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalReference_createdOn = legalReferenceSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    legalReference_createdOn.setSystemReserved(true);
    legalReference_createdOn.setUndeletable(true);
    legalReference_createdOn.setMultiLingual(false);
    legalReference_createdOn.setSortable(true);
    MetadataBuilder legalReference_deleted = legalReferenceSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    legalReference_deleted.setSystemReserved(true);
    legalReference_deleted.setUndeletable(true);
    legalReference_deleted.setMultiLingual(false);
    MetadataBuilder legalReference_denyTokens = legalReferenceSchema.create("denyTokens").setType(MetadataValueType.STRING);
    legalReference_denyTokens.setMultivalue(true);
    legalReference_denyTokens.setSystemReserved(true);
    legalReference_denyTokens.setUndeletable(true);
    legalReference_denyTokens.setMultiLingual(false);
    legalReference_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalReference_detachedPrincipalAncestorsIntIds = legalReferenceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalReference_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalReference_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalReference_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalReference_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalReference_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalReference_detachedauthorizations = legalReferenceSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    legalReference_detachedauthorizations.setSystemReserved(true);
    legalReference_detachedauthorizations.setUndeletable(true);
    legalReference_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder legalReference_errorOnPhysicalDeletion = legalReferenceSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    legalReference_errorOnPhysicalDeletion.setSystemReserved(true);
    legalReference_errorOnPhysicalDeletion.setUndeletable(true);
    legalReference_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder legalReference_estimatedSize = legalReferenceSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    legalReference_estimatedSize.setSystemReserved(true);
    legalReference_estimatedSize.setUndeletable(true);
    legalReference_estimatedSize.setMultiLingual(false);
    MetadataBuilder legalReference_hidden = legalReferenceSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    legalReference_hidden.setSystemReserved(true);
    legalReference_hidden.setUndeletable(true);
    legalReference_hidden.setMultiLingual(false);
    MetadataBuilder legalReference_id = legalReferenceSchema.create("id").setType(MetadataValueType.STRING);
    legalReference_id.setDefaultRequirement(true);
    legalReference_id.setSystemReserved(true);
    legalReference_id.setUndeletable(true);
    legalReference_id.setMultiLingual(false);
    legalReference_id.setSearchable(true);
    legalReference_id.setSortable(true);
    legalReference_id.setUniqueValue(true);
    legalReference_id.setUnmodifiable(true);
    MetadataBuilder legalReference_legacyIdentifier = legalReferenceSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    legalReference_legacyIdentifier.setDefaultRequirement(true);
    legalReference_legacyIdentifier.setSystemReserved(true);
    legalReference_legacyIdentifier.setUndeletable(true);
    legalReference_legacyIdentifier.setMultiLingual(false);
    legalReference_legacyIdentifier.setSearchable(true);
    legalReference_legacyIdentifier.setUniqueValue(true);
    legalReference_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder legalReference_logicallyDeletedOn = legalReferenceSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    legalReference_logicallyDeletedOn.setSystemReserved(true);
    legalReference_logicallyDeletedOn.setUndeletable(true);
    legalReference_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder legalReference_manualTokens = legalReferenceSchema.create("manualTokens").setType(MetadataValueType.STRING);
    legalReference_manualTokens.setMultivalue(true);
    legalReference_manualTokens.setSystemReserved(true);
    legalReference_manualTokens.setUndeletable(true);
    legalReference_manualTokens.setMultiLingual(false);
    legalReference_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalReference_markedForParsing = legalReferenceSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    legalReference_markedForParsing.setSystemReserved(true);
    legalReference_markedForParsing.setUndeletable(true);
    legalReference_markedForParsing.setMultiLingual(false);
    MetadataBuilder legalReference_markedForPreviewConversion = legalReferenceSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    legalReference_markedForPreviewConversion.setSystemReserved(true);
    legalReference_markedForPreviewConversion.setUndeletable(true);
    legalReference_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder legalReference_markedForReindexing = legalReferenceSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    legalReference_markedForReindexing.setSystemReserved(true);
    legalReference_markedForReindexing.setUndeletable(true);
    legalReference_markedForReindexing.setMultiLingual(false);
    MetadataBuilder legalReference_migrationDataVersion = legalReferenceSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    legalReference_migrationDataVersion.setSystemReserved(true);
    legalReference_migrationDataVersion.setUndeletable(true);
    legalReference_migrationDataVersion.setMultiLingual(false);
    legalReference_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder legalReference_modifiedBy = legalReferenceSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    legalReference_modifiedBy.setSystemReserved(true);
    legalReference_modifiedBy.setUndeletable(true);
    legalReference_modifiedBy.setMultiLingual(false);
    legalReference_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalReference_modifiedOn = legalReferenceSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    legalReference_modifiedOn.setSystemReserved(true);
    legalReference_modifiedOn.setUndeletable(true);
    legalReference_modifiedOn.setMultiLingual(false);
    legalReference_modifiedOn.setAvailableInSummary(true);
    legalReference_modifiedOn.setSortable(true);
    MetadataBuilder legalReference_nestedAuthorizations = legalReferenceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    legalReference_nestedAuthorizations.setSystemReserved(true);
    legalReference_nestedAuthorizations.setUndeletable(true);
    legalReference_nestedAuthorizations.setMultiLingual(false);
    legalReference_nestedAuthorizations.setEssentialInSummary(true);
    legalReference_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder legalReference_path = legalReferenceSchema.create("path").setType(MetadataValueType.STRING);
    legalReference_path.setMultivalue(true);
    legalReference_path.setSystemReserved(true);
    legalReference_path.setUndeletable(true);
    legalReference_path.setMultiLingual(false);
    MetadataBuilder legalReference_pathParts = legalReferenceSchema.create("pathParts").setType(MetadataValueType.STRING);
    legalReference_pathParts.setMultivalue(true);
    legalReference_pathParts.setSystemReserved(true);
    legalReference_pathParts.setUndeletable(true);
    legalReference_pathParts.setMultiLingual(false);
    MetadataBuilder legalReference_principalAncestorsIntIds = legalReferenceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalReference_principalAncestorsIntIds.setMultivalue(true);
    legalReference_principalAncestorsIntIds.setSystemReserved(true);
    legalReference_principalAncestorsIntIds.setUndeletable(true);
    legalReference_principalAncestorsIntIds.setMultiLingual(false);
    legalReference_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalReference_principalConceptsIntIds = legalReferenceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalReference_principalConceptsIntIds.setMultivalue(true);
    legalReference_principalConceptsIntIds.setSystemReserved(true);
    legalReference_principalConceptsIntIds.setUndeletable(true);
    legalReference_principalConceptsIntIds.setMultiLingual(false);
    legalReference_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalReference_principalpath = legalReferenceSchema.create("principalpath").setType(MetadataValueType.STRING);
    legalReference_principalpath.setSystemReserved(true);
    legalReference_principalpath.setUndeletable(true);
    legalReference_principalpath.setMultiLingual(false);
    MetadataBuilder legalReference_removedauthorizations = legalReferenceSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    legalReference_removedauthorizations.setMultivalue(true);
    legalReference_removedauthorizations.setSystemReserved(true);
    legalReference_removedauthorizations.setUndeletable(true);
    legalReference_removedauthorizations.setMultiLingual(false);
    MetadataBuilder legalReference_schema = legalReferenceSchema.create("schema").setType(MetadataValueType.STRING);
    legalReference_schema.setDefaultRequirement(true);
    legalReference_schema.setSystemReserved(true);
    legalReference_schema.setUndeletable(true);
    legalReference_schema.setMultiLingual(false);
    MetadataBuilder legalReference_secondaryConceptsIntIds = legalReferenceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalReference_secondaryConceptsIntIds.setMultivalue(true);
    legalReference_secondaryConceptsIntIds.setSystemReserved(true);
    legalReference_secondaryConceptsIntIds.setUndeletable(true);
    legalReference_secondaryConceptsIntIds.setMultiLingual(false);
    legalReference_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalReference_shareDenyTokens = legalReferenceSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    legalReference_shareDenyTokens.setMultivalue(true);
    legalReference_shareDenyTokens.setSystemReserved(true);
    legalReference_shareDenyTokens.setUndeletable(true);
    legalReference_shareDenyTokens.setMultiLingual(false);
    legalReference_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalReference_shareTokens = legalReferenceSchema.create("shareTokens").setType(MetadataValueType.STRING);
    legalReference_shareTokens.setMultivalue(true);
    legalReference_shareTokens.setSystemReserved(true);
    legalReference_shareTokens.setUndeletable(true);
    legalReference_shareTokens.setMultiLingual(false);
    legalReference_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalReference_title = legalReferenceSchema.create("title").setType(MetadataValueType.STRING);
    legalReference_title.setUndeletable(true);
    legalReference_title.setMultiLingual(false);
    legalReference_title.setAvailableInSummary(true);
    legalReference_title.setSchemaAutocomplete(true);
    legalReference_title.setSearchable(true);
    MetadataBuilder legalReference_tokens = legalReferenceSchema.create("tokens").setType(MetadataValueType.STRING);
    legalReference_tokens.setMultivalue(true);
    legalReference_tokens.setSystemReserved(true);
    legalReference_tokens.setUndeletable(true);
    legalReference_tokens.setMultiLingual(false);
    MetadataBuilder legalReference_tokensHierarchy = legalReferenceSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    legalReference_tokensHierarchy.setMultivalue(true);
    legalReference_tokensHierarchy.setSystemReserved(true);
    legalReference_tokensHierarchy.setUndeletable(true);
    legalReference_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder legalReference_url = legalReferenceSchema.create("url").setType(MetadataValueType.STRING);
    legalReference_url.setUndeletable(true);
    legalReference_url.setMultiLingual(false);
    legalReference_url.setAvailableInSummary(true);
    MetadataBuilder legalReference_visibleInTrees = legalReferenceSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    legalReference_visibleInTrees.setSystemReserved(true);
    legalReference_visibleInTrees.setUndeletable(true);
    legalReference_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createTriggerActionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder triggerActionSchemaType, MetadataSchemaBuilder triggerAction_moveInFolderSchema, MetadataSchemaBuilder triggerActionSchema) {
    MetadataBuilder triggerAction_moveInFolder_date = triggerAction_moveInFolderSchema.create("date").setType(MetadataValueType.DATE);
    triggerAction_moveInFolder_date.setUndeletable(true);
    MetadataBuilder triggerAction_allReferences = triggerActionSchema.create("allReferences").setType(MetadataValueType.STRING);
    triggerAction_allReferences.setMultivalue(true);
    triggerAction_allReferences.setSystemReserved(true);
    triggerAction_allReferences.setUndeletable(true);
    triggerAction_allReferences.setMultiLingual(false);
    MetadataBuilder triggerAction_allRemovedAuths = triggerActionSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    triggerAction_allRemovedAuths.setMultivalue(true);
    triggerAction_allRemovedAuths.setSystemReserved(true);
    triggerAction_allRemovedAuths.setUndeletable(true);
    triggerAction_allRemovedAuths.setEssential(true);
    triggerAction_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder triggerAction_attachedAncestors = triggerActionSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    triggerAction_attachedAncestors.setMultivalue(true);
    triggerAction_attachedAncestors.setSystemReserved(true);
    triggerAction_attachedAncestors.setUndeletable(true);
    triggerAction_attachedAncestors.setEssential(true);
    triggerAction_attachedAncestors.setMultiLingual(false);
    MetadataBuilder triggerAction_attachedPrincipalAncestorsIntIds = triggerActionSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerAction_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerAction_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerAction_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerAction_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerAction_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerAction_autocomplete = triggerActionSchema.create("autocomplete").setType(MetadataValueType.STRING);
    triggerAction_autocomplete.setMultivalue(true);
    triggerAction_autocomplete.setSystemReserved(true);
    triggerAction_autocomplete.setUndeletable(true);
    triggerAction_autocomplete.setEssential(true);
    triggerAction_autocomplete.setMultiLingual(true);
    MetadataBuilder triggerAction_caption = triggerActionSchema.create("caption").setType(MetadataValueType.STRING);
    triggerAction_caption.setSystemReserved(true);
    triggerAction_caption.setUndeletable(true);
    triggerAction_caption.setMultiLingual(false);
    triggerAction_caption.setSortable(true);
    MetadataBuilder triggerAction_createdBy = triggerActionSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    triggerAction_createdBy.setSystemReserved(true);
    triggerAction_createdBy.setUndeletable(true);
    triggerAction_createdBy.setMultiLingual(false);
    triggerAction_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerAction_createdOn = triggerActionSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    triggerAction_createdOn.setSystemReserved(true);
    triggerAction_createdOn.setUndeletable(true);
    triggerAction_createdOn.setMultiLingual(false);
    triggerAction_createdOn.setSortable(true);
    MetadataBuilder triggerAction_deleted = triggerActionSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    triggerAction_deleted.setSystemReserved(true);
    triggerAction_deleted.setUndeletable(true);
    triggerAction_deleted.setMultiLingual(false);
    MetadataBuilder triggerAction_denyTokens = triggerActionSchema.create("denyTokens").setType(MetadataValueType.STRING);
    triggerAction_denyTokens.setMultivalue(true);
    triggerAction_denyTokens.setSystemReserved(true);
    triggerAction_denyTokens.setUndeletable(true);
    triggerAction_denyTokens.setMultiLingual(false);
    triggerAction_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerAction_detachedPrincipalAncestorsIntIds = triggerActionSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerAction_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerAction_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerAction_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerAction_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerAction_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerAction_detachedauthorizations = triggerActionSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    triggerAction_detachedauthorizations.setSystemReserved(true);
    triggerAction_detachedauthorizations.setUndeletable(true);
    triggerAction_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerAction_errorOnPhysicalDeletion = triggerActionSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    triggerAction_errorOnPhysicalDeletion.setSystemReserved(true);
    triggerAction_errorOnPhysicalDeletion.setUndeletable(true);
    triggerAction_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder triggerAction_estimatedSize = triggerActionSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    triggerAction_estimatedSize.setSystemReserved(true);
    triggerAction_estimatedSize.setUndeletable(true);
    triggerAction_estimatedSize.setMultiLingual(false);
    MetadataBuilder triggerAction_hidden = triggerActionSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    triggerAction_hidden.setSystemReserved(true);
    triggerAction_hidden.setUndeletable(true);
    triggerAction_hidden.setMultiLingual(false);
    MetadataBuilder triggerAction_id = triggerActionSchema.create("id").setType(MetadataValueType.STRING);
    triggerAction_id.setDefaultRequirement(true);
    triggerAction_id.setSystemReserved(true);
    triggerAction_id.setUndeletable(true);
    triggerAction_id.setMultiLingual(false);
    triggerAction_id.setSearchable(true);
    triggerAction_id.setSortable(true);
    triggerAction_id.setUniqueValue(true);
    triggerAction_id.setUnmodifiable(true);
    MetadataBuilder triggerAction_legacyIdentifier = triggerActionSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    triggerAction_legacyIdentifier.setDefaultRequirement(true);
    triggerAction_legacyIdentifier.setSystemReserved(true);
    triggerAction_legacyIdentifier.setUndeletable(true);
    triggerAction_legacyIdentifier.setMultiLingual(false);
    triggerAction_legacyIdentifier.setSearchable(true);
    triggerAction_legacyIdentifier.setUniqueValue(true);
    triggerAction_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder triggerAction_logicallyDeletedOn = triggerActionSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    triggerAction_logicallyDeletedOn.setSystemReserved(true);
    triggerAction_logicallyDeletedOn.setUndeletable(true);
    triggerAction_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder triggerAction_manualTokens = triggerActionSchema.create("manualTokens").setType(MetadataValueType.STRING);
    triggerAction_manualTokens.setMultivalue(true);
    triggerAction_manualTokens.setSystemReserved(true);
    triggerAction_manualTokens.setUndeletable(true);
    triggerAction_manualTokens.setMultiLingual(false);
    triggerAction_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerAction_markedForParsing = triggerActionSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    triggerAction_markedForParsing.setSystemReserved(true);
    triggerAction_markedForParsing.setUndeletable(true);
    triggerAction_markedForParsing.setMultiLingual(false);
    MetadataBuilder triggerAction_markedForPreviewConversion = triggerActionSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    triggerAction_markedForPreviewConversion.setSystemReserved(true);
    triggerAction_markedForPreviewConversion.setUndeletable(true);
    triggerAction_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder triggerAction_markedForReindexing = triggerActionSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    triggerAction_markedForReindexing.setSystemReserved(true);
    triggerAction_markedForReindexing.setUndeletable(true);
    triggerAction_markedForReindexing.setMultiLingual(false);
    MetadataBuilder triggerAction_migrationDataVersion = triggerActionSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    triggerAction_migrationDataVersion.setSystemReserved(true);
    triggerAction_migrationDataVersion.setUndeletable(true);
    triggerAction_migrationDataVersion.setMultiLingual(false);
    triggerAction_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder triggerAction_modifiedBy = triggerActionSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    triggerAction_modifiedBy.setSystemReserved(true);
    triggerAction_modifiedBy.setUndeletable(true);
    triggerAction_modifiedBy.setMultiLingual(false);
    triggerAction_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerAction_modifiedOn = triggerActionSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    triggerAction_modifiedOn.setSystemReserved(true);
    triggerAction_modifiedOn.setUndeletable(true);
    triggerAction_modifiedOn.setMultiLingual(false);
    triggerAction_modifiedOn.setAvailableInSummary(true);
    triggerAction_modifiedOn.setSortable(true);
    MetadataBuilder triggerAction_nestedAuthorizations = triggerActionSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    triggerAction_nestedAuthorizations.setSystemReserved(true);
    triggerAction_nestedAuthorizations.setUndeletable(true);
    triggerAction_nestedAuthorizations.setMultiLingual(false);
    triggerAction_nestedAuthorizations.setEssentialInSummary(true);
    triggerAction_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder triggerAction_path = triggerActionSchema.create("path").setType(MetadataValueType.STRING);
    triggerAction_path.setMultivalue(true);
    triggerAction_path.setSystemReserved(true);
    triggerAction_path.setUndeletable(true);
    triggerAction_path.setMultiLingual(false);
    MetadataBuilder triggerAction_pathParts = triggerActionSchema.create("pathParts").setType(MetadataValueType.STRING);
    triggerAction_pathParts.setMultivalue(true);
    triggerAction_pathParts.setSystemReserved(true);
    triggerAction_pathParts.setUndeletable(true);
    triggerAction_pathParts.setMultiLingual(false);
    MetadataBuilder triggerAction_principalAncestorsIntIds = triggerActionSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerAction_principalAncestorsIntIds.setMultivalue(true);
    triggerAction_principalAncestorsIntIds.setSystemReserved(true);
    triggerAction_principalAncestorsIntIds.setUndeletable(true);
    triggerAction_principalAncestorsIntIds.setMultiLingual(false);
    triggerAction_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerAction_principalConceptsIntIds = triggerActionSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerAction_principalConceptsIntIds.setMultivalue(true);
    triggerAction_principalConceptsIntIds.setSystemReserved(true);
    triggerAction_principalConceptsIntIds.setUndeletable(true);
    triggerAction_principalConceptsIntIds.setMultiLingual(false);
    triggerAction_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerAction_principalpath = triggerActionSchema.create("principalpath").setType(MetadataValueType.STRING);
    triggerAction_principalpath.setSystemReserved(true);
    triggerAction_principalpath.setUndeletable(true);
    triggerAction_principalpath.setMultiLingual(false);
    MetadataBuilder triggerAction_removedauthorizations = triggerActionSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    triggerAction_removedauthorizations.setMultivalue(true);
    triggerAction_removedauthorizations.setSystemReserved(true);
    triggerAction_removedauthorizations.setUndeletable(true);
    triggerAction_removedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerAction_schema = triggerActionSchema.create("schema").setType(MetadataValueType.STRING);
    triggerAction_schema.setDefaultRequirement(true);
    triggerAction_schema.setSystemReserved(true);
    triggerAction_schema.setUndeletable(true);
    triggerAction_schema.setMultiLingual(false);
    MetadataBuilder triggerAction_secondaryConceptsIntIds = triggerActionSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerAction_secondaryConceptsIntIds.setMultivalue(true);
    triggerAction_secondaryConceptsIntIds.setSystemReserved(true);
    triggerAction_secondaryConceptsIntIds.setUndeletable(true);
    triggerAction_secondaryConceptsIntIds.setMultiLingual(false);
    triggerAction_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerAction_shareDenyTokens = triggerActionSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    triggerAction_shareDenyTokens.setMultivalue(true);
    triggerAction_shareDenyTokens.setSystemReserved(true);
    triggerAction_shareDenyTokens.setUndeletable(true);
    triggerAction_shareDenyTokens.setMultiLingual(false);
    triggerAction_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerAction_shareTokens = triggerActionSchema.create("shareTokens").setType(MetadataValueType.STRING);
    triggerAction_shareTokens.setMultivalue(true);
    triggerAction_shareTokens.setSystemReserved(true);
    triggerAction_shareTokens.setUndeletable(true);
    triggerAction_shareTokens.setMultiLingual(false);
    triggerAction_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerAction_title = triggerActionSchema.create("title").setType(MetadataValueType.STRING);
    triggerAction_title.setDefaultRequirement(true);
    triggerAction_title.setUndeletable(true);
    triggerAction_title.setMultiLingual(false);
    triggerAction_title.setAvailableInSummary(true);
    triggerAction_title.setSchemaAutocomplete(true);
    triggerAction_title.setSearchable(true);
    MetadataBuilder triggerAction_tokens = triggerActionSchema.create("tokens").setType(MetadataValueType.STRING);
    triggerAction_tokens.setMultivalue(true);
    triggerAction_tokens.setSystemReserved(true);
    triggerAction_tokens.setUndeletable(true);
    triggerAction_tokens.setMultiLingual(false);
    MetadataBuilder triggerAction_tokensHierarchy = triggerActionSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    triggerAction_tokensHierarchy.setMultivalue(true);
    triggerAction_tokensHierarchy.setSystemReserved(true);
    triggerAction_tokensHierarchy.setUndeletable(true);
    triggerAction_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder triggerAction_type = triggerActionSchema.create("type").setType(MetadataValueType.REFERENCE);
    triggerAction_type.setDefaultRequirement(true);
    triggerAction_type.setUndeletable(true);
    triggerAction_type.defineReferencesTo(types.getSchemaType("triggerActionType"));
    MetadataBuilder triggerAction_visibleInTrees = triggerActionSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    triggerAction_visibleInTrees.setSystemReserved(true);
    triggerAction_visibleInTrees.setUndeletable(true);
    triggerAction_visibleInTrees.setMultiLingual(false);
  ...
  private void createDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder documentSchemaType, MetadataSchemaBuilder document_emailSchema, MetadataSchemaBuilder documentSchema) {
    ...
    MetadataBuilder document_email_emailVersions = document_emailSchema.create("emailVersions").setType(MetadataValueType.STRING);
    document_email_emailVersions.setMultivalue(true);
    document_email_emailVersions.setSystemReserved(true);
    document_email_emailVersions.setUndeletable(true);
    ...
    document_allRemovedAuths.setEssentialInSummary(true);
    ...
    MetadataBuilder document_attachedPrincipalAncestorsIntIds = documentSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    document_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    document_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    document_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    document_attachedPrincipalAncestorsIntIds.setEssential(true);
    document_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    document_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder document_contentCheckedOutDate = documentSchema.create("contentCheckedOutDate").setType(MetadataValueType.DATE_TIME);
    MetadataBuilder document_contentCheckedOutFrom = documentSchema.create("contentCheckedOutFrom").setType(MetadataValueType.INTEGER);
    document_contentCheckedOutFrom.setUndeletable(true);
    ...
    MetadataBuilder document_currentContentSize = documentSchema.create("currentContentSize").setType(MetadataValueType.NUMBER);
    document_currentContentSize.setUndeletable(true);
    ...
    MetadataBuilder document_detachedPrincipalAncestorsIntIds = documentSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    document_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    document_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    document_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    document_detachedPrincipalAncestorsIntIds.setEssential(true);
    document_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    document_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder document_encryptionKey = documentSchema.create("encryptionKey").setType(MetadataValueType.STRING);
    document_encryptionKey.setSystemReserved(true);
    document_encryptionKey.setUndeletable(true);
    document_encryptionKey.setAvailableInSummary(true);
    ...
    MetadataBuilder document_filename = documentSchema.create("filename").setType(MetadataValueType.STRING);
    document_filename.setUndeletable(true);
    document_filename.setAvailableInSummary(true);
    ...
    document_folder.setCacheIndex(true);
    ...
    document_formCreatedOn.setEssentialInSummary(true);
    ...
    document_formModifiedOn.setEssentialInSummary(true);
    ...
    MetadataBuilder document_hidden = documentSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    document_hidden.setSystemReserved(true);
    document_hidden.setUndeletable(true);
    document_hidden.setEssential(true);
    document_hidden.setMultiLingual(false);
    ...
    MetadataBuilder document_isCheckoutAlertSent = documentSchema.create("isCheckoutAlertSent").setType(MetadataValueType.BOOLEAN);
    document_isCheckoutAlertSent.setSystemReserved(true);
    document_isCheckoutAlertSent.setUndeletable(true);
    document_isCheckoutAlertSent.setDefaultValue(false);
    MetadataBuilder document_isModel = documentSchema.create("isModel").setType(MetadataValueType.BOOLEAN);
    document_isModel.setSystemReserved(true);
    document_isModel.setUndeletable(true);
    ...
    MetadataBuilder document_linkedTo = documentSchema.create("linkedTo").setType(MetadataValueType.REFERENCE);
    document_linkedTo.setMultivalue(true);
    document_linkedTo.setCacheIndex(true);
    document_linkedTo.defineReferencesTo(types.getSchemaType("folder"));
    ...
    document_modifiedOn.setEssentialInSummary(true);
    document_modifiedOn.setAvailableInSummary(true);
    document_modifiedOn.setSortable(true);
    MetadataBuilder document_nestedAuthorizations = documentSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    document_nestedAuthorizations.setSystemReserved(true);
    document_nestedAuthorizations.setUndeletable(true);
    document_nestedAuthorizations.setEssential(true);
    document_nestedAuthorizations.setMultiLingual(false);
    document_nestedAuthorizations.setEssentialInSummary(true);
    document_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder document_principalAncestorsIntIds = documentSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    document_principalAncestorsIntIds.setMultivalue(true);
    document_principalAncestorsIntIds.setSystemReserved(true);
    document_principalAncestorsIntIds.setUndeletable(true);
    document_principalAncestorsIntIds.setEssential(true);
    document_principalAncestorsIntIds.setMultiLingual(false);
    document_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder document_principalConceptsIntIds = documentSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    document_principalConceptsIntIds.setMultivalue(true);
    document_principalConceptsIntIds.setSystemReserved(true);
    document_principalConceptsIntIds.setUndeletable(true);
    document_principalConceptsIntIds.setEssential(true);
    document_principalConceptsIntIds.setMultiLingual(false);
    document_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    document_principalpath.setEssentialInSummary(true);
    ...
    MetadataBuilder document_publishingExpirationDate = documentSchema.create("publishingExpirationDate").setType(MetadataValueType.DATE);
    MetadataBuilder document_publishingStartDate = documentSchema.create("publishingStartDate").setType(MetadataValueType.DATE);
    ...
    MetadataBuilder document_secondaryConceptsIntIds = documentSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    document_secondaryConceptsIntIds.setMultivalue(true);
    document_secondaryConceptsIntIds.setSystemReserved(true);
    document_secondaryConceptsIntIds.setUndeletable(true);
    document_secondaryConceptsIntIds.setEssential(true);
    document_secondaryConceptsIntIds.setMultiLingual(false);
    document_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    document_title.setAvailableInSummary(true);
    ...
    document_title.defineValidators().add(IllegalCharactersValidator.class);
    ...
    document_tokensHierarchy.setEssentialInSummary(true);
  ...
  private void createLegalRequirementSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder legalRequirementSchemaType, MetadataSchemaBuilder legalRequirementSchema) {
    MetadataBuilder legalRequirement_allReferences = legalRequirementSchema.create("allReferences").setType(MetadataValueType.STRING);
    legalRequirement_allReferences.setMultivalue(true);
    legalRequirement_allReferences.setSystemReserved(true);
    legalRequirement_allReferences.setUndeletable(true);
    legalRequirement_allReferences.setMultiLingual(false);
    MetadataBuilder legalRequirement_allRemovedAuths = legalRequirementSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    legalRequirement_allRemovedAuths.setMultivalue(true);
    legalRequirement_allRemovedAuths.setSystemReserved(true);
    legalRequirement_allRemovedAuths.setUndeletable(true);
    legalRequirement_allRemovedAuths.setEssential(true);
    legalRequirement_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder legalRequirement_attachedAncestors = legalRequirementSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    legalRequirement_attachedAncestors.setMultivalue(true);
    legalRequirement_attachedAncestors.setSystemReserved(true);
    legalRequirement_attachedAncestors.setUndeletable(true);
    legalRequirement_attachedAncestors.setEssential(true);
    legalRequirement_attachedAncestors.setMultiLingual(false);
    MetadataBuilder legalRequirement_attachedPrincipalAncestorsIntIds = legalRequirementSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirement_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalRequirement_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalRequirement_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalRequirement_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalRequirement_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_author = legalRequirementSchema.create("author").setType(MetadataValueType.REFERENCE);
    legalRequirement_author.setUndeletable(true);
    legalRequirement_author.setAvailableInSummary(true);
    legalRequirement_author.defineReferencesTo(asList(types.getSchema("user_default")));
    MetadataBuilder legalRequirement_autocomplete = legalRequirementSchema.create("autocomplete").setType(MetadataValueType.STRING);
    legalRequirement_autocomplete.setMultivalue(true);
    legalRequirement_autocomplete.setSystemReserved(true);
    legalRequirement_autocomplete.setUndeletable(true);
    legalRequirement_autocomplete.setEssential(true);
    legalRequirement_autocomplete.setMultiLingual(true);
    MetadataBuilder legalRequirement_caption = legalRequirementSchema.create("caption").setType(MetadataValueType.STRING);
    legalRequirement_caption.setSystemReserved(true);
    legalRequirement_caption.setUndeletable(true);
    legalRequirement_caption.setMultiLingual(false);
    legalRequirement_caption.setSortable(true);
    MetadataBuilder legalRequirement_code = legalRequirementSchema.create("code").setType(MetadataValueType.STRING);
    legalRequirement_code.setUndeletable(true);
    legalRequirement_code.setAvailableInSummary(true);
    MetadataBuilder legalRequirement_consequences = legalRequirementSchema.create("consequences").setType(MetadataValueType.TEXT);
    legalRequirement_consequences.setUndeletable(true);
    MetadataBuilder legalRequirement_createdBy = legalRequirementSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    legalRequirement_createdBy.setSystemReserved(true);
    legalRequirement_createdBy.setUndeletable(true);
    legalRequirement_createdBy.setMultiLingual(false);
    legalRequirement_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalRequirement_createdOn = legalRequirementSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    legalRequirement_createdOn.setSystemReserved(true);
    legalRequirement_createdOn.setUndeletable(true);
    legalRequirement_createdOn.setMultiLingual(false);
    legalRequirement_createdOn.setSortable(true);
    MetadataBuilder legalRequirement_deleted = legalRequirementSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    legalRequirement_deleted.setSystemReserved(true);
    legalRequirement_deleted.setUndeletable(true);
    legalRequirement_deleted.setMultiLingual(false);
    MetadataBuilder legalRequirement_denyTokens = legalRequirementSchema.create("denyTokens").setType(MetadataValueType.STRING);
    legalRequirement_denyTokens.setMultivalue(true);
    legalRequirement_denyTokens.setSystemReserved(true);
    legalRequirement_denyTokens.setUndeletable(true);
    legalRequirement_denyTokens.setMultiLingual(false);
    legalRequirement_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirement_description = legalRequirementSchema.create("description").setType(MetadataValueType.TEXT);
    legalRequirement_description.setUndeletable(true);
    MetadataBuilder legalRequirement_detachedPrincipalAncestorsIntIds = legalRequirementSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirement_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalRequirement_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalRequirement_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalRequirement_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalRequirement_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_detachedauthorizations = legalRequirementSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    legalRequirement_detachedauthorizations.setSystemReserved(true);
    legalRequirement_detachedauthorizations.setUndeletable(true);
    legalRequirement_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder legalRequirement_errorOnPhysicalDeletion = legalRequirementSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    legalRequirement_errorOnPhysicalDeletion.setSystemReserved(true);
    legalRequirement_errorOnPhysicalDeletion.setUndeletable(true);
    legalRequirement_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder legalRequirement_estimatedSize = legalRequirementSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    legalRequirement_estimatedSize.setSystemReserved(true);
    legalRequirement_estimatedSize.setUndeletable(true);
    legalRequirement_estimatedSize.setMultiLingual(false);
    MetadataBuilder legalRequirement_hidden = legalRequirementSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    legalRequirement_hidden.setSystemReserved(true);
    legalRequirement_hidden.setUndeletable(true);
    legalRequirement_hidden.setMultiLingual(false);
    MetadataBuilder legalRequirement_id = legalRequirementSchema.create("id").setType(MetadataValueType.STRING);
    legalRequirement_id.setDefaultRequirement(true);
    legalRequirement_id.setSystemReserved(true);
    legalRequirement_id.setUndeletable(true);
    legalRequirement_id.setMultiLingual(false);
    legalRequirement_id.setSearchable(true);
    legalRequirement_id.setSortable(true);
    legalRequirement_id.setUniqueValue(true);
    legalRequirement_id.setUnmodifiable(true);
    MetadataBuilder legalRequirement_legacyIdentifier = legalRequirementSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    legalRequirement_legacyIdentifier.setDefaultRequirement(true);
    legalRequirement_legacyIdentifier.setSystemReserved(true);
    legalRequirement_legacyIdentifier.setUndeletable(true);
    legalRequirement_legacyIdentifier.setMultiLingual(false);
    legalRequirement_legacyIdentifier.setSearchable(true);
    legalRequirement_legacyIdentifier.setUniqueValue(true);
    legalRequirement_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder legalRequirement_logicallyDeletedOn = legalRequirementSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    legalRequirement_logicallyDeletedOn.setSystemReserved(true);
    legalRequirement_logicallyDeletedOn.setUndeletable(true);
    legalRequirement_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder legalRequirement_manualTokens = legalRequirementSchema.create("manualTokens").setType(MetadataValueType.STRING);
    legalRequirement_manualTokens.setMultivalue(true);
    legalRequirement_manualTokens.setSystemReserved(true);
    legalRequirement_manualTokens.setUndeletable(true);
    legalRequirement_manualTokens.setMultiLingual(false);
    legalRequirement_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirement_markedForParsing = legalRequirementSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    legalRequirement_markedForParsing.setSystemReserved(true);
    legalRequirement_markedForParsing.setUndeletable(true);
    legalRequirement_markedForParsing.setMultiLingual(false);
    MetadataBuilder legalRequirement_markedForPreviewConversion = legalRequirementSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    legalRequirement_markedForPreviewConversion.setSystemReserved(true);
    legalRequirement_markedForPreviewConversion.setUndeletable(true);
    legalRequirement_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder legalRequirement_markedForReindexing = legalRequirementSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    legalRequirement_markedForReindexing.setSystemReserved(true);
    legalRequirement_markedForReindexing.setUndeletable(true);
    legalRequirement_markedForReindexing.setMultiLingual(false);
    MetadataBuilder legalRequirement_migrationDataVersion = legalRequirementSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    legalRequirement_migrationDataVersion.setSystemReserved(true);
    legalRequirement_migrationDataVersion.setUndeletable(true);
    legalRequirement_migrationDataVersion.setMultiLingual(false);
    legalRequirement_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_modifiedBy = legalRequirementSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    legalRequirement_modifiedBy.setSystemReserved(true);
    legalRequirement_modifiedBy.setUndeletable(true);
    legalRequirement_modifiedBy.setMultiLingual(false);
    legalRequirement_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalRequirement_modifiedOn = legalRequirementSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    legalRequirement_modifiedOn.setSystemReserved(true);
    legalRequirement_modifiedOn.setUndeletable(true);
    legalRequirement_modifiedOn.setMultiLingual(false);
    legalRequirement_modifiedOn.setAvailableInSummary(true);
    legalRequirement_modifiedOn.setSortable(true);
    MetadataBuilder legalRequirement_nestedAuthorizations = legalRequirementSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    legalRequirement_nestedAuthorizations.setSystemReserved(true);
    legalRequirement_nestedAuthorizations.setUndeletable(true);
    legalRequirement_nestedAuthorizations.setMultiLingual(false);
    legalRequirement_nestedAuthorizations.setEssentialInSummary(true);
    legalRequirement_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder legalRequirement_objectTypes = legalRequirementSchema.create("objectTypes").setType(MetadataValueType.TEXT);
    legalRequirement_objectTypes.setUndeletable(true);
    MetadataBuilder legalRequirement_path = legalRequirementSchema.create("path").setType(MetadataValueType.STRING);
    legalRequirement_path.setMultivalue(true);
    legalRequirement_path.setSystemReserved(true);
    legalRequirement_path.setUndeletable(true);
    legalRequirement_path.setMultiLingual(false);
    MetadataBuilder legalRequirement_pathParts = legalRequirementSchema.create("pathParts").setType(MetadataValueType.STRING);
    legalRequirement_pathParts.setMultivalue(true);
    legalRequirement_pathParts.setSystemReserved(true);
    legalRequirement_pathParts.setUndeletable(true);
    legalRequirement_pathParts.setMultiLingual(false);
    MetadataBuilder legalRequirement_principalAncestorsIntIds = legalRequirementSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirement_principalAncestorsIntIds.setMultivalue(true);
    legalRequirement_principalAncestorsIntIds.setSystemReserved(true);
    legalRequirement_principalAncestorsIntIds.setUndeletable(true);
    legalRequirement_principalAncestorsIntIds.setMultiLingual(false);
    legalRequirement_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_principalConceptsIntIds = legalRequirementSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirement_principalConceptsIntIds.setMultivalue(true);
    legalRequirement_principalConceptsIntIds.setSystemReserved(true);
    legalRequirement_principalConceptsIntIds.setUndeletable(true);
    legalRequirement_principalConceptsIntIds.setMultiLingual(false);
    legalRequirement_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_principalpath = legalRequirementSchema.create("principalpath").setType(MetadataValueType.STRING);
    legalRequirement_principalpath.setSystemReserved(true);
    legalRequirement_principalpath.setUndeletable(true);
    legalRequirement_principalpath.setMultiLingual(false);
    MetadataBuilder legalRequirement_removedauthorizations = legalRequirementSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    legalRequirement_removedauthorizations.setMultivalue(true);
    legalRequirement_removedauthorizations.setSystemReserved(true);
    legalRequirement_removedauthorizations.setUndeletable(true);
    legalRequirement_removedauthorizations.setMultiLingual(false);
    MetadataBuilder legalRequirement_schema = legalRequirementSchema.create("schema").setType(MetadataValueType.STRING);
    legalRequirement_schema.setDefaultRequirement(true);
    legalRequirement_schema.setSystemReserved(true);
    legalRequirement_schema.setUndeletable(true);
    legalRequirement_schema.setMultiLingual(false);
    MetadataBuilder legalRequirement_secondaryConceptsIntIds = legalRequirementSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirement_secondaryConceptsIntIds.setMultivalue(true);
    legalRequirement_secondaryConceptsIntIds.setSystemReserved(true);
    legalRequirement_secondaryConceptsIntIds.setUndeletable(true);
    legalRequirement_secondaryConceptsIntIds.setMultiLingual(false);
    legalRequirement_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirement_shareDenyTokens = legalRequirementSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    legalRequirement_shareDenyTokens.setMultivalue(true);
    legalRequirement_shareDenyTokens.setSystemReserved(true);
    legalRequirement_shareDenyTokens.setUndeletable(true);
    legalRequirement_shareDenyTokens.setMultiLingual(false);
    legalRequirement_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirement_shareTokens = legalRequirementSchema.create("shareTokens").setType(MetadataValueType.STRING);
    legalRequirement_shareTokens.setMultivalue(true);
    legalRequirement_shareTokens.setSystemReserved(true);
    legalRequirement_shareTokens.setUndeletable(true);
    legalRequirement_shareTokens.setMultiLingual(false);
    legalRequirement_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirement_title = legalRequirementSchema.create("title").setType(MetadataValueType.STRING);
    legalRequirement_title.setUndeletable(true);
    legalRequirement_title.setMultiLingual(false);
    legalRequirement_title.setAvailableInSummary(true);
    legalRequirement_title.setSchemaAutocomplete(true);
    legalRequirement_title.setSearchable(true);
    MetadataBuilder legalRequirement_tokens = legalRequirementSchema.create("tokens").setType(MetadataValueType.STRING);
    legalRequirement_tokens.setMultivalue(true);
    legalRequirement_tokens.setSystemReserved(true);
    legalRequirement_tokens.setUndeletable(true);
    legalRequirement_tokens.setMultiLingual(false);
    MetadataBuilder legalRequirement_tokensHierarchy = legalRequirementSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    legalRequirement_tokensHierarchy.setMultivalue(true);
    legalRequirement_tokensHierarchy.setSystemReserved(true);
    legalRequirement_tokensHierarchy.setUndeletable(true);
    legalRequirement_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder legalRequirement_type = legalRequirementSchema.create("type").setType(MetadataValueType.REFERENCE);
    legalRequirement_type.setMultivalue(true);
    legalRequirement_type.setUndeletable(true);
    legalRequirement_type.defineReferencesTo(asList(types.getSchema("ddvRequirementType_default")));
    MetadataBuilder legalRequirement_visibleInTrees = legalRequirementSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    legalRequirement_visibleInTrees.setSystemReserved(true);
    legalRequirement_visibleInTrees.setUndeletable(true);
    legalRequirement_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createDdvUserFunctionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvUserFunctionSchemaType, MetadataSchemaBuilder ddvUserFunctionSchema) {
    MetadataBuilder ddvUserFunction_abbreviation = ddvUserFunctionSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvUserFunction_abbreviation.setUndeletable(true);
    ddvUserFunction_abbreviation.setMultiLingual(true);
    ddvUserFunction_abbreviation.setSearchable(true);
    ddvUserFunction_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvUserFunction_allReferences = ddvUserFunctionSchema.create("allReferences").setType(MetadataValueType.STRING);
    ddvUserFunction_allReferences.setMultivalue(true);
    ddvUserFunction_allReferences.setSystemReserved(true);
    ddvUserFunction_allReferences.setUndeletable(true);
    ddvUserFunction_allReferences.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_allRemovedAuths = ddvUserFunctionSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    ddvUserFunction_allRemovedAuths.setMultivalue(true);
    ddvUserFunction_allRemovedAuths.setSystemReserved(true);
    ddvUserFunction_allRemovedAuths.setUndeletable(true);
    ddvUserFunction_allRemovedAuths.setEssential(true);
    ddvUserFunction_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_attachedAncestors = ddvUserFunctionSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    ddvUserFunction_attachedAncestors.setMultivalue(true);
    ddvUserFunction_attachedAncestors.setSystemReserved(true);
    ddvUserFunction_attachedAncestors.setUndeletable(true);
    ddvUserFunction_attachedAncestors.setEssential(true);
    ddvUserFunction_attachedAncestors.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_attachedPrincipalAncestorsIntIds = ddvUserFunctionSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvUserFunction_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvUserFunction_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvUserFunction_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvUserFunction_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvUserFunction_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_autocomplete = ddvUserFunctionSchema.create("autocomplete").setType(MetadataValueType.STRING);
    ddvUserFunction_autocomplete.setMultivalue(true);
    ddvUserFunction_autocomplete.setSystemReserved(true);
    ddvUserFunction_autocomplete.setUndeletable(true);
    ddvUserFunction_autocomplete.setEssential(true);
    ddvUserFunction_autocomplete.setMultiLingual(true);
    MetadataBuilder ddvUserFunction_caption = ddvUserFunctionSchema.create("caption").setType(MetadataValueType.STRING);
    ddvUserFunction_caption.setSystemReserved(true);
    ddvUserFunction_caption.setUndeletable(true);
    ddvUserFunction_caption.setMultiLingual(false);
    ddvUserFunction_caption.setSortable(true);
    MetadataBuilder ddvUserFunction_code = ddvUserFunctionSchema.create("code").setType(MetadataValueType.STRING);
    ddvUserFunction_code.setUndeletable(true);
    ddvUserFunction_code.setEnabled(false);
    ddvUserFunction_code.setSchemaAutocomplete(true);
    ddvUserFunction_code.setSearchable(true);
    ddvUserFunction_code.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvUserFunction_comments = ddvUserFunctionSchema.create("comments").setType(MetadataValueType.STRUCTURE);
    ddvUserFunction_comments.setMultivalue(true);
    ddvUserFunction_comments.defineStructureFactory(CommentFactory.class);
    MetadataBuilder ddvUserFunction_createdBy = ddvUserFunctionSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    ddvUserFunction_createdBy.setSystemReserved(true);
    ddvUserFunction_createdBy.setUndeletable(true);
    ddvUserFunction_createdBy.setMultiLingual(false);
    ddvUserFunction_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvUserFunction_createdOn = ddvUserFunctionSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    ddvUserFunction_createdOn.setSystemReserved(true);
    ddvUserFunction_createdOn.setUndeletable(true);
    ddvUserFunction_createdOn.setMultiLingual(false);
    ddvUserFunction_createdOn.setSortable(true);
    MetadataBuilder ddvUserFunction_deleted = ddvUserFunctionSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_deleted.setSystemReserved(true);
    ddvUserFunction_deleted.setUndeletable(true);
    ddvUserFunction_deleted.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_denyTokens = ddvUserFunctionSchema.create("denyTokens").setType(MetadataValueType.STRING);
    ddvUserFunction_denyTokens.setMultivalue(true);
    ddvUserFunction_denyTokens.setSystemReserved(true);
    ddvUserFunction_denyTokens.setUndeletable(true);
    ddvUserFunction_denyTokens.setMultiLingual(false);
    ddvUserFunction_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvUserFunction_description = ddvUserFunctionSchema.create("description").setType(MetadataValueType.TEXT);
    ddvUserFunction_description.setUndeletable(true);
    ddvUserFunction_description.setMultiLingual(true);
    ddvUserFunction_description.setSearchable(true);
    MetadataBuilder ddvUserFunction_detachedPrincipalAncestorsIntIds = ddvUserFunctionSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvUserFunction_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvUserFunction_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvUserFunction_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvUserFunction_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvUserFunction_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_detachedauthorizations = ddvUserFunctionSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_detachedauthorizations.setSystemReserved(true);
    ddvUserFunction_detachedauthorizations.setUndeletable(true);
    ddvUserFunction_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_errorOnPhysicalDeletion = ddvUserFunctionSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_errorOnPhysicalDeletion.setSystemReserved(true);
    ddvUserFunction_errorOnPhysicalDeletion.setUndeletable(true);
    ddvUserFunction_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_estimatedSize = ddvUserFunctionSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    ddvUserFunction_estimatedSize.setSystemReserved(true);
    ddvUserFunction_estimatedSize.setUndeletable(true);
    ddvUserFunction_estimatedSize.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_hidden = ddvUserFunctionSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_hidden.setSystemReserved(true);
    ddvUserFunction_hidden.setUndeletable(true);
    ddvUserFunction_hidden.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_id = ddvUserFunctionSchema.create("id").setType(MetadataValueType.STRING);
    ddvUserFunction_id.setDefaultRequirement(true);
    ddvUserFunction_id.setSystemReserved(true);
    ddvUserFunction_id.setUndeletable(true);
    ddvUserFunction_id.setMultiLingual(false);
    ddvUserFunction_id.setSearchable(true);
    ddvUserFunction_id.setSortable(true);
    ddvUserFunction_id.setUniqueValue(true);
    ddvUserFunction_id.setUnmodifiable(true);
    MetadataBuilder ddvUserFunction_legacyIdentifier = ddvUserFunctionSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    ddvUserFunction_legacyIdentifier.setDefaultRequirement(true);
    ddvUserFunction_legacyIdentifier.setSystemReserved(true);
    ddvUserFunction_legacyIdentifier.setUndeletable(true);
    ddvUserFunction_legacyIdentifier.setMultiLingual(false);
    ddvUserFunction_legacyIdentifier.setSearchable(true);
    ddvUserFunction_legacyIdentifier.setUniqueValue(true);
    ddvUserFunction_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder ddvUserFunction_logicallyDeletedOn = ddvUserFunctionSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    ddvUserFunction_logicallyDeletedOn.setSystemReserved(true);
    ddvUserFunction_logicallyDeletedOn.setUndeletable(true);
    ddvUserFunction_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_manualTokens = ddvUserFunctionSchema.create("manualTokens").setType(MetadataValueType.STRING);
    ddvUserFunction_manualTokens.setMultivalue(true);
    ddvUserFunction_manualTokens.setSystemReserved(true);
    ddvUserFunction_manualTokens.setUndeletable(true);
    ddvUserFunction_manualTokens.setMultiLingual(false);
    ddvUserFunction_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvUserFunction_markedForParsing = ddvUserFunctionSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_markedForParsing.setSystemReserved(true);
    ddvUserFunction_markedForParsing.setUndeletable(true);
    ddvUserFunction_markedForParsing.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_markedForPreviewConversion = ddvUserFunctionSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_markedForPreviewConversion.setSystemReserved(true);
    ddvUserFunction_markedForPreviewConversion.setUndeletable(true);
    ddvUserFunction_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_markedForReindexing = ddvUserFunctionSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_markedForReindexing.setSystemReserved(true);
    ddvUserFunction_markedForReindexing.setUndeletable(true);
    ddvUserFunction_markedForReindexing.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_migrationDataVersion = ddvUserFunctionSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    ddvUserFunction_migrationDataVersion.setSystemReserved(true);
    ddvUserFunction_migrationDataVersion.setUndeletable(true);
    ddvUserFunction_migrationDataVersion.setMultiLingual(false);
    ddvUserFunction_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_modifiedBy = ddvUserFunctionSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    ddvUserFunction_modifiedBy.setSystemReserved(true);
    ddvUserFunction_modifiedBy.setUndeletable(true);
    ddvUserFunction_modifiedBy.setMultiLingual(false);
    ddvUserFunction_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvUserFunction_modifiedOn = ddvUserFunctionSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    ddvUserFunction_modifiedOn.setSystemReserved(true);
    ddvUserFunction_modifiedOn.setUndeletable(true);
    ddvUserFunction_modifiedOn.setMultiLingual(false);
    ddvUserFunction_modifiedOn.setAvailableInSummary(true);
    ddvUserFunction_modifiedOn.setSortable(true);
    MetadataBuilder ddvUserFunction_nestedAuthorizations = ddvUserFunctionSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvUserFunction_nestedAuthorizations.setSystemReserved(true);
    ddvUserFunction_nestedAuthorizations.setUndeletable(true);
    ddvUserFunction_nestedAuthorizations.setMultiLingual(false);
    ddvUserFunction_nestedAuthorizations.setEssentialInSummary(true);
    ddvUserFunction_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder ddvUserFunction_path = ddvUserFunctionSchema.create("path").setType(MetadataValueType.STRING);
    ddvUserFunction_path.setMultivalue(true);
    ddvUserFunction_path.setSystemReserved(true);
    ddvUserFunction_path.setUndeletable(true);
    ddvUserFunction_path.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_pathParts = ddvUserFunctionSchema.create("pathParts").setType(MetadataValueType.STRING);
    ddvUserFunction_pathParts.setMultivalue(true);
    ddvUserFunction_pathParts.setSystemReserved(true);
    ddvUserFunction_pathParts.setUndeletable(true);
    ddvUserFunction_pathParts.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_principalAncestorsIntIds = ddvUserFunctionSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvUserFunction_principalAncestorsIntIds.setMultivalue(true);
    ddvUserFunction_principalAncestorsIntIds.setSystemReserved(true);
    ddvUserFunction_principalAncestorsIntIds.setUndeletable(true);
    ddvUserFunction_principalAncestorsIntIds.setMultiLingual(false);
    ddvUserFunction_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_principalConceptsIntIds = ddvUserFunctionSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvUserFunction_principalConceptsIntIds.setMultivalue(true);
    ddvUserFunction_principalConceptsIntIds.setSystemReserved(true);
    ddvUserFunction_principalConceptsIntIds.setUndeletable(true);
    ddvUserFunction_principalConceptsIntIds.setMultiLingual(false);
    ddvUserFunction_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_principalpath = ddvUserFunctionSchema.create("principalpath").setType(MetadataValueType.STRING);
    ddvUserFunction_principalpath.setSystemReserved(true);
    ddvUserFunction_principalpath.setUndeletable(true);
    ddvUserFunction_principalpath.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_removedauthorizations = ddvUserFunctionSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    ddvUserFunction_removedauthorizations.setMultivalue(true);
    ddvUserFunction_removedauthorizations.setSystemReserved(true);
    ddvUserFunction_removedauthorizations.setUndeletable(true);
    ddvUserFunction_removedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_schema = ddvUserFunctionSchema.create("schema").setType(MetadataValueType.STRING);
    ddvUserFunction_schema.setDefaultRequirement(true);
    ddvUserFunction_schema.setSystemReserved(true);
    ddvUserFunction_schema.setUndeletable(true);
    ddvUserFunction_schema.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_secondaryConceptsIntIds = ddvUserFunctionSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvUserFunction_secondaryConceptsIntIds.setMultivalue(true);
    ddvUserFunction_secondaryConceptsIntIds.setSystemReserved(true);
    ddvUserFunction_secondaryConceptsIntIds.setUndeletable(true);
    ddvUserFunction_secondaryConceptsIntIds.setMultiLingual(false);
    ddvUserFunction_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvUserFunction_shareDenyTokens = ddvUserFunctionSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    ddvUserFunction_shareDenyTokens.setMultivalue(true);
    ddvUserFunction_shareDenyTokens.setSystemReserved(true);
    ddvUserFunction_shareDenyTokens.setUndeletable(true);
    ddvUserFunction_shareDenyTokens.setMultiLingual(false);
    ddvUserFunction_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvUserFunction_shareTokens = ddvUserFunctionSchema.create("shareTokens").setType(MetadataValueType.STRING);
    ddvUserFunction_shareTokens.setMultivalue(true);
    ddvUserFunction_shareTokens.setSystemReserved(true);
    ddvUserFunction_shareTokens.setUndeletable(true);
    ddvUserFunction_shareTokens.setMultiLingual(false);
    ddvUserFunction_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvUserFunction_title = ddvUserFunctionSchema.create("title").setType(MetadataValueType.STRING);
    ddvUserFunction_title.setDefaultRequirement(true);
    ddvUserFunction_title.setUndeletable(true);
    ddvUserFunction_title.setMultiLingual(true);
    ddvUserFunction_title.setAvailableInSummary(true);
    ddvUserFunction_title.setSchemaAutocomplete(true);
    ddvUserFunction_title.setSearchable(true);
    ddvUserFunction_title.setUniqueValue(true);
    ddvUserFunction_title.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvUserFunction_tokens = ddvUserFunctionSchema.create("tokens").setType(MetadataValueType.STRING);
    ddvUserFunction_tokens.setMultivalue(true);
    ddvUserFunction_tokens.setSystemReserved(true);
    ddvUserFunction_tokens.setUndeletable(true);
    ddvUserFunction_tokens.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_tokensHierarchy = ddvUserFunctionSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    ddvUserFunction_tokensHierarchy.setMultivalue(true);
    ddvUserFunction_tokensHierarchy.setSystemReserved(true);
    ddvUserFunction_tokensHierarchy.setUndeletable(true);
    ddvUserFunction_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder ddvUserFunction_visibleInTrees = ddvUserFunctionSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    ddvUserFunction_visibleInTrees.setSystemReserved(true);
    ddvUserFunction_visibleInTrees.setUndeletable(true);
    ddvUserFunction_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createDdvStorageSpaceTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvStorageSpaceTypeSchemaType, MetadataSchemaBuilder ddvStorageSpaceTypeSchema) {
    MetadataBuilder ddvStorageSpaceType_abbreviation = ddvStorageSpaceTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvStorageSpaceType_abbreviation.setUndeletable(true);
    ddvStorageSpaceType_abbreviation.setMultiLingual(true);
    ddvStorageSpaceType_abbreviation.setSearchable(true);
    ddvStorageSpaceType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvStorageSpaceType_attachedPrincipalAncestorsIntIds = ddvStorageSpaceTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvStorageSpaceType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvStorageSpaceType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvStorageSpaceType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvStorageSpaceType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvStorageSpaceType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvStorageSpaceType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvStorageSpaceType_detachedPrincipalAncestorsIntIds = ddvStorageSpaceTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvStorageSpaceType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvStorageSpaceType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvStorageSpaceType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvStorageSpaceType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvStorageSpaceType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvStorageSpaceType_hidden = ddvStorageSpaceTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvStorageSpaceType_hidden.setSystemReserved(true);
    ddvStorageSpaceType_hidden.setUndeletable(true);
    ddvStorageSpaceType_hidden.setMultiLingual(false);
    ...
    ddvStorageSpaceType_modifiedOn.setAvailableInSummary(true);
    ddvStorageSpaceType_modifiedOn.setSortable(true);
    MetadataBuilder ddvStorageSpaceType_nestedAuthorizations = ddvStorageSpaceTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvStorageSpaceType_nestedAuthorizations.setSystemReserved(true);
    ddvStorageSpaceType_nestedAuthorizations.setUndeletable(true);
    ddvStorageSpaceType_nestedAuthorizations.setMultiLingual(false);
    ddvStorageSpaceType_nestedAuthorizations.setEssentialInSummary(true);
    ddvStorageSpaceType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvStorageSpaceType_principalAncestorsIntIds = ddvStorageSpaceTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvStorageSpaceType_principalAncestorsIntIds.setMultivalue(true);
    ddvStorageSpaceType_principalAncestorsIntIds.setSystemReserved(true);
    ddvStorageSpaceType_principalAncestorsIntIds.setUndeletable(true);
    ddvStorageSpaceType_principalAncestorsIntIds.setMultiLingual(false);
    ddvStorageSpaceType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvStorageSpaceType_principalConceptsIntIds = ddvStorageSpaceTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvStorageSpaceType_principalConceptsIntIds.setMultivalue(true);
    ddvStorageSpaceType_principalConceptsIntIds.setSystemReserved(true);
    ddvStorageSpaceType_principalConceptsIntIds.setUndeletable(true);
    ddvStorageSpaceType_principalConceptsIntIds.setMultiLingual(false);
    ddvStorageSpaceType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvStorageSpaceType_secondaryConceptsIntIds = ddvStorageSpaceTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvStorageSpaceType_secondaryConceptsIntIds.setMultivalue(true);
    ddvStorageSpaceType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvStorageSpaceType_secondaryConceptsIntIds.setUndeletable(true);
    ddvStorageSpaceType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvStorageSpaceType_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvStorageSpaceType_title.setAvailableInSummary(true);
    ...
    ddvStorageSpaceType_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createDdvContainerRecordTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvContainerRecordTypeSchemaType, MetadataSchemaBuilder ddvContainerRecordTypeSchema) {
    MetadataBuilder ddvContainerRecordType_abbreviation = ddvContainerRecordTypeSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvContainerRecordType_abbreviation.setUndeletable(true);
    ddvContainerRecordType_abbreviation.setMultiLingual(true);
    ddvContainerRecordType_abbreviation.setSearchable(true);
    ddvContainerRecordType_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvContainerRecordType_attachedPrincipalAncestorsIntIds = ddvContainerRecordTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvContainerRecordType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvContainerRecordType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvContainerRecordType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvContainerRecordType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvContainerRecordType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvContainerRecordType_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvContainerRecordType_detachedPrincipalAncestorsIntIds = ddvContainerRecordTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvContainerRecordType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvContainerRecordType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvContainerRecordType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvContainerRecordType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvContainerRecordType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvContainerRecordType_hidden = ddvContainerRecordTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvContainerRecordType_hidden.setSystemReserved(true);
    ddvContainerRecordType_hidden.setUndeletable(true);
    ddvContainerRecordType_hidden.setMultiLingual(false);
    ...
    ddvContainerRecordType_modifiedOn.setAvailableInSummary(true);
    ddvContainerRecordType_modifiedOn.setSortable(true);
    MetadataBuilder ddvContainerRecordType_nestedAuthorizations = ddvContainerRecordTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvContainerRecordType_nestedAuthorizations.setSystemReserved(true);
    ddvContainerRecordType_nestedAuthorizations.setUndeletable(true);
    ddvContainerRecordType_nestedAuthorizations.setMultiLingual(false);
    ddvContainerRecordType_nestedAuthorizations.setEssentialInSummary(true);
    ddvContainerRecordType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvContainerRecordType_principalAncestorsIntIds = ddvContainerRecordTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvContainerRecordType_principalAncestorsIntIds.setMultivalue(true);
    ddvContainerRecordType_principalAncestorsIntIds.setSystemReserved(true);
    ddvContainerRecordType_principalAncestorsIntIds.setUndeletable(true);
    ddvContainerRecordType_principalAncestorsIntIds.setMultiLingual(false);
    ddvContainerRecordType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvContainerRecordType_principalConceptsIntIds = ddvContainerRecordTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvContainerRecordType_principalConceptsIntIds.setMultivalue(true);
    ddvContainerRecordType_principalConceptsIntIds.setSystemReserved(true);
    ddvContainerRecordType_principalConceptsIntIds.setUndeletable(true);
    ddvContainerRecordType_principalConceptsIntIds.setMultiLingual(false);
    ddvContainerRecordType_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvContainerRecordType_secondaryConceptsIntIds = ddvContainerRecordTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvContainerRecordType_secondaryConceptsIntIds.setMultivalue(true);
    ddvContainerRecordType_secondaryConceptsIntIds.setSystemReserved(true);
    ddvContainerRecordType_secondaryConceptsIntIds.setUndeletable(true);
    ddvContainerRecordType_secondaryConceptsIntIds.setMultiLingual(false);
    ddvContainerRecordType_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvContainerRecordType_title.setAvailableInSummary(true);
    ...
    ddvContainerRecordType_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createDdvVariablePeriodSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvVariablePeriodSchemaType, MetadataSchemaBuilder ddvVariablePeriodSchema) {
    MetadataBuilder ddvVariablePeriod_abbreviation = ddvVariablePeriodSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvVariablePeriod_abbreviation.setUndeletable(true);
    ddvVariablePeriod_abbreviation.setMultiLingual(true);
    ddvVariablePeriod_abbreviation.setSearchable(true);
    ddvVariablePeriod_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvVariablePeriod_attachedPrincipalAncestorsIntIds = ddvVariablePeriodSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvVariablePeriod_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvVariablePeriod_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvVariablePeriod_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvVariablePeriod_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvVariablePeriod_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    ddvVariablePeriod_code.setAvailableInSummary(true);
    ...
    ddvVariablePeriod_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder ddvVariablePeriod_detachedPrincipalAncestorsIntIds = ddvVariablePeriodSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvVariablePeriod_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvVariablePeriod_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvVariablePeriod_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvVariablePeriod_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvVariablePeriod_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvVariablePeriod_hidden = ddvVariablePeriodSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvVariablePeriod_hidden.setSystemReserved(true);
    ddvVariablePeriod_hidden.setUndeletable(true);
    ddvVariablePeriod_hidden.setMultiLingual(false);
    ...
    ddvVariablePeriod_modifiedOn.setAvailableInSummary(true);
    ddvVariablePeriod_modifiedOn.setSortable(true);
    MetadataBuilder ddvVariablePeriod_nestedAuthorizations = ddvVariablePeriodSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvVariablePeriod_nestedAuthorizations.setSystemReserved(true);
    ddvVariablePeriod_nestedAuthorizations.setUndeletable(true);
    ddvVariablePeriod_nestedAuthorizations.setMultiLingual(false);
    ddvVariablePeriod_nestedAuthorizations.setEssentialInSummary(true);
    ddvVariablePeriod_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder ddvVariablePeriod_principalAncestorsIntIds = ddvVariablePeriodSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvVariablePeriod_principalAncestorsIntIds.setMultivalue(true);
    ddvVariablePeriod_principalAncestorsIntIds.setSystemReserved(true);
    ddvVariablePeriod_principalAncestorsIntIds.setUndeletable(true);
    ddvVariablePeriod_principalAncestorsIntIds.setMultiLingual(false);
    ddvVariablePeriod_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvVariablePeriod_principalConceptsIntIds = ddvVariablePeriodSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvVariablePeriod_principalConceptsIntIds.setMultivalue(true);
    ddvVariablePeriod_principalConceptsIntIds.setSystemReserved(true);
    ddvVariablePeriod_principalConceptsIntIds.setUndeletable(true);
    ddvVariablePeriod_principalConceptsIntIds.setMultiLingual(false);
    ddvVariablePeriod_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder ddvVariablePeriod_secondaryConceptsIntIds = ddvVariablePeriodSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvVariablePeriod_secondaryConceptsIntIds.setMultivalue(true);
    ddvVariablePeriod_secondaryConceptsIntIds.setSystemReserved(true);
    ddvVariablePeriod_secondaryConceptsIntIds.setUndeletable(true);
    ddvVariablePeriod_secondaryConceptsIntIds.setMultiLingual(false);
    ddvVariablePeriod_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    ddvVariablePeriod_title.setAvailableInSummary(true);
    ...
    ddvVariablePeriod_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createDecommissioningListSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder decommissioningListSchemaType, MetadataSchemaBuilder decommissioningListSchema) {
    ...
    MetadataBuilder decommissioningList_attachedPrincipalAncestorsIntIds = decommissioningListSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    decommissioningList_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    decommissioningList_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    decommissioningList_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    decommissioningList_attachedPrincipalAncestorsIntIds.setEssential(true);
    decommissioningList_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    decommissioningList_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder decommissioningList_currentBatchProcess = decommissioningListSchema.create("currentBatchProcess").setType(MetadataValueType.STRING);
    decommissioningList_currentBatchProcess.setSystemReserved(true);
    decommissioningList_currentBatchProcess.setUndeletable(true);
    ...
    MetadataBuilder decommissioningList_detachedPrincipalAncestorsIntIds = decommissioningListSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    decommissioningList_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    decommissioningList_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    decommissioningList_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    decommissioningList_detachedPrincipalAncestorsIntIds.setEssential(true);
    decommissioningList_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    decommissioningList_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    decommissioningList_documents.setCacheIndex(true);
    ...
    MetadataBuilder decommissioningList_externalLinkDisposalMode = decommissioningListSchema.create("externalLinkDisposalMode").setType(MetadataValueType.ENUM);
    decommissioningList_externalLinkDisposalMode.setUndeletable(true);
    decommissioningList_externalLinkDisposalMode.defineAsEnum(DisposalMode.class);
    ...
    decommissioningList_folders.setCacheIndex(true);
    ...
    MetadataBuilder decommissioningList_hidden = decommissioningListSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    decommissioningList_hidden.setSystemReserved(true);
    decommissioningList_hidden.setUndeletable(true);
    decommissioningList_hidden.setEssential(true);
    decommissioningList_hidden.setMultiLingual(false);
    ...
    decommissioningList_modifiedOn.setAvailableInSummary(true);
    decommissioningList_modifiedOn.setSortable(true);
    MetadataBuilder decommissioningList_nestedAuthorizations = decommissioningListSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    decommissioningList_nestedAuthorizations.setSystemReserved(true);
    decommissioningList_nestedAuthorizations.setUndeletable(true);
    decommissioningList_nestedAuthorizations.setEssential(true);
    decommissioningList_nestedAuthorizations.setMultiLingual(false);
    decommissioningList_nestedAuthorizations.setEssentialInSummary(true);
    decommissioningList_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder decommissioningList_principalAncestorsIntIds = decommissioningListSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    decommissioningList_principalAncestorsIntIds.setMultivalue(true);
    decommissioningList_principalAncestorsIntIds.setSystemReserved(true);
    decommissioningList_principalAncestorsIntIds.setUndeletable(true);
    decommissioningList_principalAncestorsIntIds.setEssential(true);
    decommissioningList_principalAncestorsIntIds.setMultiLingual(false);
    decommissioningList_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder decommissioningList_principalConceptsIntIds = decommissioningListSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    decommissioningList_principalConceptsIntIds.setMultivalue(true);
    decommissioningList_principalConceptsIntIds.setSystemReserved(true);
    decommissioningList_principalConceptsIntIds.setUndeletable(true);
    decommissioningList_principalConceptsIntIds.setEssential(true);
    decommissioningList_principalConceptsIntIds.setMultiLingual(false);
    decommissioningList_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder decommissioningList_requester = decommissioningListSchema.create("requester").setType(MetadataValueType.REFERENCE);
    decommissioningList_requester.setUndeletable(true);
    decommissioningList_requester.defineReferencesTo(asList(types.getSchema("user_default")));
    ...
    MetadataBuilder decommissioningList_secondaryConceptsIntIds = decommissioningListSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    decommissioningList_secondaryConceptsIntIds.setMultivalue(true);
    decommissioningList_secondaryConceptsIntIds.setSystemReserved(true);
    decommissioningList_secondaryConceptsIntIds.setUndeletable(true);
    decommissioningList_secondaryConceptsIntIds.setEssential(true);
    decommissioningList_secondaryConceptsIntIds.setMultiLingual(false);
    decommissioningList_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder decommissioningList_superUser = decommissioningListSchema.create("superUser").setType(MetadataValueType.REFERENCE);
    decommissioningList_superUser.setUndeletable(true);
    decommissioningList_superUser.defineReferencesTo(asList(types.getSchema("user_default")));
    ...
    decommissioningList_title.setAvailableInSummary(true);
    ...
    MetadataBuilder decommissioningList_validationRequester = decommissioningListSchema.create("validationRequester").setType(MetadataValueType.REFERENCE);
    decommissioningList_validationRequester.setUndeletable(true);
    decommissioningList_validationRequester.defineReferencesTo(types.getSchemaType("user"));
  ...
  private void createEventSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder eventSchemaType, MetadataSchemaBuilder eventSchema) {
    ...
    event_task.setAvailableInSummary(true);
  ...
  private void createLegalRequirementReferenceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder legalRequirementReferenceSchemaType, MetadataSchemaBuilder legalRequirementReferenceSchema) {
    MetadataBuilder legalRequirementReference_allReferences = legalRequirementReferenceSchema.create("allReferences").setType(MetadataValueType.STRING);
    legalRequirementReference_allReferences.setMultivalue(true);
    legalRequirementReference_allReferences.setSystemReserved(true);
    legalRequirementReference_allReferences.setUndeletable(true);
    legalRequirementReference_allReferences.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_allRemovedAuths = legalRequirementReferenceSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    legalRequirementReference_allRemovedAuths.setMultivalue(true);
    legalRequirementReference_allRemovedAuths.setSystemReserved(true);
    legalRequirementReference_allRemovedAuths.setUndeletable(true);
    legalRequirementReference_allRemovedAuths.setEssential(true);
    legalRequirementReference_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_attachedAncestors = legalRequirementReferenceSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    legalRequirementReference_attachedAncestors.setMultivalue(true);
    legalRequirementReference_attachedAncestors.setSystemReserved(true);
    legalRequirementReference_attachedAncestors.setUndeletable(true);
    legalRequirementReference_attachedAncestors.setEssential(true);
    legalRequirementReference_attachedAncestors.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_attachedPrincipalAncestorsIntIds = legalRequirementReferenceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirementReference_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalRequirementReference_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalRequirementReference_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalRequirementReference_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalRequirementReference_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_autocomplete = legalRequirementReferenceSchema.create("autocomplete").setType(MetadataValueType.STRING);
    legalRequirementReference_autocomplete.setMultivalue(true);
    legalRequirementReference_autocomplete.setSystemReserved(true);
    legalRequirementReference_autocomplete.setUndeletable(true);
    legalRequirementReference_autocomplete.setEssential(true);
    legalRequirementReference_autocomplete.setMultiLingual(true);
    MetadataBuilder legalRequirementReference_caption = legalRequirementReferenceSchema.create("caption").setType(MetadataValueType.STRING);
    legalRequirementReference_caption.setSystemReserved(true);
    legalRequirementReference_caption.setUndeletable(true);
    legalRequirementReference_caption.setMultiLingual(false);
    legalRequirementReference_caption.setSortable(true);
    MetadataBuilder legalRequirementReference_createdBy = legalRequirementReferenceSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    legalRequirementReference_createdBy.setSystemReserved(true);
    legalRequirementReference_createdBy.setUndeletable(true);
    legalRequirementReference_createdBy.setMultiLingual(false);
    legalRequirementReference_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalRequirementReference_createdOn = legalRequirementReferenceSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    legalRequirementReference_createdOn.setSystemReserved(true);
    legalRequirementReference_createdOn.setUndeletable(true);
    legalRequirementReference_createdOn.setMultiLingual(false);
    legalRequirementReference_createdOn.setSortable(true);
    MetadataBuilder legalRequirementReference_deleted = legalRequirementReferenceSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_deleted.setSystemReserved(true);
    legalRequirementReference_deleted.setUndeletable(true);
    legalRequirementReference_deleted.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_denyTokens = legalRequirementReferenceSchema.create("denyTokens").setType(MetadataValueType.STRING);
    legalRequirementReference_denyTokens.setMultivalue(true);
    legalRequirementReference_denyTokens.setSystemReserved(true);
    legalRequirementReference_denyTokens.setUndeletable(true);
    legalRequirementReference_denyTokens.setMultiLingual(false);
    legalRequirementReference_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirementReference_description = legalRequirementReferenceSchema.create("description").setType(MetadataValueType.TEXT);
    legalRequirementReference_description.setUndeletable(true);
    legalRequirementReference_description.setAvailableInSummary(true);
    MetadataBuilder legalRequirementReference_detachedPrincipalAncestorsIntIds = legalRequirementReferenceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirementReference_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    legalRequirementReference_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    legalRequirementReference_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    legalRequirementReference_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    legalRequirementReference_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_detachedauthorizations = legalRequirementReferenceSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_detachedauthorizations.setSystemReserved(true);
    legalRequirementReference_detachedauthorizations.setUndeletable(true);
    legalRequirementReference_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_errorOnPhysicalDeletion = legalRequirementReferenceSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_errorOnPhysicalDeletion.setSystemReserved(true);
    legalRequirementReference_errorOnPhysicalDeletion.setUndeletable(true);
    legalRequirementReference_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_estimatedSize = legalRequirementReferenceSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    legalRequirementReference_estimatedSize.setSystemReserved(true);
    legalRequirementReference_estimatedSize.setUndeletable(true);
    legalRequirementReference_estimatedSize.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_hidden = legalRequirementReferenceSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_hidden.setSystemReserved(true);
    legalRequirementReference_hidden.setUndeletable(true);
    legalRequirementReference_hidden.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_id = legalRequirementReferenceSchema.create("id").setType(MetadataValueType.STRING);
    legalRequirementReference_id.setDefaultRequirement(true);
    legalRequirementReference_id.setSystemReserved(true);
    legalRequirementReference_id.setUndeletable(true);
    legalRequirementReference_id.setMultiLingual(false);
    legalRequirementReference_id.setSearchable(true);
    legalRequirementReference_id.setSortable(true);
    legalRequirementReference_id.setUniqueValue(true);
    legalRequirementReference_id.setUnmodifiable(true);
    MetadataBuilder legalRequirementReference_legacyIdentifier = legalRequirementReferenceSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    legalRequirementReference_legacyIdentifier.setDefaultRequirement(true);
    legalRequirementReference_legacyIdentifier.setSystemReserved(true);
    legalRequirementReference_legacyIdentifier.setUndeletable(true);
    legalRequirementReference_legacyIdentifier.setMultiLingual(false);
    legalRequirementReference_legacyIdentifier.setSearchable(true);
    legalRequirementReference_legacyIdentifier.setUniqueValue(true);
    legalRequirementReference_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder legalRequirementReference_logicallyDeletedOn = legalRequirementReferenceSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    legalRequirementReference_logicallyDeletedOn.setSystemReserved(true);
    legalRequirementReference_logicallyDeletedOn.setUndeletable(true);
    legalRequirementReference_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_manualTokens = legalRequirementReferenceSchema.create("manualTokens").setType(MetadataValueType.STRING);
    legalRequirementReference_manualTokens.setMultivalue(true);
    legalRequirementReference_manualTokens.setSystemReserved(true);
    legalRequirementReference_manualTokens.setUndeletable(true);
    legalRequirementReference_manualTokens.setMultiLingual(false);
    legalRequirementReference_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirementReference_markedForParsing = legalRequirementReferenceSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_markedForParsing.setSystemReserved(true);
    legalRequirementReference_markedForParsing.setUndeletable(true);
    legalRequirementReference_markedForParsing.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_markedForPreviewConversion = legalRequirementReferenceSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_markedForPreviewConversion.setSystemReserved(true);
    legalRequirementReference_markedForPreviewConversion.setUndeletable(true);
    legalRequirementReference_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_markedForReindexing = legalRequirementReferenceSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_markedForReindexing.setSystemReserved(true);
    legalRequirementReference_markedForReindexing.setUndeletable(true);
    legalRequirementReference_markedForReindexing.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_migrationDataVersion = legalRequirementReferenceSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    legalRequirementReference_migrationDataVersion.setSystemReserved(true);
    legalRequirementReference_migrationDataVersion.setUndeletable(true);
    legalRequirementReference_migrationDataVersion.setMultiLingual(false);
    legalRequirementReference_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_modifiedBy = legalRequirementReferenceSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    legalRequirementReference_modifiedBy.setSystemReserved(true);
    legalRequirementReference_modifiedBy.setUndeletable(true);
    legalRequirementReference_modifiedBy.setMultiLingual(false);
    legalRequirementReference_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder legalRequirementReference_modifiedOn = legalRequirementReferenceSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    legalRequirementReference_modifiedOn.setSystemReserved(true);
    legalRequirementReference_modifiedOn.setUndeletable(true);
    legalRequirementReference_modifiedOn.setMultiLingual(false);
    legalRequirementReference_modifiedOn.setAvailableInSummary(true);
    legalRequirementReference_modifiedOn.setSortable(true);
    MetadataBuilder legalRequirementReference_nestedAuthorizations = legalRequirementReferenceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    legalRequirementReference_nestedAuthorizations.setSystemReserved(true);
    legalRequirementReference_nestedAuthorizations.setUndeletable(true);
    legalRequirementReference_nestedAuthorizations.setMultiLingual(false);
    legalRequirementReference_nestedAuthorizations.setEssentialInSummary(true);
    legalRequirementReference_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder legalRequirementReference_path = legalRequirementReferenceSchema.create("path").setType(MetadataValueType.STRING);
    legalRequirementReference_path.setMultivalue(true);
    legalRequirementReference_path.setSystemReserved(true);
    legalRequirementReference_path.setUndeletable(true);
    legalRequirementReference_path.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_pathParts = legalRequirementReferenceSchema.create("pathParts").setType(MetadataValueType.STRING);
    legalRequirementReference_pathParts.setMultivalue(true);
    legalRequirementReference_pathParts.setSystemReserved(true);
    legalRequirementReference_pathParts.setUndeletable(true);
    legalRequirementReference_pathParts.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_principalAncestorsIntIds = legalRequirementReferenceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirementReference_principalAncestorsIntIds.setMultivalue(true);
    legalRequirementReference_principalAncestorsIntIds.setSystemReserved(true);
    legalRequirementReference_principalAncestorsIntIds.setUndeletable(true);
    legalRequirementReference_principalAncestorsIntIds.setMultiLingual(false);
    legalRequirementReference_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_principalConceptsIntIds = legalRequirementReferenceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirementReference_principalConceptsIntIds.setMultivalue(true);
    legalRequirementReference_principalConceptsIntIds.setSystemReserved(true);
    legalRequirementReference_principalConceptsIntIds.setUndeletable(true);
    legalRequirementReference_principalConceptsIntIds.setMultiLingual(false);
    legalRequirementReference_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_principalpath = legalRequirementReferenceSchema.create("principalpath").setType(MetadataValueType.STRING);
    legalRequirementReference_principalpath.setSystemReserved(true);
    legalRequirementReference_principalpath.setUndeletable(true);
    legalRequirementReference_principalpath.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_removedauthorizations = legalRequirementReferenceSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    legalRequirementReference_removedauthorizations.setMultivalue(true);
    legalRequirementReference_removedauthorizations.setSystemReserved(true);
    legalRequirementReference_removedauthorizations.setUndeletable(true);
    legalRequirementReference_removedauthorizations.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_ruleReference = legalRequirementReferenceSchema.create("ruleReference").setType(MetadataValueType.REFERENCE);
    legalRequirementReference_ruleReference.setUndeletable(true);
    legalRequirementReference_ruleReference.setAvailableInSummary(true);
    legalRequirementReference_ruleReference.defineReferencesTo(asList(types.getSchema("legalReference_default")));
    MetadataBuilder legalRequirementReference_ruleRequirement = legalRequirementReferenceSchema.create("ruleRequirement").setType(MetadataValueType.REFERENCE);
    legalRequirementReference_ruleRequirement.setUndeletable(true);
    legalRequirementReference_ruleRequirement.setAvailableInSummary(true);
    legalRequirementReference_ruleRequirement.defineReferencesTo(asList(types.getSchema("legalRequirement_default")));
    MetadataBuilder legalRequirementReference_schema = legalRequirementReferenceSchema.create("schema").setType(MetadataValueType.STRING);
    legalRequirementReference_schema.setDefaultRequirement(true);
    legalRequirementReference_schema.setSystemReserved(true);
    legalRequirementReference_schema.setUndeletable(true);
    legalRequirementReference_schema.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_secondaryConceptsIntIds = legalRequirementReferenceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    legalRequirementReference_secondaryConceptsIntIds.setMultivalue(true);
    legalRequirementReference_secondaryConceptsIntIds.setSystemReserved(true);
    legalRequirementReference_secondaryConceptsIntIds.setUndeletable(true);
    legalRequirementReference_secondaryConceptsIntIds.setMultiLingual(false);
    legalRequirementReference_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder legalRequirementReference_shareDenyTokens = legalRequirementReferenceSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    legalRequirementReference_shareDenyTokens.setMultivalue(true);
    legalRequirementReference_shareDenyTokens.setSystemReserved(true);
    legalRequirementReference_shareDenyTokens.setUndeletable(true);
    legalRequirementReference_shareDenyTokens.setMultiLingual(false);
    legalRequirementReference_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirementReference_shareTokens = legalRequirementReferenceSchema.create("shareTokens").setType(MetadataValueType.STRING);
    legalRequirementReference_shareTokens.setMultivalue(true);
    legalRequirementReference_shareTokens.setSystemReserved(true);
    legalRequirementReference_shareTokens.setUndeletable(true);
    legalRequirementReference_shareTokens.setMultiLingual(false);
    legalRequirementReference_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder legalRequirementReference_title = legalRequirementReferenceSchema.create("title").setType(MetadataValueType.STRING);
    legalRequirementReference_title.setUndeletable(true);
    legalRequirementReference_title.setMultiLingual(false);
    legalRequirementReference_title.setAvailableInSummary(true);
    legalRequirementReference_title.setSchemaAutocomplete(true);
    legalRequirementReference_title.setSearchable(true);
    MetadataBuilder legalRequirementReference_tokens = legalRequirementReferenceSchema.create("tokens").setType(MetadataValueType.STRING);
    legalRequirementReference_tokens.setMultivalue(true);
    legalRequirementReference_tokens.setSystemReserved(true);
    legalRequirementReference_tokens.setUndeletable(true);
    legalRequirementReference_tokens.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_tokensHierarchy = legalRequirementReferenceSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    legalRequirementReference_tokensHierarchy.setMultivalue(true);
    legalRequirementReference_tokensHierarchy.setSystemReserved(true);
    legalRequirementReference_tokensHierarchy.setUndeletable(true);
    legalRequirementReference_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder legalRequirementReference_visibleInTrees = legalRequirementReferenceSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    legalRequirementReference_visibleInTrees.setSystemReserved(true);
    legalRequirementReference_visibleInTrees.setUndeletable(true);
    legalRequirementReference_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createTriggerActionTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder triggerActionTypeSchemaType, MetadataSchemaBuilder triggerActionTypeSchema) {
    MetadataBuilder triggerActionType_allReferences = triggerActionTypeSchema.create("allReferences").setType(MetadataValueType.STRING);
    triggerActionType_allReferences.setMultivalue(true);
    triggerActionType_allReferences.setSystemReserved(true);
    triggerActionType_allReferences.setUndeletable(true);
    triggerActionType_allReferences.setMultiLingual(false);
    MetadataBuilder triggerActionType_allRemovedAuths = triggerActionTypeSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    triggerActionType_allRemovedAuths.setMultivalue(true);
    triggerActionType_allRemovedAuths.setSystemReserved(true);
    triggerActionType_allRemovedAuths.setUndeletable(true);
    triggerActionType_allRemovedAuths.setEssential(true);
    triggerActionType_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder triggerActionType_attachedAncestors = triggerActionTypeSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    triggerActionType_attachedAncestors.setMultivalue(true);
    triggerActionType_attachedAncestors.setSystemReserved(true);
    triggerActionType_attachedAncestors.setUndeletable(true);
    triggerActionType_attachedAncestors.setEssential(true);
    triggerActionType_attachedAncestors.setMultiLingual(false);
    MetadataBuilder triggerActionType_attachedPrincipalAncestorsIntIds = triggerActionTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerActionType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerActionType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerActionType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerActionType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerActionType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_autocomplete = triggerActionTypeSchema.create("autocomplete").setType(MetadataValueType.STRING);
    triggerActionType_autocomplete.setMultivalue(true);
    triggerActionType_autocomplete.setSystemReserved(true);
    triggerActionType_autocomplete.setUndeletable(true);
    triggerActionType_autocomplete.setEssential(true);
    triggerActionType_autocomplete.setMultiLingual(true);
    MetadataBuilder triggerActionType_caption = triggerActionTypeSchema.create("caption").setType(MetadataValueType.STRING);
    triggerActionType_caption.setSystemReserved(true);
    triggerActionType_caption.setUndeletable(true);
    triggerActionType_caption.setMultiLingual(false);
    triggerActionType_caption.setSortable(true);
    MetadataBuilder triggerActionType_code = triggerActionTypeSchema.create("code").setType(MetadataValueType.STRING);
    triggerActionType_code.setDefaultRequirement(true);
    triggerActionType_code.setSystemReserved(true);
    triggerActionType_code.setUndeletable(true);
    triggerActionType_code.setUniqueValue(true);
    MetadataBuilder triggerActionType_createdBy = triggerActionTypeSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    triggerActionType_createdBy.setSystemReserved(true);
    triggerActionType_createdBy.setUndeletable(true);
    triggerActionType_createdBy.setMultiLingual(false);
    triggerActionType_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerActionType_createdOn = triggerActionTypeSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    triggerActionType_createdOn.setSystemReserved(true);
    triggerActionType_createdOn.setUndeletable(true);
    triggerActionType_createdOn.setMultiLingual(false);
    triggerActionType_createdOn.setSortable(true);
    MetadataBuilder triggerActionType_deleted = triggerActionTypeSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    triggerActionType_deleted.setSystemReserved(true);
    triggerActionType_deleted.setUndeletable(true);
    triggerActionType_deleted.setMultiLingual(false);
    MetadataBuilder triggerActionType_denyTokens = triggerActionTypeSchema.create("denyTokens").setType(MetadataValueType.STRING);
    triggerActionType_denyTokens.setMultivalue(true);
    triggerActionType_denyTokens.setSystemReserved(true);
    triggerActionType_denyTokens.setUndeletable(true);
    triggerActionType_denyTokens.setMultiLingual(false);
    triggerActionType_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerActionType_detachedPrincipalAncestorsIntIds = triggerActionTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerActionType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerActionType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerActionType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerActionType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerActionType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_detachedauthorizations = triggerActionTypeSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    triggerActionType_detachedauthorizations.setSystemReserved(true);
    triggerActionType_detachedauthorizations.setUndeletable(true);
    triggerActionType_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerActionType_errorOnPhysicalDeletion = triggerActionTypeSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    triggerActionType_errorOnPhysicalDeletion.setSystemReserved(true);
    triggerActionType_errorOnPhysicalDeletion.setUndeletable(true);
    triggerActionType_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder triggerActionType_estimatedSize = triggerActionTypeSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    triggerActionType_estimatedSize.setSystemReserved(true);
    triggerActionType_estimatedSize.setUndeletable(true);
    triggerActionType_estimatedSize.setMultiLingual(false);
    MetadataBuilder triggerActionType_hidden = triggerActionTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    triggerActionType_hidden.setSystemReserved(true);
    triggerActionType_hidden.setUndeletable(true);
    triggerActionType_hidden.setMultiLingual(false);
    MetadataBuilder triggerActionType_id = triggerActionTypeSchema.create("id").setType(MetadataValueType.STRING);
    triggerActionType_id.setDefaultRequirement(true);
    triggerActionType_id.setSystemReserved(true);
    triggerActionType_id.setUndeletable(true);
    triggerActionType_id.setMultiLingual(false);
    triggerActionType_id.setSearchable(true);
    triggerActionType_id.setSortable(true);
    triggerActionType_id.setUniqueValue(true);
    triggerActionType_id.setUnmodifiable(true);
    MetadataBuilder triggerActionType_legacyIdentifier = triggerActionTypeSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    triggerActionType_legacyIdentifier.setDefaultRequirement(true);
    triggerActionType_legacyIdentifier.setSystemReserved(true);
    triggerActionType_legacyIdentifier.setUndeletable(true);
    triggerActionType_legacyIdentifier.setMultiLingual(false);
    triggerActionType_legacyIdentifier.setSearchable(true);
    triggerActionType_legacyIdentifier.setUniqueValue(true);
    triggerActionType_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder triggerActionType_linkedSchema = triggerActionTypeSchema.create("linkedSchema").setType(MetadataValueType.STRING);
    triggerActionType_linkedSchema.setDefaultRequirement(true);
    triggerActionType_linkedSchema.setUndeletable(true);
    MetadataBuilder triggerActionType_logicallyDeletedOn = triggerActionTypeSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    triggerActionType_logicallyDeletedOn.setSystemReserved(true);
    triggerActionType_logicallyDeletedOn.setUndeletable(true);
    triggerActionType_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder triggerActionType_manualTokens = triggerActionTypeSchema.create("manualTokens").setType(MetadataValueType.STRING);
    triggerActionType_manualTokens.setMultivalue(true);
    triggerActionType_manualTokens.setSystemReserved(true);
    triggerActionType_manualTokens.setUndeletable(true);
    triggerActionType_manualTokens.setMultiLingual(false);
    triggerActionType_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerActionType_markedForParsing = triggerActionTypeSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    triggerActionType_markedForParsing.setSystemReserved(true);
    triggerActionType_markedForParsing.setUndeletable(true);
    triggerActionType_markedForParsing.setMultiLingual(false);
    MetadataBuilder triggerActionType_markedForPreviewConversion = triggerActionTypeSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    triggerActionType_markedForPreviewConversion.setSystemReserved(true);
    triggerActionType_markedForPreviewConversion.setUndeletable(true);
    triggerActionType_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder triggerActionType_markedForReindexing = triggerActionTypeSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    triggerActionType_markedForReindexing.setSystemReserved(true);
    triggerActionType_markedForReindexing.setUndeletable(true);
    triggerActionType_markedForReindexing.setMultiLingual(false);
    MetadataBuilder triggerActionType_migrationDataVersion = triggerActionTypeSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    triggerActionType_migrationDataVersion.setSystemReserved(true);
    triggerActionType_migrationDataVersion.setUndeletable(true);
    triggerActionType_migrationDataVersion.setMultiLingual(false);
    triggerActionType_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_modifiedBy = triggerActionTypeSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    triggerActionType_modifiedBy.setSystemReserved(true);
    triggerActionType_modifiedBy.setUndeletable(true);
    triggerActionType_modifiedBy.setMultiLingual(false);
    triggerActionType_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerActionType_modifiedOn = triggerActionTypeSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    triggerActionType_modifiedOn.setSystemReserved(true);
    triggerActionType_modifiedOn.setUndeletable(true);
    triggerActionType_modifiedOn.setMultiLingual(false);
    triggerActionType_modifiedOn.setAvailableInSummary(true);
    triggerActionType_modifiedOn.setSortable(true);
    MetadataBuilder triggerActionType_nestedAuthorizations = triggerActionTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    triggerActionType_nestedAuthorizations.setSystemReserved(true);
    triggerActionType_nestedAuthorizations.setUndeletable(true);
    triggerActionType_nestedAuthorizations.setMultiLingual(false);
    triggerActionType_nestedAuthorizations.setEssentialInSummary(true);
    triggerActionType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder triggerActionType_path = triggerActionTypeSchema.create("path").setType(MetadataValueType.STRING);
    triggerActionType_path.setMultivalue(true);
    triggerActionType_path.setSystemReserved(true);
    triggerActionType_path.setUndeletable(true);
    triggerActionType_path.setMultiLingual(false);
    MetadataBuilder triggerActionType_pathParts = triggerActionTypeSchema.create("pathParts").setType(MetadataValueType.STRING);
    triggerActionType_pathParts.setMultivalue(true);
    triggerActionType_pathParts.setSystemReserved(true);
    triggerActionType_pathParts.setUndeletable(true);
    triggerActionType_pathParts.setMultiLingual(false);
    MetadataBuilder triggerActionType_principalAncestorsIntIds = triggerActionTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerActionType_principalAncestorsIntIds.setMultivalue(true);
    triggerActionType_principalAncestorsIntIds.setSystemReserved(true);
    triggerActionType_principalAncestorsIntIds.setUndeletable(true);
    triggerActionType_principalAncestorsIntIds.setMultiLingual(false);
    triggerActionType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_principalConceptsIntIds = triggerActionTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerActionType_principalConceptsIntIds.setMultivalue(true);
    triggerActionType_principalConceptsIntIds.setSystemReserved(true);
    triggerActionType_principalConceptsIntIds.setUndeletable(true);
    triggerActionType_principalConceptsIntIds.setMultiLingual(false);
    triggerActionType_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_principalpath = triggerActionTypeSchema.create("principalpath").setType(MetadataValueType.STRING);
    triggerActionType_principalpath.setSystemReserved(true);
    triggerActionType_principalpath.setUndeletable(true);
    triggerActionType_principalpath.setMultiLingual(false);
    MetadataBuilder triggerActionType_removedauthorizations = triggerActionTypeSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    triggerActionType_removedauthorizations.setMultivalue(true);
    triggerActionType_removedauthorizations.setSystemReserved(true);
    triggerActionType_removedauthorizations.setUndeletable(true);
    triggerActionType_removedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerActionType_schema = triggerActionTypeSchema.create("schema").setType(MetadataValueType.STRING);
    triggerActionType_schema.setDefaultRequirement(true);
    triggerActionType_schema.setSystemReserved(true);
    triggerActionType_schema.setUndeletable(true);
    triggerActionType_schema.setMultiLingual(false);
    MetadataBuilder triggerActionType_secondaryConceptsIntIds = triggerActionTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerActionType_secondaryConceptsIntIds.setMultivalue(true);
    triggerActionType_secondaryConceptsIntIds.setSystemReserved(true);
    triggerActionType_secondaryConceptsIntIds.setUndeletable(true);
    triggerActionType_secondaryConceptsIntIds.setMultiLingual(false);
    triggerActionType_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerActionType_shareDenyTokens = triggerActionTypeSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    triggerActionType_shareDenyTokens.setMultivalue(true);
    triggerActionType_shareDenyTokens.setSystemReserved(true);
    triggerActionType_shareDenyTokens.setUndeletable(true);
    triggerActionType_shareDenyTokens.setMultiLingual(false);
    triggerActionType_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerActionType_shareTokens = triggerActionTypeSchema.create("shareTokens").setType(MetadataValueType.STRING);
    triggerActionType_shareTokens.setMultivalue(true);
    triggerActionType_shareTokens.setSystemReserved(true);
    triggerActionType_shareTokens.setUndeletable(true);
    triggerActionType_shareTokens.setMultiLingual(false);
    triggerActionType_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerActionType_title = triggerActionTypeSchema.create("title").setType(MetadataValueType.STRING);
    triggerActionType_title.setUndeletable(true);
    triggerActionType_title.setMultiLingual(false);
    triggerActionType_title.setAvailableInSummary(true);
    triggerActionType_title.setSchemaAutocomplete(true);
    triggerActionType_title.setSearchable(true);
    MetadataBuilder triggerActionType_tokens = triggerActionTypeSchema.create("tokens").setType(MetadataValueType.STRING);
    triggerActionType_tokens.setMultivalue(true);
    triggerActionType_tokens.setSystemReserved(true);
    triggerActionType_tokens.setUndeletable(true);
    triggerActionType_tokens.setMultiLingual(false);
    MetadataBuilder triggerActionType_tokensHierarchy = triggerActionTypeSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    triggerActionType_tokensHierarchy.setMultivalue(true);
    triggerActionType_tokensHierarchy.setSystemReserved(true);
    triggerActionType_tokensHierarchy.setUndeletable(true);
    triggerActionType_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder triggerActionType_visibleInTrees = triggerActionTypeSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    triggerActionType_visibleInTrees.setSystemReserved(true);
    triggerActionType_visibleInTrees.setUndeletable(true);
    triggerActionType_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createTriggerSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder triggerSchemaType, MetadataSchemaBuilder triggerSchema) {
    MetadataBuilder trigger_actions = triggerSchema.create("actions").setType(MetadataValueType.REFERENCE);
    trigger_actions.setMultivalue(true);
    trigger_actions.setDefaultRequirement(true);
    trigger_actions.setUndeletable(true);
    trigger_actions.defineReferencesTo(types.getSchemaType("triggerAction"));
    MetadataBuilder trigger_allReferences = triggerSchema.create("allReferences").setType(MetadataValueType.STRING);
    trigger_allReferences.setMultivalue(true);
    trigger_allReferences.setSystemReserved(true);
    trigger_allReferences.setUndeletable(true);
    trigger_allReferences.setMultiLingual(false);
    MetadataBuilder trigger_allRemovedAuths = triggerSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    trigger_allRemovedAuths.setMultivalue(true);
    trigger_allRemovedAuths.setSystemReserved(true);
    trigger_allRemovedAuths.setUndeletable(true);
    trigger_allRemovedAuths.setEssential(true);
    trigger_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder trigger_attachedAncestors = triggerSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    trigger_attachedAncestors.setMultivalue(true);
    trigger_attachedAncestors.setSystemReserved(true);
    trigger_attachedAncestors.setUndeletable(true);
    trigger_attachedAncestors.setEssential(true);
    trigger_attachedAncestors.setMultiLingual(false);
    MetadataBuilder trigger_attachedPrincipalAncestorsIntIds = triggerSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    trigger_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    trigger_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    trigger_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    trigger_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    trigger_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder trigger_autocomplete = triggerSchema.create("autocomplete").setType(MetadataValueType.STRING);
    trigger_autocomplete.setMultivalue(true);
    trigger_autocomplete.setSystemReserved(true);
    trigger_autocomplete.setUndeletable(true);
    trigger_autocomplete.setEssential(true);
    trigger_autocomplete.setMultiLingual(true);
    MetadataBuilder trigger_caption = triggerSchema.create("caption").setType(MetadataValueType.STRING);
    trigger_caption.setSystemReserved(true);
    trigger_caption.setUndeletable(true);
    trigger_caption.setMultiLingual(false);
    trigger_caption.setSortable(true);
    MetadataBuilder trigger_createdBy = triggerSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    trigger_createdBy.setSystemReserved(true);
    trigger_createdBy.setUndeletable(true);
    trigger_createdBy.setMultiLingual(false);
    trigger_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder trigger_createdOn = triggerSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    trigger_createdOn.setSystemReserved(true);
    trigger_createdOn.setUndeletable(true);
    trigger_createdOn.setMultiLingual(false);
    trigger_createdOn.setSortable(true);
    MetadataBuilder trigger_criteria = triggerSchema.create("criteria").setType(MetadataValueType.STRUCTURE);
    trigger_criteria.setMultivalue(true);
    trigger_criteria.setDefaultRequirement(true);
    trigger_criteria.setUndeletable(true);
    trigger_criteria.defineStructureFactory(CriterionFactory.class);
    MetadataBuilder trigger_deleted = triggerSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    trigger_deleted.setSystemReserved(true);
    trigger_deleted.setUndeletable(true);
    trigger_deleted.setMultiLingual(false);
    MetadataBuilder trigger_denyTokens = triggerSchema.create("denyTokens").setType(MetadataValueType.STRING);
    trigger_denyTokens.setMultivalue(true);
    trigger_denyTokens.setSystemReserved(true);
    trigger_denyTokens.setUndeletable(true);
    trigger_denyTokens.setMultiLingual(false);
    trigger_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder trigger_description = triggerSchema.create("description").setType(MetadataValueType.TEXT);
    trigger_description.setUndeletable(true);
    trigger_description.setAvailableInSummary(true);
    MetadataBuilder trigger_detachedPrincipalAncestorsIntIds = triggerSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    trigger_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    trigger_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    trigger_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    trigger_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    trigger_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder trigger_detachedauthorizations = triggerSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    trigger_detachedauthorizations.setSystemReserved(true);
    trigger_detachedauthorizations.setUndeletable(true);
    trigger_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder trigger_errorOnPhysicalDeletion = triggerSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    trigger_errorOnPhysicalDeletion.setSystemReserved(true);
    trigger_errorOnPhysicalDeletion.setUndeletable(true);
    trigger_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder trigger_estimatedSize = triggerSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    trigger_estimatedSize.setSystemReserved(true);
    trigger_estimatedSize.setUndeletable(true);
    trigger_estimatedSize.setMultiLingual(false);
    MetadataBuilder trigger_hidden = triggerSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    trigger_hidden.setSystemReserved(true);
    trigger_hidden.setUndeletable(true);
    trigger_hidden.setMultiLingual(false);
    MetadataBuilder trigger_id = triggerSchema.create("id").setType(MetadataValueType.STRING);
    trigger_id.setDefaultRequirement(true);
    trigger_id.setSystemReserved(true);
    trigger_id.setUndeletable(true);
    trigger_id.setMultiLingual(false);
    trigger_id.setSearchable(true);
    trigger_id.setSortable(true);
    trigger_id.setUniqueValue(true);
    trigger_id.setUnmodifiable(true);
    MetadataBuilder trigger_legacyIdentifier = triggerSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    trigger_legacyIdentifier.setDefaultRequirement(true);
    trigger_legacyIdentifier.setSystemReserved(true);
    trigger_legacyIdentifier.setUndeletable(true);
    trigger_legacyIdentifier.setMultiLingual(false);
    trigger_legacyIdentifier.setSearchable(true);
    trigger_legacyIdentifier.setUniqueValue(true);
    trigger_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder trigger_logicallyDeletedOn = triggerSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    trigger_logicallyDeletedOn.setSystemReserved(true);
    trigger_logicallyDeletedOn.setUndeletable(true);
    trigger_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder trigger_manualTokens = triggerSchema.create("manualTokens").setType(MetadataValueType.STRING);
    trigger_manualTokens.setMultivalue(true);
    trigger_manualTokens.setSystemReserved(true);
    trigger_manualTokens.setUndeletable(true);
    trigger_manualTokens.setMultiLingual(false);
    trigger_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder trigger_markedForParsing = triggerSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    trigger_markedForParsing.setSystemReserved(true);
    trigger_markedForParsing.setUndeletable(true);
    trigger_markedForParsing.setMultiLingual(false);
    MetadataBuilder trigger_markedForPreviewConversion = triggerSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    trigger_markedForPreviewConversion.setSystemReserved(true);
    trigger_markedForPreviewConversion.setUndeletable(true);
    trigger_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder trigger_markedForReindexing = triggerSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    trigger_markedForReindexing.setSystemReserved(true);
    trigger_markedForReindexing.setUndeletable(true);
    trigger_markedForReindexing.setMultiLingual(false);
    MetadataBuilder trigger_migrationDataVersion = triggerSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    trigger_migrationDataVersion.setSystemReserved(true);
    trigger_migrationDataVersion.setUndeletable(true);
    trigger_migrationDataVersion.setMultiLingual(false);
    trigger_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder trigger_modifiedBy = triggerSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    trigger_modifiedBy.setSystemReserved(true);
    trigger_modifiedBy.setUndeletable(true);
    trigger_modifiedBy.setMultiLingual(false);
    trigger_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder trigger_modifiedOn = triggerSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    trigger_modifiedOn.setSystemReserved(true);
    trigger_modifiedOn.setUndeletable(true);
    trigger_modifiedOn.setMultiLingual(false);
    trigger_modifiedOn.setAvailableInSummary(true);
    trigger_modifiedOn.setSortable(true);
    MetadataBuilder trigger_nestedAuthorizations = triggerSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    trigger_nestedAuthorizations.setSystemReserved(true);
    trigger_nestedAuthorizations.setUndeletable(true);
    trigger_nestedAuthorizations.setMultiLingual(false);
    trigger_nestedAuthorizations.setEssentialInSummary(true);
    trigger_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder trigger_path = triggerSchema.create("path").setType(MetadataValueType.STRING);
    trigger_path.setMultivalue(true);
    trigger_path.setSystemReserved(true);
    trigger_path.setUndeletable(true);
    trigger_path.setMultiLingual(false);
    MetadataBuilder trigger_pathParts = triggerSchema.create("pathParts").setType(MetadataValueType.STRING);
    trigger_pathParts.setMultivalue(true);
    trigger_pathParts.setSystemReserved(true);
    trigger_pathParts.setUndeletable(true);
    trigger_pathParts.setMultiLingual(false);
    MetadataBuilder trigger_principalAncestorsIntIds = triggerSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    trigger_principalAncestorsIntIds.setMultivalue(true);
    trigger_principalAncestorsIntIds.setSystemReserved(true);
    trigger_principalAncestorsIntIds.setUndeletable(true);
    trigger_principalAncestorsIntIds.setMultiLingual(false);
    trigger_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder trigger_principalConceptsIntIds = triggerSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    trigger_principalConceptsIntIds.setMultivalue(true);
    trigger_principalConceptsIntIds.setSystemReserved(true);
    trigger_principalConceptsIntIds.setUndeletable(true);
    trigger_principalConceptsIntIds.setMultiLingual(false);
    trigger_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder trigger_principalpath = triggerSchema.create("principalpath").setType(MetadataValueType.STRING);
    trigger_principalpath.setSystemReserved(true);
    trigger_principalpath.setUndeletable(true);
    trigger_principalpath.setMultiLingual(false);
    MetadataBuilder trigger_removedauthorizations = triggerSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    trigger_removedauthorizations.setMultivalue(true);
    trigger_removedauthorizations.setSystemReserved(true);
    trigger_removedauthorizations.setUndeletable(true);
    trigger_removedauthorizations.setMultiLingual(false);
    MetadataBuilder trigger_schema = triggerSchema.create("schema").setType(MetadataValueType.STRING);
    trigger_schema.setDefaultRequirement(true);
    trigger_schema.setSystemReserved(true);
    trigger_schema.setUndeletable(true);
    trigger_schema.setMultiLingual(false);
    MetadataBuilder trigger_secondaryConceptsIntIds = triggerSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    trigger_secondaryConceptsIntIds.setMultivalue(true);
    trigger_secondaryConceptsIntIds.setSystemReserved(true);
    trigger_secondaryConceptsIntIds.setUndeletable(true);
    trigger_secondaryConceptsIntIds.setMultiLingual(false);
    trigger_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder trigger_shareDenyTokens = triggerSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    trigger_shareDenyTokens.setMultivalue(true);
    trigger_shareDenyTokens.setSystemReserved(true);
    trigger_shareDenyTokens.setUndeletable(true);
    trigger_shareDenyTokens.setMultiLingual(false);
    trigger_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder trigger_shareTokens = triggerSchema.create("shareTokens").setType(MetadataValueType.STRING);
    trigger_shareTokens.setMultivalue(true);
    trigger_shareTokens.setSystemReserved(true);
    trigger_shareTokens.setUndeletable(true);
    trigger_shareTokens.setMultiLingual(false);
    trigger_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder trigger_target = triggerSchema.create("target").setType(MetadataValueType.REFERENCE);
    trigger_target.setMultivalue(true);
    trigger_target.setSystemReserved(true);
    trigger_target.setUndeletable(true);
    trigger_target.defineReferencesTo(types.getSchemaType("folder"));
    MetadataBuilder trigger_title = triggerSchema.create("title").setType(MetadataValueType.STRING);
    trigger_title.setDefaultRequirement(true);
    trigger_title.setUndeletable(true);
    trigger_title.setMultiLingual(false);
    trigger_title.setAvailableInSummary(true);
    trigger_title.setSchemaAutocomplete(true);
    trigger_title.setSearchable(true);
    MetadataBuilder trigger_tokens = triggerSchema.create("tokens").setType(MetadataValueType.STRING);
    trigger_tokens.setMultivalue(true);
    trigger_tokens.setSystemReserved(true);
    trigger_tokens.setUndeletable(true);
    trigger_tokens.setMultiLingual(false);
    MetadataBuilder trigger_tokensHierarchy = triggerSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    trigger_tokensHierarchy.setMultivalue(true);
    trigger_tokensHierarchy.setSystemReserved(true);
    trigger_tokensHierarchy.setUndeletable(true);
    trigger_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder trigger_type = triggerSchema.create("type").setType(MetadataValueType.REFERENCE);
    trigger_type.setDefaultRequirement(true);
    trigger_type.setUndeletable(true);
    trigger_type.defineReferencesTo(asList(types.getSchema("triggerType_default")));
    MetadataBuilder trigger_visibleInTrees = triggerSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    trigger_visibleInTrees.setSystemReserved(true);
    trigger_visibleInTrees.setUndeletable(true);
    trigger_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createMessageSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder messageSchemaType, MetadataSchemaBuilder messageSchema) {
    MetadataBuilder message_haslinkedDocuments = messageSchema.create("haslinkedDocuments").setType(MetadataValueType.BOOLEAN);
    message_haslinkedDocuments.setUndeletable(true);
    MetadataBuilder message_linkedDocuments = messageSchema.create("linkedDocuments").setType(MetadataValueType.REFERENCE);
    message_linkedDocuments.setMultivalue(true);
    message_linkedDocuments.setUndeletable(true);
    message_linkedDocuments.defineReferencesTo(asList(types.getSchema("document_default")));
    MetadataBuilder message_linkedDocumentsTitles = messageSchema.create("linkedDocumentsTitles").setType(MetadataValueType.STRING);
    message_linkedDocumentsTitles.setMultivalue(true);
    message_linkedDocumentsTitles.setUndeletable(true);
    message_linkedDocumentsTitles.setSearchable(true);
  }
  ...
  private void createPrintableSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder printableSchemaType, MetadataSchemaBuilder printable_labelSchema, MetadataSchemaBuilder printable_reportSchema, MetadataSchemaBuilder printableSchema) {
    ...
    printable_label_colonne.setDefaultRequirement(true);
    ...
    printable_label_ligne.setDefaultRequirement(true);
    ...
    MetadataBuilder printable_report_jasperSubreportFiles = printable_reportSchema.create("jasperSubreportFiles").setType(MetadataValueType.CONTENT);
    printable_report_jasperSubreportFiles.setMultivalue(true);
    printable_report_jasperSubreportFiles.setUndeletable(true);
    printable_report_jasperSubreportFiles.setEssential(true);
    printable_report_jasperSubreportFiles.defineStructureFactory(ContentFactory.class);
    printable_report_jasperSubreportFiles.defineValidators().add(JasperFilesPrintableValidator.class);
    ...
    printable_report_recordSchema.setAvailableInSummary(true);
    ...
    MetadataBuilder printable_report_supportedExtensions = printable_reportSchema.create("supportedExtensions").setType(MetadataValueType.ENUM);
    printable_report_supportedExtensions.setMultivalue(true);
    printable_report_supportedExtensions.setDefaultRequirement(true);
    printable_report_supportedExtensions.setUndeletable(true);
    printable_report_supportedExtensions.setEssential(true);
    printable_report_supportedExtensions.defineAsEnum(PrintableExtension.class);
    MetadataBuilder printable_templateVersion = printableSchema.create("templateVersion").setType(MetadataValueType.ENUM);
    printable_templateVersion.setDefaultRequirement(true);
    printable_templateVersion.setUndeletable(true);
    printable_templateVersion.defineAsEnum(TemplateVersionType.class);
    ...
    MetadataBuilder printable_label_templateVersion = printable_labelSchema.get("templateVersion");
    ...
    MetadataBuilder printable_report_templateVersion = printable_reportSchema.get("templateVersion");
  ...
  private void createUserTaskSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userTaskSchemaType, MetadataSchemaBuilder userTask_borrowExtensionRequestSchema, MetadataSchemaBuilder userTask_borrowRequestSchema, MetadataSchemaBuilder userTask_reactivationRequestSchema, MetadataSchemaBuilder userTask_returnRequestSchema, MetadataSchemaBuilder userTaskSchema) {
    ...
    userTask_administrativeUnit.setCacheIndex(true);
    userTask_administrativeUnit.defineTaxonomyRelationshipToType(types.getSchemaType("administrativeUnit"));
    MetadataBuilder userTask_createdAuthorizations = userTaskSchema.create("createdAuthorizations").setType(MetadataValueType.STRING);
    userTask_createdAuthorizations.setMultivalue(true);
    userTask_createdAuthorizations.setSystemReserved(true);
    userTask_createdAuthorizations.setUndeletable(true);
    ...
    userTask_linkedDocuments.setCacheIndex(true);
    userTask_linkedDocuments.setEssentialInSummary(true);
    ...
    userTask_linkedFolders.setCacheIndex(true);
  ...
  private void createTriggerTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder triggerTypeSchemaType, MetadataSchemaBuilder triggerTypeSchema) {
    MetadataBuilder triggerType_allReferences = triggerTypeSchema.create("allReferences").setType(MetadataValueType.STRING);
    triggerType_allReferences.setMultivalue(true);
    triggerType_allReferences.setSystemReserved(true);
    triggerType_allReferences.setUndeletable(true);
    triggerType_allReferences.setMultiLingual(false);
    MetadataBuilder triggerType_allRemovedAuths = triggerTypeSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    triggerType_allRemovedAuths.setMultivalue(true);
    triggerType_allRemovedAuths.setSystemReserved(true);
    triggerType_allRemovedAuths.setUndeletable(true);
    triggerType_allRemovedAuths.setEssential(true);
    triggerType_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder triggerType_attachedAncestors = triggerTypeSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    triggerType_attachedAncestors.setMultivalue(true);
    triggerType_attachedAncestors.setSystemReserved(true);
    triggerType_attachedAncestors.setUndeletable(true);
    triggerType_attachedAncestors.setEssential(true);
    triggerType_attachedAncestors.setMultiLingual(false);
    MetadataBuilder triggerType_attachedPrincipalAncestorsIntIds = triggerTypeSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerType_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerType_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerType_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerType_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerType_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerType_autocomplete = triggerTypeSchema.create("autocomplete").setType(MetadataValueType.STRING);
    triggerType_autocomplete.setMultivalue(true);
    triggerType_autocomplete.setSystemReserved(true);
    triggerType_autocomplete.setUndeletable(true);
    triggerType_autocomplete.setEssential(true);
    triggerType_autocomplete.setMultiLingual(true);
    MetadataBuilder triggerType_caption = triggerTypeSchema.create("caption").setType(MetadataValueType.STRING);
    triggerType_caption.setSystemReserved(true);
    triggerType_caption.setUndeletable(true);
    triggerType_caption.setMultiLingual(false);
    triggerType_caption.setSortable(true);
    MetadataBuilder triggerType_code = triggerTypeSchema.create("code").setType(MetadataValueType.STRING);
    triggerType_code.setDefaultRequirement(true);
    triggerType_code.setSystemReserved(true);
    triggerType_code.setUndeletable(true);
    triggerType_code.setUniqueValue(true);
    MetadataBuilder triggerType_createdBy = triggerTypeSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    triggerType_createdBy.setSystemReserved(true);
    triggerType_createdBy.setUndeletable(true);
    triggerType_createdBy.setMultiLingual(false);
    triggerType_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerType_createdOn = triggerTypeSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    triggerType_createdOn.setSystemReserved(true);
    triggerType_createdOn.setUndeletable(true);
    triggerType_createdOn.setMultiLingual(false);
    triggerType_createdOn.setSortable(true);
    MetadataBuilder triggerType_deleted = triggerTypeSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    triggerType_deleted.setSystemReserved(true);
    triggerType_deleted.setUndeletable(true);
    triggerType_deleted.setMultiLingual(false);
    MetadataBuilder triggerType_denyTokens = triggerTypeSchema.create("denyTokens").setType(MetadataValueType.STRING);
    triggerType_denyTokens.setMultivalue(true);
    triggerType_denyTokens.setSystemReserved(true);
    triggerType_denyTokens.setUndeletable(true);
    triggerType_denyTokens.setMultiLingual(false);
    triggerType_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerType_detachedPrincipalAncestorsIntIds = triggerTypeSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerType_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    triggerType_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    triggerType_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    triggerType_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    triggerType_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerType_detachedauthorizations = triggerTypeSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    triggerType_detachedauthorizations.setSystemReserved(true);
    triggerType_detachedauthorizations.setUndeletable(true);
    triggerType_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerType_errorOnPhysicalDeletion = triggerTypeSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    triggerType_errorOnPhysicalDeletion.setSystemReserved(true);
    triggerType_errorOnPhysicalDeletion.setUndeletable(true);
    triggerType_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder triggerType_estimatedSize = triggerTypeSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    triggerType_estimatedSize.setSystemReserved(true);
    triggerType_estimatedSize.setUndeletable(true);
    triggerType_estimatedSize.setMultiLingual(false);
    MetadataBuilder triggerType_hidden = triggerTypeSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    triggerType_hidden.setSystemReserved(true);
    triggerType_hidden.setUndeletable(true);
    triggerType_hidden.setMultiLingual(false);
    MetadataBuilder triggerType_id = triggerTypeSchema.create("id").setType(MetadataValueType.STRING);
    triggerType_id.setDefaultRequirement(true);
    triggerType_id.setSystemReserved(true);
    triggerType_id.setUndeletable(true);
    triggerType_id.setMultiLingual(false);
    triggerType_id.setSearchable(true);
    triggerType_id.setSortable(true);
    triggerType_id.setUniqueValue(true);
    triggerType_id.setUnmodifiable(true);
    MetadataBuilder triggerType_legacyIdentifier = triggerTypeSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    triggerType_legacyIdentifier.setDefaultRequirement(true);
    triggerType_legacyIdentifier.setSystemReserved(true);
    triggerType_legacyIdentifier.setUndeletable(true);
    triggerType_legacyIdentifier.setMultiLingual(false);
    triggerType_legacyIdentifier.setSearchable(true);
    triggerType_legacyIdentifier.setUniqueValue(true);
    triggerType_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder triggerType_logicallyDeletedOn = triggerTypeSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    triggerType_logicallyDeletedOn.setSystemReserved(true);
    triggerType_logicallyDeletedOn.setUndeletable(true);
    triggerType_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder triggerType_manualTokens = triggerTypeSchema.create("manualTokens").setType(MetadataValueType.STRING);
    triggerType_manualTokens.setMultivalue(true);
    triggerType_manualTokens.setSystemReserved(true);
    triggerType_manualTokens.setUndeletable(true);
    triggerType_manualTokens.setMultiLingual(false);
    triggerType_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerType_markedForParsing = triggerTypeSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    triggerType_markedForParsing.setSystemReserved(true);
    triggerType_markedForParsing.setUndeletable(true);
    triggerType_markedForParsing.setMultiLingual(false);
    MetadataBuilder triggerType_markedForPreviewConversion = triggerTypeSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    triggerType_markedForPreviewConversion.setSystemReserved(true);
    triggerType_markedForPreviewConversion.setUndeletable(true);
    triggerType_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder triggerType_markedForReindexing = triggerTypeSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    triggerType_markedForReindexing.setSystemReserved(true);
    triggerType_markedForReindexing.setUndeletable(true);
    triggerType_markedForReindexing.setMultiLingual(false);
    MetadataBuilder triggerType_migrationDataVersion = triggerTypeSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    triggerType_migrationDataVersion.setSystemReserved(true);
    triggerType_migrationDataVersion.setUndeletable(true);
    triggerType_migrationDataVersion.setMultiLingual(false);
    triggerType_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder triggerType_modifiedBy = triggerTypeSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    triggerType_modifiedBy.setSystemReserved(true);
    triggerType_modifiedBy.setUndeletable(true);
    triggerType_modifiedBy.setMultiLingual(false);
    triggerType_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder triggerType_modifiedOn = triggerTypeSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    triggerType_modifiedOn.setSystemReserved(true);
    triggerType_modifiedOn.setUndeletable(true);
    triggerType_modifiedOn.setMultiLingual(false);
    triggerType_modifiedOn.setAvailableInSummary(true);
    triggerType_modifiedOn.setSortable(true);
    MetadataBuilder triggerType_nestedAuthorizations = triggerTypeSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    triggerType_nestedAuthorizations.setSystemReserved(true);
    triggerType_nestedAuthorizations.setUndeletable(true);
    triggerType_nestedAuthorizations.setMultiLingual(false);
    triggerType_nestedAuthorizations.setEssentialInSummary(true);
    triggerType_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder triggerType_path = triggerTypeSchema.create("path").setType(MetadataValueType.STRING);
    triggerType_path.setMultivalue(true);
    triggerType_path.setSystemReserved(true);
    triggerType_path.setUndeletable(true);
    triggerType_path.setMultiLingual(false);
    MetadataBuilder triggerType_pathParts = triggerTypeSchema.create("pathParts").setType(MetadataValueType.STRING);
    triggerType_pathParts.setMultivalue(true);
    triggerType_pathParts.setSystemReserved(true);
    triggerType_pathParts.setUndeletable(true);
    triggerType_pathParts.setMultiLingual(false);
    MetadataBuilder triggerType_principalAncestorsIntIds = triggerTypeSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    triggerType_principalAncestorsIntIds.setMultivalue(true);
    triggerType_principalAncestorsIntIds.setSystemReserved(true);
    triggerType_principalAncestorsIntIds.setUndeletable(true);
    triggerType_principalAncestorsIntIds.setMultiLingual(false);
    triggerType_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerType_principalConceptsIntIds = triggerTypeSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerType_principalConceptsIntIds.setMultivalue(true);
    triggerType_principalConceptsIntIds.setSystemReserved(true);
    triggerType_principalConceptsIntIds.setUndeletable(true);
    triggerType_principalConceptsIntIds.setMultiLingual(false);
    triggerType_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerType_principalpath = triggerTypeSchema.create("principalpath").setType(MetadataValueType.STRING);
    triggerType_principalpath.setSystemReserved(true);
    triggerType_principalpath.setUndeletable(true);
    triggerType_principalpath.setMultiLingual(false);
    MetadataBuilder triggerType_removedauthorizations = triggerTypeSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    triggerType_removedauthorizations.setMultivalue(true);
    triggerType_removedauthorizations.setSystemReserved(true);
    triggerType_removedauthorizations.setUndeletable(true);
    triggerType_removedauthorizations.setMultiLingual(false);
    MetadataBuilder triggerType_schema = triggerTypeSchema.create("schema").setType(MetadataValueType.STRING);
    triggerType_schema.setDefaultRequirement(true);
    triggerType_schema.setSystemReserved(true);
    triggerType_schema.setUndeletable(true);
    triggerType_schema.setMultiLingual(false);
    MetadataBuilder triggerType_secondaryConceptsIntIds = triggerTypeSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    triggerType_secondaryConceptsIntIds.setMultivalue(true);
    triggerType_secondaryConceptsIntIds.setSystemReserved(true);
    triggerType_secondaryConceptsIntIds.setUndeletable(true);
    triggerType_secondaryConceptsIntIds.setMultiLingual(false);
    triggerType_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder triggerType_shareDenyTokens = triggerTypeSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    triggerType_shareDenyTokens.setMultivalue(true);
    triggerType_shareDenyTokens.setSystemReserved(true);
    triggerType_shareDenyTokens.setUndeletable(true);
    triggerType_shareDenyTokens.setMultiLingual(false);
    triggerType_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerType_shareTokens = triggerTypeSchema.create("shareTokens").setType(MetadataValueType.STRING);
    triggerType_shareTokens.setMultivalue(true);
    triggerType_shareTokens.setSystemReserved(true);
    triggerType_shareTokens.setUndeletable(true);
    triggerType_shareTokens.setMultiLingual(false);
    triggerType_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder triggerType_title = triggerTypeSchema.create("title").setType(MetadataValueType.STRING);
    triggerType_title.setUndeletable(true);
    triggerType_title.setMultiLingual(false);
    triggerType_title.setAvailableInSummary(true);
    triggerType_title.setSchemaAutocomplete(true);
    triggerType_title.setSearchable(true);
    MetadataBuilder triggerType_tokens = triggerTypeSchema.create("tokens").setType(MetadataValueType.STRING);
    triggerType_tokens.setMultivalue(true);
    triggerType_tokens.setSystemReserved(true);
    triggerType_tokens.setUndeletable(true);
    triggerType_tokens.setMultiLingual(false);
    MetadataBuilder triggerType_tokensHierarchy = triggerTypeSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    triggerType_tokensHierarchy.setMultivalue(true);
    triggerType_tokensHierarchy.setSystemReserved(true);
    triggerType_tokensHierarchy.setUndeletable(true);
    triggerType_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder triggerType_visibleInTrees = triggerTypeSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    triggerType_visibleInTrees.setSystemReserved(true);
    triggerType_visibleInTrees.setUndeletable(true);
    triggerType_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createCategorySchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder categorySchemaType, MetadataSchemaBuilder categorySchema) {
    MetadataBuilder category_abbreviation = categorySchema.create("abbreviation").setType(MetadataValueType.STRING);
    category_abbreviation.setUndeletable(true);
    category_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder category_attachedPrincipalAncestorsIntIds = categorySchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    category_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    category_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    category_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    category_attachedPrincipalAncestorsIntIds.setEssential(true);
    category_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    category_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    category_code.defineValidators().add(IllegalCharactersValidator.class);
    ...
    MetadataBuilder category_detachedPrincipalAncestorsIntIds = categorySchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    category_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    category_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    category_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    category_detachedPrincipalAncestorsIntIds.setEssential(true);
    category_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    category_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder category_hidden = categorySchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    category_hidden.setSystemReserved(true);
    category_hidden.setUndeletable(true);
    category_hidden.setEssential(true);
    category_hidden.setMultiLingual(false);
    ...
    MetadataBuilder category_legalRequirements = categorySchema.create("legalRequirements").setType(MetadataValueType.REFERENCE);
    category_legalRequirements.setMultivalue(true);
    category_legalRequirements.setUndeletable(true);
    category_legalRequirements.defineReferencesTo(asList(types.getSchema("legalRequirement_default")));
    ...
    category_modifiedOn.setAvailableInSummary(true);
    category_modifiedOn.setSortable(true);
    MetadataBuilder category_nestedAuthorizations = categorySchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    category_nestedAuthorizations.setSystemReserved(true);
    category_nestedAuthorizations.setUndeletable(true);
    category_nestedAuthorizations.setEssential(true);
    category_nestedAuthorizations.setMultiLingual(false);
    category_nestedAuthorizations.setEssentialInSummary(true);
    category_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder category_parent = categorySchema.create("parent").setType(MetadataValueType.REFERENCE);
    category_parent.setCacheIndex(true);
    ...
    MetadataBuilder category_principalAncestorsIntIds = categorySchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    category_principalAncestorsIntIds.setMultivalue(true);
    category_principalAncestorsIntIds.setSystemReserved(true);
    category_principalAncestorsIntIds.setUndeletable(true);
    category_principalAncestorsIntIds.setEssential(true);
    category_principalAncestorsIntIds.setMultiLingual(false);
    category_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder category_principalConceptsIntIds = categorySchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    category_principalConceptsIntIds.setMultivalue(true);
    category_principalConceptsIntIds.setSystemReserved(true);
    category_principalConceptsIntIds.setUndeletable(true);
    category_principalConceptsIntIds.setEssential(true);
    category_principalConceptsIntIds.setMultiLingual(false);
    category_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder category_secondaryConceptsIntIds = categorySchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    category_secondaryConceptsIntIds.setMultivalue(true);
    category_secondaryConceptsIntIds.setSystemReserved(true);
    category_secondaryConceptsIntIds.setUndeletable(true);
    category_secondaryConceptsIntIds.setEssential(true);
    category_secondaryConceptsIntIds.setMultiLingual(false);
    category_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    category_title.setAvailableInSummary(true);
    category_title.setSchemaAutocomplete(true);
    category_title.setSearchable(true);
    category_title.defineValidators().add(IllegalCharactersValidator.class);
  ...
  private void createUserSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userSchemaType, MetadataSchemaBuilder userSchema) {
    ...
    MetadataBuilder user_favoritesDisplayOrder = userSchema.create("favoritesDisplayOrder").setType(MetadataValueType.STRING);
    user_favoritesDisplayOrder.setMultivalue(true);
    user_favoritesDisplayOrder.setSystemReserved(true);
    user_favoritesDisplayOrder.setUndeletable(true);
  ...
  public void applySchemasDisplay(SchemasDisplayManager manager) {
    ...
    transaction.add(manager.getSchema(collection, "administrativeUnit_default").withFormMetadataCodes(asList("administrativeUnit_default_code", "administrativeUnit_default_title", "administrativeUnit_default_parent", "administrativeUnit_default_decommissioningMonth", "administrativeUnit_default_adress", "administrativeUnit_default_description", "administrativeUnit_default_abbreviation")).withDisplayMetadataCodes(asList("administrativeUnit_default_code", "administrativeUnit_default_title", "administrativeUnit_default_parent", "administrativeUnit_default_createdOn", "administrativeUnit_default_modifiedBy", "administrativeUnit_default_createdBy", "administrativeUnit_default_decommissioningMonth", "administrativeUnit_default_functions", "administrativeUnit_default_abbreviation")).withSearchResultsMetadataCodes(asList("administrativeUnit_default_title", "administrativeUnit_default_modifiedOn")).withTableMetadataCodes(asList("administrativeUnit_default_title", "administrativeUnit_default_modifiedOn")));
    ...
    transaction.add(manager.getSchema(collection, "category_default").withFormMetadataCodes(asList("category_default_code", "category_default_title", "category_default_description", "category_default_keywords", "category_default_parent", "category_default_retentionRules", "category_default_deactivate", "category_default_abbreviation")).withDisplayMetadataCodes(asList("category_default_code", "category_default_title", "category_default_description", "category_default_createdOn", "category_default_modifiedBy", "category_default_createdBy", "category_default_keywords", "category_default_parent", "category_default_retentionRules", "category_default_comments", "category_default_deactivate", "category_default_abbreviation")).withSearchResultsMetadataCodes(asList("category_default_title", "category_default_modifiedOn")).withTableMetadataCodes(asList("category_default_title", "category_default_modifiedOn")));
    ...
    transaction.add(manager.getSchema(collection, "ddvContainerRecordType_default").withFormMetadataCodes(asList("ddvContainerRecordType_default_title", "ddvContainerRecordType_default_code", "ddvContainerRecordType_default_description", "ddvContainerRecordType_default_linkedSchema", "ddvContainerRecordType_default_abbreviation")).withDisplayMetadataCodes(asList("ddvContainerRecordType_default_title", "ddvContainerRecordType_default_code", "ddvContainerRecordType_default_description", "ddvContainerRecordType_default_linkedSchema")).withSearchResultsMetadataCodes(asList("ddvContainerRecordType_default_title", "ddvContainerRecordType_default_modifiedOn")).withTableMetadataCodes(asList("ddvContainerRecordType_default_title", "ddvContainerRecordType_default_modifiedOn")));
    transaction.add(manager.getMetadata(collection, "ddvContainerRecordType_default_abbreviation").withMetadataGroup("").withInputType(MetadataInputType.HIDDEN).withHighlightStatus(true).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getSchema(collection, "ddvDocumentType_default").withFormMetadataCodes(asList("ddvDocumentType_default_title", "ddvDocumentType_default_code", "ddvDocumentType_default_description", "ddvDocumentType_default_linkedSchema", "ddvDocumentType_default_abbreviation", "ddvDocumentType_default_templates")).withDisplayMetadataCodes(asList("ddvDocumentType_default_title", "ddvDocumentType_default_code", "ddvDocumentType_default_description", "ddvDocumentType_default_linkedSchema", "ddvDocumentType_default_templates")).withSearchResultsMetadataCodes(asList("ddvDocumentType_default_title", "ddvDocumentType_default_modifiedOn")).withTableMetadataCodes(asList("ddvDocumentType_default_title", "ddvDocumentType_default_modifiedOn")));
    transaction.add(manager.getMetadata(collection, "ddvDocumentType_default_abbreviation").withMetadataGroup("").withInputType(MetadataInputType.HIDDEN).withHighlightStatus(true).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getSchema(collection, "ddvFolderType_default").withFormMetadataCodes(asList("ddvFolderType_default_code", "ddvFolderType_default_title", "ddvFolderType_default_description", "ddvFolderType_default_linkedSchema", "ddvFolderType_default_abbreviation")).withDisplayMetadataCodes(asList("ddvFolderType_default_title", "ddvFolderType_default_code", "ddvFolderType_default_description", "ddvFolderType_default_linkedSchema")).withSearchResultsMetadataCodes(asList("ddvFolderType_default_title", "ddvFolderType_default_modifiedOn")).withTableMetadataCodes(asList("ddvFolderType_default_title", "ddvFolderType_default_modifiedOn")));
    transaction.add(manager.getMetadata(collection, "ddvFolderType_default_abbreviation").withMetadataGroup("").withInputType(MetadataInputType.HIDDEN).withHighlightStatus(true).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getSchema(collection, "ddvVariablePeriod_default").withFormMetadataCodes(asList("ddvVariablePeriod_default_code", "ddvVariablePeriod_default_title", "ddvVariablePeriod_default_abbreviation", "ddvVariablePeriod_default_description")).withDisplayMetadataCodes(asList("ddvVariablePeriod_default_code", "ddvVariablePeriod_default_title", "ddvVariablePeriod_default_createdBy", "ddvVariablePeriod_default_createdOn", "ddvVariablePeriod_default_modifiedBy", "ddvVariablePeriod_default_modifiedOn", "ddvVariablePeriod_default_abbreviation", "ddvVariablePeriod_default_description", "ddvVariablePeriod_default_comments")).withSearchResultsMetadataCodes(asList("ddvVariablePeriod_default_code", "ddvVariablePeriod_default_title", "ddvVariablePeriod_default_modifiedOn")).withTableMetadataCodes(asList("ddvVariablePeriod_default_code", "ddvVariablePeriod_default_title", "ddvVariablePeriod_default_modifiedOn")));
    transaction.add(manager.getMetadata(collection, "ddvVariablePeriod_default_abbreviation").withMetadataGroup("").withInputType(MetadataInputType.FIELD).withHighlightStatus(true).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getMetadata(collection, "ddvYearType_default_abbreviation").withMetadataGroup("").withInputType(MetadataInputType.FIELD).withHighlightStatus(true).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getSchema(collection, "event_default").withFormMetadataCodes(asList("event_default_title", "event_default_type", "event_default_delta", "event_default_eventPrincipalPath", "event_default_ip", "event_default_permissionDateRange", "event_default_permissionRoles", "event_default_permissionUsers", "event_default_reason", "event_default_recordVersion", "event_default_sharedBy", "event_default_totalModifiedRecord", "event_default_userRoles", "event_default_username", "event_default_negative", "event_default_batchProcessIdentifier", "event_default_content")).withDisplayMetadataCodes(asList("event_default_title", "event_default_type", "event_default_createdBy", "event_default_createdOn", "event_default_modifiedBy", "event_default_modifiedOn", "event_default_delta", "event_default_eventPrincipalPath", "event_default_ip", "event_default_negative", "event_default_permissionDateRange", "event_default_permissionRoles", "event_default_permissionUsers", "event_default_reason", "event_default_recordIdentifier", "event_default_recordVersion", "event_default_sharedBy", "event_default_totalModifiedRecord", "event_default_userRoles", "event_default_username", "event_default_batchProcessIdentifier", "event_default_content")).withSearchResultsMetadataCodes(asList("event_default_title", "event_default_modifiedOn")).withTableMetadataCodes(asList("event_default_recordIdentifier", "event_default_title", "event_default_receiverName", "event_default_task", "event_default_description", "event_default_createdOn")));
    transaction.add(manager.getSchema(collection, "externalLink_default").withFormMetadataCodes(asList("externalLink_default_title", "externalLink_default_type", "externalLink_default_importedOn")).withDisplayMetadataCodes(asList("externalLink_default_title", "externalLink_default_type", "externalLink_default_createdBy", "externalLink_default_createdOn", "externalLink_default_modifiedBy", "externalLink_default_modifiedOn", "externalLink_default_importedOn")).withSearchResultsMetadataCodes(asList("externalLink_default_title", "externalLink_default_modifiedOn")).withTableMetadataCodes(asList("externalLink_default_title", "externalLink_default_type")));
    ...
    transaction.add(manager.getSchema(collection, "legalReference_default").withFormMetadataCodes(asList("legalReference_default_code", "legalReference_default_title", "legalReference_default_url")).withDisplayMetadataCodes(asList("legalReference_default_code", "legalReference_default_title", "legalReference_default_createdBy", "legalReference_default_createdOn", "legalReference_default_modifiedBy", "legalReference_default_modifiedOn", "legalReference_default_url")).withSearchResultsMetadataCodes(asList("legalReference_default_title", "legalReference_default_modifiedOn")).withTableMetadataCodes(asList("legalReference_default_title", "legalReference_default_code", "legalReference_default_url")));
    transaction.add(manager.getMetadata(collection, "legalReference_default_url").withMetadataGroup("").withInputType(MetadataInputType.URL).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
    transaction.add(manager.getSchema(collection, "legalRequirement_default").withFormMetadataCodes(asList("legalRequirement_default_code", "legalRequirement_default_title", "legalRequirement_default_type", "legalRequirement_default_author", "legalRequirement_default_consequences", "legalRequirement_default_description", "legalRequirement_default_objectTypes")).withDisplayMetadataCodes(asList("legalRequirement_default_code", "legalRequirement_default_title", "legalRequirement_default_type", "legalRequirement_default_createdBy", "legalRequirement_default_createdOn", "legalRequirement_default_modifiedBy", "legalRequirement_default_modifiedOn", "legalRequirement_default_author", "legalRequirement_default_consequences", "legalRequirement_default_description", "legalRequirement_default_objectTypes")).withSearchResultsMetadataCodes(asList("legalRequirement_default_title", "legalRequirement_default_modifiedOn")).withTableMetadataCodes(asList("legalRequirement_default_title", "legalRequirement_default_code", "legalRequirement_default_author")));
    transaction.add(manager.getSchema(collection, "legalRequirementReference_default").withFormMetadataCodes(asList("legalRequirementReference_default_title", "legalRequirementReference_default_ruleReference", "legalRequirementReference_default_ruleRequirement", "legalRequirementReference_default_description")).withDisplayMetadataCodes(asList("legalRequirementReference_default_title", "legalRequirementReference_default_createdBy", "legalRequirementReference_default_createdOn", "legalRequirementReference_default_modifiedBy", "legalRequirementReference_default_modifiedOn", "legalRequirementReference_default_ruleReference", "legalRequirementReference_default_ruleRequirement", "legalRequirementReference_default_description")).withSearchResultsMetadataCodes(asList("legalRequirementReference_default_title", "legalRequirementReference_default_modifiedOn")).withTableMetadataCodes(asList("legalRequirementReference_default_ruleRequirement", "legalRequirementReference_default_ruleReference", "legalRequirementReference_default_description")));
    ...
    transaction.add(manager.getSchema(collection, "printable_report").withFormMetadataCodes(asList("printable_report_title", "printable_report_jasperfile", "printable_report_jasperSubreportFiles", "printable_report_recordType", "printable_report_recordSchema", "printable_report_supportedExtensions")).withDisplayMetadataCodes(asList("printable_report_title", "printable_report_createdBy", "printable_report_createdOn", "printable_report_modifiedBy", "printable_report_modifiedOn", "printable_report_jasperfile", "printable_report_recordSchema", "printable_report_recordType", "printable_report_jasperSubreportFiles", "printable_report_supportedExtensions", "printable_report_templateVersion")).withSearchResultsMetadataCodes(asList("printable_report_title", "printable_report_modifiedOn")).withTableMetadataCodes(asList("printable_report_modifiedOn", "printable_report_title", "printable_report_recordSchema")));
    ...
    transaction.add(manager.getSchema(collection, "retentionRuleDocumentType_default").withFormMetadataCodes(asList("retentionRuleDocumentType_default_title", "retentionRuleDocumentType_default_category", "retentionRuleDocumentType_default_documentType", "retentionRuleDocumentType_default_retentionRule", "retentionRuleDocumentType_default_retentionRuleCopy")).withDisplayMetadataCodes(asList("retentionRuleDocumentType_default_createdBy", "retentionRuleDocumentType_default_createdOn", "retentionRuleDocumentType_default_modifiedBy", "retentionRuleDocumentType_default_modifiedOn", "retentionRuleDocumentType_default_title", "retentionRuleDocumentType_default_category", "retentionRuleDocumentType_default_documentType", "retentionRuleDocumentType_default_retentionRule", "retentionRuleDocumentType_default_retentionRuleCopy")).withSearchResultsMetadataCodes(asList("retentionRuleDocumentType_default_title", "retentionRuleDocumentType_default_modifiedOn")).withTableMetadataCodes(asList("retentionRuleDocumentType_default_title", "retentionRuleDocumentType_default_category", "retentionRuleDocumentType_default_documentType", "retentionRuleDocumentType_default_retentionRule", "retentionRuleDocumentType_default_retentionRuleCopy")));
    ...
    transaction.add(manager.getSchema(collection, "trigger_default").withFormMetadataCodes(asList("trigger_default_title", "trigger_default_type", "trigger_default_actions", "trigger_default_criteria", "trigger_default_description")).withDisplayMetadataCodes(asList("trigger_default_title", "trigger_default_type", "trigger_default_createdBy", "trigger_default_createdOn", "trigger_default_modifiedBy", "trigger_default_modifiedOn", "trigger_default_actions", "trigger_default_description")).withSearchResultsMetadataCodes(asList("trigger_default_title", "trigger_default_modifiedOn")).withTableMetadataCodes(asList("trigger_default_title", "trigger_default_description", "trigger_default_modifiedOn")));
