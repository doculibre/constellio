...
public final class GeneratedRMMigrationCombo {
	...
	public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
		...
		MetadataBuilder folder_activeRetentionPeriodCode = folderSchema.create("activeRetentionPeriodCode")
				.setType(MetadataValueType.STRING);
		folder_activeRetentionPeriodCode.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		MetadataBuilder folder_copyRulesExpectedDepositDates = folderSchema.create("copyRulesExpectedDepositDates")
				.setType(MetadataValueType.DATE);
		folder_copyRulesExpectedDepositDates.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		MetadataBuilder folder_copyRulesExpectedDestructionDates = folderSchema.create("copyRulesExpectedDestructionDates")
				.setType(MetadataValueType.DATE);
		folder_copyRulesExpectedDestructionDates.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		MetadataBuilder folder_copyRulesExpectedTransferDates = folderSchema.create("copyRulesExpectedTransferDates")
				.setType(MetadataValueType.DATE);
		folder_copyRulesExpectedTransferDates.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		folder_decommissioningDate.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		folder_mainCopyRule.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		MetadataBuilder folder_semiactiveRetentionPeriodCode = folderSchema.create("semiactiveRetentionPeriodCode")
				.setType(MetadataValueType.STRING);
		folder_semiactiveRetentionPeriodCode.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		MetadataBuilder folder_semiactiveRetentionType = folderSchema.create("semiactiveRetentionType")
				.setType(MetadataValueType.ENUM);
		folder_semiactiveRetentionType.setTransiency(MetadataTransiency.TRANSIENT_EAGER);
		...
		printable_label_typelabel.setUndeletable(true);
		printable_label_typelabel.setEssential(true);
	...
	public void applySchemasDisplay(SchemasDisplayManager manager) {
		...
		transaction.add(manager.getSchema(collection, "authorizationDetails_default").withFormMetadataCodes(
				asList("authorizationDetails_default_title", "authorizationDetails_default_roles",
						"authorizationDetails_default_target", "authorizationDetails_default_endDate",
						"authorizationDetails_default_startDate", "authorizationDetails_default_synced"))
				.withDisplayMetadataCodes(asList("authorizationDetails_default_title", "authorizationDetails_default_createdBy",
						"authorizationDetails_default_createdOn", "authorizationDetails_default_modifiedBy",
						"authorizationDetails_default_modifiedOn", "authorizationDetails_default_endDate",
						"authorizationDetails_default_roles", "authorizationDetails_default_startDate",
						"authorizationDetails_default_synced", "authorizationDetails_default_target"))
				.withSearchResultsMetadataCodes(
						asList("authorizationDetails_default_title", "authorizationDetails_default_modifiedOn"))
				.withTableMetadataCodes(asList("authorizationDetails_default_title", "authorizationDetails_default_modifiedOn")));
		...
		transaction.add(manager.getSchema(collection, "containerRecord_default").withFormMetadataCodes(
				asList("containerRecord_default_type", "containerRecord_default_temporaryIdentifier",
						...
						"containerRecord_default_capacity")).withDisplayMetadataCodes(
				asList("containerRecord_default_type", "containerRecord_default_temporaryIdentifier",
		...
		transaction.add(manager.getSchema(collection, "storageSpace_default").withFormMetadataCodes(
				asList("storageSpace_default_type", "storageSpace_default_code", "storageSpace_default_description",
						"storageSpace_default_capacity", "storageSpace_default_decommissioningType",
						"storageSpace_default_parentStorageSpace", "storageSpace_default_containerType"))
				.withDisplayMetadataCodes(
						asList("storageSpace_default_type", "storageSpace_default_code", "storageSpace_default_title",
								...
								"storageSpace_default_description", "storageSpace_default_containerType"))
	...
	public void applyGeneratedRoles() {
		...
		rolesManager.updateRole(rolesManager.getRole(collection, "ADM").withNewPermissions(
				asList("core.deleteContentVersion", "core.ldapConfigurationManagement", "core.manageConnectors",
						"core.manageEmailServer", "core.manageFacets", "core.manageLabels", "core.manageMetadataExtractor",
						...
						"rm.createActiveFolderToSemiActiveDecommissioningList", "rm.createDocuments", "rm.createFolders",
						"rm.createInactiveDocuments", "rm.createSemiActiveDocuments", "rm.createSubFolders",
						"rm.createSubFoldersInInactiveFolders", "rm.createSubFoldersInSemiActiveFolders", "rm.decommissioning",
						"rm.deleteBorrowedDocuments", "rm.deleteInactiveDocuments", "rm.deleteInactiveFolders",
						"rm.deletePublishedDocuments", "rm.deleteSemiActiveDocuments", "rm.deleteSemiActiveFolders",
						"rm.duplicateInactiveFolders", "rm.duplicateSemiActiveFolders",
						"rm.editActiveFolderToSemiActiveDecommissioningList", "rm.editDecommissioningList",
						"rm.manageClassificationPlan", "rm.manageContainers", "rm.manageDocumentAuthorizations",
						"rm.manageFolderAuthorizations", "rm.manageReports", "rm.manageRetentionRule", "rm.manageStorageSpaces",
						"rm.manageUniformSubdivisions", "rm.modifyFolderDecomDate", "rm.modifyImportedDocuments",
						"rm.modifyImportedFolders", "rm.modifyInactiveBorrowedFolder", "rm.modifyInactiveDocuments",
						...
						"rm.publishAndUnpublishDocuments", "rm.returnOtherUsersDocuments", "rm.shareDocuments", "rm.shareFolders",
						...
						"rm.uploadInactiveDocuments", "rm.uploadSemiActiveDocuments", "rm.useCart", "tasks.manageWorkflows",
		...
		rolesManager.addRole(new Role(collection, "M", "Gestionnaire",
				asList("manageLabels", "rm.borrowFolder", "rm.createDocuments", "rm.createFolders", "rm.createSubFolders",
						...
						"rm.publishAndUnpublishDocuments", "rm.shareDocuments", "rm.shareFolders", "rm.shareSemiActiveDocuments",
						"rm.shareSemiActiveFolders", "rm.uploadSemiActiveDocuments", "rm.useCart")));
