...
public final class GeneratedRMMigrationCombo {
	...
	public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
		...
		MetadataSchemaTypeBuilder ddvUserFunctionSchemaType = typesBuilder.createNewSchemaType("ddvUserFunction", false).setSecurity(false);
		...
		MetadataSchemaTypeBuilder documentSchemaType = typesBuilder.createNewSchemaType("document", false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE).setSmallCode("d");
		...
		MetadataSchemaTypeBuilder folderSchemaType = typesBuilder.createNewSchemaType("folder", false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE).setSmallCode("f");
		...
		ddvUserFunctionSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator.class);
		...
		ddvUserFunctionSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator4.class);
	...
	private void createDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
		...
		document_category.setCacheIndex(true);
		...
		document_contentCheckedOutDate.setUndeletable(true);
	...
	private void createDdvUserFunctionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														  MetadataSchemaTypeBuilder ddvUserFunctionSchemaType,
														  MetadataSchemaBuilder ddvUserFunctionSchema) {
	...
	private void createFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
		...
		folder_attachedAncestors.setEssentialInSummary(true);
