...
public class RMMigrationTo9_0_0_42 extends MigrationHelper implements MigrationScript {
	...
	public void migrate(String collection, MigrationResourcesProvider migrationResourcesProvider,
			...
			throws Exception {
		new SchemaAlterationFor9_0_0_3(collection, migrationResourcesProvider, appLayerFactory).migrate();
	}

	class SchemaAlterationFor9_0_0_3 extends MetadataSchemasAlterationHelper {

		protected SchemaAlterationFor9_0_0_3(String collection, MigrationResourcesProvider migrationResourcesProvider,
											 AppLayerFactory appLayerFactory) {
