...
public class DisplayLegalReferenceViewImpl extends BaseViewImpl implements DisplayLegalRequirementView {

	private static Logger LOGGER = LoggerFactory.getLogger(DisplayLegalReferenceViewImpl.class);

	private DisplayLegalReferencePresenter presenter;

	public DisplayLegalReferenceViewImpl() {
		presenter = new DisplayLegalReferencePresenter(this);
	}
	...
	protected String getTitle() {
		return $("LegalRequirementManagement.legalReference");
	}
