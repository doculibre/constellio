...
public abstract class ShareContentDataProvider extends RecordVODataProvider {
	...
	public final LogicalSearchQuery getQuery() {
		...
		List<Authorization> recordList = schemasRecordsServices.wrapAuthorizations(searchServices.search(getAuthorizationQuery()));
		...
		queryOnRecord.filteredWithUserRead(user);
