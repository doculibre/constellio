...
public abstract class RetentionRuleForm extends RecordForm {

	public RetentionRuleForm(RecordVO record, RetentionRuleFieldFactory fieldFactory) {
		super(record, fieldFactory);
	}
