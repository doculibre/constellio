...
public class AddNewContainerPresenter extends AddEditContainerPresenter {
	...
	protected boolean hasRestrictedRecordAccess(String params, User user, Record restrictedRecord) {
		...
		return user.has(RMPermissionsTo.CREATE_DECOMISSIONING_LIST).on(administrativeUnit) || decommissioningSecurityService.hasPermissionToCreateTransferOnList(decommissioningList, user);
	}
