...
public class BatchProcessingResultReportBuilder implements ReportBuilder {
    private static final WritableFont.FontName FONT = WritableFont.TIMES;
    private static final int FONT_SIZE = 10;
    BatchProcessingResultModel model;
    Locale locale;

    public BatchProcessingResultReportBuilder(BatchProcessingResultModel model, Locale locale) {
        this.model = model;
        this.locale = locale;
    }
