...
public class AdministrativeUnitReportWriter implements ReportWriter {
	...
	public AdministrativeUnitReportWriter(AdministrativeUnitReportModel model, FoldersLocator foldersLocator) {
		this.model = model;
