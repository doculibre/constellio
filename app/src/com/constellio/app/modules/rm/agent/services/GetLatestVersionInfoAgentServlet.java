...
public class GetLatestVersionInfoAgentServlet extends SocketAgentServlet<Map<String, Object>> {

	@Override
	protected Map<String, Object> respond(Map<String, Object> inParams) throws Exception {
		...
		String agentJarHash = getHash(new FileInputStream(agentJarFile));
		
		versionInfoMap.put("version", version);
		versionInfoMap.put("fileLength", agentJarLength);
		versionInfoMap.put("fileHash", agentJarHash);
