...
public class FolderActiveRetentionTypeCalculator extends AbstractMetadataValueCalculator<RetentionType> {
	...
	public RetentionType calculate(CalculatorParameters parameters) {
		return parameters.get(mainCopyRuleParam).getActiveRetentionPeriod().getRetentionType();
	}
