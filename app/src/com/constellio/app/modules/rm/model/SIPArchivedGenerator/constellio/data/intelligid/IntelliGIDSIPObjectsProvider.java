package com.constellio.app.modules.rm.model.SIPArchivedGenerator.constellio.data.intelligid;
...
public class IntelliGIDSIPObjectsProvider implements SIPObjectsProvider {
	...
	public List<String> getMetadataValues(SIPObject sipObject, String metadataId) {
		...
		if (sipObject instanceof IntelliGIDSIPFolder) {
			...
			Folder ficheDossierCourante = sipFolder.getFicheMetadonnees();
...
//			List<Langue> langues = ficheDocument.getLangues();
