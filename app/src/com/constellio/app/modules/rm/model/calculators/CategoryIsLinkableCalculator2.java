...
public class CategoryIsLinkableCalculator2 extends AbstractMetadataValueCalculator<Boolean> {
	...
	LocalDependency<Boolean> booleanDeactivated = LocalDependency.toABoolean(Category.DEACTIVATE);
	...
	public Boolean calculate(CalculatorParameters parameters) {
		...
		Boolean isDeactivated = parameters.get(booleanDeactivated);
	...
	public List<? extends Dependency> getDependencies() {
		return Arrays.asList(rulesDependency, parentDependency, rulesApprovedDependency, rulesInactiveDependency, configNotRoot,
				configRulesApproved, booleanDeactivated);
	}
}
