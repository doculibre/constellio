...
public class ConstellioSIP {
    ...
    public void build(File zipFile) throws IOException, JDOMException {
    ...
    private void buildMetsFile(ValidationErrors errors) throws IOException, METSException, SAXException, JDOMException {
