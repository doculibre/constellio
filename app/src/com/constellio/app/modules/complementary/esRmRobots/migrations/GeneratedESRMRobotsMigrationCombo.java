...
public final class GeneratedESRMRobotsMigrationCombo {
	...
	public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
		...
		MetadataSchemaBuilder temporaryRecord_ConsolidatedPdfSchema = temporaryRecordSchemaType
				.getCustomSchema("ConsolidatedPdf");
		MetadataSchemaBuilder temporaryRecord_batchProcessReportSchema = temporaryRecordSchemaType
				.getCustomSchema("batchProcessReport");
		...
		MetadataSchemaBuilder temporaryRecord_vaultScanReportSchema = temporaryRecordSchemaType
				.getCustomSchema("vaultScanReport");
		...
		MetadataSchemaBuilder userTask_borrowExtensionRequestSchema = userTaskSchemaType
				.getCustomSchema("borrowExtensionRequest");
		...
		createActionParametersSchemaTypeMetadatas(typesBuilder, actionParametersSchemaType,
				actionParameters_classifyConnectorFolderDirectlyInThePlanSchema,
				actionParameters_classifyConnectorFolderInParentFolderSchema, actionParameters_classifyConnectorTaxonomySchema,
		...
		createConnectorHttpDocumentSchemaTypeMetadatas(typesBuilder, connectorHttpDocumentSchemaType,
				connectorHttpDocumentSchema);
		createConnectorInstanceSchemaTypeMetadatas(typesBuilder, connectorInstanceSchemaType, connectorInstance_httpSchema,
				connectorInstance_ldapSchema, connectorInstance_smbSchema, connectorInstanceSchema);
		createConnectorLdapUserDocumentSchemaTypeMetadatas(typesBuilder, connectorLdapUserDocumentSchemaType,
		...
		createDdvContainerRecordTypeSchemaTypeMetadatas(typesBuilder, ddvContainerRecordTypeSchemaType,
				ddvContainerRecordTypeSchema);
		...
		createPrintableSchemaTypeMetadatas(typesBuilder, printableSchemaType, printable_labelSchema, printable_reportSchema,
				printableSchema);
		...
		createTemporaryRecordSchemaTypeMetadatas(typesBuilder, temporaryRecordSchemaType, temporaryRecord_ConsolidatedPdfSchema,
				temporaryRecord_batchProcessReportSchema, temporaryRecord_exportAuditSchema, temporaryRecord_importAuditSchema,
				temporaryRecord_scriptReportSchema, temporaryRecord_sipArchiveSchema, temporaryRecord_vaultScanReportSchema,
		...
		createUserTaskSchemaTypeMetadatas(typesBuilder, userTaskSchemaType, userTask_borrowExtensionRequestSchema,
				userTask_borrowRequestSchema, userTask_reactivationRequestSchema, userTask_returnRequestSchema, userTaskSchema);
	...
	private void createDdvTaskTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvTaskTypeSchemaType, MetadataSchemaBuilder ddvTaskTypeSchema) {
	}

	private void createConnectorSmbFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorSmbFolderSchemaType, MetadataSchemaBuilder connectorSmbFolderSchema) {
	}

	private void createCartSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder cartSchemaType,
			MetadataSchemaBuilder cartSchema) {
	}

	private void createDdvYearTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvYearTypeSchemaType, MetadataSchemaBuilder ddvYearTypeSchema) {
	}

	private void createRobotSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder robotSchemaType,
	...
	private void createActionParametersSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			...
			MetadataSchemaBuilder actionParameters_classifyConnectorFolderDirectlyInThePlanSchema,
			MetadataSchemaBuilder actionParameters_classifyConnectorFolderInParentFolderSchema,
			MetadataSchemaBuilder actionParameters_classifyConnectorTaxonomySchema,
			MetadataSchemaBuilder actionParameters_classifySmbDocumentInFolderSchema,
			MetadataSchemaBuilder actionParameters_classifySmbFolderInFolderSchema,
		...
		actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultAdminUnit
				.defineReferencesTo(types.getSchemaType("administrativeUnit"));
		...
		actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultCategory
				.defineReferencesTo(types.getSchemaType("category"));
		...
		actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultRetentionRule
				.defineReferencesTo(types.getSchemaType("retentionRule"));
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultUniformSubdivision = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.create("defaultUniformSubdivision").setType(MetadataValueType.REFERENCE);
		actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultUniformSubdivision
				.defineReferencesTo(types.getSchemaType("uniformSubdivision"));
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_documentType = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
		...
		actionParameters_classifyConnectorFolderDirectlyInThePlan_documentType
				.defineReferencesTo(types.getSchemaType("ddvDocumentType"));
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_folderType = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.create("folderType").setType(MetadataValueType.REFERENCE);
		actionParameters_classifyConnectorFolderDirectlyInThePlan_folderType.setUndeletable(true);
		actionParameters_classifyConnectorFolderDirectlyInThePlan_folderType
				.defineReferencesTo(types.getSchemaType("ddvFolderType"));
		...
		actionParameters_classifyConnectorFolderInParentFolder_defaultParentFolder
				.defineReferencesTo(types.getSchemaType("folder"));
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_documentType = actionParameters_classifyConnectorFolderInParentFolderSchema
				.create("documentType").setType(MetadataValueType.REFERENCE);
		actionParameters_classifyConnectorFolderInParentFolder_documentType.setUndeletable(true);
		actionParameters_classifyConnectorFolderInParentFolder_documentType
				.defineReferencesTo(types.getSchemaType("ddvDocumentType"));
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_folderType = actionParameters_classifyConnectorFolderInParentFolderSchema
				.create("folderType").setType(MetadataValueType.REFERENCE);
		actionParameters_classifyConnectorFolderInParentFolder_folderType.setUndeletable(true);
		actionParameters_classifyConnectorFolderInParentFolder_folderType
				.defineReferencesTo(types.getSchemaType("ddvFolderType"));
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_defaultUniformSubdivision = actionParameters_classifyConnectorTaxonomySchema
				.create("defaultUniformSubdivision").setType(MetadataValueType.REFERENCE);
		actionParameters_classifyConnectorTaxonomy_defaultUniformSubdivision
				.defineReferencesTo(types.getSchemaType("uniformSubdivision"));
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_documentType = actionParameters_classifyConnectorTaxonomySchema
				.create("documentType").setType(MetadataValueType.REFERENCE);
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_folderType = actionParameters_classifyConnectorTaxonomySchema
				.create("folderType").setType(MetadataValueType.REFERENCE);
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_allReferences = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("allReferences");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_allRemovedAuths = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("allRemovedAuths");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_attachedAncestors = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("attachedAncestors");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_autocomplete = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("autocomplete");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_caption = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("caption");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_estimatedSize = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("estimatedSize");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_manualTokens = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("manualTokens");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_markedForParsing = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_migrationDataVersion = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_tokens = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("tokens");
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_tokensHierarchy = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema
				.get("tokensHierarchy");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_allReferences = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("allReferences");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_allRemovedAuths = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("allRemovedAuths");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_attachedAncestors = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("attachedAncestors");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_autocomplete = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("autocomplete");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_caption = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("caption");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_errorOnPhysicalDeletion = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_estimatedSize = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("estimatedSize");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_manualTokens = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("manualTokens");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_markedForParsing = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("markedForParsing");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_markedForReindexing = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("markedForReindexing");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_migrationDataVersion = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_tokens = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("tokens");
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_tokensHierarchy = actionParameters_classifyConnectorFolderInParentFolderSchema
				.get("tokensHierarchy");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_allReferences = actionParameters_classifyConnectorTaxonomySchema
				.get("allReferences");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_allRemovedAuths = actionParameters_classifyConnectorTaxonomySchema
				.get("allRemovedAuths");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_attachedAncestors = actionParameters_classifyConnectorTaxonomySchema
				.get("attachedAncestors");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_autocomplete = actionParameters_classifyConnectorTaxonomySchema
				.get("autocomplete");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_caption = actionParameters_classifyConnectorTaxonomySchema
				.get("caption");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_errorOnPhysicalDeletion = actionParameters_classifyConnectorTaxonomySchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_estimatedSize = actionParameters_classifyConnectorTaxonomySchema
				.get("estimatedSize");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_manualTokens = actionParameters_classifyConnectorTaxonomySchema
				.get("manualTokens");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_markedForParsing = actionParameters_classifyConnectorTaxonomySchema
				.get("markedForParsing");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_markedForReindexing = actionParameters_classifyConnectorTaxonomySchema
				.get("markedForReindexing");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_migrationDataVersion = actionParameters_classifyConnectorTaxonomySchema
				.get("migrationDataVersion");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_tokens = actionParameters_classifyConnectorTaxonomySchema
				.get("tokens");
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_tokensHierarchy = actionParameters_classifyConnectorTaxonomySchema
				.get("tokensHierarchy");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_allReferences = actionParameters_classifySmbDocumentInFolderSchema
				.get("allReferences");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_allRemovedAuths = actionParameters_classifySmbDocumentInFolderSchema
				.get("allRemovedAuths");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_attachedAncestors = actionParameters_classifySmbDocumentInFolderSchema
				.get("attachedAncestors");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_autocomplete = actionParameters_classifySmbDocumentInFolderSchema
				.get("autocomplete");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_caption = actionParameters_classifySmbDocumentInFolderSchema
				.get("caption");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_errorOnPhysicalDeletion = actionParameters_classifySmbDocumentInFolderSchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_estimatedSize = actionParameters_classifySmbDocumentInFolderSchema
				.get("estimatedSize");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_manualTokens = actionParameters_classifySmbDocumentInFolderSchema
				.get("manualTokens");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_markedForParsing = actionParameters_classifySmbDocumentInFolderSchema
				.get("markedForParsing");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_markedForReindexing = actionParameters_classifySmbDocumentInFolderSchema
				.get("markedForReindexing");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_migrationDataVersion = actionParameters_classifySmbDocumentInFolderSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_tokens = actionParameters_classifySmbDocumentInFolderSchema
				.get("tokens");
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_tokensHierarchy = actionParameters_classifySmbDocumentInFolderSchema
				.get("tokensHierarchy");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_allReferences = actionParameters_classifySmbFolderInFolderSchema
				.get("allReferences");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_allRemovedAuths = actionParameters_classifySmbFolderInFolderSchema
				.get("allRemovedAuths");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_attachedAncestors = actionParameters_classifySmbFolderInFolderSchema
				.get("attachedAncestors");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_autocomplete = actionParameters_classifySmbFolderInFolderSchema
				.get("autocomplete");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_caption = actionParameters_classifySmbFolderInFolderSchema
				.get("caption");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_errorOnPhysicalDeletion = actionParameters_classifySmbFolderInFolderSchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_estimatedSize = actionParameters_classifySmbFolderInFolderSchema
				.get("estimatedSize");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_manualTokens = actionParameters_classifySmbFolderInFolderSchema
				.get("manualTokens");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_markedForParsing = actionParameters_classifySmbFolderInFolderSchema
				.get("markedForParsing");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_markedForReindexing = actionParameters_classifySmbFolderInFolderSchema
				.get("markedForReindexing");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_migrationDataVersion = actionParameters_classifySmbFolderInFolderSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_tokens = actionParameters_classifySmbFolderInFolderSchema
				.get("tokens");
		MetadataBuilder actionParameters_classifySmbFolderInFolder_tokensHierarchy = actionParameters_classifySmbFolderInFolderSchema
				.get("tokensHierarchy");
	...
	private void createUserDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder userDocumentSchemaType, MetadataSchemaBuilder userDocumentSchema) {
	}

	private void createDdvCapsuleLanguageSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvCapsuleLanguageSchemaType, MetadataSchemaBuilder ddvCapsuleLanguageSchema) {
	}

	private void createStorageSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder storageSpaceSchemaType, MetadataSchemaBuilder storageSpaceSchema) {
	}

	private void createGroupSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder groupSchemaType,
			MetadataSchemaBuilder groupSchema) {
	}

	private void createWorkflowInstanceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder workflowInstanceSchemaType, MetadataSchemaBuilder workflowInstanceSchema) {
	}

	private void createBagInfoSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder bagInfoSchemaType,
			MetadataSchemaBuilder bagInfoSchema) {
	}

	private void createDdvMediumTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvMediumTypeSchemaType, MetadataSchemaBuilder ddvMediumTypeSchema) {
	}

	private void createFilingSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder filingSpaceSchemaType, MetadataSchemaBuilder filingSpaceSchema) {
	}

	private void createWorkflowSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder workflowSchemaType,
			MetadataSchemaBuilder workflowSchema) {
	}

	private void createDdvFolderTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvFolderTypeSchemaType, MetadataSchemaBuilder ddvFolderTypeSchema) {
	}

	private void createCollectionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder collectionSchemaType, MetadataSchemaBuilder collectionSchema) {
	}

	private void createConnectorHttpDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorHttpDocumentSchemaType, MetadataSchemaBuilder connectorHttpDocumentSchema) {
	}

	private void createUniformSubdivisionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder uniformSubdivisionSchemaType, MetadataSchemaBuilder uniformSubdivisionSchema) {
	}

	private void createAuthorizationDetailsSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder authorizationDetailsSchemaType, MetadataSchemaBuilder authorizationDetailsSchema) {
	}

	private void createAdministrativeUnitSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder administrativeUnitSchemaType, MetadataSchemaBuilder administrativeUnitSchema) {
	}

	private void createDdvDocumentTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvDocumentTypeSchemaType, MetadataSchemaBuilder ddvDocumentTypeSchema) {
	}

	private void createFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder folderSchemaType,
			MetadataSchemaBuilder folderSchema) {
	...
	private void createTaskSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder taskSchemaType,
			MetadataSchemaBuilder task_approvalSchema, MetadataSchemaBuilder taskSchema) {
	...
	private void createContainerRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder containerRecordSchemaType, MetadataSchemaBuilder containerRecordSchema) {
	}

	private void createSearchEventSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder searchEventSchemaType, MetadataSchemaBuilder searchEventSchema) {
	}

	private void createRetentionRuleSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder retentionRuleSchemaType, MetadataSchemaBuilder retentionRuleSchema) {
	}

	private void createConnectorSmbDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorSmbDocumentSchemaType, MetadataSchemaBuilder connectorSmbDocumentSchema) {
	}

	private void createCapsuleSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder capsuleSchemaType,
			MetadataSchemaBuilder capsuleSchema) {
	}

	private void createDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder documentSchemaType,
			MetadataSchemaBuilder document_emailSchema, MetadataSchemaBuilder documentSchema) {
	...
	private void createConnectorInstanceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorInstanceSchemaType, MetadataSchemaBuilder connectorInstance_httpSchema,
			MetadataSchemaBuilder connectorInstance_ldapSchema, MetadataSchemaBuilder connectorInstance_smbSchema,
			MetadataSchemaBuilder connectorInstanceSchema) {
	...
	private void createDdvStorageSpaceTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvStorageSpaceTypeSchemaType, MetadataSchemaBuilder ddvStorageSpaceTypeSchema) {
	}

	private void createDdvContainerRecordTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvContainerRecordTypeSchemaType, MetadataSchemaBuilder ddvContainerRecordTypeSchema) {
	}

	private void createSavedSearchSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder savedSearchSchemaType, MetadataSchemaBuilder savedSearchSchema) {
	}

	private void createConnectorLdapUserDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorLdapUserDocumentSchemaType,
			MetadataSchemaBuilder connectorLdapUserDocumentSchema) {
	}

	private void createDdvVariablePeriodSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvVariablePeriodSchemaType, MetadataSchemaBuilder ddvVariablePeriodSchema) {
	}

	private void createDecommissioningListSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder decommissioningListSchemaType, MetadataSchemaBuilder decommissioningListSchema) {
	}

	private void createEmailToSendSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder emailToSendSchemaType, MetadataSchemaBuilder emailToSendSchema) {
	}

	private void createEventSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder eventSchemaType,
			MetadataSchemaBuilder eventSchema) {
	}

	private void createRobotLogSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder robotLogSchemaType,
			MetadataSchemaBuilder robotLogSchema) {
	}

	private void createConnectorTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder connectorTypeSchemaType, MetadataSchemaBuilder connectorTypeSchema) {
	}

	private void createPrintableSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder printableSchemaType, MetadataSchemaBuilder printable_labelSchema,
			MetadataSchemaBuilder printable_reportSchema, MetadataSchemaBuilder printableSchema) {
	...
	private void createThesaurusConfigSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder thesaurusConfigSchemaType, MetadataSchemaBuilder thesaurusConfigSchema) {
	}

	private void createUserTaskSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userTaskSchemaType,
			MetadataSchemaBuilder userTask_borrowExtensionRequestSchema, MetadataSchemaBuilder userTask_borrowRequestSchema,
			MetadataSchemaBuilder userTask_reactivationRequestSchema, MetadataSchemaBuilder userTask_returnRequestSchema,
			MetadataSchemaBuilder userTaskSchema) {
		...
		MetadataBuilder userTask_borrowExtensionRequest_estimatedSize = userTask_borrowExtensionRequestSchema
				.get("estimatedSize");
		...
		MetadataBuilder userTask_borrowExtensionRequest_tokensHierarchy = userTask_borrowExtensionRequestSchema
				.get("tokensHierarchy");
	...
	private void createDdvTaskStatusSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder ddvTaskStatusSchemaType, MetadataSchemaBuilder ddvTaskStatusSchema) {
	}

	private void createUserFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder userFolderSchemaType, MetadataSchemaBuilder userFolderSchema) {
	}

	private void createReportSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder reportSchemaType,
			MetadataSchemaBuilder reportSchema) {
	}

	private void createCategorySchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder categorySchemaType,
			MetadataSchemaBuilder categorySchema) {
	}

	private void createTemporaryRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
			MetadataSchemaTypeBuilder temporaryRecordSchemaType, MetadataSchemaBuilder temporaryRecord_ConsolidatedPdfSchema,
			MetadataSchemaBuilder temporaryRecord_batchProcessReportSchema,
			MetadataSchemaBuilder temporaryRecord_exportAuditSchema, MetadataSchemaBuilder temporaryRecord_importAuditSchema,
			MetadataSchemaBuilder temporaryRecord_scriptReportSchema, MetadataSchemaBuilder temporaryRecord_sipArchiveSchema,
			MetadataSchemaBuilder temporaryRecord_vaultScanReportSchema, MetadataSchemaBuilder temporaryRecordSchema) {
		MetadataBuilder temporaryRecord_ConsolidatedPdf_allReferences = temporaryRecord_ConsolidatedPdfSchema
				.get("allReferences");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_allRemovedAuths = temporaryRecord_ConsolidatedPdfSchema
				.get("allRemovedAuths");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_attachedAncestors = temporaryRecord_ConsolidatedPdfSchema
				.get("attachedAncestors");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_daysBeforeDestruction = temporaryRecord_ConsolidatedPdfSchema
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_destructionDate = temporaryRecord_ConsolidatedPdfSchema
				.get("destructionDate");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_detachedauthorizations = temporaryRecord_ConsolidatedPdfSchema
				.get("detachedauthorizations");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_errorOnPhysicalDeletion = temporaryRecord_ConsolidatedPdfSchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_estimatedSize = temporaryRecord_ConsolidatedPdfSchema
				.get("estimatedSize");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_id = temporaryRecord_ConsolidatedPdfSchema.get("id");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_legacyIdentifier = temporaryRecord_ConsolidatedPdfSchema
				.get("legacyIdentifier");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_logicallyDeletedOn = temporaryRecord_ConsolidatedPdfSchema
				.get("logicallyDeletedOn");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_manualTokens = temporaryRecord_ConsolidatedPdfSchema.get("manualTokens");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_markedForParsing = temporaryRecord_ConsolidatedPdfSchema
				.get("markedForParsing");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_markedForPreviewConversion = temporaryRecord_ConsolidatedPdfSchema
				.get("markedForPreviewConversion");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_markedForReindexing = temporaryRecord_ConsolidatedPdfSchema
				.get("markedForReindexing");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_migrationDataVersion = temporaryRecord_ConsolidatedPdfSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_principalpath = temporaryRecord_ConsolidatedPdfSchema
				.get("principalpath");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_removedauthorizations = temporaryRecord_ConsolidatedPdfSchema
				.get("removedauthorizations");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_schema = temporaryRecord_ConsolidatedPdfSchema.get("schema");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_shareDenyTokens = temporaryRecord_ConsolidatedPdfSchema
				.get("shareDenyTokens");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_tokensHierarchy = temporaryRecord_ConsolidatedPdfSchema
				.get("tokensHierarchy");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_visibleInTrees = temporaryRecord_ConsolidatedPdfSchema
				.get("visibleInTrees");
		MetadataBuilder temporaryRecord_batchProcessReport_allReferences = temporaryRecord_batchProcessReportSchema
				.get("allReferences");
		MetadataBuilder temporaryRecord_batchProcessReport_allRemovedAuths = temporaryRecord_batchProcessReportSchema
				.get("allRemovedAuths");
		MetadataBuilder temporaryRecord_batchProcessReport_attachedAncestors = temporaryRecord_batchProcessReportSchema
				.get("attachedAncestors");
		MetadataBuilder temporaryRecord_batchProcessReport_autocomplete = temporaryRecord_batchProcessReportSchema
				.get("autocomplete");
		...
		MetadataBuilder temporaryRecord_batchProcessReport_daysBeforeDestruction = temporaryRecord_batchProcessReportSchema
				.get("daysBeforeDestruction");
		MetadataBuilder temporaryRecord_batchProcessReport_deleted = temporaryRecord_batchProcessReportSchema.get("deleted");
		MetadataBuilder temporaryRecord_batchProcessReport_denyTokens = temporaryRecord_batchProcessReportSchema
				.get("denyTokens");
		MetadataBuilder temporaryRecord_batchProcessReport_destructionDate = temporaryRecord_batchProcessReportSchema
				.get("destructionDate");
		MetadataBuilder temporaryRecord_batchProcessReport_detachedauthorizations = temporaryRecord_batchProcessReportSchema
				.get("detachedauthorizations");
		MetadataBuilder temporaryRecord_batchProcessReport_errorOnPhysicalDeletion = temporaryRecord_batchProcessReportSchema
				.get("errorOnPhysicalDeletion");
		...
		MetadataBuilder temporaryRecord_batchProcessReport_legacyIdentifier = temporaryRecord_batchProcessReportSchema
				.get("legacyIdentifier");
		MetadataBuilder temporaryRecord_batchProcessReport_logicallyDeletedOn = temporaryRecord_batchProcessReportSchema
				.get("logicallyDeletedOn");
		MetadataBuilder temporaryRecord_batchProcessReport_manualTokens = temporaryRecord_batchProcessReportSchema
				.get("manualTokens");
		MetadataBuilder temporaryRecord_batchProcessReport_markedForParsing = temporaryRecord_batchProcessReportSchema
				.get("markedForParsing");
		MetadataBuilder temporaryRecord_batchProcessReport_markedForPreviewConversion = temporaryRecord_batchProcessReportSchema
				.get("markedForPreviewConversion");
		MetadataBuilder temporaryRecord_batchProcessReport_markedForReindexing = temporaryRecord_batchProcessReportSchema
				.get("markedForReindexing");
		MetadataBuilder temporaryRecord_batchProcessReport_migrationDataVersion = temporaryRecord_batchProcessReportSchema
				.get("migrationDataVersion");
		MetadataBuilder temporaryRecord_batchProcessReport_modifiedBy = temporaryRecord_batchProcessReportSchema
				.get("modifiedBy");
		MetadataBuilder temporaryRecord_batchProcessReport_modifiedOn = temporaryRecord_batchProcessReportSchema
				.get("modifiedOn");
		...
		MetadataBuilder temporaryRecord_batchProcessReport_principalpath = temporaryRecord_batchProcessReportSchema
				.get("principalpath");
		MetadataBuilder temporaryRecord_batchProcessReport_removedauthorizations = temporaryRecord_batchProcessReportSchema
				.get("removedauthorizations");
		MetadataBuilder temporaryRecord_batchProcessReport_schema = temporaryRecord_batchProcessReportSchema.get("schema");
		MetadataBuilder temporaryRecord_batchProcessReport_shareDenyTokens = temporaryRecord_batchProcessReportSchema
				.get("shareDenyTokens");
		MetadataBuilder temporaryRecord_batchProcessReport_shareTokens = temporaryRecord_batchProcessReportSchema
				.get("shareTokens");
		...
		MetadataBuilder temporaryRecord_batchProcessReport_tokensHierarchy = temporaryRecord_batchProcessReportSchema
				.get("tokensHierarchy");
		MetadataBuilder temporaryRecord_batchProcessReport_visibleInTrees = temporaryRecord_batchProcessReportSchema
				.get("visibleInTrees");
		...
		MetadataBuilder temporaryRecord_scriptReport_attachedAncestors = temporaryRecord_scriptReportSchema
				.get("attachedAncestors");
		...
		MetadataBuilder temporaryRecord_scriptReport_daysBeforeDestruction = temporaryRecord_scriptReportSchema
				.get("daysBeforeDestruction");
		...
		MetadataBuilder temporaryRecord_scriptReport_detachedauthorizations = temporaryRecord_scriptReportSchema
				.get("detachedauthorizations");
		MetadataBuilder temporaryRecord_scriptReport_errorOnPhysicalDeletion = temporaryRecord_scriptReportSchema
				.get("errorOnPhysicalDeletion");
		...
		MetadataBuilder temporaryRecord_scriptReport_legacyIdentifier = temporaryRecord_scriptReportSchema
				.get("legacyIdentifier");
		MetadataBuilder temporaryRecord_scriptReport_logicallyDeletedOn = temporaryRecord_scriptReportSchema
				.get("logicallyDeletedOn");
		MetadataBuilder temporaryRecord_scriptReport_manualTokens = temporaryRecord_scriptReportSchema.get("manualTokens");
		MetadataBuilder temporaryRecord_scriptReport_markedForParsing = temporaryRecord_scriptReportSchema
				.get("markedForParsing");
		MetadataBuilder temporaryRecord_scriptReport_markedForPreviewConversion = temporaryRecord_scriptReportSchema
				.get("markedForPreviewConversion");
		MetadataBuilder temporaryRecord_scriptReport_markedForReindexing = temporaryRecord_scriptReportSchema
				.get("markedForReindexing");
		MetadataBuilder temporaryRecord_scriptReport_migrationDataVersion = temporaryRecord_scriptReportSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder temporaryRecord_scriptReport_removedauthorizations = temporaryRecord_scriptReportSchema
				.get("removedauthorizations");
		...
		MetadataBuilder temporaryRecord_vaultScanReport_allReferences = temporaryRecord_vaultScanReportSchema
				.get("allReferences");
		MetadataBuilder temporaryRecord_vaultScanReport_allRemovedAuths = temporaryRecord_vaultScanReportSchema
				.get("allRemovedAuths");
		MetadataBuilder temporaryRecord_vaultScanReport_attachedAncestors = temporaryRecord_vaultScanReportSchema
				.get("attachedAncestors");
		...
		MetadataBuilder temporaryRecord_vaultScanReport_daysBeforeDestruction = temporaryRecord_vaultScanReportSchema
				.get("daysBeforeDestruction");
		...
		MetadataBuilder temporaryRecord_vaultScanReport_destructionDate = temporaryRecord_vaultScanReportSchema
				.get("destructionDate");
		MetadataBuilder temporaryRecord_vaultScanReport_detachedauthorizations = temporaryRecord_vaultScanReportSchema
				.get("detachedauthorizations");
		MetadataBuilder temporaryRecord_vaultScanReport_errorOnPhysicalDeletion = temporaryRecord_vaultScanReportSchema
				.get("errorOnPhysicalDeletion");
		MetadataBuilder temporaryRecord_vaultScanReport_estimatedSize = temporaryRecord_vaultScanReportSchema
				.get("estimatedSize");
		MetadataBuilder temporaryRecord_vaultScanReport_id = temporaryRecord_vaultScanReportSchema.get("id");
		MetadataBuilder temporaryRecord_vaultScanReport_legacyIdentifier = temporaryRecord_vaultScanReportSchema
				.get("legacyIdentifier");
		MetadataBuilder temporaryRecord_vaultScanReport_logicallyDeletedOn = temporaryRecord_vaultScanReportSchema
				.get("logicallyDeletedOn");
		MetadataBuilder temporaryRecord_vaultScanReport_manualTokens = temporaryRecord_vaultScanReportSchema.get("manualTokens");
		MetadataBuilder temporaryRecord_vaultScanReport_markedForParsing = temporaryRecord_vaultScanReportSchema
				.get("markedForParsing");
		MetadataBuilder temporaryRecord_vaultScanReport_markedForPreviewConversion = temporaryRecord_vaultScanReportSchema
				.get("markedForPreviewConversion");
		MetadataBuilder temporaryRecord_vaultScanReport_markedForReindexing = temporaryRecord_vaultScanReportSchema
				.get("markedForReindexing");
		MetadataBuilder temporaryRecord_vaultScanReport_migrationDataVersion = temporaryRecord_vaultScanReportSchema
				.get("migrationDataVersion");
		...
		MetadataBuilder temporaryRecord_vaultScanReport_principalpath = temporaryRecord_vaultScanReportSchema
				.get("principalpath");
		MetadataBuilder temporaryRecord_vaultScanReport_removedauthorizations = temporaryRecord_vaultScanReportSchema
				.get("removedauthorizations");
		MetadataBuilder temporaryRecord_vaultScanReport_schema = temporaryRecord_vaultScanReportSchema.get("schema");
		MetadataBuilder temporaryRecord_vaultScanReport_shareDenyTokens = temporaryRecord_vaultScanReportSchema
				.get("shareDenyTokens");
		...
		MetadataBuilder temporaryRecord_vaultScanReport_tokensHierarchy = temporaryRecord_vaultScanReportSchema
				.get("tokensHierarchy");
		MetadataBuilder temporaryRecord_vaultScanReport_visibleInTrees = temporaryRecord_vaultScanReportSchema
				.get("visibleInTrees");
	}

	private void createUserSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userSchemaType,
			MetadataSchemaBuilder userSchema) {
	}

	private void createFacetSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder facetSchemaType,
			MetadataSchemaBuilder facet_fieldSchema, MetadataSchemaBuilder facet_querySchema, MetadataSchemaBuilder facetSchema) {
	...
	public void applySchemasDisplay(SchemasDisplayManager manager) {
		...
		transaction.add(manager.getSchema(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan")
				.withFormMetadataCodes(asList("actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultAdminUnit",
						...
						"actionParameters_classifyConnectorFolderDirectlyInThePlan_folderType",
						"actionParameters_classifyConnectorFolderDirectlyInThePlan_documentType")).withDisplayMetadataCodes(
		...
		transaction.add(manager
				...
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager
				.getMetadata(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan_defaultUniformSubdivision")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction
				.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan_documentMapping")
						.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
						.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan_documentType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan_folderMapping")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderDirectlyInThePlan_folderType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getSchema(collection, "actionParameters_classifyConnectorFolderInParentFolder")
				.withFormMetadataCodes(asList("actionParameters_classifyConnectorFolderInParentFolder_defaultParentFolder",
						...
						"actionParameters_classifyConnectorFolderInParentFolder_folderType",
						"actionParameters_classifyConnectorFolderInParentFolder_documentType")).withDisplayMetadataCodes(
		...
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderInParentFolder_documentMapping")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderInParentFolder_documentType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderInParentFolder_folderMapping")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorFolderInParentFolder_folderType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getSchema(collection, "actionParameters_classifyConnectorTaxonomy").withFormMetadataCodes(
				asList("actionParameters_classifyConnectorTaxonomy_inTaxonomy",
						...
						"actionParameters_classifyConnectorTaxonomy_actionAfterClassification",
						"actionParameters_classifyConnectorTaxonomy_folderType",
						"actionParameters_classifyConnectorTaxonomy_documentType")).withDisplayMetadataCodes(
		...
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_defaultParentFolder")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_defaultRetentionRule")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_defaultUniformSubdivision")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		...
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_documentMapping")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_documentType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_folderMapping")
				.withMetadataGroup("tab.to.hide").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
		transaction.add(manager.getMetadata(collection, "actionParameters_classifyConnectorTaxonomy_folderType")
				.withMetadataGroup("tab.defaultValues").withInputType(MetadataInputType.LOOKUP).withHighlightStatus(false)
				.withVisibleInAdvancedSearchStatus(false));
	...
	public void applyGeneratedRoles() {
		...
		rolesManager.updateRole(rolesManager.getRole(collection, "ADM").withNewPermissions(
				asList("core.accessDeleteAllTemporaryRecords", "core.deleteContentVersion", "core.deletePublicSavedSearch",
						"core.ldapConfigurationManagement", "core.manageConnectors", "core.manageEmailServer",
						"core.manageExcelReport", "core.manageFacets", "core.manageLabels", "core.manageMetadataExtractor",
						"core.manageMetadataSchemas", "core.managePrintableReport", "core.manageSearchBoost",
						"core.manageSecurity", "core.manageSystemCollections", "core.manageSystemConfiguration",
						"core.manageSystemDataImports", "core.manageSystemGroups", "core.manageSystemGroupsActivation",
						"core.manageSystemUpdates", "core.manageSystemUsers", "core.manageTaxonomies", "core.manageTrash",
						"core.manageValueList", "core.managerTemporaryRecords", "core.modifyPublicSavedSearch",
						"core.seeAllTemporaryRecords", "core.useExternalAPIS", "core.viewEvents", "core.viewSystemBatchProcesses",
						...
						"rm.editDecommissioningList", "rm.generateSIPArchives", "rm.manageBagInfo", "rm.manageClassificationPlan",
						...
						"rm.returnOtherUsersDocuments", "rm.returnOtherUsersFolders", "rm.shareDocuments", "rm.shareFolders",
						"rm.shareImportedDocuments", "rm.shareImportedFolders", "rm.shareInactiveDocuments",
						"rm.shareInactiveFolders", "rm.shareSemiActiveDocuments", "rm.shareSemiActiveFolders",
						"rm.uploadInactiveDocuments", "rm.uploadSemiActiveDocuments", "rm.useCart", "rm.viewSystemFilename",
						"robots.manageRobots", "tasks.manageWorkflows", "tasks.startWorkflows")));
