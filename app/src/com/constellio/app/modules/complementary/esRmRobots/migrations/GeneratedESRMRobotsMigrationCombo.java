...
public final class GeneratedESRMRobotsMigrationCombo {
	...
	private void createDdvTaskTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
													  MetadataSchemaTypeBuilder ddvTaskTypeSchemaType,
													  MetadataSchemaBuilder ddvTaskTypeSchema) {
	}

	private void createConnectorSmbFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															 MetadataSchemaTypeBuilder connectorSmbFolderSchemaType,
															 MetadataSchemaBuilder connectorSmbFolderSchema) {
	}

	private void createCartSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
											   MetadataSchemaTypeBuilder cartSchemaType,
											   MetadataSchemaBuilder cartSchema) {
	}

	private void createDdvYearTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
													  MetadataSchemaTypeBuilder ddvYearTypeSchemaType,
													  MetadataSchemaBuilder ddvYearTypeSchema) {
	}
	...
	private void createActionParametersSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
		...
		MetadataBuilder actionParameters_classifyConnectorFolderDirectlyInThePlan_nonTaxonomyAuthorizations = actionParameters_classifyConnectorFolderDirectlyInThePlanSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder actionParameters_classifyConnectorFolderInParentFolder_nonTaxonomyAuthorizations = actionParameters_classifyConnectorFolderInParentFolderSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder actionParameters_classifyConnectorTaxonomy_nonTaxonomyAuthorizations = actionParameters_classifyConnectorTaxonomySchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder actionParameters_classifySmbDocumentInFolder_nonTaxonomyAuthorizations = actionParameters_classifySmbDocumentInFolderSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder actionParameters_classifySmbFolderInFolder_nonTaxonomyAuthorizations = actionParameters_classifySmbFolderInFolderSchema.get("nonTaxonomyAuthorizations");
	...
	private void createStorageSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
													   MetadataSchemaTypeBuilder storageSpaceSchemaType,
													   MetadataSchemaBuilder storageSpaceSchema) {
	}
	...
	private void createWorkflowInstanceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														   MetadataSchemaTypeBuilder workflowInstanceSchemaType,
														   MetadataSchemaBuilder workflowInstanceSchema) {
	}

	private void createBagInfoSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
												  MetadataSchemaTypeBuilder bagInfoSchemaType,
												  MetadataSchemaBuilder bagInfoSchema) {
	}

	private void createDdvMediumTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														MetadataSchemaTypeBuilder ddvMediumTypeSchemaType,
														MetadataSchemaBuilder ddvMediumTypeSchema) {
	}
	...
	private void createFilingSpaceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
													  ...
													  MetadataSchemaBuilder filingSpaceSchema) {
	}

	private void createWorkflowSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
												   MetadataSchemaTypeBuilder workflowSchemaType,
												   MetadataSchemaBuilder workflowSchema) {
	}

	private void createDdvFolderTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														MetadataSchemaTypeBuilder ddvFolderTypeSchemaType,
														MetadataSchemaBuilder ddvFolderTypeSchema) {
	}
	...
	private void createConnectorHttpDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
																MetadataSchemaTypeBuilder connectorHttpDocumentSchemaType,
																MetadataSchemaBuilder connectorHttpDocumentSchema) {
	}
	...
	private void createUniformSubdivisionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															 ...
															 MetadataSchemaBuilder uniformSubdivisionSchema) {
	}
	...
	private void createAdministrativeUnitSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															 ...
															 MetadataSchemaBuilder administrativeUnitSchema) {
	}

	private void createDdvDocumentTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														  MetadataSchemaTypeBuilder ddvDocumentTypeSchemaType,
														  MetadataSchemaBuilder ddvDocumentTypeSchema) {
	}

	private void createFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
	...
	private void createContainerRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														  MetadataSchemaTypeBuilder containerRecordSchemaType,
														  MetadataSchemaBuilder containerRecordSchema) {
	}
	...
	private void createRetentionRuleSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														...
														MetadataSchemaBuilder retentionRuleSchema) {
	}

	private void createConnectorSmbDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															   MetadataSchemaTypeBuilder connectorSmbDocumentSchemaType,
															   MetadataSchemaBuilder connectorSmbDocumentSchema) {
	}
	...
	private void createDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
												   MetadataSchemaTypeBuilder documentSchemaType,
												   MetadataSchemaBuilder document_emailSchema,
												   MetadataSchemaBuilder documentSchema) {
		...
		MetadataBuilder document_email_nonTaxonomyAuthorizations = document_emailSchema.get("nonTaxonomyAuthorizations");
	...
	private void createConnectorInstanceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															MetadataSchemaTypeBuilder connectorInstanceSchemaType,
															MetadataSchemaBuilder connectorInstance_httpSchema,
															MetadataSchemaBuilder connectorInstance_ldapSchema,
															MetadataSchemaBuilder connectorInstance_smbSchema,
		...
		MetadataBuilder connectorInstance_http_nonTaxonomyAuthorizations = connectorInstance_httpSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder connectorInstance_ldap_nonTaxonomyAuthorizations = connectorInstance_ldapSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder connectorInstance_smb_nonTaxonomyAuthorizations = connectorInstance_smbSchema.get("nonTaxonomyAuthorizations");
	...
	private void createDdvStorageSpaceTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															  MetadataSchemaTypeBuilder ddvStorageSpaceTypeSchemaType,
															  MetadataSchemaBuilder ddvStorageSpaceTypeSchema) {
	}

	private void createDdvContainerRecordTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
																 MetadataSchemaTypeBuilder ddvContainerRecordTypeSchemaType,
																 MetadataSchemaBuilder ddvContainerRecordTypeSchema) {
	}
	...
	private void createDdvVariablePeriodSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															MetadataSchemaTypeBuilder ddvVariablePeriodSchemaType,
															MetadataSchemaBuilder ddvVariablePeriodSchema) {
	}

	private void createDecommissioningListSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
															  MetadataSchemaTypeBuilder decommissioningListSchemaType,
															  MetadataSchemaBuilder decommissioningListSchema) {
	}
	...
	private void createConnectorTypeSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														MetadataSchemaTypeBuilder connectorTypeSchemaType,
														MetadataSchemaBuilder connectorTypeSchema) {
	}
	...
	private void createPrintableSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
													...
													MetadataSchemaBuilder printable_labelSchema,
													MetadataSchemaBuilder printable_reportSchema,
		...
		MetadataBuilder printable_label_nonTaxonomyAuthorizations = printable_labelSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder printable_report_nonTaxonomyAuthorizations = printable_reportSchema.get("nonTaxonomyAuthorizations");
	...
	private void createUserTaskSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
												   MetadataSchemaTypeBuilder userTaskSchemaType,
												   MetadataSchemaBuilder userTask_borrowExtensionRequestSchema,
												   MetadataSchemaBuilder userTask_borrowRequestSchema,
												   MetadataSchemaBuilder userTask_reactivationRequestSchema,
												   MetadataSchemaBuilder userTask_returnRequestSchema,
		...
		MetadataBuilder userTask_borrowExtensionRequest_nonTaxonomyAuthorizations = userTask_borrowExtensionRequestSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder userTask_borrowRequest_nonTaxonomyAuthorizations = userTask_borrowRequestSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder userTask_reactivationRequest_nonTaxonomyAuthorizations = userTask_reactivationRequestSchema.get("nonTaxonomyAuthorizations");
		...
		MetadataBuilder userTask_returnRequest_nonTaxonomyAuthorizations = userTask_returnRequestSchema.get("nonTaxonomyAuthorizations");
	...
	private void createDdvTaskStatusSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														MetadataSchemaTypeBuilder ddvTaskStatusSchemaType,
														MetadataSchemaBuilder ddvTaskStatusSchema) {
	}
	...
	private void createCategorySchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
	...
	private void createTemporaryRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types,
														  ...
														  MetadataSchemaBuilder temporaryRecord_ConsolidatedPdfSchema,
														  ...
														  MetadataSchemaBuilder temporaryRecord_sipArchiveSchema,
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_allauthorizations = temporaryRecord_ConsolidatedPdfSchema.get("allauthorizations");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_authorizations = temporaryRecord_ConsolidatedPdfSchema.get("authorizations");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_followers = temporaryRecord_ConsolidatedPdfSchema.get("followers");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_id = temporaryRecord_ConsolidatedPdfSchema.get("id");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_inheritedauthorizations = temporaryRecord_ConsolidatedPdfSchema.get("inheritedauthorizations");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_nonTaxonomyAuthorizations = temporaryRecord_ConsolidatedPdfSchema.get("nonTaxonomyAuthorizations");
		MetadataBuilder temporaryRecord_ConsolidatedPdf_parentpath = temporaryRecord_ConsolidatedPdfSchema.get("parentpath");
		...
		MetadataBuilder temporaryRecord_ConsolidatedPdf_searchable = temporaryRecord_ConsolidatedPdfSchema.get("searchable");
		...
		MetadataBuilder temporaryRecord_sipArchive_nonTaxonomyAuthorizations = temporaryRecord_sipArchiveSchema.get("nonTaxonomyAuthorizations");
	...
	public void applyGeneratedRoles() {
		...
		rolesManager.updateRole(rolesManager.getRole(collection, "RGD").withNewPermissions(asList("core.accessDeleteAllTemporaryRecords", "core.deleteContentVersion", "core.deletePublicSavedSearch", "core.ldapConfigurationManagement", "core.manageConnectors", "core.manageEmailServer", "core.manageExcelReport", "core.manageFacets", "core.manageLabels", "core.manageMetadataExtractor", "core.manageMetadataSchemas", "core.managePrintableReport", "core.manageSearchBoost", "core.manageSecurity", "core.manageSystemCollections", "core.manageSystemConfiguration", "core.manageSystemDataImports", "core.manageSystemGroups", "core.manageSystemGroupsActivation", "core.manageSystemUpdates", "core.manageSystemUsers", "core.manageTaxonomies", "core.manageTrash", "core.manageValueList", "core.managerTemporaryRecords", "core.seeAllTemporaryRecords", "core.useExternalAPIS", "core.viewEvents", "core.viewSystemBatchProcesses", "rm.borrowContainer", "rm.borrowFolder", "rm.borrowingFolderDirectly", "rm.borrowingRequestOnContainer", "rm.borrowingRequestOnFolder", "rm.createActiveFolderToSemiActiveDecommissioningList", "rm.createDocuments", "rm.createFolders", "rm.createInactiveDocuments", "rm.createSemiActiveDocuments", "rm.createSubFolders", "rm.createSubFoldersInInactiveFolders", "rm.createSubFoldersInSemiActiveFolders", "rm.decommissioning", "rm.deleteBorrowedDocuments", "rm.deleteContainers", "rm.deleteInactiveDocuments", "rm.deleteInactiveFolders", "rm.deletePublishedDocuments", "rm.deleteSemiActiveDocuments", "rm.deleteSemiActiveFolders", "rm.displayContainers", "rm.duplicateInactiveFolders", "rm.duplicateSemiActiveFolders", "rm.editActiveFolderToSemiActiveDecommissioningList", "rm.editDecommissioningList", "rm.generateSIPArchives", "rm.manageBagInfo", "rm.manageClassificationPlan", "rm.manageContainers", "rm.manageDocumentAuthorizations", "rm.manageFolderAuthorizations", "rm.manageReports", "rm.manageRequestOnContainer", "rm.manageRequestOnFolder", "rm.manageRetentionRule", "rm.manageStorageSpaces", "rm.manageUniformSubdivisions", "rm.modifyFolderDecomDate", "rm.modifyImportedDocuments", "rm.modifyImportedFolders", "rm.modifyInactiveBorrowedFolder", "rm.modifyInactiveDocuments", "rm.modifyInactiveFolders", "rm.modifyOpeningDateFolder", "rm.modifySemiActiveBorrowedFolder", "rm.modifySemiActiveDocuments", "rm.modifySemiActiveFolders", "rm.processDecommissioningList", "rm.publishAndUnpublishDocuments", "rm.reactivationRequestOnFolder", "rm.returnOtherUsersDocuments", "rm.shareDocuments", "rm.shareFolders", "rm.shareImportedDocuments", "rm.shareImportedFolders", "rm.shareInactiveDocuments", "rm.shareInactiveFolders", "rm.shareSemiActiveDocuments", "rm.shareSemiActiveFolders", "rm.uploadInactiveDocuments", "rm.uploadSemiActiveDocuments", "rm.useCart", "rm.viewSystemFilename", "tasks.manageWorkflows")));
	}
}