...
public class CoreMigrationTo_7_0_1 implements MigrationScript {
    ...
    class CoreAlternationFor7_0_1 extends MetadataSchemasAlterationHelper {
        ...
        protected void migrate(MetadataSchemaTypesBuilder typesBuilder) {
            ...
            defaultSchema.create(UserFolder.USER_FOLDER).setType(MetadataValueType.REFERENCE).setEssential(false).defineReferencesTo(typesBuilder.getSchemaType(UserFolder.SCHEMA_TYPE));
