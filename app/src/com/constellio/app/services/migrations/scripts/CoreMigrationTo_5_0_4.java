...
public class CoreMigrationTo_5_0_4 implements MigrationScript {
	...
	class CoreSchemaAlterationFor5_0_4 extends MetadataSchemasAlterationHelper {
		...
		private void addMetadataToUserSchema(MetadataSchemaTypesBuilder typesBuilder) {
			typesBuilder.getSchema(User.DEFAULT_SCHEMA).createUndeletable(User.DEFAULT_TAB_IN_FOLDER_DISPLAY).setType(
