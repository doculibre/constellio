...
public final class GeneratedCoreMigrationCombo {
  ...
  public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
    MetadataSchemaTypeBuilder collectionSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("collection",false).setSecurity(false);
    MetadataSchemaBuilder collectionSchema = collectionSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder groupSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("group",false).setSecurity(false);
    MetadataSchemaBuilder groupSchema = groupSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder userSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("user",false).setSecurity(false);
    MetadataSchemaBuilder userSchema = userSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder authorizationDetailsSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("authorizationDetails",false).setSecurity(false);
    MetadataSchemaBuilder authorizationDetailsSchema = authorizationDetailsSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder capsuleSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("capsule",false).setSecurity(false);
    MetadataSchemaBuilder capsuleSchema = capsuleSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder conversationSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("conversation",false);
    MetadataSchemaBuilder conversationSchema = conversationSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvCapsuleLanguageSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvCapsuleLanguage",false).setSecurity(false);
    MetadataSchemaBuilder ddvCapsuleLanguageSchema = ddvCapsuleLanguageSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder ddvSourceSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("ddvSource",false).setSecurity(false);
    MetadataSchemaBuilder ddvSourceSchema = ddvSourceSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder emailToSendSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("emailToSend",false).setSecurity(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder emailToSendSchema = emailToSendSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder eventSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("event",false).setSecurity(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder eventSchema = eventSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder externalAccessUrlSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("externalAccessUrl",false).setSecurity(false);
    MetadataSchemaBuilder externalAccessUrlSchema = externalAccessUrlSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder facetSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("facet",false).setSecurity(false);
    ...
    MetadataSchemaTypeBuilder messageSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("message",false);
    MetadataSchemaBuilder messageSchema = messageSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder printableSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("printable",false).setSecurity(false);
    MetadataSchemaBuilder printableSchema = printableSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder reportSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("report",false).setSecurity(false);
    MetadataSchemaBuilder reportSchema = reportSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder savedSearchSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("savedSearch",false).setSecurity(false).setRecordCacheType(RecordCacheType.NOT_CACHED);
    MetadataSchemaBuilder savedSearchSchema = savedSearchSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder searchEventSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("searchEvent",false).setSecurity(false).setRecordCacheType(RecordCacheType.NOT_CACHED).setDataStore("events");
    MetadataSchemaBuilder searchEventSchema = searchEventSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder taskSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("task",false).setSecurity(false);
    ...
    MetadataSchemaTypeBuilder temporaryRecordSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("temporaryRecord",false).setSecurity(false);
    ...
    MetadataSchemaBuilder temporaryRecord_vaultScanReportSchema = temporaryRecordSchemaType.createCustomSchema("vaultScanReport");
    MetadataSchemaBuilder temporaryRecordSchema = temporaryRecordSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder thesaurusConfigSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("thesaurusConfig",false).setSecurity(false);
    MetadataSchemaBuilder thesaurusConfigSchema = thesaurusConfigSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder userDocumentSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("userDocument",false).setSecurity(false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE);
    MetadataSchemaBuilder userDocumentSchema = userDocumentSchemaType.getDefaultSchema();
    MetadataSchemaTypeBuilder userFolderSchemaType = typesBuilder.createNewSchemaTypeWithSecurity("userFolder",false).setSecurity(false).setRecordCacheType(RecordCacheType.SUMMARY_CACHED_WITH_VOLATILE);
    ...
    collectionSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    collectionSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    collectionSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    collectionSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    collectionSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    collectionSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    collectionSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    collectionSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    groupSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    groupSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    groupSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    groupSchema.get("caption").defineDataEntry().asCalculated(GroupCaptionCalculator.class);
    groupSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    groupSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    groupSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    groupSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    groupSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    userSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    userSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    userSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    userSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    userSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    userSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    userSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    userSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    authorizationDetailsSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    authorizationDetailsSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    authorizationDetailsSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    authorizationDetailsSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    authorizationDetailsSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    authorizationDetailsSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    authorizationDetailsSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    authorizationDetailsSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    capsuleSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    capsuleSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    capsuleSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    capsuleSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    capsuleSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    capsuleSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    capsuleSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    capsuleSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    capsuleSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    capsuleSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    conversationSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    conversationSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    conversationSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    conversationSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    conversationSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    conversationSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    conversationSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    conversationSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    conversationSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    conversationSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    conversationSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    conversationSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    conversationSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    conversationSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ddvCapsuleLanguageSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    ddvCapsuleLanguageSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    ddvCapsuleLanguageSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvCapsuleLanguageSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvCapsuleLanguageSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvCapsuleLanguageSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ddvCapsuleLanguageSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    ddvCapsuleLanguageSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    ddvCapsuleLanguageSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvCapsuleLanguageSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvCapsuleLanguageSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvCapsuleLanguageSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvCapsuleLanguageSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvCapsuleLanguageSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ddvSourceSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    ddvSourceSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    ddvSourceSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    ddvSourceSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ddvSourceSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    ddvSourceSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ddvSourceSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    ddvSourceSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    ddvSourceSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    ddvSourceSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    ddvSourceSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    ddvSourceSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ddvSourceSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ddvSourceSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    emailToSendSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    emailToSendSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    emailToSendSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    emailToSendSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    emailToSendSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    emailToSendSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    emailToSendSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    emailToSendSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    externalAccessUrlSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    externalAccessUrlSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    externalAccessUrlSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    externalAccessUrlSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    externalAccessUrlSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    externalAccessUrlSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    externalAccessUrlSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    externalAccessUrlSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    externalAccessUrlSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    externalAccessUrlSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    externalAccessUrlSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    externalAccessUrlSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    externalAccessUrlSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    externalAccessUrlSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    facetSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    facetSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    facetSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    facetSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    facetSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    facetSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    facetSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    facetSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    messageSchema.get("allReferences").defineDataEntry().asCalculated(AllReferencesCalculator.class);
    messageSchema.get("allRemovedAuths").defineDataEntry().asCalculated(AllRemovedAuthsCalculator.class);
    messageSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    messageSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    messageSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    messageSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    messageSchema.get("hasUrlInMessage").defineDataEntry().asCalculated(MessageHasUrlInBodyCalculator.class);
    messageSchema.get("messageReplyCount").defineDataEntry().asReferenceCount(typesBuilder.getMetadata("message_default_messageParent"));
    messageSchema.get("path").defineDataEntry().asCalculated(PathCalculator.class);
    messageSchema.get("pathParts").defineDataEntry().asCalculated(PathPartsCalculator.class);
    messageSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    messageSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    messageSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    messageSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    messageSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    messageSchema.get("tokensHierarchy").defineDataEntry().asCalculated(DefaultTokensOfHierarchyCalculator.class);
    ...
    printableSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    printableSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    printableSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    printableSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    printableSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    printableSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    printableSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    printableSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    printableSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    reportSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    reportSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    reportSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    reportSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    reportSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    reportSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    reportSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    reportSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    taskSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    taskSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    taskSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    taskSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    taskSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    taskSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    taskSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    taskSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    temporaryRecordSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    temporaryRecordSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    temporaryRecordSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    temporaryRecordSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    temporaryRecordSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    temporaryRecordSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    temporaryRecordSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    temporaryRecordSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    thesaurusConfigSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    thesaurusConfigSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    thesaurusConfigSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    thesaurusConfigSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    thesaurusConfigSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    thesaurusConfigSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    thesaurusConfigSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    thesaurusConfigSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    thesaurusConfigSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
    ...
    userDocumentSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    userDocumentSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    ...
    userDocumentSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    userDocumentSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    userDocumentSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    userDocumentSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    userDocumentSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    ...
    userFolderSchema.get("attachedAncestors").defineDataEntry().asCalculated(AttachedAncestorsCalculator2.class);
    userFolderSchema.get("attachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerAttachedPrincipalConceptsAncestorsCalculator.class);
    userFolderSchema.get("autocomplete").defineDataEntry().asCalculated(AutocompleteFieldCalculator.class);
    userFolderSchema.get("detachedPrincipalAncestorsIntIds").defineDataEntry().asCalculated(IntegerDetachedPrincipalConceptsAncestorsCalculator.class);
    ...
    userFolderSchema.get("principalAncestorsIntIds").defineDataEntry().asCalculated(PrincipalAncestorsCalculator.class);
    userFolderSchema.get("principalConceptsIntIds").defineDataEntry().asCalculated(PrincipalConceptsIntIdsCalculator.class);
    userFolderSchema.get("principalpath").defineDataEntry().asCalculated(PrincipalPathCalculator.class);
    userFolderSchema.get("secondaryConceptsIntIds").defineDataEntry().asCalculated(SecondaryConceptsIntIdsCalculator.class);
    userFolderSchema.get("tokens").defineDataEntry().asCalculated(TokensCalculator5.class);
  ...
  private void createCapsuleSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder capsuleSchemaType, MetadataSchemaBuilder capsuleSchema) {
    ...
    MetadataBuilder capsule_attachedPrincipalAncestorsIntIds = capsuleSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    capsule_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    capsule_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    capsule_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    capsule_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    capsule_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder capsule_detachedPrincipalAncestorsIntIds = capsuleSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    capsule_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    capsule_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    capsule_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    capsule_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    capsule_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder capsule_images = capsuleSchema.create("images").setType(MetadataValueType.CONTENT);
    capsule_images.setMultivalue(true);
    capsule_images.defineStructureFactory(ContentFactory.class);
    ...
    MetadataBuilder capsule_language = capsuleSchema.create("language").setType(MetadataValueType.REFERENCE);
    capsule_language.defineReferencesTo(types.getSchemaType("ddvCapsuleLanguage"));
    ...
    MetadataBuilder capsule_nestedAuthorizations = capsuleSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    capsule_nestedAuthorizations.setSystemReserved(true);
    capsule_nestedAuthorizations.setUndeletable(true);
    capsule_nestedAuthorizations.setMultiLingual(false);
    capsule_nestedAuthorizations.setEssentialInSummary(true);
    capsule_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder capsule_principalAncestorsIntIds = capsuleSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    capsule_principalAncestorsIntIds.setMultivalue(true);
    capsule_principalAncestorsIntIds.setSystemReserved(true);
    capsule_principalAncestorsIntIds.setUndeletable(true);
    capsule_principalAncestorsIntIds.setMultiLingual(false);
    capsule_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder capsule_principalConceptsIntIds = capsuleSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    capsule_principalConceptsIntIds.setMultivalue(true);
    capsule_principalConceptsIntIds.setSystemReserved(true);
    capsule_principalConceptsIntIds.setUndeletable(true);
    capsule_principalConceptsIntIds.setMultiLingual(false);
    capsule_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder capsule_secondaryConceptsIntIds = capsuleSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    capsule_secondaryConceptsIntIds.setMultivalue(true);
    capsule_secondaryConceptsIntIds.setSystemReserved(true);
    capsule_secondaryConceptsIntIds.setUndeletable(true);
    capsule_secondaryConceptsIntIds.setMultiLingual(false);
    capsule_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createExternalAccessUrlSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder externalAccessUrlSchemaType, MetadataSchemaBuilder externalAccessUrlSchema) {
    MetadataBuilder externalAccessUrl_accessRecord = externalAccessUrlSchema.create("accessRecord").setType(MetadataValueType.STRING);
    externalAccessUrl_accessRecord.setUndeletable(true);
    MetadataBuilder externalAccessUrl_allReferences = externalAccessUrlSchema.create("allReferences").setType(MetadataValueType.STRING);
    externalAccessUrl_allReferences.setMultivalue(true);
    externalAccessUrl_allReferences.setSystemReserved(true);
    externalAccessUrl_allReferences.setUndeletable(true);
    externalAccessUrl_allReferences.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_allRemovedAuths = externalAccessUrlSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    externalAccessUrl_allRemovedAuths.setMultivalue(true);
    externalAccessUrl_allRemovedAuths.setSystemReserved(true);
    externalAccessUrl_allRemovedAuths.setUndeletable(true);
    externalAccessUrl_allRemovedAuths.setEssential(true);
    externalAccessUrl_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_attachedAncestors = externalAccessUrlSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    externalAccessUrl_attachedAncestors.setMultivalue(true);
    externalAccessUrl_attachedAncestors.setSystemReserved(true);
    externalAccessUrl_attachedAncestors.setUndeletable(true);
    externalAccessUrl_attachedAncestors.setEssential(true);
    externalAccessUrl_attachedAncestors.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_attachedPrincipalAncestorsIntIds = externalAccessUrlSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalAccessUrl_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalAccessUrl_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalAccessUrl_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalAccessUrl_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalAccessUrl_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_autocomplete = externalAccessUrlSchema.create("autocomplete").setType(MetadataValueType.STRING);
    externalAccessUrl_autocomplete.setMultivalue(true);
    externalAccessUrl_autocomplete.setSystemReserved(true);
    externalAccessUrl_autocomplete.setUndeletable(true);
    externalAccessUrl_autocomplete.setEssential(true);
    externalAccessUrl_autocomplete.setMultiLingual(true);
    MetadataBuilder externalAccessUrl_caption = externalAccessUrlSchema.create("caption").setType(MetadataValueType.STRING);
    externalAccessUrl_caption.setSystemReserved(true);
    externalAccessUrl_caption.setUndeletable(true);
    externalAccessUrl_caption.setMultiLingual(false);
    externalAccessUrl_caption.setSortable(true);
    MetadataBuilder externalAccessUrl_createdBy = externalAccessUrlSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    externalAccessUrl_createdBy.setSystemReserved(true);
    externalAccessUrl_createdBy.setUndeletable(true);
    externalAccessUrl_createdBy.setMultiLingual(false);
    externalAccessUrl_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalAccessUrl_createdOn = externalAccessUrlSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    externalAccessUrl_createdOn.setSystemReserved(true);
    externalAccessUrl_createdOn.setUndeletable(true);
    externalAccessUrl_createdOn.setMultiLingual(false);
    externalAccessUrl_createdOn.setSortable(true);
    MetadataBuilder externalAccessUrl_deleted = externalAccessUrlSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_deleted.setSystemReserved(true);
    externalAccessUrl_deleted.setUndeletable(true);
    externalAccessUrl_deleted.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_denyTokens = externalAccessUrlSchema.create("denyTokens").setType(MetadataValueType.STRING);
    externalAccessUrl_denyTokens.setMultivalue(true);
    externalAccessUrl_denyTokens.setSystemReserved(true);
    externalAccessUrl_denyTokens.setUndeletable(true);
    externalAccessUrl_denyTokens.setMultiLingual(false);
    externalAccessUrl_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalAccessUrl_detachedPrincipalAncestorsIntIds = externalAccessUrlSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalAccessUrl_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    externalAccessUrl_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    externalAccessUrl_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    externalAccessUrl_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    externalAccessUrl_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_detachedauthorizations = externalAccessUrlSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_detachedauthorizations.setSystemReserved(true);
    externalAccessUrl_detachedauthorizations.setUndeletable(true);
    externalAccessUrl_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_email = externalAccessUrlSchema.create("email").setType(MetadataValueType.STRING);
    externalAccessUrl_email.setUndeletable(true);
    MetadataBuilder externalAccessUrl_errorOnPhysicalDeletion = externalAccessUrlSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_errorOnPhysicalDeletion.setSystemReserved(true);
    externalAccessUrl_errorOnPhysicalDeletion.setUndeletable(true);
    externalAccessUrl_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_estimatedSize = externalAccessUrlSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    externalAccessUrl_estimatedSize.setSystemReserved(true);
    externalAccessUrl_estimatedSize.setUndeletable(true);
    externalAccessUrl_estimatedSize.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_expirationDate = externalAccessUrlSchema.create("expirationDate").setType(MetadataValueType.DATE);
    externalAccessUrl_expirationDate.setUndeletable(true);
    MetadataBuilder externalAccessUrl_fullname = externalAccessUrlSchema.create("fullname").setType(MetadataValueType.STRING);
    externalAccessUrl_fullname.setUndeletable(true);
    MetadataBuilder externalAccessUrl_hidden = externalAccessUrlSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_hidden.setSystemReserved(true);
    externalAccessUrl_hidden.setUndeletable(true);
    externalAccessUrl_hidden.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_id = externalAccessUrlSchema.create("id").setType(MetadataValueType.STRING);
    externalAccessUrl_id.setDefaultRequirement(true);
    externalAccessUrl_id.setSystemReserved(true);
    externalAccessUrl_id.setUndeletable(true);
    externalAccessUrl_id.setMultiLingual(false);
    externalAccessUrl_id.setSearchable(true);
    externalAccessUrl_id.setSortable(true);
    externalAccessUrl_id.setUniqueValue(true);
    externalAccessUrl_id.setUnmodifiable(true);
    MetadataBuilder externalAccessUrl_legacyIdentifier = externalAccessUrlSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    externalAccessUrl_legacyIdentifier.setDefaultRequirement(true);
    externalAccessUrl_legacyIdentifier.setSystemReserved(true);
    externalAccessUrl_legacyIdentifier.setUndeletable(true);
    externalAccessUrl_legacyIdentifier.setMultiLingual(false);
    externalAccessUrl_legacyIdentifier.setSearchable(true);
    externalAccessUrl_legacyIdentifier.setUniqueValue(true);
    externalAccessUrl_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder externalAccessUrl_logicallyDeletedOn = externalAccessUrlSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    externalAccessUrl_logicallyDeletedOn.setSystemReserved(true);
    externalAccessUrl_logicallyDeletedOn.setUndeletable(true);
    externalAccessUrl_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_manualTokens = externalAccessUrlSchema.create("manualTokens").setType(MetadataValueType.STRING);
    externalAccessUrl_manualTokens.setMultivalue(true);
    externalAccessUrl_manualTokens.setSystemReserved(true);
    externalAccessUrl_manualTokens.setUndeletable(true);
    externalAccessUrl_manualTokens.setMultiLingual(false);
    externalAccessUrl_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalAccessUrl_markedForParsing = externalAccessUrlSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_markedForParsing.setSystemReserved(true);
    externalAccessUrl_markedForParsing.setUndeletable(true);
    externalAccessUrl_markedForParsing.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_markedForPreviewConversion = externalAccessUrlSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_markedForPreviewConversion.setSystemReserved(true);
    externalAccessUrl_markedForPreviewConversion.setUndeletable(true);
    externalAccessUrl_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_markedForReindexing = externalAccessUrlSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_markedForReindexing.setSystemReserved(true);
    externalAccessUrl_markedForReindexing.setUndeletable(true);
    externalAccessUrl_markedForReindexing.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_migrationDataVersion = externalAccessUrlSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    externalAccessUrl_migrationDataVersion.setSystemReserved(true);
    externalAccessUrl_migrationDataVersion.setUndeletable(true);
    externalAccessUrl_migrationDataVersion.setMultiLingual(false);
    externalAccessUrl_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_modifiedBy = externalAccessUrlSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    externalAccessUrl_modifiedBy.setSystemReserved(true);
    externalAccessUrl_modifiedBy.setUndeletable(true);
    externalAccessUrl_modifiedBy.setMultiLingual(false);
    externalAccessUrl_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder externalAccessUrl_modifiedOn = externalAccessUrlSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    externalAccessUrl_modifiedOn.setSystemReserved(true);
    externalAccessUrl_modifiedOn.setUndeletable(true);
    externalAccessUrl_modifiedOn.setMultiLingual(false);
    externalAccessUrl_modifiedOn.setSortable(true);
    MetadataBuilder externalAccessUrl_nestedAuthorizations = externalAccessUrlSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    externalAccessUrl_nestedAuthorizations.setSystemReserved(true);
    externalAccessUrl_nestedAuthorizations.setUndeletable(true);
    externalAccessUrl_nestedAuthorizations.setMultiLingual(false);
    externalAccessUrl_nestedAuthorizations.setEssentialInSummary(true);
    externalAccessUrl_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder externalAccessUrl_path = externalAccessUrlSchema.create("path").setType(MetadataValueType.STRING);
    externalAccessUrl_path.setMultivalue(true);
    externalAccessUrl_path.setSystemReserved(true);
    externalAccessUrl_path.setUndeletable(true);
    externalAccessUrl_path.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_pathParts = externalAccessUrlSchema.create("pathParts").setType(MetadataValueType.STRING);
    externalAccessUrl_pathParts.setMultivalue(true);
    externalAccessUrl_pathParts.setSystemReserved(true);
    externalAccessUrl_pathParts.setUndeletable(true);
    externalAccessUrl_pathParts.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_principalAncestorsIntIds = externalAccessUrlSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    externalAccessUrl_principalAncestorsIntIds.setMultivalue(true);
    externalAccessUrl_principalAncestorsIntIds.setSystemReserved(true);
    externalAccessUrl_principalAncestorsIntIds.setUndeletable(true);
    externalAccessUrl_principalAncestorsIntIds.setMultiLingual(false);
    externalAccessUrl_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_principalConceptsIntIds = externalAccessUrlSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalAccessUrl_principalConceptsIntIds.setMultivalue(true);
    externalAccessUrl_principalConceptsIntIds.setSystemReserved(true);
    externalAccessUrl_principalConceptsIntIds.setUndeletable(true);
    externalAccessUrl_principalConceptsIntIds.setMultiLingual(false);
    externalAccessUrl_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_principalpath = externalAccessUrlSchema.create("principalpath").setType(MetadataValueType.STRING);
    externalAccessUrl_principalpath.setSystemReserved(true);
    externalAccessUrl_principalpath.setUndeletable(true);
    externalAccessUrl_principalpath.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_removedauthorizations = externalAccessUrlSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    externalAccessUrl_removedauthorizations.setMultivalue(true);
    externalAccessUrl_removedauthorizations.setSystemReserved(true);
    externalAccessUrl_removedauthorizations.setUndeletable(true);
    externalAccessUrl_removedauthorizations.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_roles = externalAccessUrlSchema.create("roles").setType(MetadataValueType.STRING);
    externalAccessUrl_roles.setMultivalue(true);
    externalAccessUrl_roles.setUndeletable(true);
    MetadataBuilder externalAccessUrl_schema = externalAccessUrlSchema.create("schema").setType(MetadataValueType.STRING);
    externalAccessUrl_schema.setDefaultRequirement(true);
    externalAccessUrl_schema.setSystemReserved(true);
    externalAccessUrl_schema.setUndeletable(true);
    externalAccessUrl_schema.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_secondaryConceptsIntIds = externalAccessUrlSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    externalAccessUrl_secondaryConceptsIntIds.setMultivalue(true);
    externalAccessUrl_secondaryConceptsIntIds.setSystemReserved(true);
    externalAccessUrl_secondaryConceptsIntIds.setUndeletable(true);
    externalAccessUrl_secondaryConceptsIntIds.setMultiLingual(false);
    externalAccessUrl_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder externalAccessUrl_shareDenyTokens = externalAccessUrlSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    externalAccessUrl_shareDenyTokens.setMultivalue(true);
    externalAccessUrl_shareDenyTokens.setSystemReserved(true);
    externalAccessUrl_shareDenyTokens.setUndeletable(true);
    externalAccessUrl_shareDenyTokens.setMultiLingual(false);
    externalAccessUrl_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalAccessUrl_shareTokens = externalAccessUrlSchema.create("shareTokens").setType(MetadataValueType.STRING);
    externalAccessUrl_shareTokens.setMultivalue(true);
    externalAccessUrl_shareTokens.setSystemReserved(true);
    externalAccessUrl_shareTokens.setUndeletable(true);
    externalAccessUrl_shareTokens.setMultiLingual(false);
    externalAccessUrl_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder externalAccessUrl_status = externalAccessUrlSchema.create("status").setType(MetadataValueType.ENUM);
    externalAccessUrl_status.setUndeletable(true);
    externalAccessUrl_status.defineAsEnum(ExternalAccessUrlStatus.class);
    MetadataBuilder externalAccessUrl_title = externalAccessUrlSchema.create("title").setType(MetadataValueType.STRING);
    externalAccessUrl_title.setUndeletable(true);
    externalAccessUrl_title.setMultiLingual(false);
    externalAccessUrl_title.setSchemaAutocomplete(true);
    externalAccessUrl_title.setSearchable(true);
    MetadataBuilder externalAccessUrl_token = externalAccessUrlSchema.create("token").setType(MetadataValueType.STRING);
    externalAccessUrl_token.setUndeletable(true);
    MetadataBuilder externalAccessUrl_tokens = externalAccessUrlSchema.create("tokens").setType(MetadataValueType.STRING);
    externalAccessUrl_tokens.setMultivalue(true);
    externalAccessUrl_tokens.setSystemReserved(true);
    externalAccessUrl_tokens.setUndeletable(true);
    externalAccessUrl_tokens.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_tokensHierarchy = externalAccessUrlSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    externalAccessUrl_tokensHierarchy.setMultivalue(true);
    externalAccessUrl_tokensHierarchy.setSystemReserved(true);
    externalAccessUrl_tokensHierarchy.setUndeletable(true);
    externalAccessUrl_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder externalAccessUrl_user = externalAccessUrlSchema.create("user").setType(MetadataValueType.REFERENCE);
    externalAccessUrl_user.setUndeletable(true);
    externalAccessUrl_user.defineReferencesTo(asList(types.getSchema("user_default")));
    MetadataBuilder externalAccessUrl_visibleInTrees = externalAccessUrlSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    externalAccessUrl_visibleInTrees.setSystemReserved(true);
    externalAccessUrl_visibleInTrees.setUndeletable(true);
    externalAccessUrl_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createCollectionSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder collectionSchemaType, MetadataSchemaBuilder collectionSchema) {
    ...
    MetadataBuilder collection_attachedPrincipalAncestorsIntIds = collectionSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    collection_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    collection_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    collection_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    collection_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    collection_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder collection_detachedPrincipalAncestorsIntIds = collectionSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    collection_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    collection_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    collection_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    collection_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    collection_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder collection_nestedAuthorizations = collectionSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    collection_nestedAuthorizations.setSystemReserved(true);
    collection_nestedAuthorizations.setUndeletable(true);
    collection_nestedAuthorizations.setMultiLingual(false);
    collection_nestedAuthorizations.setEssentialInSummary(true);
    collection_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder collection_principalAncestorsIntIds = collectionSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    collection_principalAncestorsIntIds.setMultivalue(true);
    collection_principalAncestorsIntIds.setSystemReserved(true);
    collection_principalAncestorsIntIds.setUndeletable(true);
    collection_principalAncestorsIntIds.setMultiLingual(false);
    collection_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder collection_principalConceptsIntIds = collectionSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    collection_principalConceptsIntIds.setMultivalue(true);
    collection_principalConceptsIntIds.setSystemReserved(true);
    collection_principalConceptsIntIds.setUndeletable(true);
    collection_principalConceptsIntIds.setMultiLingual(false);
    collection_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder collection_secondaryConceptsIntIds = collectionSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    collection_secondaryConceptsIntIds.setMultivalue(true);
    collection_secondaryConceptsIntIds.setSystemReserved(true);
    collection_secondaryConceptsIntIds.setUndeletable(true);
    collection_secondaryConceptsIntIds.setMultiLingual(false);
    collection_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createMessageSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder messageSchemaType, MetadataSchemaBuilder messageSchema) {
    MetadataBuilder message_allReferences = messageSchema.create("allReferences").setType(MetadataValueType.STRING);
    message_allReferences.setMultivalue(true);
    message_allReferences.setSystemReserved(true);
    message_allReferences.setUndeletable(true);
    message_allReferences.setMultiLingual(false);
    MetadataBuilder message_allRemovedAuths = messageSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    message_allRemovedAuths.setMultivalue(true);
    message_allRemovedAuths.setSystemReserved(true);
    message_allRemovedAuths.setUndeletable(true);
    message_allRemovedAuths.setEssential(true);
    message_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder message_attachedAncestors = messageSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    message_attachedAncestors.setMultivalue(true);
    message_attachedAncestors.setSystemReserved(true);
    message_attachedAncestors.setUndeletable(true);
    message_attachedAncestors.setEssential(true);
    message_attachedAncestors.setMultiLingual(false);
    MetadataBuilder message_attachedPrincipalAncestorsIntIds = messageSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    message_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    message_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    message_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    message_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    message_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder message_autocomplete = messageSchema.create("autocomplete").setType(MetadataValueType.STRING);
    message_autocomplete.setMultivalue(true);
    message_autocomplete.setSystemReserved(true);
    message_autocomplete.setUndeletable(true);
    message_autocomplete.setEssential(true);
    message_autocomplete.setMultiLingual(true);
    MetadataBuilder message_caption = messageSchema.create("caption").setType(MetadataValueType.STRING);
    message_caption.setSystemReserved(true);
    message_caption.setUndeletable(true);
    message_caption.setMultiLingual(false);
    message_caption.setSortable(true);
    MetadataBuilder message_conversation = messageSchema.create("conversation").setType(MetadataValueType.REFERENCE);
    message_conversation.setDefaultRequirement(true);
    message_conversation.setUndeletable(true);
    message_conversation.defineReferencesTo(asList(types.getSchema("conversation_default")));
    MetadataBuilder message_createdBy = messageSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    message_createdBy.setSystemReserved(true);
    message_createdBy.setUndeletable(true);
    message_createdBy.setMultiLingual(false);
    message_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder message_createdOn = messageSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    message_createdOn.setSystemReserved(true);
    message_createdOn.setUndeletable(true);
    message_createdOn.setMultiLingual(false);
    message_createdOn.setSortable(true);
    MetadataBuilder message_deleted = messageSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    message_deleted.setSystemReserved(true);
    message_deleted.setUndeletable(true);
    message_deleted.setMultiLingual(false);
    MetadataBuilder message_denyTokens = messageSchema.create("denyTokens").setType(MetadataValueType.STRING);
    message_denyTokens.setMultivalue(true);
    message_denyTokens.setSystemReserved(true);
    message_denyTokens.setUndeletable(true);
    message_denyTokens.setMultiLingual(false);
    message_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder message_detachedPrincipalAncestorsIntIds = messageSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    message_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    message_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    message_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    message_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    message_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder message_detachedauthorizations = messageSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    message_detachedauthorizations.setSystemReserved(true);
    message_detachedauthorizations.setUndeletable(true);
    message_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder message_errorOnPhysicalDeletion = messageSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    message_errorOnPhysicalDeletion.setSystemReserved(true);
    message_errorOnPhysicalDeletion.setUndeletable(true);
    message_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder message_estimatedSize = messageSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    message_estimatedSize.setSystemReserved(true);
    message_estimatedSize.setUndeletable(true);
    message_estimatedSize.setMultiLingual(false);
    MetadataBuilder message_hasUrlInMessage = messageSchema.create("hasUrlInMessage").setType(MetadataValueType.BOOLEAN);
    message_hasUrlInMessage.setUndeletable(true);
    MetadataBuilder message_hidden = messageSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    message_hidden.setSystemReserved(true);
    message_hidden.setUndeletable(true);
    message_hidden.setMultiLingual(false);
    MetadataBuilder message_id = messageSchema.create("id").setType(MetadataValueType.STRING);
    message_id.setDefaultRequirement(true);
    message_id.setSystemReserved(true);
    message_id.setUndeletable(true);
    message_id.setMultiLingual(false);
    message_id.setSearchable(true);
    message_id.setSortable(true);
    message_id.setUniqueValue(true);
    message_id.setUnmodifiable(true);
    MetadataBuilder message_legacyIdentifier = messageSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    message_legacyIdentifier.setDefaultRequirement(true);
    message_legacyIdentifier.setSystemReserved(true);
    message_legacyIdentifier.setUndeletable(true);
    message_legacyIdentifier.setMultiLingual(false);
    message_legacyIdentifier.setSearchable(true);
    message_legacyIdentifier.setUniqueValue(true);
    message_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder message_logicallyDeletedOn = messageSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    message_logicallyDeletedOn.setSystemReserved(true);
    message_logicallyDeletedOn.setUndeletable(true);
    message_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder message_manualTokens = messageSchema.create("manualTokens").setType(MetadataValueType.STRING);
    message_manualTokens.setMultivalue(true);
    message_manualTokens.setSystemReserved(true);
    message_manualTokens.setUndeletable(true);
    message_manualTokens.setMultiLingual(false);
    message_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder message_markedForParsing = messageSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    message_markedForParsing.setSystemReserved(true);
    message_markedForParsing.setUndeletable(true);
    message_markedForParsing.setMultiLingual(false);
    MetadataBuilder message_markedForPreviewConversion = messageSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    message_markedForPreviewConversion.setSystemReserved(true);
    message_markedForPreviewConversion.setUndeletable(true);
    message_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder message_markedForReindexing = messageSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    message_markedForReindexing.setSystemReserved(true);
    message_markedForReindexing.setUndeletable(true);
    message_markedForReindexing.setMultiLingual(false);
    MetadataBuilder message_messageAuthor = messageSchema.create("messageAuthor").setType(MetadataValueType.REFERENCE);
    message_messageAuthor.setDefaultRequirement(true);
    message_messageAuthor.setUndeletable(true);
    message_messageAuthor.defineReferencesTo(asList(types.getSchema("user_default")));
    MetadataBuilder message_messageBody = messageSchema.create("messageBody").setType(MetadataValueType.TEXT);
    message_messageBody.setDefaultRequirement(true);
    message_messageBody.setUndeletable(true);
    message_messageBody.setSearchable(true);
    MetadataBuilder message_messageBodyType = messageSchema.create("messageBodyType").setType(MetadataValueType.ENUM);
    message_messageBodyType.setUndeletable(true);
    message_messageBodyType.defineAsEnum(MessageBodyType.class);
    MetadataBuilder message_messageParent = messageSchema.create("messageParent").setType(MetadataValueType.REFERENCE);
    message_messageParent.setUndeletable(true);
    message_messageParent.defineReferencesTo(asList(types.getSchema("message_default")));
    MetadataBuilder message_messageReplyCount = messageSchema.create("messageReplyCount").setType(MetadataValueType.NUMBER);
    message_messageReplyCount.setUndeletable(true);
    MetadataBuilder message_migrationDataVersion = messageSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    message_migrationDataVersion.setSystemReserved(true);
    message_migrationDataVersion.setUndeletable(true);
    message_migrationDataVersion.setMultiLingual(false);
    message_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder message_modifiedBy = messageSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    message_modifiedBy.setSystemReserved(true);
    message_modifiedBy.setUndeletable(true);
    message_modifiedBy.setMultiLingual(false);
    message_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder message_modifiedOn = messageSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    message_modifiedOn.setSystemReserved(true);
    message_modifiedOn.setUndeletable(true);
    message_modifiedOn.setMultiLingual(false);
    message_modifiedOn.setSortable(true);
    MetadataBuilder message_nestedAuthorizations = messageSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    message_nestedAuthorizations.setSystemReserved(true);
    message_nestedAuthorizations.setUndeletable(true);
    message_nestedAuthorizations.setMultiLingual(false);
    message_nestedAuthorizations.setEssentialInSummary(true);
    message_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder message_path = messageSchema.create("path").setType(MetadataValueType.STRING);
    message_path.setMultivalue(true);
    message_path.setSystemReserved(true);
    message_path.setUndeletable(true);
    message_path.setMultiLingual(false);
    MetadataBuilder message_pathParts = messageSchema.create("pathParts").setType(MetadataValueType.STRING);
    message_pathParts.setMultivalue(true);
    message_pathParts.setSystemReserved(true);
    message_pathParts.setUndeletable(true);
    message_pathParts.setMultiLingual(false);
    MetadataBuilder message_principalAncestorsIntIds = messageSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    message_principalAncestorsIntIds.setMultivalue(true);
    message_principalAncestorsIntIds.setSystemReserved(true);
    message_principalAncestorsIntIds.setUndeletable(true);
    message_principalAncestorsIntIds.setMultiLingual(false);
    message_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder message_principalConceptsIntIds = messageSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    message_principalConceptsIntIds.setMultivalue(true);
    message_principalConceptsIntIds.setSystemReserved(true);
    message_principalConceptsIntIds.setUndeletable(true);
    message_principalConceptsIntIds.setMultiLingual(false);
    message_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder message_principalpath = messageSchema.create("principalpath").setType(MetadataValueType.STRING);
    message_principalpath.setSystemReserved(true);
    message_principalpath.setUndeletable(true);
    message_principalpath.setMultiLingual(false);
    MetadataBuilder message_removedauthorizations = messageSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    message_removedauthorizations.setMultivalue(true);
    message_removedauthorizations.setSystemReserved(true);
    message_removedauthorizations.setUndeletable(true);
    message_removedauthorizations.setMultiLingual(false);
    MetadataBuilder message_schema = messageSchema.create("schema").setType(MetadataValueType.STRING);
    message_schema.setDefaultRequirement(true);
    message_schema.setSystemReserved(true);
    message_schema.setUndeletable(true);
    message_schema.setMultiLingual(false);
    MetadataBuilder message_secondaryConceptsIntIds = messageSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    message_secondaryConceptsIntIds.setMultivalue(true);
    message_secondaryConceptsIntIds.setSystemReserved(true);
    message_secondaryConceptsIntIds.setUndeletable(true);
    message_secondaryConceptsIntIds.setMultiLingual(false);
    message_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder message_shareDenyTokens = messageSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    message_shareDenyTokens.setMultivalue(true);
    message_shareDenyTokens.setSystemReserved(true);
    message_shareDenyTokens.setUndeletable(true);
    message_shareDenyTokens.setMultiLingual(false);
    message_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder message_shareTokens = messageSchema.create("shareTokens").setType(MetadataValueType.STRING);
    message_shareTokens.setMultivalue(true);
    message_shareTokens.setSystemReserved(true);
    message_shareTokens.setUndeletable(true);
    message_shareTokens.setMultiLingual(false);
    message_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder message_title = messageSchema.create("title").setType(MetadataValueType.STRING);
    message_title.setUndeletable(true);
    message_title.setMultiLingual(false);
    message_title.setSchemaAutocomplete(true);
    message_title.setSearchable(true);
    MetadataBuilder message_tokens = messageSchema.create("tokens").setType(MetadataValueType.STRING);
    message_tokens.setMultivalue(true);
    message_tokens.setSystemReserved(true);
    message_tokens.setUndeletable(true);
    message_tokens.setMultiLingual(false);
    MetadataBuilder message_tokensHierarchy = messageSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    message_tokensHierarchy.setMultivalue(true);
    message_tokensHierarchy.setSystemReserved(true);
    message_tokensHierarchy.setUndeletable(true);
    message_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder message_visibleInTrees = messageSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    message_visibleInTrees.setSystemReserved(true);
    message_visibleInTrees.setUndeletable(true);
    message_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createPrintableSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder printableSchemaType, MetadataSchemaBuilder printableSchema) {
    ...
    MetadataBuilder printable_attachedPrincipalAncestorsIntIds = printableSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    printable_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    printable_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    printable_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    printable_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    printable_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder printable_detachedPrincipalAncestorsIntIds = printableSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    printable_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    printable_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    printable_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    printable_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    printable_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder printable_nestedAuthorizations = printableSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    printable_nestedAuthorizations.setSystemReserved(true);
    printable_nestedAuthorizations.setUndeletable(true);
    printable_nestedAuthorizations.setMultiLingual(false);
    printable_nestedAuthorizations.setEssentialInSummary(true);
    printable_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder printable_principalAncestorsIntIds = printableSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    printable_principalAncestorsIntIds.setMultivalue(true);
    printable_principalAncestorsIntIds.setSystemReserved(true);
    printable_principalAncestorsIntIds.setUndeletable(true);
    printable_principalAncestorsIntIds.setMultiLingual(false);
    printable_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder printable_principalConceptsIntIds = printableSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    printable_principalConceptsIntIds.setMultivalue(true);
    printable_principalConceptsIntIds.setSystemReserved(true);
    printable_principalConceptsIntIds.setUndeletable(true);
    printable_principalConceptsIntIds.setMultiLingual(false);
    printable_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder printable_secondaryConceptsIntIds = printableSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    printable_secondaryConceptsIntIds.setMultivalue(true);
    printable_secondaryConceptsIntIds.setSystemReserved(true);
    printable_secondaryConceptsIntIds.setUndeletable(true);
    printable_secondaryConceptsIntIds.setMultiLingual(false);
    printable_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createThesaurusConfigSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder thesaurusConfigSchemaType, MetadataSchemaBuilder thesaurusConfigSchema) {
    ...
    MetadataBuilder thesaurusConfig_attachedPrincipalAncestorsIntIds = thesaurusConfigSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    thesaurusConfig_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    thesaurusConfig_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    thesaurusConfig_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    thesaurusConfig_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    thesaurusConfig_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder thesaurusConfig_detachedPrincipalAncestorsIntIds = thesaurusConfigSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    thesaurusConfig_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    thesaurusConfig_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    thesaurusConfig_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    thesaurusConfig_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    thesaurusConfig_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder thesaurusConfig_nestedAuthorizations = thesaurusConfigSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    thesaurusConfig_nestedAuthorizations.setSystemReserved(true);
    thesaurusConfig_nestedAuthorizations.setUndeletable(true);
    thesaurusConfig_nestedAuthorizations.setMultiLingual(false);
    thesaurusConfig_nestedAuthorizations.setEssentialInSummary(true);
    thesaurusConfig_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder thesaurusConfig_principalAncestorsIntIds = thesaurusConfigSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    thesaurusConfig_principalAncestorsIntIds.setMultivalue(true);
    thesaurusConfig_principalAncestorsIntIds.setSystemReserved(true);
    thesaurusConfig_principalAncestorsIntIds.setUndeletable(true);
    thesaurusConfig_principalAncestorsIntIds.setMultiLingual(false);
    thesaurusConfig_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder thesaurusConfig_principalConceptsIntIds = thesaurusConfigSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    thesaurusConfig_principalConceptsIntIds.setMultivalue(true);
    thesaurusConfig_principalConceptsIntIds.setSystemReserved(true);
    thesaurusConfig_principalConceptsIntIds.setUndeletable(true);
    thesaurusConfig_principalConceptsIntIds.setMultiLingual(false);
    thesaurusConfig_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder thesaurusConfig_secondaryConceptsIntIds = thesaurusConfigSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    thesaurusConfig_secondaryConceptsIntIds.setMultivalue(true);
    thesaurusConfig_secondaryConceptsIntIds.setSystemReserved(true);
    thesaurusConfig_secondaryConceptsIntIds.setUndeletable(true);
    thesaurusConfig_secondaryConceptsIntIds.setMultiLingual(false);
    thesaurusConfig_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createSavedSearchSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder savedSearchSchemaType, MetadataSchemaBuilder savedSearchSchema) {
    ...
    MetadataBuilder savedSearch_attachedPrincipalAncestorsIntIds = savedSearchSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    savedSearch_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    savedSearch_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    savedSearch_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    savedSearch_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    savedSearch_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder savedSearch_detachedPrincipalAncestorsIntIds = savedSearchSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    savedSearch_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    savedSearch_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    savedSearch_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    savedSearch_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    savedSearch_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder savedSearch_nestedAuthorizations = savedSearchSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    savedSearch_nestedAuthorizations.setSystemReserved(true);
    savedSearch_nestedAuthorizations.setUndeletable(true);
    savedSearch_nestedAuthorizations.setMultiLingual(false);
    savedSearch_nestedAuthorizations.setEssentialInSummary(true);
    savedSearch_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder savedSearch_principalAncestorsIntIds = savedSearchSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    savedSearch_principalAncestorsIntIds.setMultivalue(true);
    savedSearch_principalAncestorsIntIds.setSystemReserved(true);
    savedSearch_principalAncestorsIntIds.setUndeletable(true);
    savedSearch_principalAncestorsIntIds.setMultiLingual(false);
    savedSearch_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder savedSearch_principalConceptsIntIds = savedSearchSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    savedSearch_principalConceptsIntIds.setMultivalue(true);
    savedSearch_principalConceptsIntIds.setSystemReserved(true);
    savedSearch_principalConceptsIntIds.setUndeletable(true);
    savedSearch_principalConceptsIntIds.setMultiLingual(false);
    savedSearch_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder savedSearch_secondaryConceptsIntIds = savedSearchSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    savedSearch_secondaryConceptsIntIds.setMultivalue(true);
    savedSearch_secondaryConceptsIntIds.setSystemReserved(true);
    savedSearch_secondaryConceptsIntIds.setUndeletable(true);
    savedSearch_secondaryConceptsIntIds.setMultiLingual(false);
    savedSearch_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder savedSearch_sharedGroups = savedSearchSchema.create("sharedGroups").setType(MetadataValueType.REFERENCE);
    savedSearch_sharedGroups.setMultivalue(true);
    savedSearch_sharedGroups.setUndeletable(true);
    savedSearch_sharedGroups.defineReferencesTo(types.getSchemaType("group"));
    MetadataBuilder savedSearch_sharedUsers = savedSearchSchema.create("sharedUsers").setType(MetadataValueType.REFERENCE);
    savedSearch_sharedUsers.setMultivalue(true);
    savedSearch_sharedUsers.setUndeletable(true);
    savedSearch_sharedUsers.defineReferencesTo(types.getSchemaType("user"));
  ...
  private void createAuthorizationDetailsSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder authorizationDetailsSchemaType, MetadataSchemaBuilder authorizationDetailsSchema) {
    ...
    MetadataBuilder authorizationDetails_attachedPrincipalAncestorsIntIds = authorizationDetailsSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    authorizationDetails_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    authorizationDetails_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    authorizationDetails_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    authorizationDetails_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    authorizationDetails_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder authorizationDetails_detachedPrincipalAncestorsIntIds = authorizationDetailsSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    authorizationDetails_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    authorizationDetails_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    authorizationDetails_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    authorizationDetails_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    authorizationDetails_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder authorizationDetails_nestedAuthorizations = authorizationDetailsSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    authorizationDetails_nestedAuthorizations.setSystemReserved(true);
    authorizationDetails_nestedAuthorizations.setUndeletable(true);
    authorizationDetails_nestedAuthorizations.setMultiLingual(false);
    authorizationDetails_nestedAuthorizations.setEssentialInSummary(true);
    authorizationDetails_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder authorizationDetails_principalAncestorsIntIds = authorizationDetailsSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    authorizationDetails_principalAncestorsIntIds.setMultivalue(true);
    authorizationDetails_principalAncestorsIntIds.setSystemReserved(true);
    authorizationDetails_principalAncestorsIntIds.setUndeletable(true);
    authorizationDetails_principalAncestorsIntIds.setMultiLingual(false);
    authorizationDetails_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder authorizationDetails_principalConceptsIntIds = authorizationDetailsSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    authorizationDetails_principalConceptsIntIds.setMultivalue(true);
    authorizationDetails_principalConceptsIntIds.setSystemReserved(true);
    authorizationDetails_principalConceptsIntIds.setUndeletable(true);
    authorizationDetails_principalConceptsIntIds.setMultiLingual(false);
    authorizationDetails_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder authorizationDetails_secondaryConceptsIntIds = authorizationDetailsSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    authorizationDetails_secondaryConceptsIntIds.setMultivalue(true);
    authorizationDetails_secondaryConceptsIntIds.setSystemReserved(true);
    authorizationDetails_secondaryConceptsIntIds.setUndeletable(true);
    authorizationDetails_secondaryConceptsIntIds.setMultiLingual(false);
    authorizationDetails_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createUserDocumentSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userDocumentSchemaType, MetadataSchemaBuilder userDocumentSchema) {
    ...
    MetadataBuilder userDocument_attachedPrincipalAncestorsIntIds = userDocumentSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userDocument_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    userDocument_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    userDocument_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    userDocument_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    userDocument_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userDocument_detachedPrincipalAncestorsIntIds = userDocumentSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userDocument_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    userDocument_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    userDocument_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    userDocument_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    userDocument_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userDocument_nestedAuthorizations = userDocumentSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    userDocument_nestedAuthorizations.setSystemReserved(true);
    userDocument_nestedAuthorizations.setUndeletable(true);
    userDocument_nestedAuthorizations.setMultiLingual(false);
    userDocument_nestedAuthorizations.setEssentialInSummary(true);
    userDocument_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder userDocument_principalAncestorsIntIds = userDocumentSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userDocument_principalAncestorsIntIds.setMultivalue(true);
    userDocument_principalAncestorsIntIds.setSystemReserved(true);
    userDocument_principalAncestorsIntIds.setUndeletable(true);
    userDocument_principalAncestorsIntIds.setMultiLingual(false);
    userDocument_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder userDocument_principalConceptsIntIds = userDocumentSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    userDocument_principalConceptsIntIds.setMultivalue(true);
    userDocument_principalConceptsIntIds.setSystemReserved(true);
    userDocument_principalConceptsIntIds.setUndeletable(true);
    userDocument_principalConceptsIntIds.setMultiLingual(false);
    userDocument_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userDocument_secondaryConceptsIntIds = userDocumentSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    userDocument_secondaryConceptsIntIds.setMultivalue(true);
    userDocument_secondaryConceptsIntIds.setSystemReserved(true);
    userDocument_secondaryConceptsIntIds.setUndeletable(true);
    userDocument_secondaryConceptsIntIds.setMultiLingual(false);
    userDocument_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    userDocument_user.setCacheIndex(true);
    ...
    userDocument_userFolder.setCacheIndex(true);
  ...
  private void createTaskSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder taskSchemaType, MetadataSchemaBuilder task_approvalSchema, MetadataSchemaBuilder taskSchema) {
    ...
    MetadataBuilder task_attachedPrincipalAncestorsIntIds = taskSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    task_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    task_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    task_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    task_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    task_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder task_detachedPrincipalAncestorsIntIds = taskSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    task_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    task_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    task_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    task_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    task_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder task_nestedAuthorizations = taskSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    task_nestedAuthorizations.setSystemReserved(true);
    task_nestedAuthorizations.setUndeletable(true);
    task_nestedAuthorizations.setMultiLingual(false);
    task_nestedAuthorizations.setEssentialInSummary(true);
    task_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder task_principalAncestorsIntIds = taskSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    task_principalAncestorsIntIds.setMultivalue(true);
    task_principalAncestorsIntIds.setSystemReserved(true);
    task_principalAncestorsIntIds.setUndeletable(true);
    task_principalAncestorsIntIds.setMultiLingual(false);
    task_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder task_principalConceptsIntIds = taskSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    task_principalConceptsIntIds.setMultivalue(true);
    task_principalConceptsIntIds.setSystemReserved(true);
    task_principalConceptsIntIds.setUndeletable(true);
    task_principalConceptsIntIds.setMultiLingual(false);
    task_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder task_secondaryConceptsIntIds = taskSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    task_secondaryConceptsIntIds.setMultivalue(true);
    task_secondaryConceptsIntIds.setSystemReserved(true);
    task_secondaryConceptsIntIds.setUndeletable(true);
    task_secondaryConceptsIntIds.setMultiLingual(false);
    task_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createDdvSourceSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvSourceSchemaType, MetadataSchemaBuilder ddvSourceSchema) {
    MetadataBuilder ddvSource_abbreviation = ddvSourceSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvSource_abbreviation.setUndeletable(true);
    ddvSource_abbreviation.setMultiLingual(true);
    ddvSource_abbreviation.setSearchable(true);
    ddvSource_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvSource_allReferences = ddvSourceSchema.create("allReferences").setType(MetadataValueType.STRING);
    ddvSource_allReferences.setMultivalue(true);
    ddvSource_allReferences.setSystemReserved(true);
    ddvSource_allReferences.setUndeletable(true);
    ddvSource_allReferences.setMultiLingual(false);
    MetadataBuilder ddvSource_allRemovedAuths = ddvSourceSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    ddvSource_allRemovedAuths.setMultivalue(true);
    ddvSource_allRemovedAuths.setSystemReserved(true);
    ddvSource_allRemovedAuths.setUndeletable(true);
    ddvSource_allRemovedAuths.setEssential(true);
    ddvSource_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder ddvSource_attachedAncestors = ddvSourceSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    ddvSource_attachedAncestors.setMultivalue(true);
    ddvSource_attachedAncestors.setSystemReserved(true);
    ddvSource_attachedAncestors.setUndeletable(true);
    ddvSource_attachedAncestors.setEssential(true);
    ddvSource_attachedAncestors.setMultiLingual(false);
    MetadataBuilder ddvSource_attachedPrincipalAncestorsIntIds = ddvSourceSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvSource_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvSource_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvSource_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvSource_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvSource_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvSource_autocomplete = ddvSourceSchema.create("autocomplete").setType(MetadataValueType.STRING);
    ddvSource_autocomplete.setMultivalue(true);
    ddvSource_autocomplete.setSystemReserved(true);
    ddvSource_autocomplete.setUndeletable(true);
    ddvSource_autocomplete.setEssential(true);
    ddvSource_autocomplete.setMultiLingual(true);
    MetadataBuilder ddvSource_caption = ddvSourceSchema.create("caption").setType(MetadataValueType.STRING);
    ddvSource_caption.setSystemReserved(true);
    ddvSource_caption.setUndeletable(true);
    ddvSource_caption.setMultiLingual(false);
    ddvSource_caption.setSortable(true);
    MetadataBuilder ddvSource_code = ddvSourceSchema.create("code").setType(MetadataValueType.STRING);
    ddvSource_code.setDefaultRequirement(true);
    ddvSource_code.setUndeletable(true);
    ddvSource_code.setSchemaAutocomplete(true);
    ddvSource_code.setSearchable(true);
    ddvSource_code.setUniqueValue(true);
    ddvSource_code.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvSource_comments = ddvSourceSchema.create("comments").setType(MetadataValueType.STRUCTURE);
    ddvSource_comments.setMultivalue(true);
    ddvSource_comments.defineStructureFactory(CommentFactory.class);
    MetadataBuilder ddvSource_createdBy = ddvSourceSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    ddvSource_createdBy.setSystemReserved(true);
    ddvSource_createdBy.setUndeletable(true);
    ddvSource_createdBy.setMultiLingual(false);
    ddvSource_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvSource_createdOn = ddvSourceSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    ddvSource_createdOn.setSystemReserved(true);
    ddvSource_createdOn.setUndeletable(true);
    ddvSource_createdOn.setMultiLingual(false);
    ddvSource_createdOn.setSortable(true);
    MetadataBuilder ddvSource_deleted = ddvSourceSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    ddvSource_deleted.setSystemReserved(true);
    ddvSource_deleted.setUndeletable(true);
    ddvSource_deleted.setMultiLingual(false);
    MetadataBuilder ddvSource_denyTokens = ddvSourceSchema.create("denyTokens").setType(MetadataValueType.STRING);
    ddvSource_denyTokens.setMultivalue(true);
    ddvSource_denyTokens.setSystemReserved(true);
    ddvSource_denyTokens.setUndeletable(true);
    ddvSource_denyTokens.setMultiLingual(false);
    ddvSource_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvSource_description = ddvSourceSchema.create("description").setType(MetadataValueType.TEXT);
    ddvSource_description.setUndeletable(true);
    ddvSource_description.setMultiLingual(true);
    ddvSource_description.setSearchable(true);
    MetadataBuilder ddvSource_detachedPrincipalAncestorsIntIds = ddvSourceSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvSource_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvSource_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvSource_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvSource_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvSource_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvSource_detachedauthorizations = ddvSourceSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    ddvSource_detachedauthorizations.setSystemReserved(true);
    ddvSource_detachedauthorizations.setUndeletable(true);
    ddvSource_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvSource_errorOnPhysicalDeletion = ddvSourceSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    ddvSource_errorOnPhysicalDeletion.setSystemReserved(true);
    ddvSource_errorOnPhysicalDeletion.setUndeletable(true);
    ddvSource_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder ddvSource_estimatedSize = ddvSourceSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    ddvSource_estimatedSize.setSystemReserved(true);
    ddvSource_estimatedSize.setUndeletable(true);
    ddvSource_estimatedSize.setMultiLingual(false);
    MetadataBuilder ddvSource_hidden = ddvSourceSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvSource_hidden.setSystemReserved(true);
    ddvSource_hidden.setUndeletable(true);
    ddvSource_hidden.setMultiLingual(false);
    MetadataBuilder ddvSource_id = ddvSourceSchema.create("id").setType(MetadataValueType.STRING);
    ddvSource_id.setDefaultRequirement(true);
    ddvSource_id.setSystemReserved(true);
    ddvSource_id.setUndeletable(true);
    ddvSource_id.setMultiLingual(false);
    ddvSource_id.setSearchable(true);
    ddvSource_id.setSortable(true);
    ddvSource_id.setUniqueValue(true);
    ddvSource_id.setUnmodifiable(true);
    MetadataBuilder ddvSource_legacyIdentifier = ddvSourceSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    ddvSource_legacyIdentifier.setDefaultRequirement(true);
    ddvSource_legacyIdentifier.setSystemReserved(true);
    ddvSource_legacyIdentifier.setUndeletable(true);
    ddvSource_legacyIdentifier.setMultiLingual(false);
    ddvSource_legacyIdentifier.setSearchable(true);
    ddvSource_legacyIdentifier.setUniqueValue(true);
    ddvSource_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder ddvSource_logicallyDeletedOn = ddvSourceSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    ddvSource_logicallyDeletedOn.setSystemReserved(true);
    ddvSource_logicallyDeletedOn.setUndeletable(true);
    ddvSource_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder ddvSource_manualTokens = ddvSourceSchema.create("manualTokens").setType(MetadataValueType.STRING);
    ddvSource_manualTokens.setMultivalue(true);
    ddvSource_manualTokens.setSystemReserved(true);
    ddvSource_manualTokens.setUndeletable(true);
    ddvSource_manualTokens.setMultiLingual(false);
    ddvSource_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvSource_markedForParsing = ddvSourceSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    ddvSource_markedForParsing.setSystemReserved(true);
    ddvSource_markedForParsing.setUndeletable(true);
    ddvSource_markedForParsing.setMultiLingual(false);
    MetadataBuilder ddvSource_markedForPreviewConversion = ddvSourceSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    ddvSource_markedForPreviewConversion.setSystemReserved(true);
    ddvSource_markedForPreviewConversion.setUndeletable(true);
    ddvSource_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder ddvSource_markedForReindexing = ddvSourceSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    ddvSource_markedForReindexing.setSystemReserved(true);
    ddvSource_markedForReindexing.setUndeletable(true);
    ddvSource_markedForReindexing.setMultiLingual(false);
    MetadataBuilder ddvSource_migrationDataVersion = ddvSourceSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    ddvSource_migrationDataVersion.setSystemReserved(true);
    ddvSource_migrationDataVersion.setUndeletable(true);
    ddvSource_migrationDataVersion.setMultiLingual(false);
    ddvSource_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder ddvSource_modifiedBy = ddvSourceSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    ddvSource_modifiedBy.setSystemReserved(true);
    ddvSource_modifiedBy.setUndeletable(true);
    ddvSource_modifiedBy.setMultiLingual(false);
    ddvSource_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvSource_modifiedOn = ddvSourceSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    ddvSource_modifiedOn.setSystemReserved(true);
    ddvSource_modifiedOn.setUndeletable(true);
    ddvSource_modifiedOn.setMultiLingual(false);
    ddvSource_modifiedOn.setSortable(true);
    MetadataBuilder ddvSource_nestedAuthorizations = ddvSourceSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvSource_nestedAuthorizations.setSystemReserved(true);
    ddvSource_nestedAuthorizations.setUndeletable(true);
    ddvSource_nestedAuthorizations.setMultiLingual(false);
    ddvSource_nestedAuthorizations.setEssentialInSummary(true);
    ddvSource_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder ddvSource_path = ddvSourceSchema.create("path").setType(MetadataValueType.STRING);
    ddvSource_path.setMultivalue(true);
    ddvSource_path.setSystemReserved(true);
    ddvSource_path.setUndeletable(true);
    ddvSource_path.setMultiLingual(false);
    MetadataBuilder ddvSource_pathParts = ddvSourceSchema.create("pathParts").setType(MetadataValueType.STRING);
    ddvSource_pathParts.setMultivalue(true);
    ddvSource_pathParts.setSystemReserved(true);
    ddvSource_pathParts.setUndeletable(true);
    ddvSource_pathParts.setMultiLingual(false);
    MetadataBuilder ddvSource_principalAncestorsIntIds = ddvSourceSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvSource_principalAncestorsIntIds.setMultivalue(true);
    ddvSource_principalAncestorsIntIds.setSystemReserved(true);
    ddvSource_principalAncestorsIntIds.setUndeletable(true);
    ddvSource_principalAncestorsIntIds.setMultiLingual(false);
    ddvSource_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvSource_principalConceptsIntIds = ddvSourceSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvSource_principalConceptsIntIds.setMultivalue(true);
    ddvSource_principalConceptsIntIds.setSystemReserved(true);
    ddvSource_principalConceptsIntIds.setUndeletable(true);
    ddvSource_principalConceptsIntIds.setMultiLingual(false);
    ddvSource_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvSource_principalpath = ddvSourceSchema.create("principalpath").setType(MetadataValueType.STRING);
    ddvSource_principalpath.setSystemReserved(true);
    ddvSource_principalpath.setUndeletable(true);
    ddvSource_principalpath.setMultiLingual(false);
    MetadataBuilder ddvSource_removedauthorizations = ddvSourceSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    ddvSource_removedauthorizations.setMultivalue(true);
    ddvSource_removedauthorizations.setSystemReserved(true);
    ddvSource_removedauthorizations.setUndeletable(true);
    ddvSource_removedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvSource_schema = ddvSourceSchema.create("schema").setType(MetadataValueType.STRING);
    ddvSource_schema.setDefaultRequirement(true);
    ddvSource_schema.setSystemReserved(true);
    ddvSource_schema.setUndeletable(true);
    ddvSource_schema.setMultiLingual(false);
    MetadataBuilder ddvSource_secondaryConceptsIntIds = ddvSourceSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvSource_secondaryConceptsIntIds.setMultivalue(true);
    ddvSource_secondaryConceptsIntIds.setSystemReserved(true);
    ddvSource_secondaryConceptsIntIds.setUndeletable(true);
    ddvSource_secondaryConceptsIntIds.setMultiLingual(false);
    ddvSource_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvSource_shareDenyTokens = ddvSourceSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    ddvSource_shareDenyTokens.setMultivalue(true);
    ddvSource_shareDenyTokens.setSystemReserved(true);
    ddvSource_shareDenyTokens.setUndeletable(true);
    ddvSource_shareDenyTokens.setMultiLingual(false);
    ddvSource_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvSource_shareTokens = ddvSourceSchema.create("shareTokens").setType(MetadataValueType.STRING);
    ddvSource_shareTokens.setMultivalue(true);
    ddvSource_shareTokens.setSystemReserved(true);
    ddvSource_shareTokens.setUndeletable(true);
    ddvSource_shareTokens.setMultiLingual(false);
    ddvSource_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvSource_title = ddvSourceSchema.create("title").setType(MetadataValueType.STRING);
    ddvSource_title.setDefaultRequirement(true);
    ddvSource_title.setUndeletable(true);
    ddvSource_title.setMultiLingual(true);
    ddvSource_title.setSchemaAutocomplete(true);
    ddvSource_title.setSearchable(true);
    ddvSource_title.setUniqueValue(true);
    ddvSource_title.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvSource_tokens = ddvSourceSchema.create("tokens").setType(MetadataValueType.STRING);
    ddvSource_tokens.setMultivalue(true);
    ddvSource_tokens.setSystemReserved(true);
    ddvSource_tokens.setUndeletable(true);
    ddvSource_tokens.setMultiLingual(false);
    MetadataBuilder ddvSource_tokensHierarchy = ddvSourceSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    ddvSource_tokensHierarchy.setMultivalue(true);
    ddvSource_tokensHierarchy.setSystemReserved(true);
    ddvSource_tokensHierarchy.setUndeletable(true);
    ddvSource_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder ddvSource_visibleInTrees = ddvSourceSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    ddvSource_visibleInTrees.setSystemReserved(true);
    ddvSource_visibleInTrees.setUndeletable(true);
    ddvSource_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createUserFolderSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userFolderSchemaType, MetadataSchemaBuilder userFolderSchema) {
    ...
    MetadataBuilder userFolder_attachedPrincipalAncestorsIntIds = userFolderSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userFolder_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    userFolder_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    userFolder_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    userFolder_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    userFolder_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userFolder_detachedPrincipalAncestorsIntIds = userFolderSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userFolder_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    userFolder_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    userFolder_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    userFolder_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    userFolder_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userFolder_nestedAuthorizations = userFolderSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    userFolder_nestedAuthorizations.setSystemReserved(true);
    userFolder_nestedAuthorizations.setUndeletable(true);
    userFolder_nestedAuthorizations.setMultiLingual(false);
    userFolder_nestedAuthorizations.setEssentialInSummary(true);
    userFolder_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder userFolder_principalAncestorsIntIds = userFolderSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    userFolder_principalAncestorsIntIds.setMultivalue(true);
    userFolder_principalAncestorsIntIds.setSystemReserved(true);
    userFolder_principalAncestorsIntIds.setUndeletable(true);
    userFolder_principalAncestorsIntIds.setMultiLingual(false);
    userFolder_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder userFolder_principalConceptsIntIds = userFolderSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    userFolder_principalConceptsIntIds.setMultivalue(true);
    userFolder_principalConceptsIntIds.setSystemReserved(true);
    userFolder_principalConceptsIntIds.setUndeletable(true);
    userFolder_principalConceptsIntIds.setMultiLingual(false);
    userFolder_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder userFolder_secondaryConceptsIntIds = userFolderSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    userFolder_secondaryConceptsIntIds.setMultivalue(true);
    userFolder_secondaryConceptsIntIds.setSystemReserved(true);
    userFolder_secondaryConceptsIntIds.setUndeletable(true);
    userFolder_secondaryConceptsIntIds.setMultiLingual(false);
    userFolder_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    userFolder_user.setCacheIndex(true);
  ...
  private void createDdvCapsuleLanguageSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder ddvCapsuleLanguageSchemaType, MetadataSchemaBuilder ddvCapsuleLanguageSchema) {
    MetadataBuilder ddvCapsuleLanguage_abbreviation = ddvCapsuleLanguageSchema.create("abbreviation").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_abbreviation.setUndeletable(true);
    ddvCapsuleLanguage_abbreviation.setMultiLingual(true);
    ddvCapsuleLanguage_abbreviation.setSearchable(true);
    ddvCapsuleLanguage_abbreviation.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvCapsuleLanguage_allReferences = ddvCapsuleLanguageSchema.create("allReferences").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_allReferences.setMultivalue(true);
    ddvCapsuleLanguage_allReferences.setSystemReserved(true);
    ddvCapsuleLanguage_allReferences.setUndeletable(true);
    ddvCapsuleLanguage_allReferences.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_allRemovedAuths = ddvCapsuleLanguageSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_allRemovedAuths.setMultivalue(true);
    ddvCapsuleLanguage_allRemovedAuths.setSystemReserved(true);
    ddvCapsuleLanguage_allRemovedAuths.setUndeletable(true);
    ddvCapsuleLanguage_allRemovedAuths.setEssential(true);
    ddvCapsuleLanguage_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_attachedAncestors = ddvCapsuleLanguageSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_attachedAncestors.setMultivalue(true);
    ddvCapsuleLanguage_attachedAncestors.setSystemReserved(true);
    ddvCapsuleLanguage_attachedAncestors.setUndeletable(true);
    ddvCapsuleLanguage_attachedAncestors.setEssential(true);
    ddvCapsuleLanguage_attachedAncestors.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds = ddvCapsuleLanguageSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvCapsuleLanguage_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_autocomplete = ddvCapsuleLanguageSchema.create("autocomplete").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_autocomplete.setMultivalue(true);
    ddvCapsuleLanguage_autocomplete.setSystemReserved(true);
    ddvCapsuleLanguage_autocomplete.setUndeletable(true);
    ddvCapsuleLanguage_autocomplete.setEssential(true);
    ddvCapsuleLanguage_autocomplete.setMultiLingual(true);
    MetadataBuilder ddvCapsuleLanguage_caption = ddvCapsuleLanguageSchema.create("caption").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_caption.setSystemReserved(true);
    ddvCapsuleLanguage_caption.setUndeletable(true);
    ddvCapsuleLanguage_caption.setMultiLingual(false);
    ddvCapsuleLanguage_caption.setSortable(true);
    MetadataBuilder ddvCapsuleLanguage_code = ddvCapsuleLanguageSchema.create("code").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_code.setDefaultRequirement(true);
    ddvCapsuleLanguage_code.setUndeletable(true);
    ...
    ddvCapsuleLanguage_code.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvCapsuleLanguage_comments = ddvCapsuleLanguageSchema.create("comments").setType(MetadataValueType.STRUCTURE);
    ...
    ddvCapsuleLanguage_createdBy.setSystemReserved(true);
    ddvCapsuleLanguage_createdBy.setUndeletable(true);
    ddvCapsuleLanguage_createdBy.setMultiLingual(false);
    ddvCapsuleLanguage_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvCapsuleLanguage_createdOn = ddvCapsuleLanguageSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    ddvCapsuleLanguage_createdOn.setSystemReserved(true);
    ddvCapsuleLanguage_createdOn.setUndeletable(true);
    ddvCapsuleLanguage_createdOn.setMultiLingual(false);
    ddvCapsuleLanguage_createdOn.setSortable(true);
    MetadataBuilder ddvCapsuleLanguage_deleted = ddvCapsuleLanguageSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_deleted.setSystemReserved(true);
    ddvCapsuleLanguage_deleted.setUndeletable(true);
    ddvCapsuleLanguage_deleted.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_denyTokens = ddvCapsuleLanguageSchema.create("denyTokens").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_denyTokens.setMultivalue(true);
    ddvCapsuleLanguage_denyTokens.setSystemReserved(true);
    ddvCapsuleLanguage_denyTokens.setUndeletable(true);
    ddvCapsuleLanguage_denyTokens.setMultiLingual(false);
    ddvCapsuleLanguage_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvCapsuleLanguage_description = ddvCapsuleLanguageSchema.create("description").setType(MetadataValueType.TEXT);
    ddvCapsuleLanguage_description.setUndeletable(true);
    ddvCapsuleLanguage_description.setMultiLingual(true);
    ddvCapsuleLanguage_description.setSearchable(true);
    MetadataBuilder ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds = ddvCapsuleLanguageSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    ddvCapsuleLanguage_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_detachedauthorizations = ddvCapsuleLanguageSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_detachedauthorizations.setSystemReserved(true);
    ddvCapsuleLanguage_detachedauthorizations.setUndeletable(true);
    ddvCapsuleLanguage_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_errorOnPhysicalDeletion = ddvCapsuleLanguageSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_errorOnPhysicalDeletion.setSystemReserved(true);
    ddvCapsuleLanguage_errorOnPhysicalDeletion.setUndeletable(true);
    ddvCapsuleLanguage_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_estimatedSize = ddvCapsuleLanguageSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_estimatedSize.setSystemReserved(true);
    ddvCapsuleLanguage_estimatedSize.setUndeletable(true);
    ddvCapsuleLanguage_estimatedSize.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_hidden = ddvCapsuleLanguageSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_hidden.setSystemReserved(true);
    ddvCapsuleLanguage_hidden.setUndeletable(true);
    ddvCapsuleLanguage_hidden.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_id = ddvCapsuleLanguageSchema.create("id").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_id.setDefaultRequirement(true);
    ddvCapsuleLanguage_id.setSystemReserved(true);
    ddvCapsuleLanguage_id.setUndeletable(true);
    ddvCapsuleLanguage_id.setMultiLingual(false);
    ddvCapsuleLanguage_id.setSearchable(true);
    ddvCapsuleLanguage_id.setSortable(true);
    ddvCapsuleLanguage_id.setUniqueValue(true);
    ddvCapsuleLanguage_id.setUnmodifiable(true);
    MetadataBuilder ddvCapsuleLanguage_legacyIdentifier = ddvCapsuleLanguageSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_legacyIdentifier.setDefaultRequirement(true);
    ddvCapsuleLanguage_legacyIdentifier.setSystemReserved(true);
    ddvCapsuleLanguage_legacyIdentifier.setUndeletable(true);
    ddvCapsuleLanguage_legacyIdentifier.setMultiLingual(false);
    ddvCapsuleLanguage_legacyIdentifier.setSearchable(true);
    ddvCapsuleLanguage_legacyIdentifier.setUniqueValue(true);
    ddvCapsuleLanguage_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder ddvCapsuleLanguage_logicallyDeletedOn = ddvCapsuleLanguageSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    ddvCapsuleLanguage_logicallyDeletedOn.setSystemReserved(true);
    ddvCapsuleLanguage_logicallyDeletedOn.setUndeletable(true);
    ddvCapsuleLanguage_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_manualTokens = ddvCapsuleLanguageSchema.create("manualTokens").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_manualTokens.setMultivalue(true);
    ddvCapsuleLanguage_manualTokens.setSystemReserved(true);
    ddvCapsuleLanguage_manualTokens.setUndeletable(true);
    ddvCapsuleLanguage_manualTokens.setMultiLingual(false);
    ddvCapsuleLanguage_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvCapsuleLanguage_markedForParsing = ddvCapsuleLanguageSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_markedForParsing.setSystemReserved(true);
    ddvCapsuleLanguage_markedForParsing.setUndeletable(true);
    ddvCapsuleLanguage_markedForParsing.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_markedForPreviewConversion = ddvCapsuleLanguageSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_markedForPreviewConversion.setSystemReserved(true);
    ddvCapsuleLanguage_markedForPreviewConversion.setUndeletable(true);
    ddvCapsuleLanguage_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_markedForReindexing = ddvCapsuleLanguageSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_markedForReindexing.setSystemReserved(true);
    ddvCapsuleLanguage_markedForReindexing.setUndeletable(true);
    ddvCapsuleLanguage_markedForReindexing.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_migrationDataVersion = ddvCapsuleLanguageSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    ddvCapsuleLanguage_migrationDataVersion.setSystemReserved(true);
    ddvCapsuleLanguage_migrationDataVersion.setUndeletable(true);
    ddvCapsuleLanguage_migrationDataVersion.setMultiLingual(false);
    ddvCapsuleLanguage_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_modifiedBy = ddvCapsuleLanguageSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    ddvCapsuleLanguage_modifiedBy.setSystemReserved(true);
    ddvCapsuleLanguage_modifiedBy.setUndeletable(true);
    ddvCapsuleLanguage_modifiedBy.setMultiLingual(false);
    ddvCapsuleLanguage_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder ddvCapsuleLanguage_modifiedOn = ddvCapsuleLanguageSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    ddvCapsuleLanguage_modifiedOn.setSystemReserved(true);
    ddvCapsuleLanguage_modifiedOn.setUndeletable(true);
    ddvCapsuleLanguage_modifiedOn.setMultiLingual(false);
    ddvCapsuleLanguage_modifiedOn.setSortable(true);
    MetadataBuilder ddvCapsuleLanguage_nestedAuthorizations = ddvCapsuleLanguageSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    ddvCapsuleLanguage_nestedAuthorizations.setSystemReserved(true);
    ddvCapsuleLanguage_nestedAuthorizations.setUndeletable(true);
    ddvCapsuleLanguage_nestedAuthorizations.setMultiLingual(false);
    ddvCapsuleLanguage_nestedAuthorizations.setEssentialInSummary(true);
    ddvCapsuleLanguage_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder ddvCapsuleLanguage_path = ddvCapsuleLanguageSchema.create("path").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_path.setMultivalue(true);
    ddvCapsuleLanguage_path.setSystemReserved(true);
    ddvCapsuleLanguage_path.setUndeletable(true);
    ddvCapsuleLanguage_path.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_pathParts = ddvCapsuleLanguageSchema.create("pathParts").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_pathParts.setMultivalue(true);
    ddvCapsuleLanguage_pathParts.setSystemReserved(true);
    ddvCapsuleLanguage_pathParts.setUndeletable(true);
    ddvCapsuleLanguage_pathParts.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_principalAncestorsIntIds = ddvCapsuleLanguageSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_principalAncestorsIntIds.setMultivalue(true);
    ddvCapsuleLanguage_principalAncestorsIntIds.setSystemReserved(true);
    ddvCapsuleLanguage_principalAncestorsIntIds.setUndeletable(true);
    ddvCapsuleLanguage_principalAncestorsIntIds.setMultiLingual(false);
    ddvCapsuleLanguage_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_principalConceptsIntIds = ddvCapsuleLanguageSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_principalConceptsIntIds.setMultivalue(true);
    ddvCapsuleLanguage_principalConceptsIntIds.setSystemReserved(true);
    ddvCapsuleLanguage_principalConceptsIntIds.setUndeletable(true);
    ddvCapsuleLanguage_principalConceptsIntIds.setMultiLingual(false);
    ddvCapsuleLanguage_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_principalpath = ddvCapsuleLanguageSchema.create("principalpath").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_principalpath.setSystemReserved(true);
    ddvCapsuleLanguage_principalpath.setUndeletable(true);
    ddvCapsuleLanguage_principalpath.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_removedauthorizations = ddvCapsuleLanguageSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_removedauthorizations.setMultivalue(true);
    ddvCapsuleLanguage_removedauthorizations.setSystemReserved(true);
    ddvCapsuleLanguage_removedauthorizations.setUndeletable(true);
    ddvCapsuleLanguage_removedauthorizations.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_schema = ddvCapsuleLanguageSchema.create("schema").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_schema.setDefaultRequirement(true);
    ddvCapsuleLanguage_schema.setSystemReserved(true);
    ddvCapsuleLanguage_schema.setUndeletable(true);
    ddvCapsuleLanguage_schema.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_secondaryConceptsIntIds = ddvCapsuleLanguageSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    ddvCapsuleLanguage_secondaryConceptsIntIds.setMultivalue(true);
    ddvCapsuleLanguage_secondaryConceptsIntIds.setSystemReserved(true);
    ddvCapsuleLanguage_secondaryConceptsIntIds.setUndeletable(true);
    ddvCapsuleLanguage_secondaryConceptsIntIds.setMultiLingual(false);
    ddvCapsuleLanguage_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder ddvCapsuleLanguage_shareDenyTokens = ddvCapsuleLanguageSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_shareDenyTokens.setMultivalue(true);
    ddvCapsuleLanguage_shareDenyTokens.setSystemReserved(true);
    ddvCapsuleLanguage_shareDenyTokens.setUndeletable(true);
    ddvCapsuleLanguage_shareDenyTokens.setMultiLingual(false);
    ddvCapsuleLanguage_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvCapsuleLanguage_shareTokens = ddvCapsuleLanguageSchema.create("shareTokens").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_shareTokens.setMultivalue(true);
    ddvCapsuleLanguage_shareTokens.setSystemReserved(true);
    ddvCapsuleLanguage_shareTokens.setUndeletable(true);
    ddvCapsuleLanguage_shareTokens.setMultiLingual(false);
    ddvCapsuleLanguage_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder ddvCapsuleLanguage_title = ddvCapsuleLanguageSchema.create("title").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_title.setDefaultRequirement(true);
    ddvCapsuleLanguage_title.setUndeletable(true);
    ddvCapsuleLanguage_title.setMultiLingual(true);
    ddvCapsuleLanguage_title.setSchemaAutocomplete(true);
    ddvCapsuleLanguage_title.setSearchable(true);
    ddvCapsuleLanguage_title.setUniqueValue(true);
    ddvCapsuleLanguage_title.defineValidators().add(IllegalCharactersValidator.class);
    MetadataBuilder ddvCapsuleLanguage_tokens = ddvCapsuleLanguageSchema.create("tokens").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_tokens.setMultivalue(true);
    ddvCapsuleLanguage_tokens.setSystemReserved(true);
    ddvCapsuleLanguage_tokens.setUndeletable(true);
    ddvCapsuleLanguage_tokens.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_tokensHierarchy = ddvCapsuleLanguageSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    ddvCapsuleLanguage_tokensHierarchy.setMultivalue(true);
    ddvCapsuleLanguage_tokensHierarchy.setSystemReserved(true);
    ddvCapsuleLanguage_tokensHierarchy.setUndeletable(true);
    ddvCapsuleLanguage_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder ddvCapsuleLanguage_visibleInTrees = ddvCapsuleLanguageSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    ddvCapsuleLanguage_visibleInTrees.setSystemReserved(true);
    ddvCapsuleLanguage_visibleInTrees.setUndeletable(true);
    ddvCapsuleLanguage_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createReportSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder reportSchemaType, MetadataSchemaBuilder reportSchema) {
    ...
    MetadataBuilder report_attachedPrincipalAncestorsIntIds = reportSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    report_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    report_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    report_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    report_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    report_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder report_detachedPrincipalAncestorsIntIds = reportSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    report_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    report_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    report_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    report_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    report_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder report_nestedAuthorizations = reportSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    report_nestedAuthorizations.setSystemReserved(true);
    report_nestedAuthorizations.setUndeletable(true);
    report_nestedAuthorizations.setMultiLingual(false);
    report_nestedAuthorizations.setEssentialInSummary(true);
    report_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder report_principalAncestorsIntIds = reportSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    report_principalAncestorsIntIds.setMultivalue(true);
    report_principalAncestorsIntIds.setSystemReserved(true);
    report_principalAncestorsIntIds.setUndeletable(true);
    report_principalAncestorsIntIds.setMultiLingual(false);
    report_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder report_principalConceptsIntIds = reportSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    report_principalConceptsIntIds.setMultivalue(true);
    report_principalConceptsIntIds.setSystemReserved(true);
    report_principalConceptsIntIds.setUndeletable(true);
    report_principalConceptsIntIds.setMultiLingual(false);
    report_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder report_secondaryConceptsIntIds = reportSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    report_secondaryConceptsIntIds.setMultivalue(true);
    report_secondaryConceptsIntIds.setSystemReserved(true);
    report_secondaryConceptsIntIds.setUndeletable(true);
    report_secondaryConceptsIntIds.setMultiLingual(false);
    report_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createEmailToSendSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder emailToSendSchemaType, MetadataSchemaBuilder emailToSendSchema) {
    ...
    MetadataBuilder emailToSend_attachedPrincipalAncestorsIntIds = emailToSendSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    emailToSend_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    emailToSend_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    emailToSend_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    emailToSend_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    emailToSend_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder emailToSend_detachedPrincipalAncestorsIntIds = emailToSendSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    emailToSend_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    emailToSend_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    emailToSend_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    emailToSend_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    emailToSend_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder emailToSend_nestedAuthorizations = emailToSendSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    emailToSend_nestedAuthorizations.setSystemReserved(true);
    emailToSend_nestedAuthorizations.setUndeletable(true);
    emailToSend_nestedAuthorizations.setMultiLingual(false);
    emailToSend_nestedAuthorizations.setEssentialInSummary(true);
    emailToSend_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder emailToSend_principalAncestorsIntIds = emailToSendSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    emailToSend_principalAncestorsIntIds.setMultivalue(true);
    emailToSend_principalAncestorsIntIds.setSystemReserved(true);
    emailToSend_principalAncestorsIntIds.setUndeletable(true);
    emailToSend_principalAncestorsIntIds.setMultiLingual(false);
    emailToSend_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder emailToSend_principalConceptsIntIds = emailToSendSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    emailToSend_principalConceptsIntIds.setMultivalue(true);
    emailToSend_principalConceptsIntIds.setSystemReserved(true);
    emailToSend_principalConceptsIntIds.setUndeletable(true);
    emailToSend_principalConceptsIntIds.setMultiLingual(false);
    emailToSend_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder emailToSend_secondaryConceptsIntIds = emailToSendSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    emailToSend_secondaryConceptsIntIds.setMultivalue(true);
    emailToSend_secondaryConceptsIntIds.setSystemReserved(true);
    emailToSend_secondaryConceptsIntIds.setUndeletable(true);
    emailToSend_secondaryConceptsIntIds.setMultiLingual(false);
    emailToSend_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createEventSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder eventSchemaType, MetadataSchemaBuilder eventSchema) {
    ...
    MetadataBuilder event_attachedPrincipalAncestorsIntIds = eventSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    event_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    event_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    event_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    event_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    event_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder event_detachedPrincipalAncestorsIntIds = eventSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    event_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    event_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    event_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    event_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    event_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder event_nestedAuthorizations = eventSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    event_nestedAuthorizations.setSystemReserved(true);
    event_nestedAuthorizations.setUndeletable(true);
    event_nestedAuthorizations.setMultiLingual(false);
    event_nestedAuthorizations.setEssentialInSummary(true);
    event_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder event_principalAncestorsIntIds = eventSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    event_principalAncestorsIntIds.setMultivalue(true);
    event_principalAncestorsIntIds.setSystemReserved(true);
    event_principalAncestorsIntIds.setUndeletable(true);
    event_principalAncestorsIntIds.setMultiLingual(false);
    event_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder event_principalConceptsIntIds = eventSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    event_principalConceptsIntIds.setMultivalue(true);
    event_principalConceptsIntIds.setSystemReserved(true);
    event_principalConceptsIntIds.setUndeletable(true);
    event_principalConceptsIntIds.setMultiLingual(false);
    event_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder event_secondaryConceptsIntIds = eventSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    event_secondaryConceptsIntIds.setMultivalue(true);
    event_secondaryConceptsIntIds.setSystemReserved(true);
    event_secondaryConceptsIntIds.setUndeletable(true);
    event_secondaryConceptsIntIds.setMultiLingual(false);
    event_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createSearchEventSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder searchEventSchemaType, MetadataSchemaBuilder searchEventSchema) {
    ...
    MetadataBuilder searchEvent_attachedPrincipalAncestorsIntIds = searchEventSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    searchEvent_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    searchEvent_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    searchEvent_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    searchEvent_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    searchEvent_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder searchEvent_detachedPrincipalAncestorsIntIds = searchEventSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    searchEvent_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    searchEvent_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    searchEvent_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    searchEvent_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    searchEvent_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder searchEvent_nestedAuthorizations = searchEventSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    searchEvent_nestedAuthorizations.setSystemReserved(true);
    searchEvent_nestedAuthorizations.setUndeletable(true);
    searchEvent_nestedAuthorizations.setMultiLingual(false);
    searchEvent_nestedAuthorizations.setEssentialInSummary(true);
    searchEvent_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder searchEvent_principalAncestorsIntIds = searchEventSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    searchEvent_principalAncestorsIntIds.setMultivalue(true);
    searchEvent_principalAncestorsIntIds.setSystemReserved(true);
    searchEvent_principalAncestorsIntIds.setUndeletable(true);
    searchEvent_principalAncestorsIntIds.setMultiLingual(false);
    searchEvent_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder searchEvent_principalConceptsIntIds = searchEventSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    searchEvent_principalConceptsIntIds.setMultivalue(true);
    searchEvent_principalConceptsIntIds.setSystemReserved(true);
    searchEvent_principalConceptsIntIds.setUndeletable(true);
    searchEvent_principalConceptsIntIds.setMultiLingual(false);
    searchEvent_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder searchEvent_secondaryConceptsIntIds = searchEventSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    searchEvent_secondaryConceptsIntIds.setMultivalue(true);
    searchEvent_secondaryConceptsIntIds.setSystemReserved(true);
    searchEvent_secondaryConceptsIntIds.setUndeletable(true);
    searchEvent_secondaryConceptsIntIds.setMultiLingual(false);
    searchEvent_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createTemporaryRecordSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder temporaryRecordSchemaType, MetadataSchemaBuilder temporaryRecord_batchProcessReportSchema, MetadataSchemaBuilder temporaryRecord_exportAuditSchema, MetadataSchemaBuilder temporaryRecord_importAuditSchema, MetadataSchemaBuilder temporaryRecord_scriptReportSchema, MetadataSchemaBuilder temporaryRecord_vaultScanReportSchema, MetadataSchemaBuilder temporaryRecordSchema) {
    ...
    MetadataBuilder temporaryRecord_vaultScanReport_message = temporaryRecord_vaultScanReportSchema.create("message").setType(MetadataValueType.TEXT);
    temporaryRecord_vaultScanReport_message.setSystemReserved(true);
    temporaryRecord_vaultScanReport_message.setUndeletable(true);
    MetadataBuilder temporaryRecord_vaultScanReport_numberOfDeletedContents = temporaryRecord_vaultScanReportSchema.create("numberOfDeletedContents").setType(MetadataValueType.NUMBER);
    temporaryRecord_vaultScanReport_numberOfDeletedContents.setSystemReserved(true);
    temporaryRecord_vaultScanReport_numberOfDeletedContents.setUndeletable(true);
    ...
    MetadataBuilder temporaryRecord_attachedPrincipalAncestorsIntIds = temporaryRecordSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    temporaryRecord_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    temporaryRecord_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    temporaryRecord_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    temporaryRecord_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    temporaryRecord_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder temporaryRecord_detachedPrincipalAncestorsIntIds = temporaryRecordSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    temporaryRecord_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    temporaryRecord_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    temporaryRecord_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    temporaryRecord_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    temporaryRecord_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder temporaryRecord_nestedAuthorizations = temporaryRecordSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    temporaryRecord_nestedAuthorizations.setSystemReserved(true);
    temporaryRecord_nestedAuthorizations.setUndeletable(true);
    temporaryRecord_nestedAuthorizations.setMultiLingual(false);
    temporaryRecord_nestedAuthorizations.setEssentialInSummary(true);
    temporaryRecord_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder temporaryRecord_principalAncestorsIntIds = temporaryRecordSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    temporaryRecord_principalAncestorsIntIds.setMultivalue(true);
    temporaryRecord_principalAncestorsIntIds.setSystemReserved(true);
    temporaryRecord_principalAncestorsIntIds.setUndeletable(true);
    temporaryRecord_principalAncestorsIntIds.setMultiLingual(false);
    temporaryRecord_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder temporaryRecord_principalConceptsIntIds = temporaryRecordSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    temporaryRecord_principalConceptsIntIds.setMultivalue(true);
    temporaryRecord_principalConceptsIntIds.setSystemReserved(true);
    temporaryRecord_principalConceptsIntIds.setUndeletable(true);
    temporaryRecord_principalConceptsIntIds.setMultiLingual(false);
    temporaryRecord_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder temporaryRecord_secondaryConceptsIntIds = temporaryRecordSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    temporaryRecord_secondaryConceptsIntIds.setMultivalue(true);
    temporaryRecord_secondaryConceptsIntIds.setSystemReserved(true);
    temporaryRecord_secondaryConceptsIntIds.setUndeletable(true);
    temporaryRecord_secondaryConceptsIntIds.setMultiLingual(false);
    temporaryRecord_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createUserSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder userSchemaType, MetadataSchemaBuilder userSchema) {
    ...
    MetadataBuilder user_attachedPrincipalAncestorsIntIds = userSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    user_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    user_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    user_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    user_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    user_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder user_azureuser = userSchema.create("azureuser").setType(MetadataValueType.STRING);
    user_azureuser.setUniqueValue(true);
    ...
    MetadataBuilder user_detachedPrincipalAncestorsIntIds = userSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    user_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    user_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    user_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    user_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    user_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder user_domain = userSchema.create("domain").setType(MetadataValueType.STRING);
    user_domain.setUndeletable(true);
    user_domain.setDefaultValue("");
    MetadataBuilder user_email = userSchema.create("email").setType(MetadataValueType.STRING);
    user_email.setUndeletable(true);
    user_email.setSearchable(true);
    ...
    MetadataBuilder user_msExchangeDelegateList = userSchema.create("msExchangeDelegateList").setType(MetadataValueType.STRING);
    user_msExchangeDelegateList.setMultivalue(true);
    user_msExchangeDelegateList.setUndeletable(true);
    MetadataBuilder user_nestedAuthorizations = userSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    user_nestedAuthorizations.setSystemReserved(true);
    user_nestedAuthorizations.setUndeletable(true);
    user_nestedAuthorizations.setMultiLingual(false);
    user_nestedAuthorizations.setEssentialInSummary(true);
    user_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder user_principalAncestorsIntIds = userSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    user_principalAncestorsIntIds.setMultivalue(true);
    user_principalAncestorsIntIds.setSystemReserved(true);
    user_principalAncestorsIntIds.setUndeletable(true);
    user_principalAncestorsIntIds.setMultiLingual(false);
    user_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder user_principalConceptsIntIds = userSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    user_principalConceptsIntIds.setMultivalue(true);
    user_principalConceptsIntIds.setSystemReserved(true);
    user_principalConceptsIntIds.setUndeletable(true);
    user_principalConceptsIntIds.setMultiLingual(false);
    user_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder user_secondaryConceptsIntIds = userSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    user_secondaryConceptsIntIds.setMultivalue(true);
    user_secondaryConceptsIntIds.setSystemReserved(true);
    user_secondaryConceptsIntIds.setUndeletable(true);
    user_secondaryConceptsIntIds.setMultiLingual(false);
    user_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    user_username.setSchemaAutocomplete(true);
    user_username.setSearchable(true);
  ...
  private void createFacetSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder facetSchemaType, MetadataSchemaBuilder facet_fieldSchema, MetadataSchemaBuilder facet_querySchema, MetadataSchemaBuilder facetSchema) {
    ...
    MetadataBuilder facet_attachedPrincipalAncestorsIntIds = facetSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    facet_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    facet_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    facet_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    facet_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    facet_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder facet_detachedPrincipalAncestorsIntIds = facetSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    facet_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    facet_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    facet_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    facet_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    facet_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder facet_nestedAuthorizations = facetSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    facet_nestedAuthorizations.setSystemReserved(true);
    facet_nestedAuthorizations.setUndeletable(true);
    facet_nestedAuthorizations.setMultiLingual(false);
    facet_nestedAuthorizations.setEssentialInSummary(true);
    facet_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder facet_principalAncestorsIntIds = facetSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    facet_principalAncestorsIntIds.setMultivalue(true);
    facet_principalAncestorsIntIds.setSystemReserved(true);
    facet_principalAncestorsIntIds.setUndeletable(true);
    facet_principalAncestorsIntIds.setMultiLingual(false);
    facet_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder facet_principalConceptsIntIds = facetSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    facet_principalConceptsIntIds.setMultivalue(true);
    facet_principalConceptsIntIds.setSystemReserved(true);
    facet_principalConceptsIntIds.setUndeletable(true);
    facet_principalConceptsIntIds.setMultiLingual(false);
    facet_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder facet_secondaryConceptsIntIds = facetSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    facet_secondaryConceptsIntIds.setMultivalue(true);
    facet_secondaryConceptsIntIds.setSystemReserved(true);
    facet_secondaryConceptsIntIds.setUndeletable(true);
    facet_secondaryConceptsIntIds.setMultiLingual(false);
    facet_secondaryConceptsIntIds.setEssentialInSummary(true);
  ...
  private void createConversationSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder conversationSchemaType, MetadataSchemaBuilder conversationSchema) {
    MetadataBuilder conversation_allReferences = conversationSchema.create("allReferences").setType(MetadataValueType.STRING);
    conversation_allReferences.setMultivalue(true);
    conversation_allReferences.setSystemReserved(true);
    conversation_allReferences.setUndeletable(true);
    conversation_allReferences.setMultiLingual(false);
    MetadataBuilder conversation_allRemovedAuths = conversationSchema.create("allRemovedAuths").setType(MetadataValueType.STRING);
    conversation_allRemovedAuths.setMultivalue(true);
    conversation_allRemovedAuths.setSystemReserved(true);
    conversation_allRemovedAuths.setUndeletable(true);
    conversation_allRemovedAuths.setEssential(true);
    conversation_allRemovedAuths.setMultiLingual(false);
    MetadataBuilder conversation_attachedAncestors = conversationSchema.create("attachedAncestors").setType(MetadataValueType.STRING);
    conversation_attachedAncestors.setMultivalue(true);
    conversation_attachedAncestors.setSystemReserved(true);
    conversation_attachedAncestors.setUndeletable(true);
    conversation_attachedAncestors.setEssential(true);
    conversation_attachedAncestors.setMultiLingual(false);
    MetadataBuilder conversation_attachedPrincipalAncestorsIntIds = conversationSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    conversation_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    conversation_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    conversation_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    conversation_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    conversation_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder conversation_autocomplete = conversationSchema.create("autocomplete").setType(MetadataValueType.STRING);
    conversation_autocomplete.setMultivalue(true);
    conversation_autocomplete.setSystemReserved(true);
    conversation_autocomplete.setUndeletable(true);
    conversation_autocomplete.setEssential(true);
    conversation_autocomplete.setMultiLingual(true);
    MetadataBuilder conversation_caption = conversationSchema.create("caption").setType(MetadataValueType.STRING);
    conversation_caption.setSystemReserved(true);
    conversation_caption.setUndeletable(true);
    conversation_caption.setMultiLingual(false);
    conversation_caption.setSortable(true);
    MetadataBuilder conversation_createdBy = conversationSchema.create("createdBy").setType(MetadataValueType.REFERENCE);
    conversation_createdBy.setSystemReserved(true);
    conversation_createdBy.setUndeletable(true);
    conversation_createdBy.setMultiLingual(false);
    conversation_createdBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder conversation_createdOn = conversationSchema.create("createdOn").setType(MetadataValueType.DATE_TIME);
    conversation_createdOn.setSystemReserved(true);
    conversation_createdOn.setUndeletable(true);
    conversation_createdOn.setMultiLingual(false);
    conversation_createdOn.setSortable(true);
    MetadataBuilder conversation_deleted = conversationSchema.create("deleted").setType(MetadataValueType.BOOLEAN);
    conversation_deleted.setSystemReserved(true);
    conversation_deleted.setUndeletable(true);
    conversation_deleted.setMultiLingual(false);
    MetadataBuilder conversation_denyTokens = conversationSchema.create("denyTokens").setType(MetadataValueType.STRING);
    conversation_denyTokens.setMultivalue(true);
    conversation_denyTokens.setSystemReserved(true);
    conversation_denyTokens.setUndeletable(true);
    conversation_denyTokens.setMultiLingual(false);
    conversation_denyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder conversation_detachedPrincipalAncestorsIntIds = conversationSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    conversation_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    conversation_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    conversation_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    conversation_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    conversation_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder conversation_detachedauthorizations = conversationSchema.create("detachedauthorizations").setType(MetadataValueType.BOOLEAN);
    conversation_detachedauthorizations.setSystemReserved(true);
    conversation_detachedauthorizations.setUndeletable(true);
    conversation_detachedauthorizations.setMultiLingual(false);
    MetadataBuilder conversation_errorOnPhysicalDeletion = conversationSchema.create("errorOnPhysicalDeletion").setType(MetadataValueType.BOOLEAN);
    conversation_errorOnPhysicalDeletion.setSystemReserved(true);
    conversation_errorOnPhysicalDeletion.setUndeletable(true);
    conversation_errorOnPhysicalDeletion.setMultiLingual(false);
    MetadataBuilder conversation_estimatedSize = conversationSchema.create("estimatedSize").setType(MetadataValueType.INTEGER);
    conversation_estimatedSize.setSystemReserved(true);
    conversation_estimatedSize.setUndeletable(true);
    conversation_estimatedSize.setMultiLingual(false);
    MetadataBuilder conversation_hidden = conversationSchema.create("hidden").setType(MetadataValueType.BOOLEAN);
    conversation_hidden.setSystemReserved(true);
    conversation_hidden.setUndeletable(true);
    conversation_hidden.setMultiLingual(false);
    MetadataBuilder conversation_id = conversationSchema.create("id").setType(MetadataValueType.STRING);
    conversation_id.setDefaultRequirement(true);
    conversation_id.setSystemReserved(true);
    conversation_id.setUndeletable(true);
    conversation_id.setMultiLingual(false);
    conversation_id.setSearchable(true);
    conversation_id.setSortable(true);
    conversation_id.setUniqueValue(true);
    conversation_id.setUnmodifiable(true);
    MetadataBuilder conversation_legacyIdentifier = conversationSchema.create("legacyIdentifier").setType(MetadataValueType.STRING);
    conversation_legacyIdentifier.setDefaultRequirement(true);
    conversation_legacyIdentifier.setSystemReserved(true);
    conversation_legacyIdentifier.setUndeletable(true);
    conversation_legacyIdentifier.setMultiLingual(false);
    conversation_legacyIdentifier.setSearchable(true);
    conversation_legacyIdentifier.setUniqueValue(true);
    conversation_legacyIdentifier.setUnmodifiable(true);
    MetadataBuilder conversation_logicallyDeletedOn = conversationSchema.create("logicallyDeletedOn").setType(MetadataValueType.DATE_TIME);
    conversation_logicallyDeletedOn.setSystemReserved(true);
    conversation_logicallyDeletedOn.setUndeletable(true);
    conversation_logicallyDeletedOn.setMultiLingual(false);
    MetadataBuilder conversation_manualTokens = conversationSchema.create("manualTokens").setType(MetadataValueType.STRING);
    conversation_manualTokens.setMultivalue(true);
    conversation_manualTokens.setSystemReserved(true);
    conversation_manualTokens.setUndeletable(true);
    conversation_manualTokens.setMultiLingual(false);
    conversation_manualTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder conversation_markedForParsing = conversationSchema.create("markedForParsing").setType(MetadataValueType.BOOLEAN);
    conversation_markedForParsing.setSystemReserved(true);
    conversation_markedForParsing.setUndeletable(true);
    conversation_markedForParsing.setMultiLingual(false);
    MetadataBuilder conversation_markedForPreviewConversion = conversationSchema.create("markedForPreviewConversion").setType(MetadataValueType.BOOLEAN);
    conversation_markedForPreviewConversion.setSystemReserved(true);
    conversation_markedForPreviewConversion.setUndeletable(true);
    conversation_markedForPreviewConversion.setMultiLingual(false);
    MetadataBuilder conversation_markedForReindexing = conversationSchema.create("markedForReindexing").setType(MetadataValueType.BOOLEAN);
    conversation_markedForReindexing.setSystemReserved(true);
    conversation_markedForReindexing.setUndeletable(true);
    conversation_markedForReindexing.setMultiLingual(false);
    MetadataBuilder conversation_migrationDataVersion = conversationSchema.create("migrationDataVersion").setType(MetadataValueType.NUMBER);
    conversation_migrationDataVersion.setSystemReserved(true);
    conversation_migrationDataVersion.setUndeletable(true);
    conversation_migrationDataVersion.setMultiLingual(false);
    conversation_migrationDataVersion.setEssentialInSummary(true);
    MetadataBuilder conversation_modifiedBy = conversationSchema.create("modifiedBy").setType(MetadataValueType.REFERENCE);
    conversation_modifiedBy.setSystemReserved(true);
    conversation_modifiedBy.setUndeletable(true);
    conversation_modifiedBy.setMultiLingual(false);
    conversation_modifiedBy.defineReferencesTo(types.getSchemaType("user"));
    MetadataBuilder conversation_modifiedOn = conversationSchema.create("modifiedOn").setType(MetadataValueType.DATE_TIME);
    conversation_modifiedOn.setSystemReserved(true);
    conversation_modifiedOn.setUndeletable(true);
    conversation_modifiedOn.setMultiLingual(false);
    conversation_modifiedOn.setSortable(true);
    MetadataBuilder conversation_nestedAuthorizations = conversationSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    conversation_nestedAuthorizations.setSystemReserved(true);
    conversation_nestedAuthorizations.setUndeletable(true);
    conversation_nestedAuthorizations.setMultiLingual(false);
    conversation_nestedAuthorizations.setEssentialInSummary(true);
    conversation_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    MetadataBuilder conversation_path = conversationSchema.create("path").setType(MetadataValueType.STRING);
    conversation_path.setMultivalue(true);
    conversation_path.setSystemReserved(true);
    conversation_path.setUndeletable(true);
    conversation_path.setMultiLingual(false);
    MetadataBuilder conversation_pathParts = conversationSchema.create("pathParts").setType(MetadataValueType.STRING);
    conversation_pathParts.setMultivalue(true);
    conversation_pathParts.setSystemReserved(true);
    conversation_pathParts.setUndeletable(true);
    conversation_pathParts.setMultiLingual(false);
    MetadataBuilder conversation_principalAncestorsIntIds = conversationSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    conversation_principalAncestorsIntIds.setMultivalue(true);
    conversation_principalAncestorsIntIds.setSystemReserved(true);
    conversation_principalAncestorsIntIds.setUndeletable(true);
    conversation_principalAncestorsIntIds.setMultiLingual(false);
    conversation_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder conversation_principalConceptsIntIds = conversationSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    conversation_principalConceptsIntIds.setMultivalue(true);
    conversation_principalConceptsIntIds.setSystemReserved(true);
    conversation_principalConceptsIntIds.setUndeletable(true);
    conversation_principalConceptsIntIds.setMultiLingual(false);
    conversation_principalConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder conversation_principalpath = conversationSchema.create("principalpath").setType(MetadataValueType.STRING);
    conversation_principalpath.setSystemReserved(true);
    conversation_principalpath.setUndeletable(true);
    conversation_principalpath.setMultiLingual(false);
    MetadataBuilder conversation_removedauthorizations = conversationSchema.create("removedauthorizations").setType(MetadataValueType.STRING);
    conversation_removedauthorizations.setMultivalue(true);
    conversation_removedauthorizations.setSystemReserved(true);
    conversation_removedauthorizations.setUndeletable(true);
    conversation_removedauthorizations.setMultiLingual(false);
    MetadataBuilder conversation_schema = conversationSchema.create("schema").setType(MetadataValueType.STRING);
    conversation_schema.setDefaultRequirement(true);
    conversation_schema.setSystemReserved(true);
    conversation_schema.setUndeletable(true);
    conversation_schema.setMultiLingual(false);
    MetadataBuilder conversation_secondaryConceptsIntIds = conversationSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    conversation_secondaryConceptsIntIds.setMultivalue(true);
    conversation_secondaryConceptsIntIds.setSystemReserved(true);
    conversation_secondaryConceptsIntIds.setUndeletable(true);
    conversation_secondaryConceptsIntIds.setMultiLingual(false);
    conversation_secondaryConceptsIntIds.setEssentialInSummary(true);
    MetadataBuilder conversation_shareDenyTokens = conversationSchema.create("shareDenyTokens").setType(MetadataValueType.STRING);
    conversation_shareDenyTokens.setMultivalue(true);
    conversation_shareDenyTokens.setSystemReserved(true);
    conversation_shareDenyTokens.setUndeletable(true);
    conversation_shareDenyTokens.setMultiLingual(false);
    conversation_shareDenyTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder conversation_shareTokens = conversationSchema.create("shareTokens").setType(MetadataValueType.STRING);
    conversation_shareTokens.setMultivalue(true);
    conversation_shareTokens.setSystemReserved(true);
    conversation_shareTokens.setUndeletable(true);
    conversation_shareTokens.setMultiLingual(false);
    conversation_shareTokens.defineValidators().add(ManualTokenValidator.class);
    MetadataBuilder conversation_title = conversationSchema.create("title").setType(MetadataValueType.STRING);
    conversation_title.setUndeletable(true);
    conversation_title.setMultiLingual(false);
    conversation_title.setSchemaAutocomplete(true);
    conversation_title.setSearchable(true);
    MetadataBuilder conversation_tokens = conversationSchema.create("tokens").setType(MetadataValueType.STRING);
    conversation_tokens.setMultivalue(true);
    conversation_tokens.setSystemReserved(true);
    conversation_tokens.setUndeletable(true);
    conversation_tokens.setMultiLingual(false);
    MetadataBuilder conversation_tokensHierarchy = conversationSchema.create("tokensHierarchy").setType(MetadataValueType.STRING);
    conversation_tokensHierarchy.setMultivalue(true);
    conversation_tokensHierarchy.setSystemReserved(true);
    conversation_tokensHierarchy.setUndeletable(true);
    conversation_tokensHierarchy.setMultiLingual(false);
    MetadataBuilder conversation_visibleInTrees = conversationSchema.create("visibleInTrees").setType(MetadataValueType.BOOLEAN);
    conversation_visibleInTrees.setSystemReserved(true);
    conversation_visibleInTrees.setUndeletable(true);
    conversation_visibleInTrees.setMultiLingual(false);
  }
  ...
  private void createGroupSchemaTypeMetadatas(MetadataSchemaTypesBuilder types, MetadataSchemaTypeBuilder groupSchemaType, MetadataSchemaBuilder groupSchema) {
    ...
    MetadataBuilder group_attachedPrincipalAncestorsIntIds = groupSchema.create("attachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    group_attachedPrincipalAncestorsIntIds.setMultivalue(true);
    group_attachedPrincipalAncestorsIntIds.setSystemReserved(true);
    group_attachedPrincipalAncestorsIntIds.setUndeletable(true);
    group_attachedPrincipalAncestorsIntIds.setMultiLingual(false);
    group_attachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder group_detachedPrincipalAncestorsIntIds = groupSchema.create("detachedPrincipalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    group_detachedPrincipalAncestorsIntIds.setMultivalue(true);
    group_detachedPrincipalAncestorsIntIds.setSystemReserved(true);
    group_detachedPrincipalAncestorsIntIds.setUndeletable(true);
    group_detachedPrincipalAncestorsIntIds.setMultiLingual(false);
    group_detachedPrincipalAncestorsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder group_hierarchy = groupSchema.create("hierarchy").setType(MetadataValueType.STRING);
    group_hierarchy.setUndeletable(true);
    ...
    MetadataBuilder group_locallyCreated = groupSchema.create("locallyCreated").setType(MetadataValueType.BOOLEAN);
    group_locallyCreated.setUndeletable(true);
    group_locallyCreated.setDefaultValue(true);
    ...
    MetadataBuilder group_nestedAuthorizations = groupSchema.create("nestedAuthorizations").setType(MetadataValueType.STRUCTURE);
    group_nestedAuthorizations.setSystemReserved(true);
    group_nestedAuthorizations.setUndeletable(true);
    group_nestedAuthorizations.setMultiLingual(false);
    group_nestedAuthorizations.setEssentialInSummary(true);
    group_nestedAuthorizations.defineStructureFactory(NestedRecordAuthorizationsStructureFactory.class);
    ...
    MetadataBuilder group_principalAncestorsIntIds = groupSchema.create("principalAncestorsIntIds").setType(MetadataValueType.INTEGER);
    group_principalAncestorsIntIds.setMultivalue(true);
    group_principalAncestorsIntIds.setSystemReserved(true);
    group_principalAncestorsIntIds.setUndeletable(true);
    group_principalAncestorsIntIds.setMultiLingual(false);
    group_principalAncestorsIntIds.setEssentialInSummary(true);
    MetadataBuilder group_principalConceptsIntIds = groupSchema.create("principalConceptsIntIds").setType(MetadataValueType.INTEGER);
    group_principalConceptsIntIds.setMultivalue(true);
    group_principalConceptsIntIds.setSystemReserved(true);
    group_principalConceptsIntIds.setUndeletable(true);
    group_principalConceptsIntIds.setMultiLingual(false);
    group_principalConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder group_secondaryConceptsIntIds = groupSchema.create("secondaryConceptsIntIds").setType(MetadataValueType.INTEGER);
    group_secondaryConceptsIntIds.setMultivalue(true);
    group_secondaryConceptsIntIds.setSystemReserved(true);
    group_secondaryConceptsIntIds.setUndeletable(true);
    group_secondaryConceptsIntIds.setMultiLingual(false);
    group_secondaryConceptsIntIds.setEssentialInSummary(true);
    ...
    MetadataBuilder group_status = groupSchema.create("status").setType(MetadataValueType.ENUM);
    group_status.setDefaultRequirement(true);
    group_status.setUndeletable(true);
    group_status.defineAsEnum(GlobalGroupStatus.class);
  ...
  public void applySchemasDisplay(SchemasDisplayManager manager) {
    ...
    transaction.add(manager.getMetadata(collection, "capsule_default_images").withMetadataGroup("").withInputType(MetadataInputType.CONTENT).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
    transaction.add(manager.getMetadata(collection, "capsule_default_language").withMetadataGroup("").withInputType(MetadataInputType.DROPDOWN).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getSchema(collection, "temporaryRecord_vaultScanReport").withFormMetadataCodes(asList("temporaryRecord_vaultScanReport_title", "temporaryRecord_vaultScanReport_daysBeforeDestruction")).withDisplayMetadataCodes(asList("temporaryRecord_vaultScanReport_title", "temporaryRecord_vaultScanReport_createdBy", "temporaryRecord_vaultScanReport_createdOn", "temporaryRecord_vaultScanReport_modifiedBy", "temporaryRecord_vaultScanReport_modifiedOn", "temporaryRecord_vaultScanReport_daysBeforeDestruction", "temporaryRecord_vaultScanReport_message", "temporaryRecord_vaultScanReport_numberOfDeletedContents")).withSearchResultsMetadataCodes(asList("temporaryRecord_vaultScanReport_title", "temporaryRecord_vaultScanReport_modifiedOn")).withTableMetadataCodes(asList("temporaryRecord_vaultScanReport_createdBy", "temporaryRecord_vaultScanReport_createdOn", "temporaryRecord_vaultScanReport_destructionDate", "temporaryRecord_vaultScanReport_content", "temporaryRecord_vaultScanReport_numberOfDeletedContents", "temporaryRecord_vaultScanReport_message")));
