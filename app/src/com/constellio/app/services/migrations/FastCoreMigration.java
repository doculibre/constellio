...
public class FastCoreMigration implements FastMigrationScript {
	@Override
	...
	GeneratedFastCoreMigration generatedFastCoreMigration;

	@Override
	public void migrate(String collection, MigrationResourcesProvider migrationResourcesProvider, AppLayerFactory appLayerFactory)
			throws Exception {
		generatedFastCoreMigration = new GeneratedFastCoreMigration(collection, appLayerFactory,
	...
	class SchemaAlteration extends MetadataSchemasAlterationHelper {
		...
		private MetadataSchemaTypeBuilder createGroupSchemaType(MetadataSchemaTypesBuilder typesBuilder) {
			...
			groupSchema.get(Schemas.INHERITED_AUTHORIZATIONS.getCode()).defineDataEntry()
					.asCopied(parentGroup, allAuthorizations);
