...
import com.constellio.app.services.migrations.scripts.CoreMigrationTo_8_1_888;
import com.constellio.app.services.migrations.scripts.CoreMigrationTo_8_1_999;
...
public class ConstellioEIM {
	...
	public List<MigrationScript> getMigrationScripts() {
		...
		scripts.add(new CoreMigrationTo_8_1_888());
		...
		scripts.add(new CoreMigrationTo_8_1_0_2());
		scripts.add(new CoreMigrationTo_8_1_999());
