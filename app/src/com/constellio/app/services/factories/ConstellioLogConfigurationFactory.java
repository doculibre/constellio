...
@Order(50)
public class ConstellioLogConfigurationFactory extends ConfigurationFactory {
	static Configuration createConfiguration(final String name, ConfigurationBuilder<BuiltConfiguration> builder) {
		...
		AppenderComponentBuilder rollingFile
				= builder.newAppender("rolling", "RollingFile").addAttribute("fileName", "log/constellio-log.log");
