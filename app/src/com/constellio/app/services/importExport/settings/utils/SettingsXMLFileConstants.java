...
public interface SettingsXMLFileConstants {
	String TYPES = "types";
	String COLLECTION_SETTINGS = "collection-settings";
	String CODE = "code";
	String TAXONOMIES = "taxonomies";
	String TAXONOMY = "taxonomy";
	String TITLE = "title";
	String TITLE_FR = "title_fr";
	String VISIBLE_IN_HOME_PAGE = "visibleInHomePage";
	String CLASSIFIED_TYPES1 = "classifiedTypes";
	String CLASSIFIED_TYPES = CLASSIFIED_TYPES1;
	String GROUPS = "groups";
	String USERS = "users";
	String VALUE_LIST = "valueList";
	String CODE_MODE = "codeMode";
	...
	String REFERENCED_TYPE = "referencedType";
	...
	String VISIBLE_IN_TABLES = "visibleInTables";
	String VISIBLE_IN_RESULT_IN = "visibleInResultIn";
	String VISIBLE_IN_DISPLAY_IN = "visibleInDisplayIn";
	String VISIBLE_IN_SEARCH_RESULT = "visibleInSearchResult";
	String VISIBLE_IN_DISPLAY = "visibleInDisplay";
	String VISIBLE_IN_FORM_IN = "visibleInFormIn";
	String VISIBLE_IN_FORM = "visibleInForm";
	String REQUIRED_IN = "requiredIn";
	...
	String RECORD_AUTOCOMPLETE = "recordAutocomplete";
