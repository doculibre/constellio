...
public class SearchResultTable extends BasePagedTable<SearchResultContainer> {
	...
	public SearchResultTable(SearchResultContainer container, boolean withCheckBoxes) {
		super(container);
