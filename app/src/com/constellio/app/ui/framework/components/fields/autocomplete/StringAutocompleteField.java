 ...
 * @author Vincent
 */
public class StringAutocompleteField<T> extends AutocompleteTextField {
	...
	public StringAutocompleteField(final AutocompleteSuggestionsProvider<T> suggestionsProvider) {
		super();
