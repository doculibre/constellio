...
public class BySignedDocumentEventsDataProvider extends AbstractDataProvider implements EventsCategoryDataProvider {
	...
	public BySignedDocumentEventsDataProvider(ModelLayerFactory modelLayerFactory, String collection,
	...
	void init(ModelLayerFactory modelLayerFactory) {
		...
		acceptedRequest.setLabel($("ListEventsView.signedDoc"));
		LogicalSearchQuery query = rmSchemasRecordsServices.newFindEventByDateRangeQuery(currentUser, EventType.SIGN_DOCUMENT, this.startDate, this.endDate);
	...
	public String getDataTitle() {
		return $("ListEventsView.signedDoc");
	}
