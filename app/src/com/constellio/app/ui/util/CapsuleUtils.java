...
public class CapsuleUtils {
    ...
    public static Capsule findCapsule(String collection, String language, String query, LogicalSearchQuery searchQuery) {
        return findCapsule(collection, language, query, searchQuery, null);
    }

    public static Capsule findCapsule(String collection, String language, String query, ModifiableSolrParams solrParams) {
        return findCapsule(collection, language, query, null, solrParams);
    }

    private static Capsule findCapsule(String collection, String language, String query, LogicalSearchQuery searchQuery, ModifiableSolrParams solrParams) {
        Capsule match = null;
