...
public class ViewErrorDisplay {
    ...
    public static  boolean validateFieldsContent(Map<Language, BaseTextField> baseTextFieldMap, BaseViewImpl listValueDomainView) {
    ...
    public static void setFieldErrors(List<Language> languagesInErrors, Map<Language, BaseTextField> baseTextFieldMap, String originalStyleName) {
        int i = 0;
