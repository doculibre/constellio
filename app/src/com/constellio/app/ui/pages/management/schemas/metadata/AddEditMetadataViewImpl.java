...
public class AddEditMetadataViewImpl extends BaseViewImpl implements AddEditMetadataView {
	...
	private MetadataForm newForm(final boolean editMode, final boolean inherited) {
		...
		List<Field<?>> fields = new ArrayList<>(asList((Field<?>) localcodeField, labelsField, dataEntryGroup,
				dataEntryRef, dataEntrySource, valueType, multivalueType, inputType, inputMask, metadataGroup,
				listOptionGroupRole, refType, requiredField, duplicableField, enabledField, searchableField,
				sortableField, advancedSearchField, highlight, autocomplete, uniqueField, multiLingualField));
