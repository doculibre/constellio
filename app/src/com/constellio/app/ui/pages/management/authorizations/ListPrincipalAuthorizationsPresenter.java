...
public class ListPrincipalAuthorizationsPresenter extends ListAuthorizationsPresenter {
	public ListPrincipalAuthorizationsPresenter(ListPrincipalAuthorizationsView view) {
		super(view);
	}
