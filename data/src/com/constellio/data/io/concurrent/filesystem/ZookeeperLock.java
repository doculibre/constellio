...
public class ZookeeperLock implements DistributedLock {
	...
	private static final Logger LOG = Logger.getLogger(ZookeeperLock.class.getName());
	...
	/**
	 * Equivalent to {@link #ZookeeperLock(ZooKeeper, String, Iterable)} with a default
	 * wide open {@code acl} ({@link ZooDefs.Ids#OPEN_ACL_UNSAFE}).
	 */
	public ZookeeperLock(ZooKeeper zkClient, String lockPath) {
	 ...
	 */
	public ZookeeperLock(ZooKeeper zkClient, String lockPath, Iterable<ACL> acl) {
