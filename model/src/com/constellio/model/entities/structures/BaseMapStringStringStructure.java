...
public abstract class BaseMapStringStringStructure implements ModifiableStructure, Map<String, String> {

	protected Map<String, String> stringStringMap;
	protected boolean dirty;

	public BaseMapStringStringStructure() {
		stringStringMap = new HashMap<>();
	}

	public BaseMapStringStringStructure(Map<String, String> parameters) {
		this.stringStringMap = parameters;
		dirty = false;
	}

	public BaseMapStringStringStructure with(String key, String value) {
		put(key, value);
		return this;
	}
