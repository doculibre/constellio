...
public class XmlUserCredential implements UserCredential {
	...
	public XmlUserCredential(String username, String firstName, String lastName, String email,
	...
	public XmlUserCredential(String username, String firstName, String lastName, String email,
							 List<String> personalEmails, String serviceKey,
							 boolean systemAdmin, List<String> globalGroups, List<String> collections,
							 Map<String, LocalDateTime> tokens,
							 UserCredentialStatus status, String domain, List<String> msExchDelegateListBL, String dn) {
		this.username = username;
	...
	public XmlUserCredential(String username, String firstName, String lastName, String email,
							 ...
							 Map<String, LocalDateTime> tokens,
							 UserCredentialStatus status, String domain, List<String> msExchDelegateListBL, String dn,
							 String address, String phone, String fax, String jobTitle) {
		this.username = username;
		this.firstName = firstName;
		this.lastName = lastName;
		this.title = firstName + " " + lastName;
