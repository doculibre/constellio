...
//	}
    ...
    private static void processSKOSConceptsFirstPass(Map<String, SkosConcept> parsedConcepts, SimpleNamespaceContext namespaceContext,
    ...
    private static void processSKOSConceptsSecondPass(Map<String, SkosConcept> parsedConcepts, SimpleNamespaceContext namespaceContext,
                                                      List<Element> skosConceptElements) throws JaxenException {
        for (Element skosConceptElement : skosConceptElements) {
            Attribute rdfAboutAttribute = getAttributeFromXPath(RDF_ABOUT_ATTR_XPATH, namespaceContext,
                    skosConceptElement);
    ...
    private static void processSKOSConceptsRelationships(Map<String, SkosConcept> parsedConcepts, SimpleNamespaceContext namespaceContext,
                                                         List<Element> skosConceptElements) throws JaxenException {
        for (Element skosConceptElement : skosConceptElements) {
            Attribute rdfAboutAttribute = getAttributeFromXPath(RDF_ABOUT_ATTR_XPATH, namespaceContext,
                    skosConceptElement);
