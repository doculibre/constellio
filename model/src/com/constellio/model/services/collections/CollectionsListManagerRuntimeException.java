...
public class CollectionsListManagerRuntimeException extends RuntimeException {
	...
	public static class CollectionsListManagerRuntimeException_CollectionsAlreadyExisting
			extends CollectionsListManagerRuntimeException {

		public CollectionsListManagerRuntimeException_CollectionsAlreadyExisting(String code) {
			super("Collection with code '" + code + "' already existing");
		}
	}
}
