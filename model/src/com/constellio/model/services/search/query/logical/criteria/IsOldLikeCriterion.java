...
public class IsOldLikeCriterion extends LogicalSearchValueCondition {

	private final Object value;
	private final MeasuringUnitTime measuringUnitTime;

	public IsOldLikeCriterion(Object value, MeasuringUnitTime measuringUnitTime) {
		super();
		this.value = value;
	...
	public String getSolrQuery(DataStoreField dataStoreField) {
		...
		query.append(dataStoreField.getDataStoreCode() + ":\"" + stringValue + "\"");
