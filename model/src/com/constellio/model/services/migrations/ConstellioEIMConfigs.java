...
public class ConstellioEIMConfigs {
	...
	public static final SystemConfiguration LOGIN_NOTIFICATION_STATE_ALERT;
	...
	static {
		...
		add(LOGIN_NOTIFICATION_STATE_ALERT = hiddenSystemConfigs.createBinary("loginNotificationStateAlert").whichIsHidden());
