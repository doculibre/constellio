...
import static com.constellio.model.services.records.bulkImport.RecordsImportServices.ALL_BOOLEAN_NO;
import static com.constellio.model.services.records.bulkImport.RecordsImportServices.ALL_BOOLEAN_YES;
...
public class RecordsImportValidator {
	...
	private void feedLegacyIdResolver(ImportData importData, Metadata metadata, String resolverStr) {
		...
		Resolver resolver = toResolver(resolverStr);
